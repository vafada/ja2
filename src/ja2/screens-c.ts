namespace ja2 {
  export let GameScreens: Screens[] /* [MAX_SCREENS] */ = [
    ...
    createScreensFrom(
      SavingScreenInitialize,
      SavingScreenHandle,
      SavingScreenShutdown,
    ), // 1, Title Screen
    createScreensFrom(
    ...
    createScreensFrom(
      InitScreenInitialize,
      InitScreenHandle,
      InitScreenShutdown,
    ), // 4, Title Screen
    createScreensFrom(
      MainGameScreenInit,
      MainGameScreenHandle,
      MainGameScreenShutdown,
    ), //5
    createScreensFrom(
      AniEditScreenInit,
      AniEditScreenHandle,
      AniEditScreenShutdown,
    ), //6
    createScreensFrom(
      PalEditScreenInit,
      PalEditScreenHandle,
      PalEditScreenShutdown,
    ), // 7
    ...
    createScreensFrom(
      LaptopScreenInit,
      LaptopScreenHandle,
      LaptopScreenShutdown,
    ),
    createScreensFrom(
      LoadSaveScreenInit,
      LoadSaveScreenHandle,
      LoadSaveScreenShutdown,
    ),
    createScreensFrom(
      MapUtilScreenInit,
      MapUtilScreenHandle,
      MapUtilScreenShutdown,
    ),
    createScreensFrom(FadeScreenInit, FadeScreenHandle, FadeScreenShutdown),
    createScreensFrom(
      MessageBoxScreenInit,
      MessageBoxScreenHandle,
      MessageBoxScreenShutdown,
    ),
    createScreensFrom(
      MainMenuScreenInit,
      MainMenuScreenHandle,
      MainMenuScreenShutdown,
    ), // 15
    createScreensFrom(
      AutoResolveScreenInit,
      AutoResolveScreenHandle,
      AutoResolveScreenShutdown,
    ),
    createScreensFrom(
      SaveLoadScreenInit,
      SaveLoadScreenHandle,
      SaveLoadScreenShutdown,
    ),
    createScreensFrom(
      OptionsScreenInit,
      OptionsScreenHandle,
