namespace ja2 {
  ...
  export function copyTeamSummary(
  ...
  export function readTeamSummary(
    o: TEAMSUMMARY,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeTeamSummary(
    o: TEAMSUMMARY,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function copySummaryFile(
  ...
  export function readSummaryFile(
    o: SUMMARYFILE,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    o.usNumItems = buffer.readUInt16LE(offset);
    offset += 2;
    o.usNumLights = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.dMajorMapVersion = buffer.readFloatLE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.usWarningRoomNums = buffer.readUInt16LE(offset);
    offset += 2;
    o.ubEnemiesHaveWaypoints = buffer.readUInt8(offset++);
    offset++; // padding
    o.uiNumItemsPosition = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiEnemyPlacementPosition = buffer.readUInt32LE(offset);
    offset += 4;
