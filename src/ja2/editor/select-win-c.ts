namespace ja2 {
  ...
  const SINGLEROOF_NUMELEMENTS =
    LASTROOF -
    Enum313.FIRSTROOF +
    1 +
    (LASTSLANTROOF - Enum313.FIRSTSLANTROOF + 1) +
    (LASTWALL - Enum313.FIRSTWALL + 1) +
    (Enum313.SECONDONROOF - Enum313.FIRSTONROOF + 1);
  const SINGLENEWROOF_NUMELEMENTS = LASTROOF - Enum313.FIRSTROOF + 1;
  const SINGLEBROKENWALL_NUMELEMENTS =
    LASTDECORATIONS -
    Enum313.FIRSTDECORATIONS +
    1 +
    (LASTWALL - Enum313.FIRSTWALL + 1) * 2;
  const SINGLEDECOR_NUMELEMENTS = LASTISTRUCT - Enum313.FIRSTISTRUCT + 1;
  const SINGLEDECAL_NUMELEMENTS =
    LASTWALLDECAL -
  ...
  const SINGLETOILET_NUMELEMENTS =
    Enum313.EIGHTISTRUCT - Enum313.FIFTHISTRUCT + 1;
  //#define ROOM_NUMELEMENTS							( (LASTWALL-FIRSTWALL+1) + (LASTFLOOR-FIRSTFLOOR+1) + \
  //																				(LASTROOF-FIRSTROOF+1) + (LASTSLANTROOF-FIRSTSLANTROOF+1) )
  const ROOM_NUMELEMENTS =
    LASTWALL -
    Enum313.FIRSTWALL +
    1 +
    (LASTFLOOR - Enum313.FIRSTFLOOR + 1) +
    (LASTROOF - Enum313.FIRSTROOF + 1) +
    2;
  ...
  export let SelOStructs: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTFULLSTRUCT, 0, 1),
  ]; // Default selections
  export let SelOStructs1: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FOURTHOSTRUCT, 0, 1),
  ]; // Default selections
  export let SelOStructs2: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.THIRDOSTRUCT, 0, 1),
  ]; // Default selections
  export let SelBanks: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTCLIFF, 0, 1),
  ];
  export let SelRoads: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTROAD, 0, 1),
  ];
  export let SelDebris: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.DEBRISROCKS, 0, 1),
  ];
  export let SelSingleWall: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTWALL, 0, 1),
  ];
  export let SelSingleDoor: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTDOOR, 0, 1),
  ];
  export let SelSingleWindow: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTWALL, 44, 1),
  ];
  export let SelSingleRoof: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTROOF, 0, 1),
  ];
  export let SelSingleNewRoof: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTROOF, 0, 1),
  ];
  export let SelSingleBrokenWall: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTDECORATIONS, 0, 1),
  ];
  export let SelSingleDecor: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTISTRUCT, 0, 1),
  ];
  export let SelSingleDecal: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTWALLDECAL, 0, 1),
  ];
  export let SelSingleFloor: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTFLOOR, 0, 1),
  ];
  export let SelSingleToilet: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIFTHISTRUCT, 0, 1),
  ];
  export let SelRoom: Selections[] /* [MAX_SELECTIONS] */ = [
    createSelectionsFrom(Enum313.FIRSTWALL, 0, 1),
  ];

  // Number of objects currently in the selection list
  export let iNumOStructsSelected: INT32 = 1;
  export let iNumOStructsSelected__Pointer = createPointer(
    () => iNumOStructsSelected,
    (v) => (iNumOStructsSelected = v),
  );
  export let iNumOStructs1Selected: INT32 = 1;
  export let iNumOStructs1Selected__Pointer = createPointer(
    () => iNumOStructs1Selected,
    (v) => (iNumOStructs1Selected = v),
  );
  export let iNumOStructs2Selected: INT32 = 1;
  export let iNumOStructs2Selected__Pointer = createPointer(
    () => iNumOStructs2Selected,
    (v) => (iNumOStructs2Selected = v),
  );
  export let iNumBanksSelected: INT32 = 1;
  export let iNumBanksSelected__Pointer = createPointer(
    () => iNumBanksSelected,
    (v) => (iNumBanksSelected = v),
  );
  export let iNumRoadsSelected: INT32 = 1;
  export let iNumRoadsSelected__Pointer = createPointer(
    () => iNumRoadsSelected,
    (v) => (iNumRoadsSelected = v),
  );
  export let iNumDebrisSelected: INT32 = 1;
  export let iNumDebrisSelected__Pointer = createPointer(
    () => iNumDebrisSelected,
    (v) => (iNumDebrisSelected = v),
  );

  export let iNumWallsSelected: INT32 = 1;
  export let iNumWallsSelected__Pointer = createPointer(
    () => iNumWallsSelected,
    (v) => (iNumWallsSelected = v),
  );
  export let iNumDoorsSelected: INT32 = 1;
  export let iNumDoorsSelected__Pointer = createPointer(
    () => iNumDoorsSelected,
    (v) => (iNumDoorsSelected = v),
  );
  export let iNumWindowsSelected: INT32 = 1;
  export let iNumWindowsSelected__Pointer = createPointer(
    () => iNumWindowsSelected,
    (v) => (iNumWindowsSelected = v),
  );
  export let iNumDecorSelected: INT32 = 1;
  export let iNumDecorSelected__Pointer = createPointer(
    () => iNumDecorSelected,
    (v) => (iNumDecorSelected = v),
  );
  export let iNumDecalsSelected: INT32 = 1;
  export let iNumDecalsSelected__Pointer = createPointer(
    () => iNumDecalsSelected,
    (v) => (iNumDecalsSelected = v),
  );
  export let iNumBrokenWallsSelected: INT32 = 1;
  export let iNumBrokenWallsSelected__Pointer = createPointer(
    () => iNumBrokenWallsSelected,
    (v) => (iNumBrokenWallsSelected = v),
  );
  export let iNumFloorsSelected: INT32 = 1;
  export let iNumFloorsSelected__Pointer = createPointer(
    () => iNumFloorsSelected,
    (v) => (iNumFloorsSelected = v),
  );
  export let iNumToiletsSelected: INT32 = 1;
  export let iNumToiletsSelected__Pointer = createPointer(
    () => iNumToiletsSelected,
    (v) => (iNumToiletsSelected = v),
  );
  export let iNumRoofsSelected: INT32 = 1;
  export let iNumRoofsSelected__Pointer = createPointer(
    () => iNumRoofsSelected,
    (v) => (iNumRoofsSelected = v),
  );
  export let iNumNewRoofsSelected: INT32 = 1;
  export let iNumNewRoofsSelected__Pointer = createPointer(
    () => iNumNewRoofsSelected,
    (v) => (iNumNewRoofsSelected = v),
  );
  export let iNumRoomsSelected: INT32 = 1;
  export let iNumRoomsSelected__Pointer = createPointer(
    () => iNumRoomsSelected,
    (v) => (iNumRoomsSelected = v),
  );
  ...
  export function CreateJA2SelectionWindow(sWhat: INT16): void {
    ...
    iCancelWin = CreateIconButton(
      iButtonIcons[CANCEL_ICON],
      0,
      BUTTON_USE_DEFAULT,
      600,
      40,
    ...
    iOkWin = CreateIconButton(
      iButtonIcons[OK_ICON],
      0,
      BUTTON_USE_DEFAULT,
      600,
      0,
    ...
    iScrollUp = CreateIconButton(
      iButtonIcons[UP_ICON],
      0,
      BUTTON_USE_DEFAULT,
      600,
      80,
    ...
    iScrollDown = CreateIconButton(
      iButtonIcons[DOWN_ICON],
      0,
      BUTTON_USE_DEFAULT,
      600,
      240,
  ...
  export function InitJA2SelectionWindow(): void {
    ...
    for (
      iCount3 = 0, iCount = 0;
      iCount < LASTOSTRUCT - Enum313.FIRSTFULLSTRUCT + 1;
      iCount++
    ) {
      hVObject =
        gTileDatabase[gTileTypeStartIndex[Enum313.FIRSTFULLSTRUCT + iCount]]
          .hTileSurface;
    ...
    OStructs[iCount3].ubType = DISPLAY_GRAPHIC;
    OStructs[iCount3].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.SIXTHOSTRUCT]].hTileSurface;
    ...
    OStructs1[0].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.FOURTHOSTRUCT]].hTileSurface;
    ...
    for (
      iCount = 0;
      iCount < Enum313.THIRDOSTRUCT - Enum313.FIRSTOSTRUCT;
      iCount++
    ) {
      OStructs1[iCount + 1].ubType = DISPLAY_GRAPHIC;
      OStructs1[iCount + 1].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTOSTRUCT + iCount]
        ].hTileSurface;
    ...
    OStructs2[7].hVObject =
      gTileDatabase[
        gTileTypeStartIndex[Enum313.SECONDDEBRISSTRUCT]
      ].hTileSurface;
    ...
    OStructs2[8].hVObject =
      gTileDatabase[
        gTileTypeStartIndex[Enum313.FIRSTLARGEEXPDEBRIS]
      ].hTileSurface;
    ...
    OStructs2[9].hVObject =
      gTileDatabase[
        gTileTypeStartIndex[Enum313.SECONDLARGEEXPDEBRIS]
      ].hTileSurface;
    ...
    OStructs2[10].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.NINTHOSTRUCT]].hTileSurface;
    ...
    OStructs2[11].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.TENTHOSTRUCT]].hTileSurface;
    ...
    for (iCount = 0; iCount < LASTDEBRIS - Enum313.DEBRISROCKS + 1; iCount++) {
      ...
      DebrisList[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.DEBRISROCKS + iCount]
        ].hTileSurface;
    ...
    DebrisList[iCount].ubType = DISPLAY_GRAPHIC;
    DebrisList[iCount].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.DEBRIS2MISC]].hTileSurface;
    DebrisList[iCount].usStart = DISPLAY_ALL_OBJECTS;
    DebrisList[iCount].usEnd = 0;
    ...
    DebrisList[iCount].ubType = DISPLAY_GRAPHIC;
    DebrisList[iCount].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.ANOTHERDEBRIS]].hTileSurface;
    DebrisList[iCount].usStart = DISPLAY_ALL_OBJECTS;
    DebrisList[iCount].usEnd = 0;
    ...
    for (iCount = 0; iCount < LASTWALL - Enum313.FIRSTWALL + 1; iCount++) {
      ...
      Room[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTWALL + iCount]
        ].hTileSurface;
    ...
    for (
      iCount2 = 0;
      iCount2 < LASTFLOOR - Enum313.FIRSTFLOOR + 1;
      iCount2++, iCount++
    ) {
      Room[iCount].ubType = DISPLAY_GRAPHIC;
      Room[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTFLOOR + iCount2]
        ].hTileSurface;
      Room[iCount].usStart = 0;
      Room[iCount].usEnd = 0;
    ...
    for (
      iCount2 = 0;
      iCount2 < LASTROOF - Enum313.FIRSTROOF + 1;
      iCount2++, iCount++
    ) {
      Room[iCount].ubType = DISPLAY_GRAPHIC;
      Room[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTROOF + iCount2]
        ].hTileSurface;
      Room[iCount].usStart = 0;
      Room[iCount].usEnd = 0;
    ...
    for (
      iCount2 = 0;
      iCount2 < 2 /*(LASTSLANTROOF - FIRSTSLANTROOF + 1)*/;
      iCount2++, iCount++
    ) {
      Room[iCount].ubType = DISPLAY_GRAPHIC;
      Room[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTSLANTROOF + iCount2]
        ].hTileSurface;
      Room[iCount].usStart = 0;
      Room[iCount].usEnd = 0;
    ...
    for (
      iCount = 0, iCount2 = 0;
      iCount < LASTWALL - Enum313.FIRSTWALL + 1;
      iCount++, iCount2 += 2
    ) {
    ...
    for (
      iCount = 0, iCount2 = 0;
      iCount < LASTDOOR - Enum313.FIRSTDOOR + 1;
      iCount++, iCount2 += 5
    ) {
      // closed
      ...
      SingleDoor[iCount2].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTDOOR + iCount]
        ].hTileSurface;
    ...
    for (iCount = 0; iCount < LASTROOF - Enum313.FIRSTROOF + 1; iCount++) {
      ...
      SingleRoof[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTROOF + iCount]
        ].hTileSurface;
    ...
    for (
      iCount2 = 0;
      iCount2 < LASTSLANTROOF - Enum313.FIRSTSLANTROOF + 1;
      iCount2++, iCount++
    ) {
      // Slanted roofs
      SingleRoof[iCount].ubType = DISPLAY_GRAPHIC;
    ...
    for (
      iCount2 = 0;
      iCount2 < LASTWALL - Enum313.FIRSTWALL + 1;
      iCount2++, iCount++
    ) {
      // A-Frames
      SingleRoof[iCount].ubType = DISPLAY_GRAPHIC;
      SingleRoof[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTWALL + iCount2]
        ].hTileSurface;
    ...
    for (
      iCount2 = 0;
      iCount2 < Enum313.SECONDONROOF - Enum313.FIRSTONROOF + 1;
      iCount2++, iCount++
    ) {
      // On roofs
      SingleRoof[iCount].ubType = DISPLAY_GRAPHIC;
      SingleRoof[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTONROOF + iCount2]
        ].hTileSurface;
      SingleRoof[iCount].usStart = DISPLAY_ALL_OBJECTS;
      SingleRoof[iCount].usEnd = 0;
    ...
    for (
      iCount = 0;
      iCount < LASTDECORATIONS - Enum313.FIRSTDECORATIONS + 1;
      iCount++
    ) {
      ...
      SingleBrokenWall[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTDECORATIONS + iCount]
        ].hTileSurface;
    ...
    for (
      iCount = 0;
      iCount < LASTISTRUCT - Enum313.FIRSTISTRUCT + 1;
      iCount++
    ) {
      SingleDecor[iCount].ubType = DISPLAY_GRAPHIC;
      SingleDecor[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTISTRUCT + iCount]
        ].hTileSurface;
    ...
    for (
      iCount = 0;
      iCount < LASTWALLDECAL - Enum313.FIRSTWALLDECAL + 1;
      iCount++
    ) {
      SingleDecal[iCount].ubType = DISPLAY_GRAPHIC;
      SingleDecal[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTWALLDECAL + iCount]
        ].hTileSurface;
    ...
    for (
      iCount2 = 0;
      iCount2 < Enum313.EIGTHWALLDECAL - Enum313.FIFTHWALLDECAL + 1;
      iCount++, iCount2++
    ) {
      SingleDecal[iCount].ubType = DISPLAY_GRAPHIC;
      SingleDecal[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIFTHWALLDECAL + iCount2]
        ].hTileSurface;
      SingleDecal[iCount].usStart = DISPLAY_ALL_OBJECTS;
      SingleDecal[iCount].usEnd = 0;
    ...
    SingleDecal[iCount].ubType = DISPLAY_GRAPHIC;
    SingleDecal[iCount].hVObject =
      gTileDatabase[gTileTypeStartIndex[Enum313.FIRSTSWITCHES]].hTileSurface;
    SingleDecal[iCount].usStart = DISPLAY_ALL_OBJECTS;
    SingleDecal[iCount].usEnd = 0;
    ...
    for (iCount = 0; iCount < LASTFLOOR - Enum313.FIRSTFLOOR + 1; iCount++) {
      ...
      SingleFloor[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIRSTFLOOR + iCount]
        ].hTileSurface;
    ...
    for (
      iCount = 0;
      iCount < Enum313.EIGHTISTRUCT - Enum313.FIFTHISTRUCT + 1;
      iCount++
    ) {
      SingleToilet[iCount].ubType = DISPLAY_GRAPHIC;
      SingleToilet[iCount].hVObject =
        gTileDatabase[
          gTileTypeStartIndex[Enum313.FIFTHISTRUCT + iCount]
        ].hTileSurface;
  ...
  export function ShutdownJA2SelectionWindow(): void {
    ...
    for (x = 0; x < 4; x++) UnloadGenericButtonIcon(iButtonIcons[x]);
  ...
  export function RenderSelectionWindow(): void {
    ...
    if (gfRenderSquareArea) {
      ...
      if (
        Math.abs(iStartClickX - button.Area.MouseXPos) > 9 ||
        Math.abs(
          iStartClickY -
            (button.Area.MouseYPos + iTopWinCutOff - SelWinStartPoint.iY),
        ) > 9
      ) {
        ...
        usFillColor = Get16BPPColor(
          FROMRGB(255, RenderSelectionWindow__usFillGreen, 0),
        );
  ...
  function SelWinClkCallback(button: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      while (pNode != null && !fDone) {
        if (
          iClickX >= pNode.iX &&
          iClickX < pNode.iX + pNode.iWidth &&
          iClickY >= pNode.iY &&
          iClickY < pNode.iY + pNode.iHeight
        ) {
          fDone = true;
  ...
  export function DisplaySelectionWindowGraphicalInformation(): void {
    ...
    while (pNode != null && !fDone) {
      if (
        gusMouseXPos >= pNode.iX &&
        gusMouseXPos < pNode.iX + pNode.iWidth &&
        y >= pNode.iY &&
    ...
    if (pNode) {
      ...
      if (
        !gTilesets[giCurrentTilesetID].TileSurfaceFilenames[pNode.uiObjIndx][0]
      ) {
        mprintf(
          2,
          2,
          "%s[%d] is from default tileset %s (%s)",
  ...
  function AddToSelectionList(pNode: DisplayList): void {
    ...
    for (iIndex = 0; iIndex < pNumSelList.value && !fDone; iIndex++) {
      if (
        pNode.uiObjIndx == pSelList[iIndex].uiObject &&
  ...
  function RemoveFromSelectionList(pNode: DisplayList): boolean {
    ...
    if (pNumSelList.value <= 0) return true;
  ...
  export function GetRandomSelection(): INT32 {
    ...
    for (
      iIndex = 0;
      iIndex < pNumSelList.value && iSelectedIndex == -1;
      iIndex++
    ) {
  ...
  function BuildDisplayWindow(
    pDisplaySpecs: DisplaySpec[],
    usNumSpecs: UINT16,
    pDisplayList: Pointer<DisplayList>,
    pUpperLeft: SGPPoint,
    pBottomRight: SGPPoint,
    pSpacing: SGPPoint,
    fFlags: UINT16,
  ): boolean {
    ...
    for (usSpecLoop = 0; usSpecLoop < usNumSpecs; usSpecLoop++) {
      ...
      if (pDisplaySpec.ubType == DISPLAY_GRAPHIC) {
        ...
        for (
          usETRLELoop = usETRLEStart;
          usETRLELoop <= usETRLEEnd;
          usETRLELoop++
        ) {
          pETRLEObject = pDisplaySpec.hVObject.pETRLEObject[usETRLELoop];

          if (
            iCurrX + pETRLEObject.usWidth > pBottomRight.iX ||
            fFlags & ONE_COLUMN
          ) {
            if (fFlags & ONE_ROW) {
              break;
          ...
          if ((pCurNode = createDisplayList()) != null) {
            ...
            if (IsInSelectionList(pCurNode)) pCurNode.fChosen = true;
            else pCurNode.fChosen = false;
  ...
  //
  function DisplayWindowFunc(
    pNode: DisplayList | null,
    iTopCutOff: INT16,
    iBottomCutOff: INT16,
    pUpperLeft: SGPPoint,
    fFlags: UINT16,
