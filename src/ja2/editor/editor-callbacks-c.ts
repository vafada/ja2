namespace ja2 {
  ...
  export function BtnIncBrushDensityCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BtnDecBrushDensityCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingCrackWallCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingFurnitureCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingSmartWallCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingSmartWindowCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingSmartDoorCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingSmartCrackWallCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingDoorKeyCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingNewRoomCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingNewRoofCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingCaveDrawingCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingSawRoomCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingKillBuildingCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingCopyBuildingCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingMoveBuildingCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingDrawRoomNumCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingEraseRoomNumCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingToggleRoofViewCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingToggleWallViewCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function BuildingToggleInfoViewCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MapInfoDrawExitGridCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfoEntryPointsCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (
      reason &
      (MSYS_CALLBACK_REASON_LBUTTON_UP | MSYS_CALLBACK_REASON_RBUTTON_UP)
    ) {
      let x: INT16;
      let sGridNo: INT16;
      for (
        x = Enum32.MAPINFO_NORTH_POINT;
        x <= Enum32.MAPINFO_ISOLATED_POINT;
        x++
      ) {
  ...
  export function MapInfoNormalRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfoBasementRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfoCavesRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfoPrimeTimeRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfoNightTimeRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MapInfo24HourTimeRadioCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function BtnChangeTilesetCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  // ITEMS
  export function MouseMovedInItemsRegion(
    reg: MOUSE_REGION,
    reason: INT32,
  ): void {
  ...
  export function MouseClickedInItemsRegion(
    reg: MOUSE_REGION,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function ItemsExplosivesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function ItemsEquipment1Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function ItemsEquipment2Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function ItemsEquipment3Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function ItemsLeftScrollCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function ItemsRightScrollCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsPlayerTeamCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsCreatureTeamCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsCivilianTeamCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsInventorySlotCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else SetEnemyDroppableStatus(uiSlot, false);
    }
  }

  export function MercsSetEnemyColorCodeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsCivilianGroupCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  export function MercsScheduleAction1Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      InitPopupMenu(
        iEditorButton[Enum32.MERCS_SCHEDULE_ACTION1],
        Enum53.SCHEDULEACTION_POPUP,
        DIR_UPRIGHT,
      );
    }
  }

  export function MercsScheduleAction2Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      InitPopupMenu(
        iEditorButton[Enum32.MERCS_SCHEDULE_ACTION2],
        Enum53.SCHEDULEACTION_POPUP,
        DIR_UPRIGHT,
      );
    }
  ...
  export function MercsScheduleAction3Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      InitPopupMenu(
        iEditorButton[Enum32.MERCS_SCHEDULE_ACTION3],
        Enum53.SCHEDULEACTION_POPUP,
        DIR_UPRIGHT,
      );
    }
  ...
  export function MercsScheduleAction4Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      InitPopupMenu(
        iEditorButton[Enum32.MERCS_SCHEDULE_ACTION4],
        Enum53.SCHEDULEACTION_POPUP,
        DIR_UPRIGHT,
      );
    }
  ...
  export function MercsScheduleToggleVariance1Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else gCurrSchedule.usFlags &= ~SCHEDULE_FLAGS_VARIANCE1;
    }
  }

  export function MercsScheduleToggleVariance2Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else gCurrSchedule.usFlags &= ~SCHEDULE_FLAGS_VARIANCE2;
    }
  }

  export function MercsScheduleToggleVariance3Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else gCurrSchedule.usFlags &= ~SCHEDULE_FLAGS_VARIANCE3;
    }
  }

  export function MercsScheduleToggleVariance4Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else gCurrSchedule.usFlags &= ~SCHEDULE_FLAGS_VARIANCE4;
    }
  }

  export function MercsScheduleData1ACallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData1BCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData2ACallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData2BCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData3ACallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData3BCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData4ACallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleData4BCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsScheduleClearCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsDetailedPlacementCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function MercsPriorityExistanceCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (gpSelected) {
        ...
        if (gpSelected.pDetailedPlacement) {
          gpSelected.pDetailedPlacement.fHasKeys =
            gpSelected.pBasicPlacement.fHasKeys;
        }
      }
    }
  }

  export function MercsGeneralModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsAttributesModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsInventoryModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsAppearanceModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsProfileModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsScheduleModeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsSetAttitudeCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsDirectionSetCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsFindSelectedMercCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  export function MercsSetRelativeEquipmentCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MercsSetRelativeAttributesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
  ...
  export function MouseMovedInMercRegion(
    reg: MOUSE_REGION,
    reason: INT32,
  ): void {
    HandleMercInventoryPanel(
      reg.RelativeXPos,
      reg.RelativeYPos,
      Enum44.GUI_MOVE_EVENT,
    );
  }

  export function MouseClickedInMercRegion(
    reg: MOUSE_REGION,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
      HandleMercInventoryPanel(
        reg.RelativeXPos,
        reg.RelativeYPos,
        Enum44.GUI_LCLICK_EVENT,
      );
    else if (reason & MSYS_CALLBACK_REASON_RBUTTON_UP)
      HandleMercInventoryPanel(
        reg.RelativeXPos,
        reg.RelativeYPos,
        Enum44.GUI_RCLICK_EVENT,
      );
  }
  ...
  export function BtnEraseCallback(btn: GUI_BUTTON, reason: INT32): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      iEditorToolbarState =
        btn.uiFlags & BUTTON_CLICKED_ON
          ? Enum35.TBAR_MODE_ERASE
          : Enum35.TBAR_MODE_ERASE_OFF;
    }
  }

  // ITEM STATS
  export function ItemStatsToggleHideCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      else ExecuteItemStatsCmd(Enum48.ITEMSTATS_SHOW);
    }
  }

  export function ItemStatsDeleteCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP)
