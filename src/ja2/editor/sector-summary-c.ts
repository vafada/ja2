namespace ja2 {
  ...
  let gbSectorLevels: UINT8[][] /* boolean[16][16] */ = createArrayFrom(
    16,
    () => createArray(16, 0),
  );
  let gfGlobalSummaryLoaded: boolean = false;

  let gpSectorSummary: SUMMARYFILE[][][] /* Pointer<SUMMARYFILE>[16][16][8] */ =
    createArrayFrom(16, () =>
      createArrayFrom(16, () => createArray(8, <SUMMARYFILE>(<unknown>null))),
    );
  ...
  let gpWorldItemsSummaryArray: WORLDITEM[] /* Pointer<WORLDITEM> */ = <
    WORLDITEM[]
  >(<unknown>null);
  let gusWorldItemsSummaryArraySize: UINT16 = 0;
  let gpPEnemyItemsSummaryArray: OBJECTTYPE[] /* Pointer<OBJECTTYPE> */ = <
    OBJECTTYPE[]
  >(<unknown>null);
  let gusPEnemyItemsSummaryArraySize: UINT16 = 0;
  let gpNEnemyItemsSummaryArray: OBJECTTYPE[] /* Pointer<OBJECTTYPE> */ = <
    OBJECTTYPE[]
  >(<unknown>null);
  ...
  export function CreateSummaryWindow(): void {
    ...
    iSummaryButton[Enum58.SUMMARY_BACKGROUND] = CreateTextButton(
      "",
      0,
      0,
      0,
    ...
    SpecifyDisabledButtonStyle(
      iSummaryButton[Enum58.SUMMARY_BACKGROUND],
      Enum29.DISABLED_STYLE_NONE,
    );
    DisableButton(iSummaryButton[Enum58.SUMMARY_BACKGROUND]);

    iSummaryButton[Enum58.SUMMARY_OKAY] = CreateTextButton(
      "Okay",
      FONT12POINT1(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    iSummaryButton[Enum58.SUMMARY_GRIDCHECKBOX] = CreateCheckBoxButton(
      MAP_LEFT,
      MAP_BOTTOM + 5,
      "EDITOR//smcheckbox.sti",
      MSYS_PRIORITY_HIGH,
      SummaryToggleGridCallback,
    );
    ButtonList[iSummaryButton[Enum58.SUMMARY_GRIDCHECKBOX]].uiFlags |=
      BUTTON_CLICKED_ON;
    gfRenderGrid = true;

    iSummaryButton[Enum58.SUMMARY_PROGRESSCHECKBOX] = CreateCheckBoxButton(
      MAP_LEFT + 50,
      MAP_BOTTOM + 5,
      "EDITOR//smcheckbox.sti",
      MSYS_PRIORITY_HIGH,
    ...
    ButtonList[iSummaryButton[Enum58.SUMMARY_PROGRESSCHECKBOX]].uiFlags |=
      BUTTON_CLICKED_ON;
    gfRenderProgress = true;

    iSummaryButton[Enum58.SUMMARY_ALL] = CreateTextButton(
      "A",
      SMALLCOMPFONT(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    if (
      ...
      giCurrentViewLevel == ALTERNATE_LEVELS_MASK
    )
      ButtonList[iSummaryButton[Enum58.SUMMARY_ALL]].uiFlags |=
        BUTTON_CLICKED_ON;
    iSummaryButton[Enum58.SUMMARY_G] = CreateTextButton(
      "G",
      SMALLCOMPFONT(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    if (
      ...
      giCurrentViewLevel == ALTERNATE_GROUND_MASK
    )
      ButtonList[iSummaryButton[Enum58.SUMMARY_G]].uiFlags |= BUTTON_CLICKED_ON;
    iSummaryButton[Enum58.SUMMARY_B1] = CreateTextButton(
      "B1",
      SMALLCOMPFONT(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    if (
      ...
      ButtonList[iSummaryButton[Enum58.SUMMARY_B1]].uiFlags |=
        BUTTON_CLICKED_ON;
    iSummaryButton[Enum58.SUMMARY_B2] = CreateTextButton(
      "B2",
      SMALLCOMPFONT(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    if (
      ...
      ButtonList[iSummaryButton[Enum58.SUMMARY_B2]].uiFlags |=
        BUTTON_CLICKED_ON;
    iSummaryButton[Enum58.SUMMARY_B3] = CreateTextButton(
      "B3",
      SMALLCOMPFONT(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    if (
      ...
      ButtonList[iSummaryButton[Enum58.SUMMARY_B3]].uiFlags |=
        BUTTON_CLICKED_ON;

    iSummaryButton[Enum58.SUMMARY_ALTERNATE] = CreateCheckBoxButton(
      MAP_LEFT,
      MAP_BOTTOM + 25,
      "EDITOR//smcheckbox.sti",
      MSYS_PRIORITY_HIGH,
      SummaryToggleAlternateCallback,
    );
    if (gfAlternateMaps)
      ButtonList[iSummaryButton[Enum58.SUMMARY_ALTERNATE]].uiFlags |=
        BUTTON_CLICKED_ON;

    iSummaryButton[Enum58.SUMMARY_LOAD] = CreateTextButton(
      "LOAD",
      FONT12POINT1(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    iSummaryButton[Enum58.SUMMARY_SAVE] = CreateTextButton(
      "SAVE",
      FONT12POINT1(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    iSummaryButton[Enum58.SUMMARY_OVERRIDE] = CreateCheckBoxButton(
      MAP_LEFT + 110,
      MAP_BOTTOM + 59,
      "EDITOR\\smcheckbox.sti",
      MSYS_PRIORITY_HIGH,
      SummaryOverrideCallback,
    );

    iSummaryButton[Enum58.SUMMARY_UPDATE] = CreateTextButton(
      "Update",
      FONT12POINT1(),
      FONT_BLACK,
      FONT_BLACK,
    ...
    iSummaryButton[Enum58.SUMMARY_REAL] = CreateCheckBoxButton(
      350,
      47,
    ...
    iSummaryButton[Enum58.SUMMARY_SCIFI] = CreateCheckBoxButton(
      376,
      47,
      "EDITOR\\radiobutton.sti",
      MSYS_PRIORITY_HIGH,
      SummarySciFiCallback,
    );
    iSummaryButton[Enum58.SUMMARY_ENEMY] = CreateCheckBoxButton(
      350,
      60,
      "EDITOR\\radiobutton.sti",
      MSYS_PRIORITY_HIGH,
      SummaryEnemyCallback,
    );
    ...
    switch (gubSummaryItemMode) {
      case Enum56.ITEMMODE_SCIFI:
        ButtonList[iSummaryButton[Enum58.SUMMARY_SCIFI]].uiFlags |=
          BUTTON_CLICKED_ON;
        break;
      case Enum56.ITEMMODE_REAL:
        ButtonList[iSummaryButton[Enum58.SUMMARY_REAL]].uiFlags |=
          BUTTON_CLICKED_ON;
        break;
      case Enum56.ITEMMODE_ENEMY:
        ButtonList[iSummaryButton[Enum58.SUMMARY_ENEMY]].uiFlags |=
          BUTTON_CLICKED_ON;
        break;
    }
    ...
    AddTextInputField(
      ...
      "",
      20,
      Enum383.INPUTTYPE_EXCLUSIVE_DOSFILENAME,
    );
    ...
    if (gfAutoLoadA9) {
      ...
      ButtonList[iSummaryButton[Enum58.SUMMARY_LOAD]].uiFlags |=
        BUTTON_CLICKED_ON;
    }
  }
  ...
  export function AutoLoadMap(): void {
    SummaryLoadMapCallback(
      ButtonList[iSummaryButton[Enum58.SUMMARY_LOAD]],
  ...
  function RenderSectorInformation(): void {
    ...
    mprintf(
      10,
      42,
      "Version Info:  Summary:  1.%s,  Map:  %d.%s",
      s.ubSummaryVersion.toString().padStart(2, "0"),
      s.dMajorMapVersion,
      m.ubMapVersion.toString().padStart(2, "0"),
    );
    ...
    if (s.ubNumAdmins)
      mprintf(
        100,
        115,
        "(%d detailed, %d profile -- %d have priority existance)",
        s.ubAdminDetailed,
        s.ubAdminProfile,
        s.ubAdminExistance,
      );
    ...
    if (s.ubSummaryVersion >= 9) {
      mprintf(
        ...
        155,
        "Humans:  %d",
        s.CivTeam.ubTotal - s.ubCivCows - s.ubCivBloodcats,
      );
    ...
    if (s.ubSummaryVersion >= 9) {
      mprintf(
        ...
        195,
        "Monsters:  %d",
        s.CreatureTeam.ubTotal - s.CreatureTeam.ubNumAnimals,
      );
    ...
    mprintf(
      10,
      215,
      "Number of locked and/or trapped doors:  %d",
      s.ubNumDoors,
    );
      ...
      if (s.fTooManyExitGridDests) {
        ...
        if (ubNumInvalid) {
          ...
          mprintf(
            10,
            265,
            "ExitGrids:  %d (%d with a long distance destination)",
            s.ubNumExitGridDests,
            ubNumInvalid,
          );
        } else
          switch (s.ubNumExitGridDests) {
            ...
            case 1:
              mprintf(
                10,
                265,
                "ExitGrids:  1 destination using %d exitgrids",
                s.usExitGridSize[0],
              );
              break;
            case 2:
            ...
            case 3:
              mprintf(
                10,
                265,
                "ExitGrids:  3 -- 1) Qty: %d, 2) Qty: %d, 3) Qty: %d",
                s.usExitGridSize[0],
                s.usExitGridSize[1],
                s.usExitGridSize[2],
              );
            ...
            case 4:
              mprintf(
                10,
                265,
                "ExitGrids:  3 -- 1) Qty: %d, 2) Qty: %d, 3) Qty: %d, 4) Qty: %d",
                s.usExitGridSize[0],
                s.usExitGridSize[1],
                s.usExitGridSize[2],
                s.usExitGridSize[3],
    ...
    mprintf(
      10,
      usLine,
      "Enemy Relative Attributes:  %d bad, %d poor, %d norm, %d good, %d great (%+d Overall)",
      s.EnemyTeam.ubBadA,
      s.EnemyTeam.ubPoorA,
      s.EnemyTeam.ubAvgA,
      s.EnemyTeam.ubGoodA,
    ...
    mprintf(
      10,
      usLine,
      "Enemy Relative Equipment:  %d bad, %d poor, %d norm, %d good, %d great (%+d Overall)",
      s.EnemyTeam.ubBadE,
      s.EnemyTeam.ubPoorE,
      s.EnemyTeam.ubAvgE,
      s.EnemyTeam.ubGoodE,
    ...
    if (s.ubSummaryVersion >= 11) {
      if (s.ubEnemiesReqWaypoints) {
        ...
        mprintf(
          10,
          usLine,
          "%d placements have patrol orders without any waypoints defined.",
    ...
    if (s.ubSummaryVersion >= 13) {
      if (s.ubEnemiesHaveWaypoints) {
        ...
        mprintf(
          10,
          usLine,
          "%d placements have waypoints, but without any patrol orders.",
    ...
    if (s.ubSummaryVersion >= 12) {
      if (s.usWarningRoomNums) {
        ...
        mprintf(
          10,
          usLine,
          "%d gridnos have questionable room numbers.  Please validate.",
          s.usWarningRoomNums,
        );
      }
    }
  ...
  function RenderItemDetails(): void {
    ...
    if (
      ...
      for (index = 1; index < Enum225.MAXITEMS; index++) {
            ...
            if (gpWorldItemsSummaryArray[i].o.usItem == index) {
              if (
                (gubSummaryItemMode == Enum56.ITEMMODE_SCIFI &&
                  !(
                    gpWorldItemsSummaryArray[i].usFlags &
                    WORLD_ITEM_REALISTIC_ONLY
                  )) ||
                ...
                if (!pItem.bFrequency) bFreqIndex = 7;
                else if (pItem.bFrequency == PANIC_FREQUENCY) bFreqIndex = 0;
                else if (pItem.bFrequency == PANIC_FREQUENCY_2) bFreqIndex = 1;
                else if (pItem.bFrequency == PANIC_FREQUENCY_3) bFreqIndex = 2;
        ...
        if (uiQuantity) {
          if (!(yp % 20)) SetFontForeground(FONT_LTKHAKI);
          else SetFontForeground(FONT_GRAY2);
          // calc averages
      ...
      for (i = 0; i < 8; i++) {
        if (uiTriggerQuantity[i] || uiActionQuantity[i]) {
          if (i == 7) SetFontForeground(FONT_DKYELLOW);
          else if (!uiTriggerQuantity[i] || !uiActionQuantity[i])
            SetFontForeground(FONT_RED);
          else SetFontForeground(77);
          switch (i) {
            case 0:
              str = "Panic1";
              break;
          ...
          if (i < 7) {
            ...
            mprintf(
              xp,
              yp,
              "%s:  %s trigger(s), %s action(s)",
              str,
              dAvgExistChance.toFixed(2).padStart(3),
              dAvgStatus.toFixed(2).padStart(3),
            );
          } else {
      ...
      mprintf(
        5,
        50,
        "ERROR:  Can't load the items for this map.  Reason unknown.",
      );
    }
  }
  ...
  export function RenderSummaryWindow(): void {
    ...
    let uiDestPitchBYTES__Pointer = createPointer(
      () => uiDestPitchBYTES,
    ...
    if (gfTempFile)
      // constantly extract the temp filename for updating purposes.
      ExtractTempFilename();
    if (gfRenderSummary) {
      ...
      if (!gfItemDetailsMode) {
        mprintf(
          10,
          5,
          "CAMPAIGN EDITOR -- %s Version 1.%s",
          gszVersionType[GLOBAL_SUMMARY_STATE],
          GLOBAL_SUMMARY_VERSION.toString().padStart(2, "0"),
        );
      }
      ...
      if (gfGlobalSummaryExists) {
        ...
        if (gusNumEntriesWithOutdatedOrNoSummaryInfo && !gfOutdatedDenied) {
          ...
          mprintf(
            10,
            20,
            "You currently have %d outdated maps.",
            gusNumEntriesWithOutdatedOrNoSummaryInfo,
          );
          mprintf(
            10,
            30,
            "The more maps that need to be updated, the longer it takes.  It'll take ",
          );
          mprintf(
            10,
            40,
            "approximately 4 minutes on a P200MMX to analyse 100 maps, so",
          );
          ...
          mprintf(
            10,
            65,
            "Do you wish to regenerate info for ALL these maps at this time (y/n)?",
          );
          ...
          if (gfTempFile) {
            ...
            mprintf(
              10,
              30,
              "Entering a temp file name that doesn't follow campaign editor conventions...",
            );
            ...
            mprintf(
              10,
              30,
              "You need to either load an existing map or create a new map before being",
            );
            mprintf(
              10,
              40,
              "able to enter the editor, or you can quit (ESC or Alt+x).",
            );
          }
        } else {
          // Build sector string
          if (gsSelSectorX) (x = gsSelSectorX - 1), (y = gsSelSectorY - 1);
          else (x = gsSectorX - 1), (y = gsSectorY - 1);
          str = swprintf(
            "%s%d",
          ...
          switch (giCurrentViewLevel) {
            case ALL_LEVELS_MASK:
              ...
              else fSectorSummaryExists = false;
              break;
          ...
          if (fSectorSummaryExists) {
            ...
            if (gpCurrentSectorSummary) {
              if (
                gpCurrentSectorSummary.ubSummaryVersion < GLOBAL_SUMMARY_VERSION
              )
                ShowButton(iSummaryButton[Enum58.SUMMARY_UPDATE]);
              else HideButton(iSummaryButton[Enum58.SUMMARY_UPDATE]);
              if (!gfAlternateMaps) SetFontForeground(FONT_YELLOW);
              else SetFontForeground(FONT_LTBLUE);
              if (gfItemDetailsMode) {
            ...
            if (!gfAlternateMaps) SetFontForeground(FONT_ORANGE);
            else {
            ...
            else mprintf(10, 20, "No information exists for sector %s.", str);
            SetFontShadow(FONT_NEARBLACK);
        ...
        if (gotoSpecialCase) {
          ...
          if (gubOverrideStatus == Enum57.INACTIVE) {
            if (!gfAlternateMaps) SetFontForeground(FONT_LTKHAKI);
            else SetFontForeground(FONT_LTBLUE);
            mprintf(
              MAP_LEFT + 110,
              MAP_BOTTOM + 55,
          ...
          } // little higher to make room for the override checkbox and text.
          else {
            if (!gfAlternateMaps) SetFontForeground(FONT_LTKHAKI);
            else SetFontForeground(FONT_LTBLUE);
            mprintf(
        ...
        mprintf(
          10,
          20,
          "You currently have no summary data.  By creating one, you will be able to keep track",
        );
        mprintf(
          10,
          30,
          "of information pertaining to all of the sectors you edit and save.  The creation process",
        );
        mprintf(
          10,
          40,
          "will analyse all maps in your \\MAPS directory, and generate a new one.  This could",
        );
        mprintf(
          10,
          50,
          "take a few minutes depending on how many valid maps you have.  Valid maps are",
        );
        mprintf(
          10,
          60,
          "maps following the proper naming convention from a1.dat - p16.dat.  Underground maps",
        );
        mprintf(
          10,
          70,
          "are signified by appending _b1 to _b3 before the .dat (ex:  a9_b1.dat). ",
        );
        SetFontForeground(FONT_LTRED);
    ...
    if (gfRenderMap) {
      ...
      for (x = 1; x <= 16; x++) {
        ...
        mprintf(
          MAP_LEFT +
            x * 13 -
            Math.trunc((13 + StringPixLength(str, SMALLCOMPFONT())) / 2),
          MAP_TOP - 8,
          str,
        );
      }
        ...
        for (y = 0; y < 16; y++) {
          ...
          for (x = 0; x < 16; x++) {
            if (giCurrentViewLevel == ALL_LEVELS_MASK) {
              ...
              if (
                !gfItemDetailsMode ||
                !gpSectorSummary[x][y][giCurrLevel] ||
    ...
    if (gfGlobalSummaryExists) {
      ...
      if (gfWorldLoaded && !gfTempFile && gsSectorX) {
        ...
        RectangleDraw(
          ...
          x + 11,
          y + 11,
          Get16BPPColor(FROMRGB(50, 50, 200)),
          pDestBuf,
        );
      }
      ...
      if (gsSelSectorX > 0 && !gfTempFile) {
        ...
        RectangleDraw(
          ...
          x + 13,
          y + 13,
          Get16BPPColor(FROMRGB(200, 50, 50)),
          pDestBuf,
        );
      }
      ...
      if (gsHiSectorX > 0) {
        ...
        RectangleDraw(
          ...
          x + 15,
          y + 15,
          Get16BPPColor(FROMRGB(200, 200, 50)),
          pDestBuf,
        );
      }
      UnLockVideoSurface(FRAME_BUFFER);
  ...
  export function UpdateSectorSummary(
    gszFilename: string /* Pointer<UINT16> */,
    fUpdate: boolean,
  ): void {
    ...
    if (gszFilename[2] < "0" || gszFilename[2] > "9")
      ...
      x =
        (gszFilename.charCodeAt(1) - "0".charCodeAt(0)) * 10 +
        gszFilename.charCodeAt(2) -
        "0".charCodeAt(0);
    if (gszFilename[0] >= "a")
      y = gszFilename.charCodeAt(0) - "a".charCodeAt(0) + 1;
    else y = gszFilename.charCodeAt(0) - "A".charCodeAt(0) + 1;
    ...
    if (fUpdate) {
      ...
      if (gfSummaryWindowActive) {
        ...
        mprintf(
          320 - Math.trunc(StringPixLength(str, FONT10ARIAL()) / 2),
          190,
          str,
        );
      ...
      if (gsSectorX > 9) szCoord = szCoord.substring(0, 3);
      else szCoord = szCoord.substring(0, 2);
      gusNumEntriesWithOutdatedOrNoSummaryInfo++;
      EvaluateWorld(szCoord, giCurrLevel);

      RemoveProgressBar(0);
    } else gusNumEntriesWithOutdatedOrNoSummaryInfo++;
  }
  ...
  function SummaryToggleAlternateCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  function SummarySciFiCallback(btn: GUI_BUTTON, reason: INT32): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ButtonList[iSummaryButton[Enum58.SUMMARY_SCIFI]].uiFlags |=
        BUTTON_CLICKED_ON | BUTTON_DIRTY;
      ButtonList[iSummaryButton[Enum58.SUMMARY_REAL]].uiFlags &=
        ~BUTTON_CLICKED_ON;
  ...
  export function HandleSummaryInput(pEvent: InputAtom): boolean {
    ...
    if (
      (!HandleTextInput(pEvent) && pEvent.usEvent == KEY_DOWN) ||
      pEvent.usEvent == KEY_REPEAT
    ) {
      let x: INT32;
      switch (pEvent.usParam) {
        ...
        case ENTER:
          ...
          else if (gfWorldLoaded) DestroySummaryWindow();
          break;
        case F6:
          PerformTest();
          break;
  ...
  function CreateGlobalSummary(): void {
    ...
    if (!MakeFileManDirectory(Dir))
      AssertMsg(
        0,
        "Can't create new directory, JA2\\DevInfo for summary information.",
      );
    if (!SetFileManCurrentDirectory(Dir))
      AssertMsg(
        0,
        "Can't set to new directory, JA2\\DevInfo for summary information.",
      );
  ...
  function MapClickCallback(reg: MOUSE_REGION, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (
        gsSelSectorX != MapClickCallback__sLastX ||
        gsSelSectorY != MapClickCallback__sLastY
      ) {
        ...
        switch (giCurrentViewLevel) {
          case ALL_LEVELS_MASK:
            if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][0])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][0];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][1])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][1];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][2])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][2];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][3])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][3];
            else gpCurrentSectorSummary = <SUMMARYFILE>(<unknown>null);
            break;
          ...
          case ALTERNATE_LEVELS_MASK:
            if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][4])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][4];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][5])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][5];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][6])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][6];
            else if (gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][7])
              gpCurrentSectorSummary =
                gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][7];
            else gpCurrentSectorSummary = <SUMMARYFILE>(<unknown>null);
            break;
  ...
  function SummaryOverrideCallback(btn: GUI_BUTTON, reason: INT32): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      gfRenderSummary = true;
      if (gfOverride) EnableButton(iSummaryButton[Enum58.SUMMARY_SAVE]);
      else DisableButton(iSummaryButton[Enum58.SUMMARY_SAVE]);
    }
  }
  ...
  function CalculateOverrideStatus(): void {
    ...
    if (gfTempFile) {
      ...
      if (szFilename.length == 5) szFilename += "test.dat";
      ptr = szFilename.indexOf(".");
      if (ptr === -1) szFilename += ".dat";
      else szFilename = szFilename.substring(0, ptr) + ".dat";
    } else szFilename = sprintf("MAPS\\%s", gszFilename);
    ...
    if (FileExistsNoDB(szFilename)) {
      if (gfWorldLoaded) {
        ...
        else gubOverrideStatus = Enum57.OVERWRITE;
        ShowButton(iSummaryButton[Enum58.SUMMARY_OVERRIDE]);
        ButtonList[iSummaryButton[Enum58.SUMMARY_OVERRIDE]].uiFlags &=
          ~BUTTON_CLICKED_ON;
        DisableButton(iSummaryButton[Enum58.SUMMARY_SAVE]);
      }
      if (gfTempFile) EnableButton(iSummaryButton[Enum58.SUMMARY_LOAD]);
    } else {
      gubOverrideStatus = Enum57.INACTIVE;
      HideButton(iSummaryButton[Enum58.SUMMARY_OVERRIDE]);
      if (gfWorldLoaded) EnableButton(iSummaryButton[Enum58.SUMMARY_SAVE]);
    }
  }
  ...
  function LoadGlobalSummary(): void {
    ...
    if (gfMustForceUpdateAllMaps) {
      console.debug(
        FormatString(
          "A MAJOR MAP UPDATE EVENT HAS BEEN DETECTED FOR %d MAPS!!!!.\n",
  ...
  export function WriteSectorSummaryUpdate(
    puiFilename: string /* Pointer<UINT8> */,
    ubLevel: UINT8,
    pSummaryFileInfo: SUMMARYFILE,
  ): void {
    let fp: number;
    let ExecDir: string /* STRING512 */;
    let Dir: string /* STRING512 */;
    ...
    if (ptr === -1) AssertMsg(0, "Illegal sector summary filename.");
    ...
    else y = puiFilename.charCodeAt(0) - "A".charCodeAt(0);
    if (puiFilename[2] < "0" || puiFilename[2] > "9")
      x = puiFilename.charCodeAt(1) - "0".charCodeAt(0) - 1;
    else
      x =
        (puiFilename.charCodeAt(1) - "0".charCodeAt(0)) * 10 +
        puiFilename.charCodeAt(2) -
        "0".charCodeAt(0) -
        1;
  ...
  function SummaryNewBasementLevelCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  function LoadSummary(
    ...
    if (
      temp.ubSummaryVersion < MINIMUMVERSION ||
    ...
    if (
      pSector.charCodeAt(2) >= "0".charCodeAt(0) &&
      pSector.charCodeAt(2) <= "9".charCodeAt(0)
    )
      x =
        (pSector.charCodeAt(1) - "0".charCodeAt(0)) * 10 +
        pSector.charCodeAt(2) -
        "0".charCodeAt(0) -
        1;
    else x = pSector.charCodeAt(1) - "0".charCodeAt(0) - 1;
    ...
    if (
      gpSectorSummary[x][y][ubLevel].ubSummaryVersion < GLOBAL_SUMMARY_VERSION
    )
      gusNumEntriesWithOutdatedOrNoSummaryInfo++;
  ...
  function UpdateMasterProgress(): void {
    if (gfUpdatingNow && gusTotal) {
      ...
      } else SetRelativeStartAndEndPercentage(1, MasterStart, MasterEnd, null);
    }
  }
  ...
  function ReportError(
    ...
    mprintf(
      10,
      ReportError__yp,
      "Skipping update for %s.  Probably due to tileset conflicts...",
      str,
    );
    InvalidateScreen();
    ReportError__yp++;
  ...
  function SummaryUpdateCallback(btn: GUI_BUTTON, reason: INT32): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      str = sprintf(
        "%s%d",
        String.fromCharCode(gsSelSectorY + "A".charCodeAt(0) - 1),
        gsSelSectorX,
      );
      EvaluateWorld(str, giCurrLevel);

      gpSectorSummary[gsSelSectorX][gsSelSectorY][giCurrLevel] =
        gpCurrentSectorSummary;
  ...
  function ExtractTempFilename(): void {
    ...
    if (!str.length) gszDisplayName = "test.dat";
  }
  ...
  function ApologizeOverrideAndForceUpdateEverything(): void {
    ...
    SetFontForeground(FONT_YELLOW);
    str = swprintf(
      "There are %d maps requiring a major version update.",
      gusNumberOfMapsToBeForceUpdated,
    );
    mprintf(
      320 - Math.trunc(StringPixLength(str, FONT10ARIAL()) / 2),
    ...
    for (y = 0; y < 16; y++)
      for (x = 0; x < 16; x++) {
        ...
        if (gbSectorLevels[x][y] & GROUND_LEVEL_MASK) {
          ...
          if (
            !pSF ||
            pSF.ubSummaryVersion < MINIMUMVERSION ||
  ...
  function SetupItemDetailsMode(fAllowRecursion: boolean): void {
    ...
    if (!gpCurrentSectorSummary.uiNumItemsPosition) {
      ...
      if (gpCurrentSectorSummary.ubSummaryVersion == GLOBAL_SUMMARY_VERSION)
        gusNumEntriesWithOutdatedOrNoSummaryInfo++;
      SummaryUpdateCallback(
        ButtonList[iSummaryButton[Enum58.SUMMARY_UPDATE]],
        MSYS_CALLBACK_REASON_LBUTTON_UP,
      );
      gpCurrentSectorSummary =
        gpSectorSummary[gsSelSectorX - 1][gsSelSectorY - 1][giCurrLevel];
    }
    ...
    if (
      !FileSeek(
        hfile,
        gpCurrentSectorSummary.uiNumItemsPosition,
    ...
    if (
      !FileSeek(
        hfile,
        gpCurrentSectorSummary.uiEnemyPlacementPosition,
        FILE_SEEK_FROM_START,
      )
    ) {
      // Position couldn't be found!
    ...
    for (i = 0; i < gpCurrentSectorSummary.MapInfo.ubNumIndividuals; i++) {
      ...
      uiNumBytesRead = FileRead(
        hfile,
        buffer,
        BASIC_SOLDIER_CREATE_STRUCT_SIZE,
      );
    ...
    if (gusPEnemyItemsSummaryArraySize) {
      gpPEnemyItemsSummaryArray = createArrayFrom(
        gusPEnemyItemsSummaryArraySize,
        createObjectType,
      );
    }
    if (gusNEnemyItemsSummaryArraySize) {
      gpNEnemyItemsSummaryArray = createArrayFrom(
        gusNEnemyItemsSummaryArraySize,
        createObjectType,
      );
    }
