namespace ja2 {
  ...
  export function copyEvEPlaySound(
    destination: EV_E_PLAYSOUND,
    source: EV_E_PLAYSOUND,
  ) {
  ...
  export function copyEvSChangeState(
    destination: EV_S_CHANGESTATE,
    source: EV_S_CHANGESTATE,
  ) {
  ...
  export function copyEvSChangeDest(
    destination: EV_S_CHANGEDEST,
    source: EV_S_CHANGEDEST,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSSetPosition(
    destination: EV_S_SETPOSITION,
    source: EV_S_SETPOSITION,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSGetNewPath(
    destination: EV_S_GETNEWPATH,
    source: EV_S_GETNEWPATH,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSBeginTurn(
    destination: EV_S_BEGINTURN,
    source: EV_S_BEGINTURN,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  }
  ...
  export function copyEvSChangeStance(
    destination: EV_S_CHANGESTANCE,
    source: EV_S_CHANGESTANCE,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSSetDirection(
    destination: EV_S_SETDIRECTION,
    source: EV_S_SETDIRECTION,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSSetDesiredDirection(
    destination: EV_S_SETDESIREDDIRECTION,
    source: EV_S_SETDESIREDDIRECTION,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSBeginFireWeapon(
    destination: EV_S_BEGINFIREWEAPON,
    source: EV_S_BEGINFIREWEAPON,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSFireWeapon(
    destination: EV_S_FIREWEAPON,
    source: EV_S_FIREWEAPON,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
    destination.sTargetGridNo = source.sTargetGridNo;
  ...
  export function copyEvSWeaponHit(
    destination: EV_S_WEAPONHIT,
    source: EV_S_WEAPONHIT,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
  ...
  export function copyEvSStructureHit(
    destination: EV_S_STRUCTUREHIT,
    source: EV_S_STRUCTUREHIT,
  ) {
    destination.sXPos = source.sXPos;
    destination.sYPos = source.sYPos;
    destination.sZPos = source.sZPos;
  ...
  export function copyEvSWindowHit(
    destination: EV_S_WINDOWHIT,
    source: EV_S_WINDOWHIT,
  ) {
  ...
  export function copyEvSStopMerc(
    destination: EV_S_STOP_MERC,
    source: EV_S_STOP_MERC,
  ) {
    destination.usSoldierID = source.usSoldierID;
    destination.uiUniqueId = source.uiUniqueId;
