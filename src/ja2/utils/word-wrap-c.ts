namespace ja2 {
  ...
  function LineWrapForSingleCharWords(
    ulFont: UINT32,
    usLineWidthPixels: UINT16,
    pusLineWidthIfWordIsWiderThenWidth: Pointer<UINT16>,
    ...
    while (!fDone) {
      ...
      if (usCurrentWidthPixels > usLineWidthPixels) {
        ...
        if (DestString.length != 0) {
          ...
          if (
            WFStringPixLength(pCurrentStringLoc, ulFont) < usLineWidthPixels
          ) {
          ...
          zText = sprintf(
            "LineWrap() Error!  The string ( %s ) has a word ( %s ) that is too long to fit into the required width of %d!  Please fix!!",
            pString,
            TempString.substring(usCurIndex),
            usLineWidthPixels,
          );
          ...
          // error
          usLineWidthPixels =
            1 + WFStringPixLength(TempString[usCurIndex], ulFont);
  ...
  export function DisplayWrappedString(
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    ubGap: UINT8,
    ...
    if (gfUseSingleCharWordsForWordWrap) {
      pFirstWrappedString = LineWrapForSingleCharWords(
        uiFont,
        usWidth,
        createPointer(
  ...
  export function DrawTextToScreen(
    pStr: string /* STR16 */,
    usLocX: UINT16,
    usLocY: UINT16,
    usWidth: UINT16,
    ...
    if (ulFlags & LEFT_JUSTIFIED) {
      ...
      ({ sX: usPosX, sY: usPosY } = VarFindFontCenterCoordinates(
        usLocX,
        usLocY,
        usWidth,
        WFGetFontHeight(ulFont),
        ulFont,
        pStr,
      ));
    } else if (ulFlags & RIGHT_JUSTIFIED) {
      ({ sX: usPosX, sY: usPosY } = VarFindFontRightCoordinates(
        usLocX,
        usLocY,
        usWidth,
        WFGetFontHeight(ulFont),
  ...
  export function IanDisplayWrappedString(
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    ubGap: UINT8,
    ...
    do {
      ...
      if (
        pString.charCodeAt(usSourceCounter) != TEXT_SPACE &&
        usSourceCounter < pString.length
      ) {
        ...
        if (
          zWordString.charCodeAt(0) >= TEXT_CODE_NEWLINE &&
          zWordString.charCodeAt(0) <= TEXT_CODE_DEFCOLOR
        ) {
          switch (zWordString.charCodeAt(0)) {
            ...
            case TEXT_CODE_BOLD:
              if (!fBoldOn) {
                ...
                usPhraseLengthPixels = WFStringPixLength(
                  zLineString,
                  uiLocalFont,
                );
            ...
            case TEXT_CODE_NEWCOLOR:
              ...
              if (
                zWordString.charCodeAt(1) != TEXT_SPACE &&
                zWordString.charCodeAt(1) < 256
              )
  ...
  export function CleanOutControlCodesFromString(
    pSourceString: string /* STR16 */,
  ): string {
    ...
    while (pSourceString[iSourceCounter] != undefined) {
      ...
      if (fRemoveCurrentChar) {
        ...
        if (pSourceString[iSourceCounter + 2] != undefined) iSourceCounter += 2;
        else iSourceCounter++;
      } else {
  ...
  function IanDisplayWrappedStringToPages(
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    usPageHeight: UINT16,
    usTotalHeight: UINT16,
    usPageNumber: UINT16,
    ubGap: UINT8,
    uiFont: UINT32,
    ubColor: UINT8,
    ...
    fDirty: boolean,
    uiFlags: UINT32,
    fOnLastPageFlag: Pointer<boolean>,
  ): INT16 {
    let usHeight: UINT16;
    let usSourceCounter: UINT16 = 0;
    let usDestCounter: UINT16 = 0;
  ...
  export function IanWrappedStringHeight(
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    ubGap: UINT8,
  ...
  function WillThisStringGetCutOff(
    iTotalYPosition: INT32,
    iBottomOfPage: INT32,
    iWrapWidth: INT32,
    uiFont: UINT32,
    pString: string /* STR16 */,
  ...
  function IsThisStringBeforeTheCurrentPage(
    iTotalYPosition: INT32,
    iPageSize: INT32,
    iCurrentPage: INT32,
    iWrapWidth: INT32,
  ...
  function GetNewTotalYPositionOfThisString(
    iTotalYPosition: INT32,
    iPageSize: INT32,
    iCurrentPage: INT32,
    iWrapWidth: INT32,
  ...
  // for email
  export function GetFirstRecordOnThisPage(
    ...
    while (iCurrentPage < iPage) {
      ...
      while (
        ...
        iCurrentPositionOnThisPage += IanWrappedStringHeight(
          0,
          0,
          usWidth,
          ubGap,
  ...
  // for file viewer
  export function GetFirstStringOnThisPage(
    RecordList: FileString | null,
    uiFont: UINT32,
    usWidth: UINT16,
    ubGap: UINT8,
    iPage: INT32,
    iPageSize: INT32,
    WidthList: FileRecordWidth,
  ): FileString | null {
    // get the first record on this page - build pages up until this point
        ...
        if (iCounter == pWidthList.iRecordNumber) {
          ...
          if (pWidthList.iRecordHeightAdjustment == iPageSize) {
            if (iCurrentPositionOnThisPage != 0)
              iCurrentPositionOnThisPage +=
                iPageSize - iCurrentPositionOnThisPage;
          } else
            iCurrentPositionOnThisPage += pWidthList.iRecordHeightAdjustment;
        }
      ...
      while (
        iCurrentPositionOnThisPage +
          IanWrappedStringHeight(
            ...
            uiFont,
            0,
            (<FileString>CurrentRecord).pString,
            0,
            false,
            0,
          ) <
  ...
  export function ReduceStringLength(
    pString: string /* STR16 */,
    uiWidthToFitIn: UINT32,
    uiFont: UINT32,
  ): string {
    let OneChar: string /* wchar_t[2] */;
