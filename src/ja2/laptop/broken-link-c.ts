namespace ja2 {
  ...
  export function RenderBrokenLink(): void {
    ...
    DisplayWrappedString(
      BROKEN_LINK__MESSAGE_X,
      BROKEN_LINK__MESSAGE_Y,
      BROKEN_LINK__MESSAGE_WIDTH,
      2,
      BROKEN_LINK__FONT(),
      BROKEN_LINK__COLOR,
      BrokenLinkText[Enum379.BROKEN_LINK_TXT_ERROR_404],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      BROKEN_LINK__MESSAGE_X,
      BROKEN_LINK__SITE_NOT_FOUND_Y,
      BROKEN_LINK__MESSAGE_WIDTH,
      2,
      BROKEN_LINK__FONT(),
      BROKEN_LINK__COLOR,
      BrokenLinkText[Enum379.BROKEN_LINK_TXT_SITE_NOT_FOUND],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
