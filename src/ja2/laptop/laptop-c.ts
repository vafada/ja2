namespace ja2 {
  ...
  // BUTTON IMAGES
  let giLapTopButton: INT32[] /* [MAX_BUTTON_COUNT] */ = createArray(
    MAX_BUTTON_COUNT,
    0,
  );
  let giLapTopButtonImage: INT32[] /* [MAX_BUTTON_COUNT] */ = createArray(
    MAX_BUTTON_COUNT,
    0,
  );
  ...
  let gLaptopProgramStates: INT32[] /* [LAPTOP_PROGRAM_HISTORY + 1] */ =
    createArray(Enum93.LAPTOP_PROGRAM_HISTORY + 1, 0);
  ...
  let LaptopScreenRect: SGPRect = createSGPRectFrom(
    LAPTOP_UL_X,
    LAPTOP_UL_Y - 5,
    LAPTOP_SCREEN_LR_X + 2,
  ...
  let gfWWWaitSubSitesVisitedFlags: boolean[] /* [LAPTOP_MODE_SIRTECH - LAPTOP_MODE_WWW] */ =
    createArray(Enum95.LAPTOP_MODE_SIRTECH - Enum95.LAPTOP_MODE_WWW, false);
  ...
  let gBookmarkMouseRegions: MOUSE_REGION[] /* [MAX_BOOKMARKS] */ =
    createArrayFrom(MAX_BOOKMARKS, createMouseRegion);
  ...
  function EnterNewLaptopMode(): void {
    ...
    switch (guiCurrentLaptopMode) {
      case Enum95.LAPTOP_MODE_EMAIL:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_MAILER] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
            fInitTitle = true;
            InitTitleBarMaximizeGraphics(
              guiTITLEBARLAPTOP,
              pLaptopTitles[0],
              guiTITLEBARICONS,
              0,
      ...
      case Enum95.LAPTOP_MODE_FILES:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_FILES] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
      ...
      case Enum95.LAPTOP_MODE_PERSONNEL:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_PERSONNEL] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
      ...
      case Enum95.LAPTOP_MODE_FINANCES:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_FINANCES] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
      ...
      case Enum95.LAPTOP_MODE_HISTORY:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_HISTORY] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
      ...
      default:
        if (
          gLaptopProgramStates[Enum93.LAPTOP_PROGRAM_WEB_BROWSER] ==
          Enum94.LAPTOP_PROGRAM_MINIMIZED
        ) {
          // minized, maximized
          if (fMaximizingProgram == false) {
    ...
    if (
      guiCurrentLaptopMode >= Enum95.LAPTOP_MODE_WWW &&
      guiPreviousLaptopMode >= Enum95.LAPTOP_MODE_WWW
    ) {
      gfShowBookmarks = false;
    }
  ...
  export function LaptopScreenHandle(): UINT32 {
    ...
    if (gfShowBookmarks) {
      if (fExitingLaptopFlag) gfShowBookmarks = false;
      else DisplayBookMarks();
    }
   ...
   */
    ...
    gLaptopButtonImage[0] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      0,
      -1,
      8,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[0],
      Enum376.LAPTOP_BN_HLP_TXT_VIEW_EMAIL,
    );
    ...
    gLaptopButtonImage[1] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      1,
      -1,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[1],
      Enum376.LAPTOP_BN_HLP_TXT_BROWSE_VARIOUS_WEB_SITES,
    );
    ...
    gLaptopButtonImage[2] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      2,
      -1,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[2],
      Enum376.LAPTOP_BN_HLP_TXT_VIEW_FILES_AND_EMAIL_ATTACHMENTS,
    );
    ...
    gLaptopButtonImage[3] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      3,
      -1,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[3],
      Enum376.LAPTOP_BN_HLP_TXT_VIEW_TEAM_INFO,
    );
    ...
    gLaptopButtonImage[4] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      4,
      -1,
    ...
    gLaptopButton[4] = QuickCreateButton(
      ...
      MSYS_PRIORITY_HIGH,
      BtnGenericMouseMoveButtonCallback,
      HistoryRegionButtonCallback,
    );
    CreateLaptopButtonHelpText(
      gLaptopButton[4],
      Enum376.LAPTOP_BN_HLP_TXT_READ_LOG_OF_EVENTS,
    );
    ...
    gLaptopButtonImage[5] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      5,
      -1,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[5],
      Enum376.LAPTOP_BN_HLP_TXT_VIEW_FINANCIAL_SUMMARY_AND_HISTORY,
    );
    ...
    gLaptopButtonImage[6] = LoadButtonImage(
      "LAPTOP\\buttonsforlaptop.sti",
      -1,
      6,
      -1,
    ...
    CreateLaptopButtonHelpText(
      gLaptopButton[6],
      Enum376.LAPTOP_BN_HLP_TXT_CLOSE_LAPTOP,
    );
  ...
  */
  ...
  export function LeaveLapTopScreen(): boolean {
    if (ExitLaptopDone()) {
      ...
      if (!gfDontStartTransitionFromLaptop) {
        ...
        BlitBufferToBuffer(FRAME_BUFFER, guiSAVEBUFFER, 0, 0, 640, 480);
        PlayJA2SampleFromFile(
          "SOUNDS\\Laptop power down (8-11).wav",
          RATE_11025,
          HIGHVOLUME,
          1,
          MIDDLEPAN,
    ...
    if (LaptopSaveInfo.gfNewGameLaptop != false) {
      ...
      if (
        ...
        AddFutureDayStrategicEvent(
          Enum132.EVENT_HAVENT_MADE_IMP_CHARACTER_EMAIL,
          (8 + Random(4)) * 60,
          0,
          1,
        );
  ...
  function CreateLapTopMouseRegions(): boolean {
    ...
    MSYS_DefineRegion(
      gLapTopScreenRegion,
      LaptopScreenRect.iLeft,
      LaptopScreenRect.iTop,
      LaptopScreenRect.iRight,
      LaptopScreenRect.iBottom,
  ...
  function WWWRegionButtonCallback(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        btn.uiFlags &= ~BUTTON_CLICKED_ON;
        if (giCurrentRegion != Enum92.WWW_REGION) giOldRegion = giCurrentRegion;
        ...
        if (guiCurrentWWWMode != Enum95.LAPTOP_MODE_NONE)
          guiCurrentLaptopMode = guiCurrentWWWMode;
        else guiCurrentLaptopMode = Enum95.LAPTOP_MODE_WWW;
  ...
  function HandleLapTopScreenMouseUi(): void {
    ...
    } else giHighLightRegion = Enum92.NO_REGION;
  ...
  function EmailRegionMvtCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      BltVideoObject(
        FRAME_BUFFER,
        hLapTopIconHandle,
        EmailRegionMvtCallback__iFrame,
        LAPTOP_ICONS_X,
        LAPTOP_ICONS_MAIL_Y,
        VO_BLT_SRCTRANSPARENCY,
        null,
  ...
  function FinancialRegionMvtCallback(
    ...
    if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      BltVideoObject(
        FRAME_BUFFER,
        hLapTopIconHandle,
        FinancialRegionMvtCallback__iFrame,
        LAPTOP_ICONS_X - 4,
  ...
  function HistoryRegionMvtCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iDifference: INT32 = 0;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      BltVideoObject(
        FRAME_BUFFER,
        hLapTopIconHandle,
        HistoryRegionMvtCallback__iFrame,
        LAPTOP_ICONS_X,
  ...
  function FilesRegionMvtCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      BltVideoObject(
        FRAME_BUFFER,
        hLapTopIconHandle,
        FilesRegionMvtCallback__iFrame,
        LAPTOP_ICONS_X,
  ...
  function PersonnelRegionMvtCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iDifference: INT32 = 0;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      BltVideoObject(
        FRAME_BUFFER,
        hLapTopIconHandle,
        PersonnelRegionMvtCallback__iFrame,
        LAPTOP_ICONS_X,
  ...
  function CheckIfMouseLeaveScreen(): void {
    ...
    GetCursorPos(MousePos);
    if (
      MousePos.x > LAPTOP_SCREEN_LR_X ||
      MousePos.x < LAPTOP_UL_X ||
      MousePos.y < LAPTOP_UL_Y ||
      MousePos.y > LAPTOP_SCREEN_LR_Y
    ) {
      guiCurrentLapTopCursor = Enum97.LAPTOP_PANEL_CURSOR;
    }
  }
  function ScreenRegionMvtCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function DisplayBookMarks(): void {
    ...
    while (LaptopSaveInfo.iBookMarkList[iCounter - 1] != -1) {
      ...
      ({ sX, sY } = FindFontCenterCoordinates(
        BOOK_X + 3,
        BOOK_TOP_Y + 2 + iCounter * (BOOK_HEIGHT + 6) + 6,
        BOOK_WIDTH - 3,
        BOOK_HEIGHT + 6,
    ...
    ({ sX, sY } = FindFontCenterCoordinates(
      ...
      BOOK_WIDTH - 3,
      BOOK_HEIGHT + 6,
      pBookMarkStrings[Enum98.CANCEL_STRING],
      BOOK_FONT(),
    ));
...
*/ InvalidateRegion(
      BOOK_X,
      BOOK_TOP_Y + iCounter * BOOK_HEIGHT + 12,
      BOOK_X + BOOK_WIDTH,
  ...
  /* static */ let CreateDestoryBookMarkRegions__fOldShowBookmarks: boolean =
    false;
  function CreateDestoryBookMarkRegions(): void {
    if (gfShowBookmarks && !CreateDestoryBookMarkRegions__fOldShowBookmarks) {
      ...
      !gfShowBookmarks &&
      CreateDestoryBookMarkRegions__fOldShowBookmarks
    ) {
      // destroy bookmarks
      DeleteBookmarkRegions();
  ...
  export function GoToWebPage(iPageId: INT32): void {
    ...
    } else giRainDelayInternetSite = -1;
    ...
    switch (iPageId) {
      case Enum98.AIM_BOOKMARK:
        ...
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.AIM_BOOKMARK] == false
        ) {
      ...
      case Enum98.BOBBYR_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.BOBBYR_BOOKMARK] ==
          false
        ) {
          // reset flag and set load pending flag
      ...
      case Enum98.IMP_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.IMP_BOOKMARK] == false
        ) {
          // reset flag and set load pending flag
      ...
      case Enum98.MERC_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.MERC_BOOKMARK] == false
        ) {
          // reset flag and set load pending flag
      ...
      case Enum98.FUNERAL_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.FUNERAL_BOOKMARK] ==
          false
        ) {
          // reset flag and set load pending flag
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.FUNERAL_BOOKMARK] =
      ...
      case Enum98.FLORIST_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.FLORIST_BOOKMARK] ==
          false
        ) {
          // reset flag and set load pending flag
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.FLORIST_BOOKMARK] =
      ...
      case Enum98.INSURANCE_BOOKMARK:
        ...
        // do we have to have a World Wide Wait
        if (
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.INSURANCE_BOOKMARK] ==
          false
        ) {
          // reset flag and set load pending flag
          LaptopSaveInfo.fVisitedBookmarkAlready[Enum98.INSURANCE_BOOKMARK] =
  ...
  function DisplayLoadPending(): boolean {
    ...
    if (fFastLoadFlag == true) {
      ({ sX: sXPosition, sY: sYPosition } = FindFontCenterCoordinates(
        328,
        0,
        446 - 328,
        0,
    ...
    while (iTempTime > 0) {
      ...
      BltVideoObject(
        ...
        hLapTopIconHandle,
        0,
        LAPTOP_BAR_X + UNIT_WIDTH * iCounter,
        LAPTOP_BAR_Y,
        VO_BLT_SRCTRANSPARENCY,
        null,
      );
  ...
  function CreateDestroyErrorButton(): void {
    if (fErrorFlag && !CreateDestroyErrorButton__fOldErrorFlag) {
      ...
      giErrorButtonImage[0] = LoadButtonImage(
        "LAPTOP\\errorbutton.sti",
        -1,
        0,
        -1,
        1,
  ...
  function DrawTextOnErrorButton(): void {
    ...
    SetFontShadow(NO_SHADOW);
    mprintf(
      ERROR_X + ERROR_BTN_X + ERROR_BTN_TEXT_X,
      ERROR_BTN_Y + ERROR_BTN_TEXT_Y,
      pErrorStrings[3],
    );
    SetFontShadow(DEFAULT_SHADOW);
  ...
  function DisplayPlayersBalanceToDate(): void {
    ...
    ({ sX, sY } = FindFontCenterCoordinates(
      LAPTOP_ICON_TEXT_X,
      0,
      LAPTOP_ICON_TEXT_WIDTH,
      LAPTOP_ICON_TEXT_HEIGHT,
      sString,
      LAPTOPICONFONT(),
    ));
  ...
  export function LapTopScreenCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  export function DoLapTopMessageBox(
    ubStyle: UINT8,
    ...
    iLaptopMessageBox = DoMessageBox(
      ubStyle,
      zString,
      uiExitScreen,
  ...
  export function DoLapTopSystemMessageBoxWithRect(
    ubStyle: UINT8,
    zString: string /* Pointer<INT16> */,
    uiExitScreen: UINT32,
    usFlags: UINT16,
  ...
  export function DoLapTopSystemMessageBox(
    ubStyle: UINT8,
    zString: string /* Pointer<INT16> */,
    uiExitScreen: UINT32,
    usFlags: UINT16,
  ...
  export function WebPageTileBackground(
    ubNumX: UINT8,
    ubNumY: UINT8,
    usWidth: UINT16,
    usHeight: UINT16,
    uiBackgroundIdentifier: UINT32,
  ): boolean {
  ...
  function InitTitleBarMaximizeGraphics(
    uiBackgroundGraphic: UINT32,
    pTitle: string /* STR16 */,
    uiIconGraphic: UINT32,
    usIconGraphicIndex: UINT16,
  ): boolean {
    ...
    BltVideoObject(
      ...
      hImageHandle,
      usIconGraphicIndex,
      LAPTOP_TITLE_BAR_ICON_OFFSET_X,
      LAPTOP_TITLE_BAR_ICON_OFFSET_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
  ...
  /* static */ let DisplayTitleBarMaximizeGraphic__LastRect: SGPRect =
    createSGPRect();
  function DisplayTitleBarMaximizeGraphic(
    fForward: boolean,
    fInit: boolean,
    usTopLeftX: UINT16,
    usTopLeftY: UINT16,
    ...
    if (fInit) {
      ...
      if (fForward) {
        ...
        DisplayTitleBarMaximizeGraphic__ubCount =
          NUMBER_OF_LAPTOP_TITLEBAR_ITERATIONS - 1;
      }
    }

    dTemp =
      (LAPTOP_TITLE_BAR_TOP_LEFT_X - usTopLeftX) /
      NUMBER_OF_LAPTOP_TITLEBAR_ITERATIONS;
    sPosX = Math.trunc(
      usTopLeftX + dTemp * DisplayTitleBarMaximizeGraphic__ubCount,
    );

    dTemp =
      (LAPTOP_TITLE_BAR_TOP_RIGHT_X - usTopRightX) /
      NUMBER_OF_LAPTOP_TITLEBAR_ITERATIONS;
    sPosRightX = Math.trunc(
      usTopRightX + dTemp * DisplayTitleBarMaximizeGraphic__ubCount,
    );

    dTemp =
      (LAPTOP_TITLE_BAR_TOP_LEFT_Y - usTopLeftY) /
      NUMBER_OF_LAPTOP_TITLEBAR_ITERATIONS;
    sPosY = Math.trunc(
      usTopLeftY + dTemp * DisplayTitleBarMaximizeGraphic__ubCount,
    );
    ...
    if (fForward) {
      ...
      if (DisplayTitleBarMaximizeGraphic__ubCount > 1) {
        sWidth =
          DisplayTitleBarMaximizeGraphic__LastRect.iRight -
          DisplayTitleBarMaximizeGraphic__LastRect.iLeft;
        sHeight =
          DisplayTitleBarMaximizeGraphic__LastRect.iBottom -
          DisplayTitleBarMaximizeGraphic__LastRect.iTop;
        BlitBufferToBuffer(
          guiSAVEBUFFER,
          guiRENDERBUFFER,
          DisplayTitleBarMaximizeGraphic__LastRect.iLeft,
    ...
    if (fMaximizingProgram) {
      switch (bProgramBeingMaximized) {
        case Enum93.LAPTOP_PROGRAM_MAILER:
          fMaximizingProgram = !DisplayTitleBarMaximizeGraphic(
            true,
            fInitTitle,
            29,
            66,
      ...
      switch (bProgramBeingMaximized) {
        case Enum93.LAPTOP_PROGRAM_MAILER:
          fMinizingProgram = !DisplayTitleBarMaximizeGraphic(
            false,
            fInitTitle,
            29,
            66,
  ...
  function FlickerHDLight(): void {
    ...
    if (
      FlickerHDLight__iTotalDifference > HD_FLICKER_TIME &&
      fLoadPendingFlag == false
    ) {
      FlickerHDLight__iBaseTime = GetJA2Clock();
  ...
  /* static */ let CreateDestroyMinimizeButtonForCurrentMode__fAlreadyCreated: boolean =
    false;
  ...
  function CreateMinimizeButtonForCurrentMode(): void {
    ...
    gLaptopMinButtonImage[0] = LoadButtonImage(
      "LAPTOP\\x.sti",
      -1,
      0,
      -1,
    ...
    gLaptopMinButton[0] = QuickCreateButton(
      gLaptopMinButtonImage[0],
      590,
      30,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
  ...
  function LaptopMinimizeProgramButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (!(btn.uiFlags & BUTTON_ENABLED)) return;
    ...
    switch (guiCurrentLaptopMode) {
      case Enum95.LAPTOP_MODE_HISTORY:
        ...
        BltVideoObject(
          ...
          hHandle,
          4,
          LAPTOP_TITLE_ICONS_X,
          LAPTOP_TITLE_ICONS_Y,
          VO_BLT_SRCTRANSPARENCY,
          null,
        );
        break;
  ...
  export function PrintDate(): void {
    ...
    mprintf(
      30 +
        Math.trunc((70 - StringPixLength(gswzWorldTimeStr, FONT10ARIAL())) / 2),
      433,
      gswzWorldTimeStr,
    );
  ...
  */
  ...
  export function HandleKeyBoardShortCutsForLapTop(
    usEvent: UINT16,
    usParam: UINT32,
    usKeyState: UINT16,
  ): void {
    ...
    if (
      usEvent == KEY_DOWN &&
      (usParam == "h".charCodeAt(0) || usParam == "H".charCodeAt(0))
    ) {
  ...
  function CreateMinimizeRegionsForLaptopProgramIcons(): void {
    ...
    MSYS_DefineRegion(
      gLapTopProgramMinIcon,
      LAPTOP_PROGRAM_ICON_X,
      LAPTOP_PROGRAM_ICON_Y,
      LAPTOP_PROGRAM_ICON_X + LAPTOP_PROGRAM_ICON_WIDTH,
      LAPTOP_PROGRAM_ICON_Y + LAPTOP_PROGRAM_ICON_HEIGHT,
      MSYS_PRIORITY_NORMAL + 1,
      Enum317.CURSOR_LAPTOP_SCREEN,
      MSYS_NO_CALLBACK,
      LaptopProgramIconMinimizeCallback,
    );
  ...
  function LaptopProgramIconMinimizeCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  /* static */ let CreateDestroyMouseRegionForNewMailIcon__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionForNewMailIcon(): void {
    ...
    if (CreateDestroyMouseRegionForNewMailIcon__fCreated == false) {
      ...
      MSYS_DefineRegion(
        gNewMailIconRegion,
        LAPTOP__NEW_EMAIL_ICON_X,
        LAPTOP__NEW_EMAIL_ICON_Y + 5,
        LAPTOP__NEW_EMAIL_ICON_X + 16,
        LAPTOP__NEW_EMAIL_ICON_Y + 16,
        MSYS_PRIORITY_HIGHEST - 3,
        Enum317.CURSOR_LAPTOP_SCREEN,
        MSYS_NO_CALLBACK,
      ...
      MSYS_DefineRegion(
        gNewFileIconRegion,
        LAPTOP__NEW_FILE_ICON_X,
        LAPTOP__NEW_FILE_ICON_Y + 5,
        LAPTOP__NEW_FILE_ICON_X + 16,
        LAPTOP__NEW_FILE_ICON_Y + 16,
        MSYS_PRIORITY_HIGHEST - 3,
        Enum317.CURSOR_LAPTOP_SCREEN,
        MSYS_NO_CALLBACK,
        NewFileIconCallback,
      ...
      CreateFileAndNewEmailIconFastHelpText(
        Enum376.LAPTOP_BN_HLP_TXT_YOU_HAVE_NEW_FILE,
  ...
  function HandleWWWSubSites(): void {
    ...
    // fast or slow load?
    if (
      gfWWWaitSubSitesVisitedFlags[
        guiCurrentLaptopMode - (Enum95.LAPTOP_MODE_WWW + 1)
      ] == true
    ) {
      fFastLoadFlag = true;
    }
    ...
    if (
      (guiCurrentLaptopMode == Enum95.LAPTOP_MODE_AIM_MEMBERS &&
        guiPreviousLaptopMode == Enum95.LAPTOP_MODE_AIM_MEMBERS_FACIAL_INDEX) ||
      (guiCurrentLaptopMode == Enum95.LAPTOP_MODE_AIM_MEMBERS_FACIAL_INDEX &&
        guiPreviousLaptopMode == Enum95.LAPTOP_MODE_AIM_MEMBERS)
    ) {
      fFastLoadFlag = false;
      fLoadPendingFlag = false;
      ...
      // set fact we were here
      gfWWWaitSubSitesVisitedFlags[
        Enum95.LAPTOP_MODE_AIM_MEMBERS_FACIAL_INDEX -
          (Enum95.LAPTOP_MODE_WWW + 1)
      ] = true;
      gfWWWaitSubSitesVisitedFlags[
        Enum95.LAPTOP_MODE_AIM_MEMBERS - (Enum95.LAPTOP_MODE_WWW + 1)
      ] = true;
    }
  ...
  function InitalizeSubSitesList(): void {
    ...
    for (
      iCounter = Enum95.LAPTOP_MODE_WWW + 1;
      iCounter <= Enum95.LAPTOP_MODE_SIRTECH;
      iCounter++
    ) {
      gfWWWaitSubSitesVisitedFlags[iCounter - (Enum95.LAPTOP_MODE_WWW + 1)] =
        false;
    }
    return;
  }
  ...
  function DisplayWebBookMarkNotify(): void {
    ...
    if (
      (DisplayWebBookMarkNotify__fOldShow == false || fReDrawBookMarkInfo) &&
      fShowBookmarkInfo == true
    ) {
  ...
  /* static */ let HandleWebBookMarkNotifyTimer__fOldShowBookMarkInfo: boolean =
    false;
  function HandleWebBookMarkNotifyTimer(): void {
    ...
    if (fMaximizingProgram == true || fMinizingProgram == true) {
      HandleWebBookMarkNotifyTimer__fOldShowBookMarkInfo =
        HandleWebBookMarkNotifyTimer__fOldShowBookMarkInfo || fShowBookmarkInfo;
      fShowBookmarkInfo = false;
      return;
    }
    ...
    fShowBookmarkInfo =
      fShowBookmarkInfo || HandleWebBookMarkNotifyTimer__fOldShowBookMarkInfo;
  ...
  export function SaveLaptopInfoToSavedGame(hFile: HWFILE): boolean {
    ...
    if (LaptopSaveInfo.usNumberOfBobbyRayOrderUsed) {
      ...
      uiSize =
        BOBBY_RAY_PURCHASE_STRUCT_SIZE *
  ...
  export function LoadLaptopInfoFromSavedGame(hFile: HWFILE): boolean {
    ...
    if (LaptopSaveInfo.usNumberOfBobbyRayOrderUsed) {
      // Allocate memory for the information
      uiSize =
        BOBBY_RAY_ORDER_STRUCT_SIZE *
        LaptopSaveInfo.usNumberOfBobbyRayOrderItems;

      LaptopSaveInfo.BobbyRayOrdersOnDeliveryArray = createArrayFrom(
        LaptopSaveInfo.usNumberOfBobbyRayOrderItems,
        createBobbyRayOrderStruct,
      );
    ...
    if (LaptopSaveInfo.ubNumberLifeInsurancePayoutUsed) {
      // Allocate memory for the information
      uiSize =
        LIFE_INSURANCE_PAYOUT_SIZE *
        LaptopSaveInfo.ubNumberLifeInsurancePayouts;

      LaptopSaveInfo.pLifeInsurancePayouts = createArrayFrom(
        LaptopSaveInfo.ubNumberLifeInsurancePayouts,
        createLifeInsurancePayout,
      );
  ...
  function CreateBookMarkHelpText(
    pRegion: MOUSE_REGION,
    uiBookMarkID: UINT32,
  ): void {
    SetRegionFastHelpText(
      pRegion,
      gzLaptopHelpText[
        Enum376.BOOKMARK_TEXT_ASSOCIATION_OF_INTERNATION_MERCENARIES +
          uiBookMarkID
      ],
    );
  }

  export function CreateFileAndNewEmailIconFastHelpText(
    uiHelpTextID: UINT32,
    fClearHelpText: boolean,
  ): void {
    ...
    if (fClearHelpText) SetRegionFastHelpText(pRegion, "");
    else SetRegionFastHelpText(pRegion, gzLaptopHelpText[uiHelpTextID]);

    // fUnReadMailFlag
    // fNewFilesInFileViewer
  }

  function CreateLaptopButtonHelpText(
    iButtonIndex: INT32,
    uiButtonHelpTextID: UINT32,
  ): void {
