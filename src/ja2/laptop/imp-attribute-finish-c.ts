namespace ja2 {
  ...
  function CreateAttributeFinishButtons(): void {
    ...
    // the yes button
    giIMPAttributeFinishButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
  ...
  */
    giIMPAttributeFinishButton[0] = CreateIconAndTextButton(
      giIMPAttributeFinishButtonImage[0],
      pImpButtonText[20],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
    ...
    // the no button
    giIMPAttributeFinishButtonImage[1] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
  ...
  */
    giIMPAttributeFinishButton[1] = CreateIconAndTextButton(
      giIMPAttributeFinishButtonImage[1],
      pImpButtonText[21],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
  ...
  function BtnIMPAttributeFinishYesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  function BtnIMPAttributeFinishNoCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
