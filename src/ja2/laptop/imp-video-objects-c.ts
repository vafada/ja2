namespace ja2 {
  ...
  export function RenderAttributeFrameForIndex(
    sX: INT16,
    sY: INT16,
    iIndex: INT32,
  ): void {
    ...
    InvalidateRegion(
      LAPTOP_SCREEN_UL_X + sX + 134,
      LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY,
      LAPTOP_SCREEN_UL_X + sX + 400,
      LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY + 21,
    );
  ...
  export function LoadAttrib1IndentFrame(): boolean {
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "LAPTOP\\attributescreenindent_1.sti",
    );
  ...
  export function LoadAttrib2IndentFrame(): boolean {
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "LAPTOP\\attributescreenindent_2.sti",
    );
