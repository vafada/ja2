namespace ja2 {
  ...
  function createConditionForMercAvailableFrom(
    usMoneyPaid: UINT16,
    usDay: UINT16,
    ubMercArrayID: UINT8,
  ...
  let gubMercArray: UINT8[] /* [NUMBER_OF_MERCS] */ = createArray(
    NUMBER_OF_MERCS,
    0,
  );
  ...
  let gusSpeckDialogueActualWidth__Pointer = createPointer(
    () => gusSpeckDialogueActualWidth,
    (v) => (gusSpeckDialogueActualWidth = v),
  );
  ...
  export let gubArrivedFromMercSubSite: UINT8 =
    Enum105.MERC_CAME_FROM_OTHER_PAGE; // the merc is arriving from one of the merc sub pages
  ...
  function createNumberOfTimesQuoteSaidFrom(
    ubQuoteID: UINT8,
    uiNumberOfTimesQuoteSaid: UINT32,
  ...
  let gNumberOfTimesQuoteSaid: NUMBER_TIMES_QUOTE_SAID[] /* [MERC_NUMBER_OF_RANDOM_QUOTES] */ =
    [
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_BIFF,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_HAYWIRE,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_GASKET,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_RAZOR,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_FLO,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_GUMPY,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_LARRY,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_COUGER,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_NUMB,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_BUBBA,
        0,
      ),

      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_AIM_SLANDER_1,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_AIM_SLANDER_2,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_AIM_SLANDER_3,
        0,
      ),
      createNumberOfTimesQuoteSaidFrom(
        Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_AIM_SLANDER_4,
        0,
      ),
    ];
  ...
  */
  ...
  export function EnterMercs(): boolean {
    ...
    // Account Box button
    guiAccountBoxButtonImage = LoadButtonImage(
      "LAPTOP\\SmallButtons.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiAccountBoxButton = QuickCreateButton(
      guiAccountBoxButtonImage,
      MERC_ACCOUNT_BUTTON_X,
      MERC_ACCOUNT_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
      BtnAccountBoxButtonCallback,
    );
    ...
    if (gubArrivedFromMercSubSite == Enum105.MERC_CAME_FROM_OTHER_PAGE) {
      ...
      if (
        ...
        Enum102.MERC_SITE_NEVER_VISITED
      )
        LaptopSaveInfo.ubPlayerBeenToMercSiteStatus =
          Enum102.MERC_SITE_FIRST_VISIT;
      else if (
        LaptopSaveInfo.ubPlayerBeenToMercSiteStatus ==
        Enum102.MERC_SITE_FIRST_VISIT
      )
        LaptopSaveInfo.ubPlayerBeenToMercSiteStatus =
          Enum102.MERC_SITE_SECOND_VISIT;
      else
        LaptopSaveInfo.ubPlayerBeenToMercSiteStatus =
          Enum102.MERC_SITE_THIRD_OR_MORE_VISITS;
  ...
  */
  ...
  export function RenderMercs(): void {
    ...
    DisplayWrappedString(
      MERC_PORTRAIT_TEXT_X,
      MERC_PORTRAIT_TEXT_Y,
      MERC_PORTRAIT_TEXT_WIDTH,
      2,
      MERC_TEXT_FONT(),
      MERC_TEXT_COLOR,
      MercHomePageText[Enum343.MERC_SPECK_OWNER],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    if (LaptopSaveInfo.gubPlayersMercAccountStatus == Enum104.MERC_NO_ACCOUNT)
      DisplayWrappedString(
        MERC_ACCOUNT_BOX_TEXT_X,
        MERC_ACCOUNT_BOX_TEXT_Y,
        MERC_ACCOUNT_BOX_TEXT_WIDTH,
        2,
        MERC_TEXT_FONT(),
        MERC_TEXT_COLOR,
        MercHomePageText[Enum343.MERC_OPEN_ACCOUNT],
        FONT_MCOLOR_BLACK,
        false,
        RIGHT_JUSTIFIED,
      );
      ...
      DisplayWrappedString(
        ...
        MERC_TEXT_FONT(),
        MERC_TEXT_COLOR,
        MercHomePageText[Enum343.MERC_VIEW_ACCOUNT],
        FONT_MCOLOR_BLACK,
        false,
        RIGHT_JUSTIFIED,
      );
    ...
    DisplayWrappedString(
      MERC_FILE_BOX_TEXT_X,
      MERC_FILE_BOX_TEXT_Y,
      MERC_FILE_BOX_TEXT_WIDTH,
      2,
      MERC_TEXT_FONT(),
      MERC_TEXT_COLOR,
      MercHomePageText[Enum343.MERC_VIEW_FILES],
      FONT_MCOLOR_BLACK,
      false,
      RIGHT_JUSTIFIED,
    );
  ...
  export function DrawMecBackGround(): boolean {
    WebPageTileBackground(
      4,
      4,
      MERC_BACKGROUND_WIDTH,
      MERC_BACKGROUND_HEIGHT,
      guiMercBackGround,
    );
    return true;
  }
  ...
  function BtnAccountBoxButtonCallback(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        else guiCurrentLaptopMode = Enum95.LAPTOP_MODE_MERC_ACCOUNT;
  ...
  export function DailyUpdateOfMercSite(usDate: UINT16): void {
    ...
    for (i = 0; i < NUMBER_OF_MERCS; i++) {
      ...
      if (IsMercOnTeam(ubMercID)) {
        ...
        if (
          gMercProfiles[pSoldier.ubProfile].iMercMercContractLength > iNumDays
        )
    ...
    if (iNumDays > MERC_NUM_DAYS_TILL_ACCOUNT_INVALID) {
      ...
      if (
        LaptopSaveInfo.gubPlayersMercAccountStatus !=
        Enum104.MERC_ACCOUNT_SUSPENDED
      ) {
        LaptopSaveInfo.gubPlayersMercAccountStatus =
          Enum104.MERC_ACCOUNT_SUSPENDED;
        AddEmail(
      ...
      if (
        LaptopSaveInfo.gubPlayersMercAccountStatus !=
        Enum104.MERC_ACCOUNT_VALID_FIRST_WARNING
      ) {
        LaptopSaveInfo.gubPlayersMercAccountStatus =
          Enum104.MERC_ACCOUNT_VALID_FIRST_WARNING;
        AddEmail(
          MERC_FIRST_WARNING,
          MERC_FIRST_WARNING_LENGTH,
          Enum75.SPECK_FROM_MERC,
          GetWorldTotalMin(),
        );
  ...
  */
    ...
    if (ShouldTheMercSiteServerGoDown()) {
      ...
      AddStrategicEvent(
        Enum132.EVENT_MERC_SITE_BACK_ONLINE,
        uiTimeInMinutes,
        0,
      );
    }
...
*/
  ...
  function StartSpeckTalking(usQuoteNum: UINT16): boolean {
    if (
      usQuoteNum == MERC_VIDEO_SPECK_SPEECH_NOT_TALKING ||
    ...
    if (
      !CharacterDialogue(
        MERC_VIDEO_MERC_ID_FOR_SPECKS,
        usQuoteNum,
        giVideoSpeckFaceIndex,
        DIALOGUE_SPECK_CONTACT_PAGE_UI,
        false,
        false,
      )
    ) {
  ...
  /* static */ let HandleCurrentMercDistortion__ubCurrentMercDistortionMode: UINT8 =
    Enum101.MERC_DISTORTION_NO_DISTORTION;
  function HandleCurrentMercDistortion(): void {
    ...
    if (
      HandleCurrentMercDistortion__ubCurrentMercDistortionMode ==
      Enum101.MERC_DISTORTION_NO_DISTORTION
    ) {
      let ubRandom: UINT8;
      ...
      if (ubRandom < 40) {
        ...
        if (ubRandom < 10)
          HandleCurrentMercDistortion__ubCurrentMercDistortionMode =
            Enum101.MERC_DISRTORTION_DISTORT_IMAGE;
        else if (ubRandom < 30)
          HandleCurrentMercDistortion__ubCurrentMercDistortionMode =
            Enum101.MERC_DISTORTION_PIXELATE_UP;
      }
    }
    ...
    switch (HandleCurrentMercDistortion__ubCurrentMercDistortionMode) {
      ...
      case Enum101.MERC_DISTORTION_PIXELATE_UP:
        ...
        fReturnStatus = PixelateVideoMercImage(
          true,
          MERC_VIDEO_FACE_X,
          MERC_VIDEO_FACE_Y,
          MERC_VIDEO_FACE_WIDTH,
          MERC_VIDEO_FACE_HEIGHT,
        );
        if (fReturnStatus)
          HandleCurrentMercDistortion__ubCurrentMercDistortionMode =
            Enum101.MERC_DISTORTION_PIXELATE_DOWN;
        break;
  ...
  function PixelateVideoMercImage(
    fUp: boolean,
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    ...
    if (PixelateVideoMercImage__ubPixelationAmount == 255) {
      if (fUp) PixelateVideoMercImage__ubPixelationAmount = 1;
      else PixelateVideoMercImage__ubPixelationAmount = 4;
          ...
          if (i < usPosX + usWidth - PixelateVideoMercImage__ubPixelationAmount)
            DestColor =
              pBuffer[
                j * uiPitch +
                  i +
                  Math.trunc(PixelateVideoMercImage__ubPixelationAmount / 2)
              ];
          else DestColor = pBuffer[j * uiPitch + i];
        }
  ...
  function DistortVideoMercImage(
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    usHeight: UINT16,
    ...
    if (DistortVideoMercImage__usDistortionValue >= usPosY + usHeight) {
      ...
      else usEndOnLine = DistortVideoMercImage__usDistortionValue + 10;

      for (
        j = usPosY + DistortVideoMercImage__usDistortionValue;
        j < usPosY + usEndOnLine;
        j++
      ) {
        for (i = usPosX; i < usPosX + usWidth; i++) {
          DestColor = pBuffer[j * uiPitch + i];
          ...
          DestColor = Get16BPPColor(
            FROMRGB(255 - red, 250 - green, 250 - blue),
          );
  ...
  /* static */ let InitDestroyXToCloseVideoWindow__fButtonCreated: boolean =
    false;
  function InitDestroyXToCloseVideoWindow(fCreate: boolean): boolean {
    ...
    if (fCreate && !InitDestroyXToCloseVideoWindow__fButtonCreated) {
      guiXToCloseMercVideoButtonImage = LoadButtonImage(
        "LAPTOP\\CloseButton.sti",
        -1,
        0,
        -1,
        1,
      ...
      guiXToCloseMercVideoButton = QuickCreateButton(
        guiXToCloseMercVideoButtonImage,
        MERC_X_TO_CLOSE_VIDEO_X,
        MERC_X_TO_CLOSE_VIDEO_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGH,
        DEFAULT_MOVE_CALLBACK(),
  ...
  function BtnXToCloseMercVideoButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
        ...
        if (DisplayMercVideoIntro(MERC_INTRO_TIME)) {
          ...
          if (
            ...
            gusMercVideoSpeckSpeech !=
              <number>MERC_VIDEO_SPECK_HAS_TO_TALK_BUT_QUOTE_NOT_CHOSEN_YET
          )
  ...
  export function DisplayTextForSpeckVideoPopUp(
    ...
    if (!gGameSettings.fOptions[Enum8.TOPTION_SUBTITLES]) return;
    ...
    iMercPopUpBox = PrepareMercPopupBox(
      iMercPopUpBox,
      ...
      0,
      0,
      gusSpeckDialogueActualWidth__Pointer,
      createPointer(
        () => usActualHeight,
        (v) => (usActualHeight = v),
      ),
    ...
    if (!(gMercSiteSubTitleMouseRegion.uiFlags & MSYS_REGION_EXISTS)) {
      MSYS_DefineRegion(
        gMercSiteSubTitleMouseRegion,
        gusSpeckDialogueX,
        MERC_TEXT_BOX_POS_Y,
        gusSpeckDialogueX + gusSpeckDialogueActualWidth,
        MERC_TEXT_BOX_POS_Y + usActualHeight,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_LAPTOP_SCREEN,
        MSYS_NO_CALLBACK,
        MercSiteSubTitleRegionCallBack,
      );
  ...
  */
  ...
  /* static */ let GetSpeckConditionalOpening__usQuoteToSay: UINT16 =
  ...
  function GetSpeckConditionalOpening(fJustEnteredScreen: boolean): boolean {
    ...
    if (
      LaptopSaveInfo.ubPlayerBeenToMercSiteStatus ==
        Enum102.MERC_SITE_FIRST_VISIT &&
      GetSpeckConditionalOpening__usQuoteToSay <= 8
    ) {
      //!= 0 )
    ...
    // We have been here at least 2 times before, Check which quote we should use
      ...
      // else if it is the first visit since the server went down
        ...
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_9_FIRST_VISIT_SINCE_SERVER_WENT_DOWN,
        );
        fCanUseIdleTag = true;
      }
      /*
    ...
    */
      // else if lots of MERC mercs are DEAD, and speck can say the quote ( dont want him to continously say it )
        ...
        CountNumberOfMercMercsWhoAreDead() >= 2 &&
        LaptopSaveInfo.ubSpeckCanSayPlayersLostQuote
      ) {
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_12_PLAYERS_LOST_MERCS,
        );
      ...
      // else if player owes lots of money
        ...
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_5_PLAYER_OWES_SPECK_ACCOUNT_SUSPENDED,
        );
      ...
      // else if the player owes speck a large sum of money, have speck say so
        ...
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_6_PLAYER_OWES_SPECK_ALMOST_BANKRUPT_1,
        );
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_6_PLAYER_OWES_SPECK_ALMOST_BANKRUPT_2,
        );
        ...
        if (
          ...
          StartSpeckTalking(
            Enum111.SPECK_QUOTE_ALTERNATE_OPENING_3_BUSINESS_GOOD,
          );
          fCanUseIdleTag = true;
        }
        ...
        //			else if( ubRandom < 80 && LaptopSaveInfo.gbNumDaysTillFourthMercArrives != -1 && LaptopSaveInfo.gbNumDaysTillFirstMercArrives < MERC_NUM_DAYS_TILL_FIRST_MERC_AVAILABLE )
          ...
          ubRandom < 80 &&
          gConditionsForMercAvailability[LaptopSaveInfo.ubLastMercAvailableId]
            .usMoneyPaid <= LaptopSaveInfo.uiTotalMoneyPaidToSpeck &&
          CanMercBeAvailableYet(LaptopSaveInfo.ubLastMercAvailableId)
        ) {
          StartSpeckTalking(
            Enum111.SPECK_QUOTE_ALTERNATE_OPENING_4_TRYING_TO_RECRUIT,
          );
          fCanUseIdleTag = true;
        }
        ...
        // else use the generic opening
          ...
          StartSpeckTalking(
            Enum111.SPECK_QUOTE_ALTERNATE_OPENING_10_GENERIC_OPENING,
          );
          fCanUseIdleTag = true;
          ...
          if (!LaptopSaveInfo.fSaidGenericOpeningInMercSite) {
            ...
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_ALTERNATE_OPENING_10_TAG_FOR_20,
            );
          }
        }
      }
      ...
      if (fCanUseIdleTag) {
        ...
        if (ubRandom < 50) {
          ...
          switch (ubRandom) {
            case 0:
              StartSpeckTalking(
                Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_ON_AFTER_OTHER_TAGS_1,
              );
              break;
            case 1:
              StartSpeckTalking(
                Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_ON_AFTER_OTHER_TAGS_2,
              );
              break;
            case 2:
              StartSpeckTalking(
                Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_ON_AFTER_OTHER_TAGS_3,
              );
              break;
            case 3:
              StartSpeckTalking(
                Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_ON_AFTER_OTHER_TAGS_4,
              );
              break;
            default:
              Assert(0);
    ...
    if (fCanSayLackOfPaymentQuote) {
      if (
        ...
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_PLAYER_OWES_MONEY,
        );
      }
    }
    ...
    if (LaptopSaveInfo.fNewMercsAvailableAtMercSite) {
      ...
      StartSpeckTalking(
        Enum111.SPECK_QUOTE_ALTERNATE_OPENING_11_NEW_MERCS_AVAILABLE,
      );
    }
    ...
    if (IsAnyMercMercsDead()) {
      ...
      if (!LaptopSaveInfo.fHasAMercDiedAtMercSite) {
        ...
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_FIRST_MERC_DIES,
        );
      }
      ...
      for (ubCnt = MERC_FIRST_MERC; ubCnt < MERC_LAST_MERC; ubCnt++) {
        ...
        if (IsMercDead(ubCnt)) {
          ...
          if (
            !(
              gMercProfiles[ubCnt].ubMiscFlags3 &
            ...
            switch (ubCnt) {
              case Enum268.BIFF:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_BIFF_IS_DEAD,
                );
                break;
              case Enum268.HAYWIRE:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_HAYWIRE_IS_DEAD,
                );
                break;
              case Enum268.GASKET:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_GASKET_IS_DEAD,
                );
                break;
              case Enum268.RAZOR:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_RAZOR_IS_DEAD,
                );
                break;
              case Enum268.FLO:
                // if biff is dead
                if (IsMercDead(Enum268.BIFF))
                  StartSpeckTalking(
                    Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_FLO_IS_DEAD_BIFF_IS_DEAD,
                  );
                else {
                  StartSpeckTalking(
                    Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_FLO_IS_DEAD_BIFF_ALIVE,
                  );
              ...
              case Enum268.GUMPY:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_GUMPY_IS_DEAD,
                );
                break;
              case Enum268.LARRY_NORMAL:
              case Enum268.LARRY_DRUNK:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_LARRY_IS_DEAD,
                );
                break;
              case Enum268.COUGAR:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_COUGER_IS_DEAD,
                );
                break;
              case Enum268.NUMB:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_NUMB_IS_DEAD,
                );
                break;
              case Enum268.BUBBA:
                StartSpeckTalking(
                  Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_BUBBA_IS_DEAD,
                );
                break;
            }
          }
    ...
    if (gubFact[Enum170.FACT_PC_MARRYING_DARYL_IS_FLO]) {
      ...
      if (
        !LaptopSaveInfo.fSpeckSaidFloMarriedCousinQuote &&
        !IsMercDead(Enum268.BIFF)
      ) {
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_FLO_MARRIED_A_COUSIN_BIFF_IS_ALIVE,
        );
    ...
    if (
      ...
      !(
        LaptopSaveInfo.uiSpeckQuoteFlags &
        SPECK_QUOTE__ALREADY_TOLD_PLAYER_THAT_LARRY_RELAPSED
      )
    ) {
      LaptopSaveInfo.uiSpeckQuoteFlags |=
        SPECK_QUOTE__ALREADY_TOLD_PLAYER_THAT_LARRY_RELAPSED;
      ...
      StartSpeckTalking(
        Enum111.SPECK_QUOTE_ALTERNATE_OPENING_TAG_LARRY_RELAPSED,
      );
    }
  ...
  function MercSiteSubTitleRegionCallBack(
    ...
    //	if( LaptopSaveInfo.iCurrentBalance >= 2000 )
    {
      ...
      switch (ubHiredMercID) {
        ...
        case Enum268.BIFF:
          ...
          if (
            IsMercMercAvailable(Enum268.LARRY_NORMAL) ||
            IsMercMercAvailable(Enum268.LARRY_DRUNK)
          )
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_BIFF_SPECK_PLUGS_LARRY,
            );

          // if flo is available, advertise for flo
          if (IsMercMercAvailable(Enum268.FLO))
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_BIFF_SPECK_PLUGS_FLO,
            );
          break;
        ...
        case Enum268.HAYWIRE:
          ...
          if (IsMercMercAvailable(Enum268.RAZOR))
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_HAYWIRE_SPECK_PLUGS_RAZOR,
            );
          break;
        ...
        case Enum268.RAZOR:
          ...
          if (IsMercMercAvailable(Enum268.HAYWIRE))
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_RAZOR_SPECK_PLUGS_HAYWIRE,
            );
          break;
        ...
        case Enum268.FLO:
          ...
          if (IsMercMercAvailable(Enum268.BIFF))
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_FLO_SPECK_PLUGS_BIFF,
            );
          break;
        ...
        case Enum268.LARRY_DRUNK:
          ...
          if (IsMercMercAvailable(Enum268.BIFF))
            StartSpeckTalking(
              Enum111.SPECK_QUOTE_PLAYERS_HIRES_LARRY_SPECK_PLUGS_BIFF,
            );
          break;
      }
    }
  ...
  function ShouldSpeckStartTalkingDueToActionOnSubPage(): boolean {
    ...
    if (gfJustHiredAMercMerc) {
      ...
      if (Random(100) > 50)
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_GENERIC_THANKS_FOR_HIRING_MERCS_1,
        );
      else
        StartSpeckTalking(
          Enum111.SPECK_QUOTE_GENERIC_THANKS_FOR_HIRING_MERCS_2,
        );
  ...
  function ShouldSpeckSayAQuote(): boolean {
    ...
    if (gfJustHiredAMercMerc) {
      gusMercVideoSpeckSpeech =
        MERC_VIDEO_SPECK_HAS_TO_TALK_BUT_QUOTE_NOT_CHOSEN_YET;
      return true;
  ...
  */
  ...
  function HandleSpeckIdleConversation(fReset: boolean): void {
    ...
    if (
      uiCurTime - HandleSpeckIdleConversation__uiLastTime >
      SPECK_IDLE_CHAT_DELAY
    ) {
      // if Speck is not talking
      if (!gfMercVideoIsBeingDisplayed) {
        sLeastSaidQuote = GetRandomQuoteThatHasBeenSaidTheLeast();

        if (sLeastSaidQuote != -1) gusMercVideoSpeckSpeech = sLeastSaidQuote;
  ...
  function GetRandomQuoteThatHasBeenSaidTheLeast(): INT16 {
    ...
    for (cnt = 0; cnt < MERC_NUMBER_OF_RANDOM_QUOTES; cnt++) {
      ...
      if (CanMercQuoteBeSaid(gNumberOfTimesQuoteSaid[cnt].ubQuoteID)) {
        ...
        if (
          gNumberOfTimesQuoteSaid[cnt].uiNumberOfTimesQuoteSaid <
    ...
    if (sSmallestNumber == 255) return -1;
    else return gNumberOfTimesQuoteSaid[sSmallestNumber].ubQuoteID;
  }

  function IncreaseMercRandomQuoteValue(
    ubQuoteID: UINT8,
    ubValue: UINT8,
  ): void {
    let cnt: UINT8;
    ...
    for (cnt = 0; cnt < MERC_NUMBER_OF_RANDOM_QUOTES; cnt++) {
      if (gNumberOfTimesQuoteSaid[cnt].ubQuoteID == ubQuoteID) {
        ...
        else gNumberOfTimesQuoteSaid[cnt].uiNumberOfTimesQuoteSaid += ubValue;
        break;
      }
    }
  }
  ...
  function ShouldTheMercSiteServerGoDown(): boolean {
    ...
    if (
      ...
      LaptopSaveInfo.ubLastMercAvailableId >= 1 &&
  ...
  export function GetMercSiteBackOnline(): void {
    ...
    AddEmail(
      MERC_NEW_SITE_ADDRESS,
      MERC_NEW_SITE_ADDRESS_LENGTH,
      Enum75.SPECK_FROM_MERC,
      GetWorldTotalMin(),
    );
  ...
  function DrawMercVideoBackGround(): void {
    ...
    DrawTextToScreen(
      MercHomePageText[Enum343.MERC_SPECK_COM],
      MERC_X_VIDEO_TITLE_X,
      MERC_X_VIDEO_TITLE_Y,
      0,
      MERC_VIDEO_TITLE_FONT(),
      MERC_VIDEO_TITLE_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
  ...
  function CanMercQuoteBeSaid(uiQuoteID: UINT32): boolean {
    ...
    switch (uiQuoteID) {
      ...
      case Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_COUGER:
        if (!IsMercMercAvailable(Enum268.COUGAR)) fRetVal = false;
        break;

      case Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_NUMB:
        if (!IsMercMercAvailable(Enum268.NUMB)) fRetVal = false;
        break;

      case Enum111.SPECK_QUOTE_PLAYER_NOT_DOING_ANYTHING_SPECK_SELLS_BUBBA:
        if (!IsMercMercAvailable(Enum268.BUBBA)) fRetVal = false;
        break;
    }
  ...
  */
  ...
  function AreAnyOfTheNewMercsAvailable(): boolean {
    ...
    for (
      i = Enum268.LARRY_NORMAL - Enum268.BIFF;
      i <= LaptopSaveInfo.gubLastMercIndex;
      i++
    ) {
      ubMercID = GetMercIDFromMERCArray(i);
  ...
  function ShouldAnyNewMercMercBecomeAvailable(): void {
    ...
    if (fNewMercAreAvailable) {
      ...
      AddStrategicEvent(
        Enum132.EVENT_MERC_SITE_NEW_MERC_AVAILABLE,
        GetMidnightOfFutureDayInMinutes(1) + 420 + Random(3 * 60),
        0,
      );
    }
  }
  ...
  function CanMercBeAvailableYet(ubMercToCheck: UINT8): boolean {
    ...
    if (
      gConditionsForMercAvailability[ubMercToCheck].ubMercArrayID <=
    ...
    if (
      gConditionsForMercAvailability[ubMercToCheck].usMoneyPaid <=
  ...
  export function CalcAproximateAmountPaidToSpeck(): void {
    ...
    for (i = 0; i < NUMBER_OF_MERCS; i++) {
      ...
      LaptopSaveInfo.uiTotalMoneyPaidToSpeck +=
        gMercProfiles[ubMercID].uiTotalCostToDate;
    }
  }
