namespace ja2 {
  ...
  let giIMPPersonalityEntranceButtonImage: INT32[] /* [1] */ = createArray(
    1,
    0,
  );
  ...
  function CreateIMPPersonalityEntranceButtons(): void {
    ...
    // ths begin button
    giIMPPersonalityEntranceButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
...
*/
  ...
  function BtnIMPPersonalityEntranceDoneCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
