namespace ja2 {
  ...
  export let WeaponROF: INT16[] /* [MAX_WEAPONS] */ = [
    ...
    40 /* Glock 17        */, 1300 /* Glock 18        */,
    45 /* Beretta 92F     */, 1100 /* Beretta 93R     */,
    25 /* .38 S&W Special */, 23 /* .357 Barracuda  */,
    27 /* .357 DesertEagle*/, 35 /* .45 M1911			 */, 900 /* H&K MP5K      	 */,
    1090,
    /* .45 MAC-10	     */ // 10

    700 /* Thompson M1A1   */, 900 /* Colt Commando   */, 700 /* H&K MP53		 		 */,
    800 /* AKSU-74         */, 900 /* 5.7mm FN P90    */,
    780 /* Type-85         */, 40 /* SKS             */,
    20 /* Dragunov        */, 20 /* M24             */, 650,
    /* Steyr AUG       */ // 20

    850 /* H&K G41         */, 750 /* Ruger Mini-14   */,
    600 /* C-7             */, 900 /* FA-MAS          */,
    650 /* AK-74           */, 600 /* AKM             */,
    750 /* M-14            */, 650 /* FN-FAL          */,
    500 /* H&K G3A3        */, 600,
    ...
    21 /* Remington M870  */, 30 /* SPAS-15         */,
    -1 /* CAWS            */, 750 /* FN Minimi       */,
    800 /* RPK-74          */, 800 /* H&K 21E         */, 0 /* combat knife */,
    0 /* throwing knife */, 0 /* rock */, 1,
    /* grenade launcher */ // 40

    1 /* mortar */, 0 /* another rock    */, 0 /* claws */, 0 /* claws */,
    0 /* claws */, 0 /* claws */, 0 /* tentacles */, 0 /* spit  */,
    0 /* brass knuckles */, 1,
    /* underslung g.l. */ // 50

    1 /* rocket launcher */, 0 /* nothing */, 0 /* nothing */, 0 /* machete */,
    1 /* rocket rifle */, 666 /* Automag III */, 0 /* spit */, 0 /* spit */,
    0 /* spit */, 1 /* tank cannon */, 1 /* dart gun */,
  ];

  // SetupStoreInventory sets up the initial quantity on hand for all of Bobby Ray's inventory items
  export function SetupStoreInventory(
    ...
    for (i = 0; i < LaptopSaveInfo.usInventoryListLength[Number(fUsed)]; i++) {
      ...
      ubNumBought = DetermineInitialInvItems(
        -1,
        usItemIndex,
        StoreInventory[usItemIndex][Number(fUsed)],
        fUsed,
      );
      if (ubNumBought > 0) {
        // If doing used items
  ...
  function DoesGunOfSameClassExistInInventory(
    ubItemIndex: UINT8,
    ubDealerID: UINT8,
  ): boolean {
    let i: UINT16;
  ...
  function GetPtrToStoreInventory(ubDealerID: UINT8): STORE_INVENTORY[] | null {
    if (ubDealerID >= Enum112.BOBBY_RAY_LISTS) return null;
