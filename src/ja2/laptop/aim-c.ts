namespace ja2 {
  export let AimMercArray: UINT8[] /* [MAX_NUMBER_MERCS] */ = createArray(
    MAX_NUMBER_MERCS,
    0,
  );
  ...
  let guiBottomButtons: UINT32[] /* [NUM_AIM_SCREENS] */ = createArray(
    NUM_AIM_SCREENS,
    0,
  );
  ...
  export function EnterAIM(): boolean {
    ...
    MSYS_DefineRegion(
      ...
      MEMBERCARD_X,
      MEMBERCARD_Y,
      MEMBERCARD_X + LINK_SIZE_X,
      MEMBERCARD_Y + LINK_SIZE_Y,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      POLICIES_X,
      POLICIES_Y,
      POLICIES_X + LINK_SIZE_X,
      POLICIES_Y + LINK_SIZE_Y,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      HISTORY_X,
      HISTORY_Y,
      HISTORY_X + LINK_SIZE_X,
      HISTORY_Y + LINK_SIZE_Y,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
  ...
  export function RenderAIM(): void {
    ...
    // members
    DrawTextToScreen(
      AimBottomMenuText[Enum363.AIM_MEMBERS],
      MEMBERCARD_X,
      MEMBERS_TEXT_Y,
      LINK_SIZE_X,
      FONT12ARIAL(),
    ...
    // Policies
    DrawTextToScreen(
      AimBottomMenuText[Enum363.AIM_POLICIES],
      POLICIES_X,
      POLICIES_TEXT_Y,
      LINK_SIZE_X,
      FONT12ARIAL(),
    ...
    // History
    DrawTextToScreen(
      AimBottomMenuText[Enum363.AIM_HISTORY],
      HISTORY_X,
      HISTORY_TEXT_Y,
      LINK_SIZE_X,
      FONT12ARIAL(),
    ...
    // Links
    DrawTextToScreen(
      AimBottomMenuText[Enum363.AIM_LINKS],
      LINKS_X,
      LINK_TEXT_Y,
      LINK_SIZE_X,
      FONT12ARIAL(),
  ...
  function SelectMemberCardRegionCallBack(
  ...
  function SelectPoliciesRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectHistoryRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectLinksRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  export function InitAimDefaults(): boolean {
    ...
    MSYS_DefineRegion(
      ...
      AIM_SYMBOL_X,
      AIM_SYMBOL_Y,
      AIM_SYMBOL_X + AIM_SYMBOL_WIDTH,
      AIM_SYMBOL_Y + AIM_SYMBOL_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
  ...
  function SelectAimLogoRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  export function DisplayAimSlogan(): boolean {
    ...
    sSlogan = LoadEncryptedDataFromFile(
      AIMHISTORYFILE,
      0,
  ...
  export function DisplayAimCopyright(): boolean {
    ...
    DrawTextToScreen(
      sSlogan,
      AIM_COPYRIGHT_X,
      AIM_COPYRIGHT_Y + AIM_COPYRIGHT_GAP,
      AIM_COPYRIGHT_WIDTH,
      AIM_COPYRIGHT_FONT(),
      FONT_MCOLOR_DKWHITE,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      sSlogan,
      AIM_COPYRIGHT_X,
      AIM_COPYRIGHT_Y + AIM_COPYRIGHT_GAP * 2,
      AIM_COPYRIGHT_WIDTH,
      AIM_COPYRIGHT_FONT(),
      FONT_MCOLOR_DKWHITE,
      FONT_MCOLOR_BLACK,
  ...
  export function InitAimMenuBar(): boolean {
    ...
    guiBottomButtonImage = LoadButtonImage(
  ...
  function HandleAdAndWarningArea(fInit: boolean, fRedraw: boolean): void {
    if (fInit) gubCurrentAdvertisment = Enum62.AIM_AD_WARNING_BOX;
    else {
      if (
        HandleAdAndWarningArea__ubPreviousAdvertisment == Enum62.AIM_AD_DONE
      ) {
    ...
    switch (gubCurrentAdvertisment) {
      case Enum62.AIM_AD_WARNING_BOX:
        MSYS_DisableRegion(gSelectedBannerRegion);
        HandleAdAndWarningArea__ubPreviousAdvertisment = DrawWarningBox(
          fInit,
          fRedraw,
        );
        break;
      ...
      case Enum62.AIM_AD_FLOWER_SHOP:
        HandleAdAndWarningArea__ubPreviousAdvertisment = DisplayFlowerAd(
          fInit,
          fRedraw,
        );
        break;
      ...
      case Enum62.AIM_AD_FOR_ADS:
        // disable the region because only certain banners will be 'clickable'
        MSYS_DisableRegion(gSelectedBannerRegion);
        HandleAdAndWarningArea__ubPreviousAdvertisment = DisplayAd(
          fInit,
          fRedraw,
          AIM_AD_FOR_ADS_DELAY,
          AIM_AD_FOR_ADS__NUM_SUBIMAGES,
          guiAdForAdsImages,
        );
        break;
      ...
      case Enum62.AIM_AD_INSURANCE_AD:
        ...
        HandleAdAndWarningArea__ubPreviousAdvertisment = DisplayAd(
          fInit,
          fRedraw,
          AIM_AD_INSURANCE_AD_DELAY,
          AIM_AD_INSURANCE_AD__NUM_SUBIMAGES,
          guiInsuranceAdImages,
        );
        break;
      ...
      case Enum62.AIM_AD_FUNERAL_ADS:
        ...
        HandleAdAndWarningArea__ubPreviousAdvertisment = DisplayAd(
          fInit,
          fRedraw,
          AIM_AD_FUNERAL_AD_DELAY,
          AIM_AD_FUNERAL_AD__NUM_SUBIMAGES,
          guiFuneralAdImages,
        );
        break;
      ...
      case Enum62.AIM_AD_BOBBY_RAY_AD:
        ...
        HandleAdAndWarningArea__ubPreviousAdvertisment = DisplayBobbyRAd(
          fInit,
          fRedraw,
        );
        break;
  ...
  function DisplayFlowerAd(fInit: boolean, fRedraw: boolean): UINT8 {
    ...
    if (
      uiCurTime - DisplayFlowerAd__uiLastTime > AIM_FLOWER_AD_DELAY ||
      fRedraw
    ) {
      ...
      if (DisplayFlowerAd__ubSubImage == AIM_FLOWER_NUM_SUBIMAGES) {
        if (DisplayFlowerAd__ubCount == 0 || fRedraw) {
          ...
          DisplayWrappedString(
            ...
            FONT14ARIAL(),
            FONT_GREEN,
            AimScreenText[Enum362.AIM_INFO_6],
            FONT_MCOLOR_BLACK,
            false,
            CENTER_JUSTIFIED,
          );
          ...
          DisplayWrappedString(
            AIM_WARNING_TEXT_X,
            AIM_FLOWER_LINK_TEXT_Y,
            AIM_WARNING_TEXT_WIDTH,
            2,
            FONT12ARIAL(),
            2,
            AimScreenText[Enum362.AIM_INFO_7],
            FONT_MCOLOR_BLACK,
            false,
            CENTER_JUSTIFIED,
          );
        ...
        } else return Enum62.AIM_AD_NOT_DONE;
      } else {
        hAdHandle = GetVideoObject(guiFlowerAdvertisement);
        BltVideoObject(
          FRAME_BUFFER,
  ...
  function DrawWarningBox(fInit: boolean, fRedraw: boolean): UINT8 {
    ...
    if (fInit || fRedraw) {
      ...
      let uiStartLoc: UINT32 = 0;
      let usLocY: UINT16 =
        AIM_WARNING_TEXT_Y + (GetFontHeight(AIM_WARNING_FONT()) + 2) * 2;
      ...
      if (fInit) DrawWarningBox__uiLastTime = uiCurTime;
    }
  ...
  function SelectBannerRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
    ...
    switch (gubCurrentAdvertisment) {
      ...
      case Enum62.AIM_AD_BOBBY_RAY_AD:
        ...
        if (ubCurSubImage <= AIM_AD_BOBBYR_AD_NUM_DUCK_SUBIMAGES) {
          ...
          SetFontShadow(2);
          DisplayWrappedString(
            AIM_BOBBYR1_LINK_TEXT_X,
            AIM_BOBBYR1_LINK_TEXT_Y,
            AIM_WARNING_TEXT_WIDTH,
            2,
            BOBBYR_UNDER_CONSTRUCTION_AD_FONT(),
            BOBBYR_UNDER_CONSTRUCTION_AD_COLOR,
            AimScreenText[Enum362.AIM_BOBBYR_ADD1],
            FONT_MCOLOR_BLACK,
            false,
            LEFT_JUSTIFIED | INVALIDATE_TEXT,
          );
          SetFontShadow(DEFAULT_SHADOW);
          ...
          SetFontShadow(2);
          DisplayWrappedString(
            AIM_BOBBYR2_LINK_TEXT_X,
            AIM_BOBBYR2_LINK_TEXT_Y,
            AIM_WARNING_TEXT_WIDTH,
            2,
            BOBBYR_UNDER_CONSTRUCTION_AD_FONT(),
            BOBBYR_UNDER_CONSTRUCTION_AD_COLOR,
            AimScreenText[Enum362.AIM_BOBBYR_ADD2],
            FONT_MCOLOR_BLACK,
            false,
            LEFT_JUSTIFIED | INVALIDATE_TEXT,
          );
    ...
    if (uiCurTime - DisplayBobbyRAd__uiLastTime > usDelay || fRedraw) {
      ...
      if (DisplayBobbyRAd__ubDuckCount < 2) {
        ...
        if (DisplayBobbyRAd__ubSubImage > AIM_AD_BOBBYR_AD_NUM_DUCK_SUBIMAGES) {
          ...
          if (DisplayBobbyRAd__ubDuckCount < 2) DisplayBobbyRAd__ubSubImage = 0;
          else
            DisplayBobbyRAd__ubSubImage =
              AIM_AD_BOBBYR_AD_NUM_DUCK_SUBIMAGES + 1;
        }
        ubRetVal = Enum62.AIM_AD_NOT_DONE;
      } else {
        // Blit the ad
        ...
        if (
          DisplayBobbyRAd__ubSubImage >=
          AIM_AD_BOBBYR_AD__NUM_SUBIMAGES - 1
        ) {
  ...
  function GetNextAimAd(ubCurrentAd: UINT8): UINT8 {
    ...
    if (ubCurrentAd == Enum62.AIM_AD_WARNING_BOX) {
      if (uiDay < AIM_AD_BOBBYR_AD_STARTS) {
        ...
        ubNextAd = Enum62.AIM_AD_FLOWER_SHOP; // if( uiDay < AIM_AD_DAY_INSURANCE_AD_STARTS )
      else ubNextAd = Enum62.AIM_AD_INSURANCE_AD;
    } else {
