namespace ja2 {
  ...
  export const LAPTOP_SCREEN_WEB_LR_Y =
    LAPTOP_SCREEN_WEB_UL_Y + LAPTOP_SCREEN_HEIGHT;
  export const LAPTOP_SCREEN_WEB_DELTA_Y =
    LAPTOP_SCREEN_WEB_UL_Y - LAPTOP_SCREEN_UL_Y;
