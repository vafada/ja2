namespace ja2 {
  ...
  export function readLifeInsurancePayout(
    o: LIFE_INSURANCE_PAYOUT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset++; // padding
    o.iPayOutPrice = buffer.readInt32LE(offset);
    offset += 4;
    return offset;
  }

  export function writeLifeInsurancePayout(
    o: LIFE_INSURANCE_PAYOUT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function readLastHiredMercStruct(
    o: LAST_HIRED_MERC_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.fHaveDisplayedPopUpInLaptop = Boolean(buffer.readUInt8(offset++));
    offset += 3; // padding
    o.iIdOfMerc = buffer.readInt32LE(offset);
    offset += 4;
  ...
  export function writeLastHiredMercStruct(
    o: LAST_HIRED_MERC_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function copyBobbyRayPurchaseStruct(
    destination: BobbyRayPurchaseStruct,
    source: BobbyRayPurchaseStruct,
  ) {
  ...
  export function readBobbyRayPurchaseStruct(
    o: BobbyRayPurchaseStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.usItemIndex = buffer.readUInt16LE(offset);
    offset += 2;
    o.ubNumberPurchased = buffer.readUInt8(offset++);
    o.bItemQuality = buffer.readInt8(offset++);
    o.usBobbyItemIndex = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeBobbyRayPurchaseStruct(
    o: BobbyRayPurchaseStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function createBobbyRayOrderStruct(): BobbyRayOrderStruct {
    return {
      fActive: false,
      BobbyRayPurchase: createArrayFrom(
        MAX_PURCHASE_AMOUNT,
        createBobbyRayPurchaseStruct,
      ),
      ubNumberPurchases: 0,
    };
  }
  ...
  export function readBobbyRayOrderStruct(
    o: BobbyRayOrderStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.fActive = Boolean(buffer.readUInt8(offset++));
  ...
  export function writeBobbyRayOrderStruct(
    o: BobbyRayOrderStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function createLaptopSaveInfoStruct(): LaptopSaveInfoStruct {
    return {
      ...
      BobbyRayInventory: createArrayFrom(
        Enum225.MAXITEMS,
        createStoreInventory,
      ),
      BobbyRayUsedInventory: createArrayFrom(
        Enum225.MAXITEMS,
        createStoreInventory,
      ),
  ...
  export function readLaptopSaveInfoStruct(
    o: LaptopSaveInfoStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    o.iCurrentBalance = buffer.readInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.guiPlayersMercAccountNumber = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.guiNumberOfMercPaymentsInDays = buffer.readUInt32LE(offset);
    offset += 4;

    offset = readUIntArray(o.usInventoryListLength, buffer, offset, 2);

    o.iVoiceId = buffer.readInt32LE(offset);
    offset += 4;

    o.ubHaveBeenToBobbyRaysAtLeastOnceWhileUnderConstruction = buffer.readUInt8(
      offset++,
    );
    ...
    o.iCurrentHistoryPage = buffer.readInt32LE(offset);
    offset += 4;
    o.iCurrentFinancesPage = buffer.readInt32LE(offset);
    offset += 4;
    o.iCurrentEmailPage = buffer.readInt32LE(offset);
    offset += 4;

    o.uiSpeckQuoteFlags = buffer.readUInt32LE(offset);
    offset += 4;

    o.uiFlowerOrderNumber = buffer.readUInt32LE(offset);
    offset += 4;

    o.uiTotalMoneyPaidToSpeck = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export function writeLaptopSaveInfoStruct(
    o: LaptopSaveInfoStruct,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset = buffer.writeUInt8(
      Number(o.fFirstVisitSinceServerWentDown),
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      Number(o.fSpeckSaidFloMarriedCousinQuote),
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      o.ubHaveBeenToBobbyRaysAtLeastOnceWhileUnderConstruction,
      offset,
    );
