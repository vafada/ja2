namespace ja2 {
  ...
  const FLOWER_ORDER_NAME_BOX_Y =
    LAPTOP_SCREEN_WEB_UL_Y + 314 - FLOWER_ORDER_SMALLER_PS_OFFSET_Y;
  ...
  const FLOWER_ORDER_BILLING_INFO_Y =
  ...
  const FLOWER_ORDER_LINK_TO_CARD_GALLERY_Y =
  ...
  const FLOWER_ORDER_DROP_DOWN_LOCATION_Y =
    FLOWER_ORDER_DELIVERY_LOCATION_Y + 19;
  const FLOWER_ORDER_DROP_DOWN_LOCATION_WIDTH = 230;

  const FLOWER_ORDER_DROP_DOWN_CITY_START_X =
    FLOWER_ORDER_DROP_DOWN_LOCATION_X + 5;
  const FLOWER_ORDER_DROP_DOWN_CITY_START_Y =
    FLOWER_ORDER_DROP_DOWN_LOCATION_Y + 3;
  ...
  function createFlowerOrderLocationStructFrom(
    psCityLoc: string,
    ubNextDayDeliveryCost: UINT8,
    ubWhenItGetsThereCost: UINT8,
  ...
  let gSelectedFloristCheckBoxRegion: MOUSE_REGION[] /* [6] */ =
    createArrayFrom(6, createMouseRegion);
  ...
  export function EnterFloristOrderForm(): boolean {
    ...
    guiFlowerOrderButtonImage = LoadButtonImage(
    ...
    guiFlowerOrderBackButton = CreateIconAndTextButton(
      guiFlowerOrderButtonImage,
      sOrderFormText[Enum346.FLORIST_ORDER_BACK],
    ...
    guiFlowerOrderSendButton = CreateIconAndTextButton(
      guiFlowerOrderButtonImage,
      sOrderFormText[Enum346.FLORIST_ORDER_SEND],
      FLORIST_BUTTON_TEXT_FONT(),
      FLORIST_BUTTON_TEXT_UP_COLOR,
      FLORIST_BUTTON_TEXT_SHADOW_COLOR,
      FLORIST_BUTTON_TEXT_DOWN_COLOR,
    ...
    guiFlowerOrderClearButton = CreateIconAndTextButton(
      guiFlowerOrderButtonImage,
      sOrderFormText[Enum346.FLORIST_ORDER_CLEAR],
      FLORIST_BUTTON_TEXT_FONT(),
      FLORIST_BUTTON_TEXT_UP_COLOR,
      FLORIST_BUTTON_TEXT_SHADOW_COLOR,
      FLORIST_BUTTON_TEXT_DOWN_COLOR,
    ...
    guiFlowerOrderGalleryButton = CreateIconAndTextButton(
      guiFlowerOrderButtonImage,
      sOrderFormText[Enum346.FLORIST_ORDER_GALLERY],
      FLORIST_BUTTON_TEXT_FONT(),
      FLORIST_BUTTON_TEXT_UP_COLOR,
      FLORIST_BUTTON_TEXT_SHADOW_COLOR,
      FLORIST_BUTTON_TEXT_DOWN_COLOR,
    ...
    i = 0;
    MSYS_DefineRegion(
      gSelectedFloristCheckBoxRegion[i],
      FLOWER_ORDER_CHECK_BOX_0_X,
      FLOWER_ORDER_CHECK_BOX_0_Y,
      FLOWER_ORDER_CHECK_BOX_0_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_0_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_CHECK_BOX_1_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_1_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectFlorsitCheckBoxRegionCallBack,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_CHECK_BOX_2_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_2_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectFlorsitCheckBoxRegionCallBack,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_CHECK_BOX_3_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_3_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectFlorsitCheckBoxRegionCallBack,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_CHECK_BOX_4_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_4_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectFlorsitCheckBoxRegionCallBack,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_CHECK_BOX_5_X + FLOWER_ORDER_CHECK_WIDTH,
      FLOWER_ORDER_CHECK_BOX_5_Y + FLOWER_ORDER_CHECK_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectFlorsitCheckBoxRegionCallBack,
    ...
    usPosX =
      StringPixLength(
        sOrderFormText[Enum346.FLORIST_ORDER_SELECT_FROM_OURS],
        FLOWER_ORDEER_SMALL_FONT(),
      ) +
      2 +
      FLOWER_ORDER_LINK_TO_CARD_GALLERY_X;
    usWidth = StringPixLength(
      sOrderFormText[Enum346.FLORIST_ORDER_STANDARDIZED_CARDS],
      FLOWER_ORDEER_SMALL_FONT(),
    );
    usHeight = GetFontHeight(FLOWER_ORDEER_SMALL_FONT());
    MSYS_DefineRegion(
      gSelectedFloristCardGalleryLinkRegion,
      usPosX,
      FLOWER_ORDER_LINK_TO_CARD_GALLERY_Y,
      usPosX + usWidth,
      FLOWER_ORDER_LINK_TO_CARD_GALLERY_Y + usHeight,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      FLOWER_ORDER_FLOWER_BOX_Y + FLOWER_ORDER_FLOWER_BOX_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      gSelectedFloristDropDownRegion,
    ...
    MSYS_DefineRegion(
      gSelectedFloristDisableDropDownRegion,
      LAPTOP_SCREEN_UL_X,
  ...
  export function RenderFloristOrderForm(): void {
    ...
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_NAME_BOUQUET],
    ...
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_PRICE],
    ...
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_ORDER_NUMBER],
    ...
    // Deliverry Date
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_DELIVERY_DATE],
      FLOWER_ORDER_ORDER_NUM_NAME_X,
      FLOWER_ORDER_DATE_Y,
      0,
    ...
    // Next day
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_NEXT_DAY],
      FLOWER_ORDER_CHECK_BOX_0_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_0_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    // When it get there
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_GETS_THERE],
      FLOWER_ORDER_CHECK_BOX_1_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_1_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    // Deliverry locatiuon
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_DELIVERY_LOCATION],
      FLOWER_ORDER_ORDER_NUM_NAME_X,
    ...
    // Additional services
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_ADDITIONAL_CHARGES],
    ...
    // crushed bouquet
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_CRUSHED],
      FLOWER_ORDER_CHECK_BOX_2_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_2_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    // black roses
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_BLACK_ROSES],
      FLOWER_ORDER_CHECK_BOX_3_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_3_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    // wilted bouquet
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_WILTED],
      FLOWER_ORDER_CHECK_BOX_4_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_4_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    // fruit cake
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_FRUIT_CAKE],
      FLOWER_ORDER_CHECK_BOX_5_X + FLOWER_ORDER_CHECK_WIDTH + 3,
      FLOWER_ORDER_CHECK_BOX_5_Y + 2,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    usPosX =
      ...
      StringPixLength(
        sOrderFormText[Enum346.FLORIST_ORDER_PERSONAL_SENTIMENTS],
        FLOWER_ORDEER_BIG_FONT(),
      ) +
      5;
    DrawTextToScreen(
    ...
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_CARD_LENGTH],
      usPosX,
      FLOWER_ORDER_PERSONAL_SENT_TEXT_Y + 2,
      0,
    ...
    // Billing information
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_BILLING_INFO],
    ...
    // Billing Name
    DrawTextToScreen(
      sOrderFormText[Enum346.FLORIST_ORDER_NAME],
  ...
  function BtnFlowerOrderBackButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  function BtnFlowerOrderSendButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  function BtnFlowerOrderClearButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  function BtnFlowerOrderGalleryButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  function SelectFlorsitCheckBoxRegionCallBack(
    ...
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      switch (uiUserData) {
        ...
        case 1:
          ...
          break;
        case 2:
          if (gfFLoristCheckBox2Down) gfFLoristCheckBox2Down = false;
          else gfFLoristCheckBox2Down = true;
          break;
        case 3:
          if (gfFLoristCheckBox3Down) gfFLoristCheckBox3Down = false;
          else gfFLoristCheckBox3Down = true;
          break;
        case 4:
          if (gfFLoristCheckBox4Down) gfFLoristCheckBox4Down = false;
          else gfFLoristCheckBox4Down = true;
          break;
        case 5:
          if (gfFLoristCheckBox5Down) gfFLoristCheckBox5Down = false;
          else gfFLoristCheckBox5Down = true;
          break;
      }
      DisplayFloristCheckBox();
  ...
  function SelectFloristCardGalleryLinkRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  */
    ...
    usPosX =
      ...
      FLOWER_ORDER_BOUQUET_NAME_X;
    uiStartLoc =
      FLOR_GALLERY_TEXT_TOTAL_SIZE * guiCurrentlySelectedFlower +
      FLOR_GALLERY_TEXT_TITLE_SIZE;
    sTemp = LoadEncryptedDataFromFile(
      FLOR_GALLERY_TEXT_FILE,
      uiStartLoc,
    ...
    if (gfFLoristCheckBox0Down)
      guiFlowerPrice +=
        usPrice +
        FlowerOrderLocations[gubCurrentlySelectedFlowerLocation]
          .ubNextDayDeliveryCost;
  ...
  function SelectFloristGalleryLinkRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectFloristDropDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectFloristDisableDropDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectFlowerDropDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectFlowerDropDownMovementCallBack(
    pRegion: MOUSE_REGION,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
  ...
  /* static */ let CreateDestroyFlowerOrderDestDropDown__fMouseRegionsCreated: boolean =
    false;
  function CreateDestroyFlowerOrderDestDropDown(
    ubDropDownMode: UINT8,
  ): boolean {
      ...
      case Enum81.FLOWER_ORDER_DROP_DOWN_CREATE:
        {
          ...
          let usPosY: UINT16;
          let usTemp: UINT16;
          let usFontHeight: UINT16 = GetFontHeight(
          ...
          for (i = 0; i < FLOWER_ORDER_NUMBER_OF_DROP_DOWN_LOCATIONS; i++) {
            MSYS_DefineRegion(
              gSelectedFlowerDropDownRegion[i],
              usPosX,
              usPosY + 4,
              usPosX + FLOWER_ORDER_DROP_DOWN_LOCATION_WIDTH,
              usPosY + usFontHeight,
              MSYS_PRIORITY_HIGH + 3,
              Enum317.CURSOR_WWW,
              SelectFlowerDropDownMovementCallBack,
      ...
      case Enum81.FLOWER_ORDER_DROP_DOWN_DESTROY:
        {
          ...
          ColorFillVideoSurfaceArea(
            FRAME_BUFFER,
            FLOWER_ORDER_DROP_DOWN_LOCATION_X + 3,
          ...
          DrawTextToScreen(
            FlowerOrderLocations[gubCurrentlySelectedFlowerLocation].psCityLoc,
            FLOWER_ORDER_DROP_DOWN_CITY_START_X + 6,
            FLOWER_ORDER_DROP_DOWN_CITY_START_Y + 3,
            0,
            FLOWER_ORDEER_DROP_DOWN_FONT(),
      ...
      case Enum81.FLOWER_ORDER_DROP_DOWN_DISPLAY:
        {
          ...
          ColorFillVideoSurfaceArea(
            ...
            FLOWER_ORDER_DROP_DOWN_LOCATION_X +
              FLOWER_ORDER_DROP_DOWN_LOCATION_WIDTH,
            FLOWER_ORDER_DROP_DOWN_LOCATION_Y +
              CreateDestroyFlowerOrderDestDropDown__usHeight,
            Get16BPPColor(FROMRGB(0, 0, 0)),
          );
          ...
          for (
            i = 10;
            i < FLOWER_ORDER_DROP_DOWN_LOCATION_WIDTH - 10;
            i += 10
          ) {
            // TOP ROW
            BltVideoObject(
              ...
              hImageHandle,
              1,
              i + FLOWER_ORDER_DROP_DOWN_LOCATION_X,
          ...
          for (
            i = 10;
            i < CreateDestroyFlowerOrderDestDropDown__usHeight - 10;
            i += 10
          ) {
            BltVideoObject(
              FRAME_BUFFER,
              hImageHandle,
              3,
              usPosX + FLOWER_ORDER_DROP_DOWN_LOCATION_X,
          ...
          BltVideoObject(
            ...
            hImageHandle,
            0,
            0 + FLOWER_ORDER_DROP_DOWN_LOCATION_X,
            usPosY + FLOWER_ORDER_DROP_DOWN_LOCATION_Y,
            VO_BLT_SRCTRANSPARENCY,
            null,
          );
          ...
          for (i = 0; i < FLOWER_ORDER_NUMBER_OF_DROP_DOWN_LOCATIONS; i++) {
            DrawTextToScreen(
              FlowerOrderLocations[i].psCityLoc,
              FLOWER_ORDER_DROP_DOWN_CITY_START_X + 6,
              usPosY,
              0,
              FLOWER_ORDEER_DROP_DOWN_FONT(),
  ...
  function FlowerOrderDrawSelectedCity(ubNumber: UINT8): void {
    ...
    usPosY =
      (usFontHeight + 2) * ubNumber + FLOWER_ORDER_DROP_DOWN_CITY_START_Y;
    ...
    DrawTextToScreen(
      FlowerOrderLocations[ubNumber].psCityLoc,
      FLOWER_ORDER_DROP_DOWN_CITY_START_X + 6,
      usPosY + 3,
      0,
      FLOWER_ORDEER_DROP_DOWN_FONT(),
  ...
  function FlowerOrderDisplayShippingLocationCity(): void {
    ...
    DrawTextToScreen(
      ...
      FLOWER_ORDER_DELIVERY_LOCATION_Y + 5,
      0,
      FLOWER_ORDEER_SMALL_FONT(),
      FLOWER_ORDEER_SMALL_COLOR,
      FONT_MCOLOR_BLACK,
  ...
  function InitFlowerOrderTextInputBoxes(): void {
    ...
    if (gbCurrentlySelectedCard != -1) {
      ...
      gsSentimentTextField = sText.substring(
        0,
        FLOWER_ORDER_PERSONEL_SENTIMENT_NUM_CHARS - 1,
      );
    ...
    if (
      gsSentimentTextField.length >=
      FLOWER_ORDER_PERSONEL_SENTIMENT_NUM_CHARS - 2
    ) {
      gsSentimentTextField = gsSentimentTextField.substring(
        0,
        FLOWER_ORDER_PERSONEL_SENTIMENT_NUM_CHARS - 1,
      );
    }
  ...
  function FlowerOrderUserTextFieldCallBack(
    ubID: UINT8,
    fEntering: boolean,
  ): void {
    if (fEntering) {
