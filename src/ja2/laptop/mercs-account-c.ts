namespace ja2 {
  ...
  export function EnterMercsAccount(): boolean {
    ...
    guiMercAuthorizeButtonImage = LoadButtonImage(
    ...
    guiMercAuthorizeBoxButton = CreateIconAndTextButton(
      guiMercAuthorizeButtonImage,
      MercAccountText[Enum340.MERC_ACCOUNT_AUTHORIZE],
      FONT12ARIAL(),
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_AC_AUTHORIZE_BUTTON_X,
      MERC_AC_AUTHORIZE_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    guiMercBackBoxButton = CreateIconAndTextButton(
      guiMercAuthorizeButtonImage,
      MercAccountText[Enum340.MERC_ACCOUNT_HOME],
      FONT12ARIAL(),
      MERC_BUTTON_UP_COLOR,
      DEFAULT_SHADOW,
      MERC_BUTTON_DOWN_COLOR,
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_AC_CANCEL_BUTTON_X,
      MERC_AC_CANCEL_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
  ...
  export function RenderMercsAccount(): void {
    ...
    BltVideoObject(
      ...
      hPixHandle,
      0,
      MERC_AC_ORDER_GRID_X,
      MERC_AC_ORDER_GRID_Y,
    ...
    sText = swprintf(
      "%s %s",
      MercAccountText[Enum340.MERC_ACCOUNT_ACCOUNT],
      LaptopSaveInfo.guiPlayersMercAccountNumber.toString().padStart(5, "0"),
    );
    DrawTextToScreen(
      sText,
      MERC_AC_ACCOUNT_NUMBER_TEXT_X,
      MERC_AC_ACCOUNT_NUMBER_TEXT_Y,
      0,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      ...
      MERC_AC_FIRST_COLUMN_X,
      MERC_AC_MERC_TITLE_Y,
      MERC_AC_FIRST_COLUMN_WIDTH,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      MercAccountText[Enum340.MERC_ACCOUNT_DAYS],
      MERC_AC_SECOND_COLUMN_X,
      MERC_AC_MERC_TITLE_Y,
      MERC_AC_SECOND_COLUMN_WIDTH,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      MercAccountText[Enum340.MERC_ACCOUNT_RATE],
      MERC_AC_THIRD_COLUMN_X,
      MERC_AC_MERC_TITLE_Y,
      MERC_AC_THIRD_COLUMN_WIDTH,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      MercAccountText[Enum340.MERC_ACCOUNT_CHARGE],
      MERC_AC_FOURTH_COLUMN_X,
      MERC_AC_MERC_TITLE_Y,
      MERC_AC_FOURTH_COLUMN_WIDTH,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      MercAccountText[Enum340.MERC_ACCOUNT_TOTAL],
      MERC_AC_THIRD_COLUMN_X,
      MERC_AC_TOTAL_COST_Y,
      MERC_AC_THIRD_COLUMN_WIDTH,
      MERC_ACCOUNT_TEXT_FONT(),
      MERC_ACCOUNT_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
  ...
  function BtnMercAuthorizeButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        wzAuthorizeString = swprintf(
          MercAccountText[Enum340.MERC_ACCOUNT_AUTHORIZE_CONFIRMATION],
          wzDollarAmount,
        );
  ...
  function DisplayHiredMercs(): void {
    ...
    for (i = 0; i <= 10; i++) {
      ...
      if (
        IsMercOnTeam(usMercID) ||
        gMercProfiles[usMercID].iMercMercContractLength != 0
      ) {
        // if the merc is dead, make the color red, else white
        if (IsMercDead(usMercID)) ubFontColor = MERC_ACCOUNT_DEAD_TEXT_COLOR;
        else ubFontColor = MERC_ACCOUNT_DYNAMIC_TEXT_COLOR;

        uiContractCharge = 0;

        // Display Mercs Name
        DrawTextToScreen(
          gMercProfiles[usMercID].zName,
          MERC_AC_FIRST_COLUMN_X + 5,
          usPosY,
          MERC_AC_FIRST_COLUMN_WIDTH,
          MERC_ACCOUNT_DYNAMIC_TEXT_FONT(),
          ubFontColor,
          FONT_MCOLOR_BLACK,
          false,
          LEFT_JUSTIFIED,
        ...
        sTemp = swprintf(
          "$%s",
          gMercProfiles[usMercID].sSalary.toString().padStart(6),
        );
        DrawTextToScreen(
          sTemp,
          MERC_AC_THIRD_COLUMN_X,
    ...
    DrawTextToScreen(
      ...
      MERC_AC_FOURTH_COLUMN_WIDTH,
      MERC_ACCOUNT_DYNAMIC_TEXT_FONT(),
      MERC_ACCOUNT_DYNAMIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  function SettleMercAccounts(): void {
    ...
    AddTransactionToPlayersBook(
      Enum80.PAY_SPECK_FOR_MERC,
      GetMercIDFromMERCArray(gubCurMercIndex),
      GetWorldTotalMin(),
      -iPartialPayment,
    );
    AddHistoryToPlayersLog(
      Enum83.HISTORY_SETTLED_ACCOUNTS_AT_MERC,
      GetMercIDFromMERCArray(gubCurMercIndex),
      GetWorldTotalMin(),
      -1,
      -1,
    ...
    if (iPartialPayment != giMercTotalContractCharge)
      gusMercVideoSpeckSpeech =
        Enum111.SPECK_QUOTE_PLAYER_MAKES_PARTIAL_PAYMENT;
    else {
