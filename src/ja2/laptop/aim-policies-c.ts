namespace ja2 {
  ...
  const AIM_POLICY_TITLE_STATEMENT_X =
    IMAGE_OFFSET_X +
    Math.trunc((500 - AIM_POLICY_TITLE_STATEMENT_WIDTH) / 2) +
    5; // 80
  ...
  let gSelectedPolicyTocMenuRegion: MOUSE_REGION[] /* [NUM_AIM_POLICY_TOC_BUTTONS] */ =
    createArrayFrom(NUM_AIM_POLICY_TOC_BUTTONS, createMouseRegion);
  ...
  let guiPoliciesMenuButton: UINT32[] /* [AIM_POLICY_MENU_BUTTON_AMOUNT] */ =
    createArray(AIM_POLICY_MENU_BUTTON_AMOUNT, 0);
  ...
  let AimPoliciesSubPagesVisitedFlag: boolean[] /* [NUM_AIM_POLICY_PAGES] */ =
    createArray(NUM_AIM_POLICY_PAGES, false);
  ...
  export function RenderAimPolicies(): void {
    ...
    switch (gubCurPageNum) {
      ...
      case 2:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.DEFINITIONS_1, 1.1) +
          AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.DEFINITIONS_2, 1.2) +
          AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.DEFINITIONS_3, 1.3) +
          AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles += DisplayAimPolicyParagraph(
          usNumPixles,
          Enum68.DEFINITIONS_4,
          1.4,
        );
        break;

      case 3:
        DisplayAimPolicyTitle(
          AIM_POLICY_SUBTITLE_Y,
          Enum68.LENGTH_OF_ENGAGEMENT,
          2.0,
        );
        usNumPixles = AIM_POLICY_PARAGRAPH_Y;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LENGTH_OF_ENGAGEMENT_1,
            2.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LENGTH_OF_ENGAGEMENT_1_1,
            2.11,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LENGTH_OF_ENGAGEMENT_1_2,
            2.12,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LENGTH_OF_ENGAGEMENT_1_3,
            2.13,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LENGTH_OF_ENGAGEMENT_2,
            2.2,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 4:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_1,
            3.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_2,
            3.2,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        ...
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_2_1,
            3.21,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_2_2,
            3.22,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_2_3,
            3.23,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_2_4,
            3.3,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.LOCATION_0F_ENGAGEMENT_3,
            3.4,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 5:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.CONTRACT_EXTENSIONS_1,
            4.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.CONTRACT_EXTENSIONS_2,
            4.2,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.CONTRACT_EXTENSIONS_3,
            4.3,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 7:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.TERMS_OF_ENGAGEMENT_1,
            6.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.TERMS_OF_ENGAGEMENT_2A,
            6.2,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.TERMS_OF_ENGAGEMENT_2B,
            0.0,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 8:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.ENGAGEMENT_TERMINATION_1,
            7.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        ...
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.ENGAGEMENT_TERMINATION_1_1,
            7.11,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.ENGAGEMENT_TERMINATION_1_2,
            7.12,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicySubParagraph(
            usNumPixles,
            Enum68.ENGAGEMENT_TERMINATION_1_3,
            7.13,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 9:
        ...
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.EQUIPMENT_AND_INVENTORY_1,
            8.1,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.EQUIPMENT_AND_INVENTORY_2,
            8.2,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        break;
      ...
      case 10:
        ...
        usNumPixles = AIM_POLICY_PARAGRAPH_Y;
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.POLICY_MEDICAL_1, 9.1) +
          AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.POLICY_MEDICAL_2, 9.2) +
          AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.POLICY_MEDICAL_3A,
            9.3,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(
            usNumPixles,
            Enum68.POLICY_MEDICAL_3B,
            0.0,
          ) + AIM_POLICY_PARAGRAPH_GAP;
        usNumPixles +=
          DisplayAimPolicyParagraph(usNumPixles, Enum68.POLICY_MEDICAL_4, 9.4) +
          AIM_POLICY_PARAGRAPH_GAP;
        break;
    }
  ...
  function InitAimPolicyMenuBar(): boolean {
    ...
    guiPoliciesMenuButtonImage = LoadButtonImage(
  ...
  function DrawAimPolicyMenu(): boolean {
    ...
    for (i = 0; i < NUM_AIM_POLICY_TOC_BUTTONS; i++) {
      ...
      DrawTextToScreen(
        sText,
        AIM_POLICY_TOC_X + AIM_POLICY_TOC_TEXT_OFFSET_X,
        usPosY + AIM_POLICY_TOC_TEXT_OFFSET_Y,
  ...
  function InitAimPolicyTocMenu(): boolean {
    ...
    for (i = 0; i < NUM_AIM_POLICY_TOC_BUTTONS; i++) {
      ...
      MSYS_DefineRegion(
        gSelectedPolicyTocMenuRegion[i],
        AIM_POLICY_TOC_X,
        usPosY,
        AIM_POLICY_TOC_X + AIM_CONTENTBUTTON_WIDTH,
  ...
  function SelectPolicyTocMenuRegionCallBack(
  ...
  function DisplayAimPolicyTitleText(): boolean {
    ...
    if (gubCurPageNum == 0)
      DrawTextToScreen(
        sText,
        AIM_POLICY_TITLE_X,
        AIM_POLICY_TITLE_STATEMENT_Y - 25,
        AIM_POLICY_TITLE_WIDTH,
        AIM_POLICY_TITLE_FONT(),
        AIM_POLICY_TITLE_COLOR,
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
  ...
  function DisplayAimPolicyStatement(): boolean {
    ...
    usNumPixels = DisplayWrappedString(
      AIM_POLICY_TITLE_STATEMENT_X,
      AIM_POLICY_TITLE_STATEMENT_Y,
      AIM_POLICY_TITLE_STATEMENT_WIDTH,
      2,
      AIM_POLICY_TEXT_FONT(),
      AIM_POLICY_TEXT_COLOR,
      sText,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
  ...
  function InitAgreementRegion(): boolean {
    ...
    // Load graphic for buttons
    guiPoliciesButtonImage = LoadButtonImage(
      "LAPTOP\\BottomButtons2.sti",
      -1,
      0,
      -1,
    ...
    for (i = 0; i < 2; i++) {
      ...
      guiPoliciesAgreeButton[i] = CreateIconAndTextButton(
        ...
        AimPolicyText[i + Enum353.AIM_POLICIES_DISAGREE],
        AIM_POLICY_TOC_FONT(),
        AIM_POLICY_AGREE_TOC_COLOR_ON,
        DEFAULT_SHADOW,
        AIM_POLICY_AGREE_TOC_COLOR_OFF,
        DEFAULT_SHADOW,
        TEXT_CJUSTIFIED,
        usPosX,
  ...
  function DisplayAimPolicyTitle(
    usPosY: UINT16,
    ubPageNum: UINT8,
    fNumber: FLOAT,
  ): boolean {
    ...
    DrawTextToScreen(
      sText,
      AIM_POLICY_SUBTITLE_NUMBER,
      usPosY,
      0,
      AIM_POLICY_SUBTITLE_FONT(),
      AIM_POLICY_SUBTITLE_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
  ...
  function DisplayAimPolicyParagraph(
    usPosY: UINT16,
    ubPageNum: UINT8,
    fNumber: FLOAT,
  ): UINT16 {
    ...
    usNumPixels = DisplayWrappedString(
      AIM_POLICY_PARAGRAPH_X,
      usPosY,
      AIM_POLICY_PARAGRAPH_WIDTH,
      2,
      AIM_POLICY_TEXT_FONT(),
      AIM_POLICY_TEXT_COLOR,
      sText,
  ...
  function DisplayAimPolicySubParagraph(
    usPosY: UINT16,
    ubPageNum: UINT8,
    fNumber: FLOAT,
  ): UINT16 {
    ...
    DrawTextToScreen(
      sTemp,
      AIM_POLICY_SUBPARAGRAPH_NUMBER,
      usPosY,
      0,
      AIM_POLICY_TEXT_FONT(),
      AIM_POLICY_TEXT_COLOR,
  ...
  function BtnPoliciesAgreeButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
