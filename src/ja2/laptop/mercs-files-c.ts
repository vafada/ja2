namespace ja2 {
  ...
  export function EnterMercsFiles(): boolean {
    ...
    // Prev Box button
    guiButtonImage = LoadButtonImage(
      "LAPTOP\\BigButtons.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiPrevButton = CreateIconAndTextButton(
      guiButtonImage,
      MercInfo[Enum341.MERC_FILES_PREVIOUS],
      FONT12ARIAL(),
      MERC_BUTTON_UP_COLOR,
      DEFAULT_SHADOW,
      MERC_BUTTON_DOWN_COLOR,
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_FILES_PREV_BUTTON_X,
      MERC_FILES_PREV_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    guiNextButton = CreateIconAndTextButton(
      guiButtonImage,
      MercInfo[Enum341.MERC_FILES_NEXT],
      FONT12ARIAL(),
      MERC_BUTTON_UP_COLOR,
      DEFAULT_SHADOW,
      MERC_BUTTON_DOWN_COLOR,
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_FILES_NEXT_BUTTON_X,
      MERC_FILES_NEXT_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    guiHireButton = CreateIconAndTextButton(
      guiButtonImage,
      MercInfo[Enum341.MERC_FILES_HIRE],
      FONT12ARIAL(),
      MERC_BUTTON_UP_COLOR,
      DEFAULT_SHADOW,
      MERC_BUTTON_DOWN_COLOR,
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_FILES_HIRE_BUTTON_X,
      MERC_FILES_HIRE_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    guiMercBackButton = CreateIconAndTextButton(
      guiButtonImage,
      MercInfo[Enum341.MERC_FILES_HOME],
      FONT12ARIAL(),
      MERC_BUTTON_UP_COLOR,
      DEFAULT_SHADOW,
      MERC_BUTTON_DOWN_COLOR,
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_FILES_BACK_BUTTON_X,
      MERC_FILES_BACK_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
  ...
  export function RenderMercsFiles(): void {
    ...
    BltVideoObject(
      ...
      hPixHandle,
      0,
      MERC_FILES_STATS_BOX_X,
      MERC_FILES_STATS_BOX_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
    ...
    BltVideoObject(
      ...
      hPixHandle,
      0,
      MERC_FILES_BIO_BOX_X + 1,
      MERC_FILES_BIO_BOX_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
    ...
    // Display Mercs Name
    DrawTextToScreen(
      gMercProfiles[GetMercIDFromMERCArray(gubCurMercIndex)].zName,
      MERC_NAME_X,
      MERC_NAME_Y,
      0,
      MERC_NAME_FONT(),
    ...
    LoadAndDisplayMercBio(
      GetMercIDFromMERCArray(gubCurMercIndex) - Enum268.BIFF,
    );
    ...
    if (IsMercDead(GetMercIDFromMERCArray(gubCurMercIndex)))
      ...
      DisableButton(guiHireButton);
    } else EnableButton(guiHireButton);
  ...
  function DisplayMercFace(ubMercID: UINT8): boolean {
    ...
    if (IsMercDead(ubMercID)) {
      ...
      DisplayWrappedString(
        MERC_FACE_X,
        MERC_FACE_Y + MERC_PORTRAIT_TEXT_OFFSET_Y,
        MERC_FACE_WIDTH,
        2,
        FONT14ARIAL(),
        145,
        MercInfo[Enum341.MERC_FILES_MERC_IS_DEAD],
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
    } else if (
      ubMercID == Enum268.FLO &&
      gubFact[Enum170.FACT_PC_MARRYING_DARYL_IS_FLO]
    ) {
      ShadowVideoSurfaceRect(
        FRAME_BUFFER,
        MERC_FACE_X,
        MERC_FACE_Y,
        MERC_FACE_X + MERC_FACE_WIDTH,
      ...
      DisplayWrappedString(
        ...
        FONT14ARIAL(),
        145,
        pPersonnelDepartedStateStrings[3],
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
    ...
    // else if the merc is currently a POW or, the merc was fired as a pow
      ...
      pMerc.bMercStatus == MERC_FIRED_AS_A_POW ||
    ...
    // if the merc is away on another assignemnt, say the merc is unavailable
      ...
      DisplayWrappedString(
        ...
        FONT14ARIAL(),
        145,
        MercInfo[Enum341.MERC_FILES_MERC_UNAVAILABLE],
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
  ...
  function LoadAndDisplayMercBio(ubMercID: UINT8): void {
    ...
    sText = LoadEncryptedDataFromFile(
      MERCBIOFILE,
      uiStartLoc,
      MERC_BIO_ADD_INFO_TEXT_SIZE,
    );
    if (sText != "") {
      DrawTextToScreen(
        MercInfo[Enum341.MERC_FILES_ADDITIONAL_INFO],
  ...
  function DisplayMercsStats(ubMercID: UINT8): void {
    ...
    // Health
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_HEALTH],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
      MERC_STATIC_STATS_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bLife,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      MERC_HEALTH_Y,
      MERC_STATS_FONT(),
      MERC_DYNAMIC_STATS_COLOR,
    );
    usPosY += MERC_SPACE_BN_LINES;

    // Agility
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_AGILITY],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bAgility,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Dexterity
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_DEXTERITY],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bDexterity,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Strenght
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_STRENGTH],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bStrength,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Leadership
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_LEADERSHIP],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bLeadership,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Wisdom
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_WISDOM],
      MERC_STATS_FIRST_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bWisdom,
      3,
      MERC_STATS_FIRST_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Experience Level
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_EXPLEVEL],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
      MERC_STATIC_STATS_COLOR,
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bExpLevel,
      3,
      MERC_STATS_SECOND_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
      MERC_DYNAMIC_STATS_COLOR,
    );
    ...
    // Marksmanship
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_MARKSMANSHIP],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bMarksmanship,
      3,
      MERC_STATS_SECOND_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Mechanical
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_MECHANICAL],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bMechanical,
      3,
      MERC_STATS_SECOND_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Explosive
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_EXPLOSIVE],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bExplosive,
      3,
      MERC_STATS_SECOND_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Medical
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_MEDICAL],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_STATS_FONT(),
    ...
    DrawNumeralsToScreen(
      gMercProfiles[ubMercID].bMedical,
      3,
      MERC_STATS_SECOND_NUM_COL_X,
      usPosY,
      MERC_STATS_FONT(),
    ...
    // Daily Salary
    DrawTextToScreen(
      MercInfo[Enum341.MERC_FILES_SALARY],
      MERC_STATS_SECOND_COL_X,
      usPosY,
      0,
      MERC_NAME_FONT(),
    ...
    usPosX =
      MERC_STATS_SECOND_COL_X +
      StringPixLength(MercInfo[Enum341.MERC_FILES_SALARY], MERC_NAME_FONT()) +
      1;
    sString = swprintf(
      "%d %s",
      gMercProfiles[ubMercID].sSalary,
      MercInfo[Enum341.MERC_FILES_PER_DAY],
    );
    DrawTextToScreen(
      sString,
      usPosX,
  ...
  function MercFilesHireMerc(ubMercID: UINT8): boolean {
    ...
    if (!IsMercHireable(ubMercID)) {
      if (gMercProfiles[ubMercID].bMercStatus != MERC_IS_DEAD) {
        guiCurrentLaptopMode = Enum95.LAPTOP_MODE_MERC;
        gusMercVideoSpeckSpeech =
          Enum111.SPECK_QUOTE_PLAYER_TRIES_TO_HIRE_ALREADY_HIRED_MERC;
        gubArrivedFromMercSubSite = Enum105.MERC_CAME_FROM_HIRE_PAGE;
      }
  ...
  function BtnMercFilesBackButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  function EnableDisableMercFilesNextPreviousButton(): void {
    ...
    else DisableButton(guiNextButton);

    if (gubCurMercIndex > 0) EnableButton(guiPrevButton);
    else DisableButton(guiPrevButton);
  }
}
