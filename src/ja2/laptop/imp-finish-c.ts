namespace ja2 {
  ...
  function CreateIMPFinishButtons(): void {
    ...
    giIMPFinishButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
...
*/
    ...
    // the done button
    giIMPFinishButtonImage[1] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
  ...
  */
    ...
    giIMPFinishButtonImage[2] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
  ...
  */
    ...
    // the attribs button
    giIMPFinishButtonImage[3] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
  ...
  */
    ...
    // the portrait button
    giIMPFinishButtonImage[4] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
   ...
   */
    ...
    // the voice button
    giIMPFinishButtonImage[5] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
...
*/
  ...
  /* static */ let BtnIMPFinishPersonalityCallback__fAnimateFlag: boolean =
    false;
  ...
  function BtnIMPFinishPersonalityCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
  ...
  function BtnIMPFinishAttributesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
