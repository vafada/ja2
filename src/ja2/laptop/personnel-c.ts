namespace ja2 {
  ...
  let giPersonnelATMSideButton: INT32[] /* [NUMBER_ATM_BUTTONS] */ =
    createArray(Enum107.NUMBER_ATM_BUTTONS, 0);
  ...
  // mouse regions
  let gPortraitMouseRegions: MOUSE_REGION[] /* [20] */ = createArrayFrom(
    20,
    createMouseRegion,
  );

  let gTogglePastCurrentTeam: MOUSE_REGION[] /* [2] */ = createArrayFrom(
    2,
    createMouseRegion,
  );
  ...
  function RenderPersonnelFace(
    ...
    if (fCurrentTeamMode == true) {
      if (50 < MercPtrs[iId].ubProfile && 57 > MercPtrs[iId].ubProfile) {
        sTemp = sprintf(
          "%s%s.sti",
          FACES_DIR,
          gMercProfiles[MercPtrs[iId].ubProfile].ubFaceIndex
            .toString()
            .padStart(3, "0"),
        );
      } else {
        sTemp = sprintf(
          "%s%s.sti",
          FACES_DIR,
          Menptr[iId].ubProfile.toString().padStart(2, "0"),
        );
      }
    } else {
      ...
      if (50 < iId && 57 > iId) {
        sTemp = sprintf(
          "%s%s.sti",
          FACES_DIR,
          gMercProfiles[iId].ubFaceIndex.toString().padStart(3, "0"),
        );
      } else {
    ...
    BltVideoObject(
      ...
      hFaceHandle,
      0,
      IMAGE_BOX_X + iSlot * IMAGE_BOX_WIDTH,
      IMAGE_BOX_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
    ...
    if (!fCurrentTeamMode) {
      ...
      iHeightOfText = DisplayWrappedString(
        IMAGE_BOX_X,
        IMAGE_BOX_Y + IMAGE_FULL_NAME_OFFSET_Y,
        IMAGE_NAME_WIDTH,
        1,
        PERS_FONT(),
        PERS_FONT_COLOR,
        gMercProfiles[iId].zName,
        0,
        false,
      ...
      if (iHeightOfText - 2 > GetFontHeight(PERS_FONT())) {
        ...
        DisplayWrappedString(
          IMAGE_BOX_X,
          IMAGE_BOX_Y + IMAGE_FULL_NAME_OFFSET_Y - GetFontHeight(PERS_FONT()),
          IMAGE_NAME_WIDTH,
          1,
          PERS_FONT(),
          PERS_FONT_COLOR,
  ...
  */
  ...
  function NextPersonnelFace(): boolean {
    ...
    if (fCurrentTeamMode == true) {
      ...
      if (
        ...
        GetNumberOfMercsDeadOrAliveOnPlayersTeam() - 1
      ) {
      ...
      if (
        iCurPortraitId + 1 ==
        GetNumberOfDeadOnPastTeam() +
          GetNumberOfLeftOnPastTeam() +
  ...
  function CreatePersonnelButtons(): void {
    // left button
    giPersonnelButtonImage[0] = LoadButtonImage(
      "LAPTOP\\personnelbuttons.sti",
      -1,
      0,
      -1,
      1,
    ...
    giPersonnelButton[0] = QuickCreateButton(
      giPersonnelButtonImage[0],
      PREV_MERC_FACE_X,
      MERC_FACE_SCROLL_Y,
      BUTTON_TOGGLE,
    ...
    // right button
    giPersonnelButtonImage[1] = LoadButtonImage(
      "LAPTOP\\personnelbuttons.sti",
      -1,
      2,
      -1,
    ...
    giPersonnelButton[1] = QuickCreateButton(
      giPersonnelButtonImage[1],
      NEXT_MERC_FACE_X,
      MERC_FACE_SCROLL_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
...
*/
  ...
  */
  ...
  function DisplayHeader(): void {
    ...
    mprintf(
      pPersonnelScreenPoints[18].x,
      pPersonnelScreenPoints[18].y,
      pPersonnelTitle[0],
    );
  ...
  function DisplayCharName(iId: INT32, iSlot: INT32): void {
    ...
    if (sTownName != "") {
      ...
      sString = swprintf(
        "%s - %s",
        gMercProfiles[Menptr[iId].ubProfile].zNickname,
        sTownName,
      );
    } else {
      // nick name
    ...
    sString = swprintf(
      "%s",
      pPersonnelAssignmentStrings[Menptr[iId].bAssignment],
    );
    ...
    iHeightOfText = DisplayWrappedString(
      ...
      PERS_FONT(),
      PERS_FONT_COLOR,
      gMercProfiles[Menptr[iId].ubProfile].zName,
      0,
      false,
      CENTER_JUSTIFIED | DONT_DISPLAY_TEXT,
    );
  ...
  */
    ...
    for (iCounter = 0; iCounter < MAX_STATS; iCounter++) {
      switch (iCounter) {
        case 0:
          ...
          if (Menptr[iId].bAssignment != Enum117.ASSIGNMENT_POW) {
            if (gMercProfiles[Menptr[iId].ubProfile].bLifeDelta > 0) {
              ...
              ({ sX, sY } = FindFontRightCoordinates(
                pPersonnelScreenPoints[iCounter].x +
                  iSlot * TEXT_BOX_WIDTH +
                  TEXT_BOX_WIDTH -
                  20 +
                  TEXT_DELTA_OFFSET,
                0,
          ...
          mprintf(
            pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[iCounter].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_HEALTH],
          );
          ({ sX, sY } = FindFontRightCoordinates(
            pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
            0,
        ...
        case 1:
          ...
          mprintf(
            pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[iCounter].y,
            pPersonnelScreenStrings[iCounter],
          );
          ({ sX, sY } = FindFontRightCoordinates(
            pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
            0,
        ...
        case 14:
          // kills
          mprintf(
            pPersonnelScreenPoints[21].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[21].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_KILLS],
          );
          sString = swprintf(
            "%d",
            gMercProfiles[Menptr[iId].ubProfile].usKills,
          );
          ({ sX, sY } = FindFontRightCoordinates(
            pPersonnelScreenPoints[21].x + iSlot * TEXT_BOX_WIDTH,
            0,
        ...
        case 15:
          // assists
          mprintf(
            pPersonnelScreenPoints[22].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[22].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_ASSISTS],
          );
          sString = swprintf(
            "%d",
            gMercProfiles[Menptr[iId].ubProfile].usAssists,
          );
          ({ sX, sY } = FindFontRightCoordinates(
            pPersonnelScreenPoints[22].x + iSlot * TEXT_BOX_WIDTH,
            0,
        ...
        case 16:
          // shots/hits
          mprintf(
            pPersonnelScreenPoints[23].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[23].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_HIT_PERCENTAGE],
          );
        ...
        case 17:
          // battles
          mprintf(
            pPersonnelScreenPoints[24].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[24].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_BATTLES],
          );
          sString = swprintf(
            "%d",
        ...
        case 18:
          // wounds
          mprintf(
            pPersonnelScreenPoints[25].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[25].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_TIMES_WOUNDED],
          );
          sString = swprintf(
            "%d",
        ...
        case 19:
          {
            ...
            mprintf(
              pPersonnelScreenPoints[bScreenLocIndex].x +
                iSlot * TEXT_BOX_WIDTH,
              pPersonnelScreenPoints[bScreenLocIndex].y,
              pPersonnelScreenStrings[Enum110.PRSNL_TXT_SKILLS],
            );
            ...
            if (!fAmIaRobot) {
              let bSkill1: INT8 =
                gMercProfiles[Menptr[iId].ubProfile].bSkillTrait;
              let bSkill2: INT8 =
                gMercProfiles[Menptr[iId].ubProfile].bSkillTrait2;
              ...
              if (bSkill1 == bSkill2 && bSkill1 != Enum269.NO_SKILLTRAIT) {
                sString = swprintf(
                  ...
                  gzMercSkillText[Enum269.NUM_SKILLTRAITS],
                );
                ...
                if (bScreenLocIndex == 19) {
                  sString = swprintf(
                    "%s",
                    pPersonnelScreenStrings[Enum110.PRSNL_TXT_NOSKILLS],
                  );
  ...
  /* static */ let CreateDestroyButtonsForPersonnelDepartures__fCreated: boolean =
    false;
  ...
  /* static */ let CreateDestroyMouseRegionsForPersonnelPortraits__fCreated: boolean =
    false;
      ...
      for (sCounter = 0; sCounter < PERSONNEL_PORTRAIT_NUMBER; sCounter++) {
        MSYS_DefineRegion(
          ...
          SMALL_PORTRAIT_START_Y +
            Math.trunc(sCounter / PERSONNEL_PORTRAIT_NUMBER_WIDTH) *
              SMALL_PORT_HEIGHT,
          SMALL_PORTRAIT_START_X +
            (sCounter % PERSONNEL_PORTRAIT_NUMBER_WIDTH) * SMALL_PORT_WIDTH +
  ...
  function DisplayPicturesOfCurrentTeam(): boolean {
    ...
    for (iCounter = 0; iCounter < iTotalOnTeam; iCnt++) {
      if (MercPtrs[iId + iCnt].bActive == true) {
        ...
        if (
          50 < MercPtrs[iId + iCnt].ubProfile &&
          57 > MercPtrs[iId + iCnt].ubProfile
        ) {
          sTemp = sprintf(
            "%s%s.sti",
            SMALL_FACES_DIR,
          ...
          if (Menptr[iId + iCnt].ubProfile < 100) {
            sTemp = sprintf(
              "%s%s.sti",
              SMALL_FACES_DIR,
              Menptr[iId + iCnt].ubProfile.toString().padStart(2, "0"),
            );
          } else {
            sTemp = sprintf(
              "%s%s.sti",
              SMALL_FACES_DIR,
              Menptr[iId + iCnt].ubProfile.toString().padStart(3, "0"),
            );
          }
        }
        ...
        BltVideoObject(
          ...
          SMALL_PORTRAIT_START_Y +
            Math.trunc(iCounter / PERSONNEL_PORTRAIT_NUMBER_WIDTH) *
              SMALL_PORT_HEIGHT,
          VO_BLT_SRCTRANSPARENCY,
          null,
        );
        ...
        if (Menptr[iId + iCnt].bLife <= 0) {
          ...
          DrawTextToScreen(
            ...
            SMALL_PORTRAIT_START_Y +
              Math.trunc(iCounter / PERSONNEL_PORTRAIT_NUMBER_WIDTH) *
                SMALL_PORT_HEIGHT +
              Math.trunc(SMALL_PORT_HEIGHT / 2),
            SMALL_PORTRAIT_WIDTH_NO_BORDERS,
            FONT10ARIAL(),
            145,
            FONT_MCOLOR_BLACK,
            false,
  ...
  function PersonnelPortraitCallback(
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (
        iCurrentPersonSelectedId != -1 &&
        Menptr[GetIdOfThisSlot(iCurrentPersonSelectedId)].bAssignment ==
          Enum117.ASSIGNMENT_POW &&
        gubPersonnelInfoState == Enum108.PERSONNEL_INV_BTN
      ) {
    ...
    if (iReason & MSYS_CALLBACK_REASON_RBUTTON_UP) {
      if (fCurrentTeamMode == true) {
        ...
        if (iCurrentPersonSelectedId == iPortraitId) {
          ...
          else gubPersonnelInfoState = Enum108.PERSONNEL_STAT_BTN;
        }
  ...
  function DisplayFaceOfDisplayedMerc(): void {
    ...
    if (iCurrentPersonSelectedId != -1) {
      ...
      if (fCurrentTeamMode == true) {
        ...
        RenderPersonnelFace(
          GetIdOfPastMercInSlot(iCurrentPersonSelectedId),
          0,
    ...
    for (ubCounter = 0; ubCounter < Enum261.NUM_INV_SLOTS; ubCounter++) {
      ...
      if (pSoldier.inv[ubCounter].ubNumberOfObjects) {
        if (uiCurrentInventoryIndex > ubUpToCount) {
          ...
          sCenX =
            PosX + Math.trunc(Math.abs(57 - usWidth) / 2) - pTrav.sOffsetX;
          sCenY =
            PosY + Math.trunc(Math.abs(22 - usHeight) / 2) - pTrav.sOffsetY;
          ...
          if (Item[pSoldier.inv[ubCounter].usItem].usItemClass & IC_AMMO) {
            ...
            if (pSoldier.inv[ubCounter].ubNumberOfObjects > 1) {
              for (
                cnt = 0;
                cnt < pSoldier.inv[ubCounter].ubNumberOfObjects;
                cnt++
              ) {
                // get total ammo
            ...
            sString = swprintf(
              ...
              pSoldier.inv[ubCounter].ubNumberOfObjects *
                Magazine[Item[pSoldier.inv[ubCounter].usItem].ubClassIndex]
                  .ubMagSize,
            );
            ({ sX, sY } = FindFontRightCoordinates(
              PosX + 65,
            ...
            sString = swprintf(
              "%s%%",
              pSoldier.inv[ubCounter].bStatus[0].toString().padStart(2),
            );
            ({ sX, sY } = FindFontRightCoordinates(
              PosX + 65,
              PosY + 15,
          ...
          if (Item[pSoldier.inv[ubCounter].usItem].usItemClass & IC_GUN) {
            sString = swprintf(
              "%s",
              AmmoCaliber[
                Weapon[Item[pSoldier.inv[ubCounter].usItem].ubClassIndex]
                  .ubCalibre
              ],
            );
  ...
  function InventoryDownButtonCallback(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_REPEAT) {
      if (
        uiCurrentInventoryIndex >=
        GetNumberOfInventoryItemsOnCurrentMerc() - NUMBER_OF_INVENTORY_PERSONNEL
      ) {
        return;
      }
      ...
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        if (
          uiCurrentInventoryIndex >=
          GetNumberOfInventoryItemsOnCurrentMerc() -
  ...
  /* static */ let CreateDestroyPersonnelInventoryScrollButtons__fCreated: boolean =
    false;
  function CreateDestroyPersonnelInventoryScrollButtons(): void {
    ...
    if (
      ...
      // create buttons
      giPersonnelInventoryButtonsImages[0] = LoadButtonImage(
        "LAPTOP\\personnel_inventory.sti",
        -1,
        1,
        -1,
        2,
      ...
      giPersonnelInventoryButtons[0] = QuickCreateButton(
        ...
        MSYS_PRIORITY_HIGHEST - 1,
        BtnGenericMouseMoveButtonCallback,
        InventoryUpButtonCallback,
      );

      giPersonnelInventoryButtonsImages[1] = LoadButtonImage(
        "LAPTOP\\personnel_inventory.sti",
        -1,
        3,
        -1,
      ...
      MSYS_DefineRegion(
        ...
        X_OF_PERSONNEL_SCROLL_REGION,
        Y_OF_PERSONNEL_SCROLL_REGION,
  ...
  function DisplayCostOfCurrentTeam(): void {
    ...
    if (fCurrentTeamMode == true) {
      // daily cost
      mprintf(
        PERS_CURR_TEAM_COST_X,
        PERS_CURR_TEAM_COST_Y,
  ...
  function GetAvgStatOfCurrentTeamStat(iStat: INT32): INT32 {
    ...
    if (
      GetNumberOfMercsOnPlayersTeam() != 0 &&
      GetNumberOfMercsOnPlayersTeam() == bNumberOfPows &&
      iStat == 0
    ) {
      return -1;
    } else if (ubNumberOfMercsInCalculation - bNumberOfPows > 0) {
      return Math.trunc(
        iTotalStatValue / (ubNumberOfMercsInCalculation - bNumberOfPows),
      );
    } else {
      return 0;
    }
  ...
  function DisplayAverageStatValuesForCurrentTeam(): void {
    ...
    ({ sX, sY } = FindFontCenterCoordinates(
      ...
      PERS_STAT_AVG_WIDTH,
      0,
      pPersonnelCurrentTeamStatsStrings[1],
      FONT10ARIAL(),
    ));
    ...
    // nobody on team leave
    if (
      GetNumberOfMercsDeadOrAliveOnPlayersTeam() == 0 &&
      fCurrentTeamMode == true
    ) {
      return;
    }
    ...
    for (iCounter = 0; iCounter < 11; iCounter++) {
      ...
      if (fCurrentTeamMode == true) {
        ...
        if (iValue == -1) sString = swprintf("%s", pPOWStrings[1]);
        else sString = swprintf("%d", iValue);
      } else {
      ...
      mprintf(
        sX,
        PERS_STAT_AVG_Y + (iCounter + 1) * (GetFontHeight(FONT10ARIAL()) + 3),
        sString,
      );
    }
  ...
  function DisplayLowestStatValuesForCurrentTeam(): void {
    ...
    ({ sX, sY } = FindFontCenterCoordinates(
      PERS_STAT_LOWEST_X,
      0,
      PERS_STAT_LOWEST_WIDTH,
      0,
      pPersonnelCurrentTeamStatsStrings[0],
      FONT10ARIAL(),
    ));
    ...
    for (iCounter = 0; iCounter < 11; iCounter++) {
      ...
      if (fCurrentTeamMode == true) {
        // get name
        if (iId == -1) sString = swprintf("%s", pPOWStrings[1]);
        else sString = swprintf("%s", MercPtrs[iId].name);
      } else {
        // get name
      ...
      switch (iCounter) {
        case 0:
          ...
          if (fCurrentTeamMode == true) {
            if (iId == -1) iStat = -1;
            else iStat = MercPtrs[iId].bLifeMax;
          } else {
      ...
      if (iStat == -1) sString = swprintf("%s", pPOWStrings[1]);
      else sString = swprintf("%d", iStat);
  ...
  function DisplayHighestStatValuesForCurrentTeam(): void {
    ...
    ({ sX, sY } = FindFontCenterCoordinates(
      ...
      PERS_STAT_LOWEST_WIDTH,
      0,
      pPersonnelCurrentTeamStatsStrings[2],
      FONT10ARIAL(),
    ));
    ...
    for (iCounter = 0; iCounter < 11; iCounter++) {
      if (fCurrentTeamMode == true) iId = GetIdOfMercWithHighestStat(iCounter);
      else iId = GetIdOfDepartedMercWithHighestStat(iCounter);
  ...
  /* static */ let CreateDestroyCurrentDepartedMouseRegions__fCreated: boolean =
    false;
  function CreateDestroyCurrentDepartedMouseRegions(): void {
    ...
    if (
      ...
      // not created, create
      MSYS_DefineRegion(
        gTogglePastCurrentTeam[0],
        PERS_TOGGLE_CUR_DEPART_X,
        PERS_TOGGLE_CUR_Y,
        PERS_TOGGLE_CUR_DEPART_X + PERS_TOGGLE_CUR_DEPART_WIDTH,
        PERS_TOGGLE_CUR_Y + PERS_TOGGLE_CUR_DEPART_HEIGHT,
        MSYS_PRIORITY_HIGHEST - 3,
        Enum317.CURSOR_LAPTOP_SCREEN,
        MSYS_NO_CALLBACK,
        PersonnelCurrentTeamCallback,
      );

      MSYS_AddRegion(gTogglePastCurrentTeam[0]);

      MSYS_DefineRegion(
        gTogglePastCurrentTeam[1],
        PERS_TOGGLE_CUR_DEPART_X,
        PERS_TOGGLE_DEPART_Y,
        PERS_TOGGLE_CUR_DEPART_X + PERS_TOGGLE_CUR_DEPART_WIDTH,
  ...
  function PersonnelCurrentTeamCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  function PersonnelDepartedTeamCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  /* static */ let CreateDestroyButtonsForDepartedTeamList__fCreated: boolean =
    false;
  function CreateDestroyButtonsForDepartedTeamList(): void {
    ...
    if (
      ...
      // not created. create
      giPersonnelButtonImage[4] = LoadButtonImage(
        "LAPTOP\\departuresbuttons.sti",
        -1,
        0,
        -1,
        2,
      ...
      giPersonnelButton[4] = QuickCreateButton(
        giPersonnelButtonImage[4],
        PERS_DEPARTED_UP_X,
        PERS_DEPARTED_UP_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST - 1,
      ...
      // right button
      giPersonnelButtonImage[5] = LoadButtonImage(
        "LAPTOP\\departuresbuttons.sti",
        -1,
        1,
        -1,
      ...
      giPersonnelButton[5] = QuickCreateButton(
        giPersonnelButtonImage[5],
        PERS_DEPARTED_UP_X,
        PERS_DEPARTED_DOWN_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST - 1,
        BtnGenericMouseMoveButtonCallback,
        DepartedDownCallBack,
      );
  ...
  function DisplayPastMercsPortraits(): void {
    ...
    for (
      iCounterA = 0;
      iCounter < giCurrentUpperLeftPortraitNumber;
      iCounterA++
    ) {
    ...
    if (iStartArray == 0) {
      ...
      for (iCounterA; iCounter < 20 && iCounterA < 256; iCounterA++) {
        ...
        if (LaptopSaveInfo.ubDeadCharactersList[iCounterA] != -1) {
          DisplayPortraitOfPastMerc(
            LaptopSaveInfo.ubDeadCharactersList[iCounterA],
            iCounter,
            true,
            false,
            false,
    ...
    if (iStartArray <= 2) {
      ...
      for (iCounterA; iCounter < 20 && iCounterA < 256; iCounterA++) {
        ...
        if (LaptopSaveInfo.ubOtherCharactersList[iCounterA] != -1) {
          DisplayPortraitOfPastMerc(
            LaptopSaveInfo.ubOtherCharactersList[iCounterA],
            iCounter,
            false,
            false,
            true,
  ...
  function GetIdOfPastMercInSlot(iSlot: INT32): INT32 {
    ...
    for (
      iCounterA = 0;
      iCounter < iSlot + giCurrentUpperLeftPortraitNumber;
      iCounterA++
    ) {
      if (LaptopSaveInfo.ubDeadCharactersList[iCounterA] != -1) iCounter++;
    }
  ...
  function DisplayPortraitOfPastMerc(
    iId: INT32,
    iCounter: INT32,
    fDead: boolean,
    fFired: boolean,
    ...
    if (50 < iId && 57 > iId) {
      ...
      if (iId < 100) {
        sTemp = sprintf(
          "%s%s.sti",
          SMALL_FACES_DIR,
          iId.toString().padEnd(2, "0"),
        );
      } else {
        sTemp = sprintf(
          "%s%s.sti",
          SMALL_FACES_DIR,
          iId.toString().padEnd(3, "0"),
        );
      }
    }
  ...
  */
  ...
  function DisplayDepartedCharStats(
    iId: INT32,
    iSlot: INT32,
    iState: INT32,
  ): void {
  ...
  function DisplayDepartedCharName(
    iId: INT32,
    iSlot: INT32,
    iState: INT32,
  ): void {
    ...
    if (gMercProfiles[iId].ubMiscFlags2 & PROFILE_MISC_FLAG2_MARRIED_TO_HICKS) {
      ...
      sString = swprintf(
        "%s",
        pPersonnelDepartedStateStrings[Enum106.DEPARTED_MARRIED],
      );
    } else if (iState == Enum106.DEPARTED_DEAD) {
      sString = swprintf(
        "%s",
        pPersonnelDepartedStateStrings[Enum106.DEPARTED_DEAD],
      );
    }
    ...
    // if the merc is an AIM merc
      ...
      if (iState == Enum106.DEPARTED_FIRED)
        sString = swprintf(
          "%s",
          pPersonnelDepartedStateStrings[Enum106.DEPARTED_FIRED],
        );
      else
        sString = swprintf(
          "%s",
          pPersonnelDepartedStateStrings[Enum106.DEPARTED_CONTRACT_EXPIRED],
        );
    }
    ...
    // else if its a MERC merc
      ...
      if (iState == Enum106.DEPARTED_FIRED)
        ...
        sString = swprintf(
          "%s",
          pPersonnelDepartedStateStrings[Enum106.DEPARTED_QUIT],
        );
    }
    // must be a RPC
    else {
  ...
  function DisplayHighLightBox(): boolean {
    ...
    BltVideoObject(
      ...
      0,
      SMALL_PORTRAIT_START_X +
        (iCurrentPersonSelectedId % PERSONNEL_PORTRAIT_NUMBER_WIDTH) *
          SMALL_PORT_WIDTH -
        2,
      SMALL_PORTRAIT_START_Y +
        Math.trunc(iCurrentPersonSelectedId / PERSONNEL_PORTRAIT_NUMBER_WIDTH) *
          SMALL_PORT_HEIGHT -
        3,
      VO_BLT_SRCTRANSPARENCY,
      null,
  ...
  export function RemoveNewlyHiredMercFromPersonnelDepartedList(
    ubProfile: UINT8,
  ): boolean {
    let iCounter: INT32 = 0;
...
*/
      // the stats button
      giPersonnelATMStartButtonImage[Enum108.PERSONNEL_STAT_BTN] =
        LoadButtonImage("LAPTOP\\AtmButtons.sti", -1, 2, -1, 3, -1);
      giPersonnelATMStartButton[Enum108.PERSONNEL_STAT_BTN] = QuickCreateButton(
        giPersonnelATMStartButtonImage[Enum108.PERSONNEL_STAT_BTN],
        519,
        80,
        BUTTON_TOGGLE,
      ...
      // set text and what not
      SpecifyButtonText(
        giPersonnelATMStartButton[Enum108.PERSONNEL_STAT_BTN],
        gsAtmStartButtonText[1],
      );
      ...
      giPersonnelATMStartButtonImage[Enum108.PERSONNEL_EMPLOYMENT_BTN] =
        LoadButtonImage("LAPTOP\\AtmButtons.sti", -1, 2, -1, 3, -1);
      giPersonnelATMStartButton[Enum108.PERSONNEL_EMPLOYMENT_BTN] =
        QuickCreateButton(
          giPersonnelATMStartButtonImage[Enum108.PERSONNEL_EMPLOYMENT_BTN],
          519,
          110,
          ...
          MSYS_PRIORITY_HIGHEST - 1,
          MSYS_NO_CALLBACK,
          EmployementInfoButtonCallback,
        );

      // set text and what not
      SpecifyButtonText(
        giPersonnelATMStartButton[Enum108.PERSONNEL_EMPLOYMENT_BTN],
        gsAtmStartButtonText[3],
      );
      SpecifyButtonUpTextColors(
        giPersonnelATMStartButton[Enum108.PERSONNEL_EMPLOYMENT_BTN],
        FONT_BLACK,
      ...
      giPersonnelATMStartButtonImage[Enum108.PERSONNEL_INV_BTN] =
        LoadButtonImage("LAPTOP\\AtmButtons.sti", -1, 2, -1, 3, -1);
      giPersonnelATMStartButton[Enum108.PERSONNEL_INV_BTN] = QuickCreateButton(
        giPersonnelATMStartButtonImage[Enum108.PERSONNEL_INV_BTN],
        519,
        140,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST - 1,
        MSYS_NO_CALLBACK,
        PersonnelINVStartButtonCallback,
      );

      // set text and what not
      SpecifyButtonText(
        giPersonnelATMStartButton[Enum108.PERSONNEL_INV_BTN],
  ...
  function FindPositionOfPersInvSlider(): void {
    ...
    sSizeOfEachSubRegion = Math.trunc(
  ...
  function HandleSliderBarClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
    ...
    if (
      ...
      if (
        uiCurrentInventoryIndex >=
        iValue - NUMBER_OF_INVENTORY_PERSONNEL + 1
      ) {
        return;
      }
  ...
  */
  ...
  function PersonnelINVStartButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (!(btn.uiFlags & BUTTON_ENABLED)) return;
  ...
  function PersonnelStatStartButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (!(btn.uiFlags & BUTTON_ENABLED)) return;
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      switch (iValue) {
        case Enum107.DEPOSIT_ATM:
          ...
          fReDrawScreenFlag = true;
          ButtonList[
            giPersonnelATMSideButton[Enum107.WIDTHDRAWL_ATM]
          ].uiFlags &= ~BUTTON_CLICKED_ON;
          break;
        case Enum107.WIDTHDRAWL_ATM:
          fATMFlags = 3;
          fReDrawScreenFlag = true;
          ButtonList[giPersonnelATMSideButton[Enum107.DEPOSIT_ATM]].uiFlags &=
            ~BUTTON_CLICKED_ON;
          break;
      }
    }
            ...
            switch (iValue) {
              case Enum107.OK_ATM:
                if (fATMFlags == 0) {
                  ...
                  if (
                    GetFundsOnMerc(pSoldier) >= parseInt(sTransferString, 10)
                  ) {
                    if (parseInt(sTransferString, 10) % 10 != 0) {
                      ...
                      iValue =
                        parseInt(sTransferString, 10) -
                        (parseInt(sTransferString, 10) % 10);
                      sTransferString = swprintf("%d", iValue);
                      fReDrawScreenFlag = true;
                    } else {
                      // transfer
                      TransferFundsFromMercToBank(
                        pSoldier,
                        parseInt(sTransferString, 10),
                      );
                      sTransferString = "";
              ...
              case Enum107.CANCEL_ATM:
                if (sTransferString != "") {
                  ...
                  ButtonList[
                    giPersonnelATMSideButton[Enum107.DEPOSIT_ATM]
                  ].uiFlags &= ~BUTTON_CLICKED_ON;
                } else {
                  fShowAtmPanel = false;
                  fShowAtmPanelStartButton = true;
  ...
  function ATMNumberButtonCallback(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        // gone too far
        if (
          StringPixLength(sTransferString, ATM_FONT()) >=
          ATM_DISPLAY_WIDTH - 10
        ) {
  ...
  function HandleStateOfATMButtons(): void {
    ...
    if (fATMFlags == 0) {
      ...
      for (iCounter = 0; iCounter < Enum107.NUMBER_ATM_BUTTONS; iCounter++) {
        if (
          iCounter != Enum107.DEPOSIT_ATM &&
          iCounter != Enum107.WIDTHDRAWL_ATM &&
          iCounter != Enum107.CANCEL_ATM
        ) {
  ...
  export function GetFundsOnMerc(pSoldier: SOLDIERTYPE | null): INT32 {
    ...
    for (
      iCurrentPocket = 0;
      iCurrentPocket < Enum261.NUM_INV_SLOTS;
      iCurrentPocket++
    ) {
  ...
  export function TransferFundsFromMercToBank(
    ...
    if (iAmountLeftToTake != 0) {
      ...
      AddTransactionToPlayersBook(
        Enum80.TRANSFER_FUNDS_FROM_MERC,
        pSoldier.ubProfile,
        GetWorldTotalMin(),
  ...
  export function TransferFundsFromBankToMerc(
    pSoldier: SOLDIERTYPE,
    iCurrentBalance: INT32,
  ): boolean {
  ...
  function HandlePersonnelKeyboard(): void {
    ...
    while (DequeueEvent(InputEvent) == true) {
      if (
        ...
        InputEvent.usParam >= "0".charCodeAt(0) &&
        InputEvent.usParam <= "9".charCodeAt(0)
      ) {
      ...
      HandleKeyBoardShortCutsForLapTop(
        InputEvent.usEvent,
        InputEvent.usParam,
  ...
  function RenderRectangleForPersonnelTransactionAmount(): void {
    ...
    RectangleDraw(
      true,
      ATM_DISPLAY_X + ATM_DISPLAY_WIDTH - iLength - 2,
      ATM_DISPLAY_Y + 35,
      ATM_DISPLAY_X + ATM_DISPLAY_WIDTH + 1,
      ATM_DISPLAY_Y + iHeight + 36,
  ...
  function HandleTimedAtmModes(): void {
    ...
    if (
      GetJA2Clock() - HandleTimedAtmModes__uiBaseTime >
      DELAY_PER_MODE_CHANGE_IN_ATM
    ) {
      switch (fATMFlags) {
        case 4:
        case 5:
  ...
  function IsPastMercDead(iId: INT32): boolean {
    if (
      GetTheStateOfDepartedMerc(GetIdOfPastMercInSlot(iId)) ==
      Enum106.DEPARTED_DEAD
    ) {
      return true;
    } else {
      return false;
      ...
      switch (iCounter) {
        ...
        case 0:
          {
            ...
            if (
              Menptr[iId].ubWhatKindOfMercAmI == Enum260.MERC_TYPE__AIM_MERC ||
              Menptr[iId].ubProfile == Enum268.SLAY
            ) {
              let iTimeLeftOnContract: INT32 = CalcTimeLeftOnMercContract(
                Menptr[iId],
              );
              ...
              if (Menptr[iId].bAssignment == Enum117.IN_TRANSIT) {
                ...
                if (
                  iTimeLeftOnContract >
                  Menptr[iId].iTotalContractLength * uiMinutesInDay
                ) {
                  iTimeLeftOnContract =
                    Menptr[iId].iTotalContractLength * uiMinutesInDay;
                }
              ...
              if (Math.trunc(iTimeLeftOnContract / uiMinutesInDay)) {
                sString = swprintf(
                  "%d%s %d%s / %d%s",
                  Math.trunc(iTimeLeftOnContract / uiMinutesInDay),
                  gpStrategicString[Enum365.STR_PB_DAYS_ABBREVIATION],
                  Math.trunc((iTimeLeftOnContract % uiMinutesInDay) / 60),
                  gpStrategicString[Enum365.STR_PB_HOURS_ABBREVIATION],
                  Menptr[iId].iTotalContractLength,
                  gpStrategicString[Enum365.STR_PB_DAYS_ABBREVIATION],
                );
                mprintf(
                  pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
                  pPersonnelScreenPoints[iCounter].y,
                  pPersonnelScreenStrings[Enum110.PRSNL_TXT_CURRENT_CONTRACT],
                );
              }
              ...
              Menptr[iId].ubWhatKindOfMercAmI == Enum260.MERC_TYPE__MERC
            ) {
        ...
        case 1:
          ...
          mprintf(
            pPersonnelScreenPoints[iCounter].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[iCounter].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_TOTAL_SERVICE],
          );
        ...
        */
          {
            sStringA = swprintf(
              "%s",
              pPersonnelScreenStrings[Enum110.PRSNL_TXT_TOTAL_COST],
            );
          }
          ...
          if (Menptr[iId].ubWhatKindOfMercAmI == Enum260.MERC_TYPE__AIM_MERC) {
            // daily rate
            if (
              Menptr[iId].bTypeOfLastContract == Enum161.CONTRACT_EXTEND_2_WEEK
            ) {
              // 2 week contract
              sStringA = swprintf(
                "%d",
              ...
              Menptr[iId].bTypeOfLastContract == Enum161.CONTRACT_EXTEND_1_WEEK
            ) {
              // 1 week contract
              sStringA = swprintf(
                "%d",
          ...
          mprintf(
            pPersonnelScreenPoints[iCounter + 1].x + iSlot * TEXT_BOX_WIDTH,
            pPersonnelScreenPoints[iCounter + 1].y,
            pPersonnelScreenStrings[Enum110.PRSNL_TXT_DAILY_COST],
          );
        ...
        case 5:
          ...
          if (Menptr[iId].ubWhatKindOfMercAmI == Enum260.MERC_TYPE__MERC) {
            mprintf(
              pPersonnelScreenPoints[iCounter - 1].x + iSlot * TEXT_BOX_WIDTH,
              pPersonnelScreenPoints[iCounter - 1].y,
              pPersonnelScreenStrings[Enum110.PRSNL_TXT_UNPAID_AMOUNT],
            );
            ...
            ({ sX, sY } = FindFontRightCoordinates(
              pPersonnelScreenPoints[iCounter - 1].x +
                iSlot * TEXT_BOX_WIDTH +
                Prsnl_DATA_OffSetX,
              0,
              TEXT_BOX_WIDTH - 20,
            ...
            mprintf(
              pPersonnelScreenPoints[iCounter - 1].x + iSlot * TEXT_BOX_WIDTH,
              pPersonnelScreenPoints[iCounter - 1].y,
              pPersonnelScreenStrings[Enum110.PRSNL_TXT_MED_DEPOSIT],
            );
