namespace ja2 {
  ...
  let gSelectedInsuranceCommentLinkRegion: MOUSE_REGION[] /* [3] */ =
    createArrayFrom(3, createMouseRegion);
  ...
  export function EnterInsuranceComments(): boolean {
    ...
    for (i = 0; i < 3; i++) {
      MSYS_DefineRegion(
        gSelectedInsuranceCommentLinkRegion[i],
        usPosX,
        INS_CMNT_LINK_Y - 1,
        usPosX + INS_CMNT_LINK_WIDTH,
        INS_CMNT_LINK_Y + INS_CMNT_LINK_HEIGHT + 1,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
  ...
  export function RenderInsuranceComments(): void {
    ...
    DisplayComment(
      Enum90.INS_SNGL_GUS_TARBALLS,
      Enum90.INS_MLTI_GUS_SPEECH,
      usPosY,
    );
    ...
    DisplayComment(
      Enum90.INS_SNGL_ALI_HUSSEAN,
      Enum90.INS_MLTI_ALI_HUSSEAN_SPEECH,
      usPosY,
    );
    ...
    DisplayComment(
      Enum90.INS_SNGL_LANCE_ALLOT,
      Enum90.INS_MLTI_LANCE_ALLOT_SPEECH,
      usPosY,
    );
    ...
    DisplayComment(
      Enum90.INS_SNGL_FRED_COUSTEAU,
      Enum90.INS_MLTI_FRED_COUSTEAU_SPEECH,
      usPosY,
    );
  ...
  function SelectInsuranceCommentLinkRegionCallBack(
  ...
  function DisplayComment(
    ...
    sNumPixels = DisplayWrappedString(
      INS_CMNT_FIRST_BULLET_X + INSURANCE_BULLET_TEXT_OFFSET_X,
      usPosY,
      INS_CMNT_COMMENT_TEXT_WIDTH,
      2,
      INS_FONT_MED(),
      INS_FONT_COLOR,
      sText,
    ...
    DisplaySmallRedLineWithShadow(
      INS_CMNT_FIRST_BULLET_X + INSURANCE_BULLET_TEXT_OFFSET_X,
      usPosY + sNumPixels,
      INS_CMNT_FIRST_BULLET_X + INS_CMNT_REDLINE_WIDTH,
      usPosY + sNumPixels,
    );
