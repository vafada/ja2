namespace ja2 {
  ...
  let pIMPMainPageMouseRegions: MOUSE_REGION[] /* [4] */ = createArrayFrom(
    4,
    createMouseRegion,
  );
  ...
  function CreateIMPMainPageButtons(): void {
    ...
    giIMPMainPageButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_3.sti",
      -1,
      0,
      -1,
    ...
    giIMPMainPageButtonImage[1] = LoadButtonImage(
      "LAPTOP\\button_2.sti",
      -1,
      0,
      -1,
...
*/
    ...
    giIMPMainPageButtonImage[2] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
...
*/
    giIMPMainPageButton[2] = CreateIconAndTextButton(
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + 13,
      LAPTOP_SCREEN_WEB_UL_Y + 245,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      BtnGenericMouseMoveButtonCallback,
    ...
    // the attribs button
    giIMPMainPageButtonImage[3] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
...
*/
    ...
    // the portrait button
    giIMPMainPageButtonImage[4] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
...
*/
    ...
    // the voice button
    giIMPMainPageButtonImage[5] = LoadButtonImage(
      "LAPTOP\\button_8.sti",
      -1,
      0,
      -1,
...
*/
    ...
    SpecifyButtonTextWrappedWidth(
      giIMPMainPageButton[2],
      MAIN_PAGE_BUTTON_TEXT_WIDTH,
    );
    SpecifyButtonTextWrappedWidth(
      giIMPMainPageButton[3],
      MAIN_PAGE_BUTTON_TEXT_WIDTH,
    );
    SpecifyButtonTextWrappedWidth(
      giIMPMainPageButton[4],
      MAIN_PAGE_BUTTON_TEXT_WIDTH,
    );
    SpecifyButtonTextWrappedWidth(
      giIMPMainPageButton[5],
      MAIN_PAGE_BUTTON_TEXT_WIDTH,
    );
    return;
  }
  ...
  function BtnIMPMainPagePersonalityCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
  ...
  function BtnIMPMainPageAttributesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
  ...
  export function BtnIMPMainPagePortraitCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
  ...
  export function BtnIMPMainPageVoiceCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for Main Page Begin Profiling
  ...
  function CreateMouseRegionsForIMPMainPageBasedOnCharGenStatus(): void {
    ...
    MSYS_DefineRegion(
      pIMPMainPageMouseRegions[0],
      LAPTOP_SCREEN_UL_X + 13,
      LAPTOP_SCREEN_WEB_UL_Y + 245,
      LAPTOP_SCREEN_UL_X + 13 + 115,
      LAPTOP_SCREEN_WEB_UL_Y + 245 + 93,
    ...
    MSYS_DefineRegion(
      pIMPMainPageMouseRegions[1],
      LAPTOP_SCREEN_UL_X + 133,
      LAPTOP_SCREEN_WEB_UL_Y + 245,
      LAPTOP_SCREEN_UL_X + 133 + 115,
      LAPTOP_SCREEN_WEB_UL_Y + 245 + 93,
      MSYS_PRIORITY_HIGH + 5,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      pIMPMainPageMouseRegions[2],
      LAPTOP_SCREEN_UL_X + 253,
      LAPTOP_SCREEN_WEB_UL_Y + 245,
      LAPTOP_SCREEN_UL_X + 253 + 115,
      LAPTOP_SCREEN_WEB_UL_Y + 245 + 93,
      MSYS_PRIORITY_HIGH + 5,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      pIMPMainPageMouseRegions[3],
      LAPTOP_SCREEN_UL_X + 373,
      LAPTOP_SCREEN_WEB_UL_Y + 245,
      LAPTOP_SCREEN_UL_X + 373 + 115,
      LAPTOP_SCREEN_WEB_UL_Y + 245 + 93,
      MSYS_PRIORITY_HIGH + 5,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
  ...
  function IMPMainPageNotSelectableBtnCallback(
  ...
  function LoadCharacterPortraitForMainPage(): boolean {
    ...
    if (iCurrentProfileMode >= 4) {
      ...
      VObjectDesc.ImageFile = FilenameForBPP(
        pPlayerSelectedFaceFileNames[iPortraitNumber],
      );
