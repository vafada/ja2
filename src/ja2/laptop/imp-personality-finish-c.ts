namespace ja2 {
  ...
  function CreateIMPPersonalityFinishButtons(): void {
    ...
    // ths Yes button
    giIMPPersonalityFinishButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_5.sti",
      -1,
      0,
      -1,
  ...
  */
    giIMPPersonalityFinishButton[0] = CreateIconAndTextButton(
      giIMPPersonalityFinishButtonImage[0],
      pImpButtonText[9],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + 90,
      LAPTOP_SCREEN_WEB_UL_Y + 224,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    // the no Button
    giIMPPersonalityFinishButtonImage[1] = LoadButtonImage(
      "LAPTOP\\button_5.sti",
      -1,
      0,
      -1,
    ...
    */
    giIMPPersonalityFinishButton[1] = CreateIconAndTextButton(
      giIMPPersonalityFinishButtonImage[1],
      pImpButtonText[10],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
  ...
  function BtnIMPPersonalityFinishYesCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  function BtnIMPPersonalityFinishNoCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityFinishOkCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
