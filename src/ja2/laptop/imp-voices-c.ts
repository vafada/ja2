namespace ja2 {
  ...
  function CreateIMPVoicesButtons(): void {
    ...
    // next button
    giIMPVoicesButtonImage[0] = LoadButtonImage(
...
*/
    ...
    // previous button
    giIMPVoicesButtonImage[1] = LoadButtonImage(
      "LAPTOP\\voicearrows.sti",
      -1,
      0,
      -1,
    ...
    */
    ...
    // done button
    giIMPVoicesButtonImage[2] = LoadButtonImage(
      "LAPTOP\\button_5.sti",
      -1,
      0,
      -1,
...
*/
  ...
  function CreateIMPVoiceMouseRegions(): void {
    ...
    MSYS_DefineRegion(
      gVoicePortraitRegion,
      LAPTOP_SCREEN_UL_X + 200,
      LAPTOP_SCREEN_WEB_UL_Y + 176,
      LAPTOP_SCREEN_UL_X + 200 + 100,
      LAPTOP_SCREEN_WEB_UL_Y + 176 + 100,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
  ...
  function IMPPortraitRegionButtonCallback(
