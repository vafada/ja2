namespace ja2 {
  ...
  const AIM_SORT_ASCEND_TEXT_X =
    AIM_SORT_SORT_BY_X + 154 - AIM_SORT_ASC_DESC_WIDTH - 4 + 18;
  ...
  let AimSortCheckBoxLoc: UINT16[] /* [] */ = [
    AIM_SORT_SORT_BY_X + 9,
    AIM_SORT_SORT_BY_Y + 34,
    AIM_SORT_SORT_BY_X + 9,
    AIM_SORT_SORT_BY_Y + 47,
    AIM_SORT_SORT_BY_X + 9,
    AIM_SORT_SORT_BY_Y + 60,
    AIM_SORT_SORT_BY_X + 111,
    AIM_SORT_SORT_BY_Y + 34,
    AIM_SORT_SORT_BY_X + 111,
    AIM_SORT_SORT_BY_Y + 47,
    AIM_SORT_SORT_BY_X + 111,
    AIM_SORT_SORT_BY_Y + 60,
    AIM_SORT_SORT_BY_X + 172,
    AIM_SORT_SORT_BY_Y + 4,
    AIM_SORT_SORT_BY_X + 172,
  ...
  export function EnterAimSort(): boolean {
    ...
    MSYS_DefineRegion(
      gSelectedToMugShotRegion,
      AIM_SORT_TO_MUGSHOTS_X,
      AIM_SORT_TO_MUGSHOTS_Y,
      AIM_SORT_TO_MUGSHOTS_X + AIM_SORT_TO_MUGSHOTS_SIZE,
      AIM_SORT_TO_MUGSHOTS_Y + AIM_SORT_TO_MUGSHOTS_SIZE,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      gSelectedToStatsRegion,
      AIM_SORT_TO_STATS_X,
      AIM_SORT_TO_STATS_Y,
      AIM_SORT_TO_STATS_X + AIM_SORT_TO_STATS_SIZE,
      AIM_SORT_TO_STATS_Y + AIM_SORT_TO_STATS_SIZE,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      AIM_SORT_TO_ALUMNI_X,
      AIM_SORT_TO_ALUMNI_Y,
      AIM_SORT_TO_ALUMNI_X + AIM_SORT_TO_ALUMNI_SIZE,
      AIM_SORT_TO_ALUMNI_Y + AIM_SORT_TO_ALUMNI_SIZE,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectToArchiveRegionCallBack,
    );
    ...
    ubWidth =
      StringPixLength(AimSortText[Enum352.PRICE], AIM_SORT_FONT_SORT_TEXT()) +
      AimSortCheckBoxLoc[ubCurNumber] +
      (AIM_SORT_PRICE_TEXT_X - AimSortCheckBoxLoc[ubCurNumber]) -
      3;
    MSYS_DefineRegion(
      gSelectedPriceBoxRegion,
      AimSortCheckBoxLoc[ubCurNumber],
      AimSortCheckBoxLoc[ubCurNumber + 1],
      ubWidth,
      AimSortCheckBoxLoc[ubCurNumber + 1] + AIM_SORT_CHECKBOX_SIZE,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
    ...
    ubWidth =
      StringPixLength(
        AimSortText[Enum352.EXPERIENCE],
    ...
    ubWidth =
      StringPixLength(
        AimSortText[Enum352.AIMMARKSMANSHIP],
        AIM_SORT_FONT_SORT_TEXT(),
      ) +
      AimSortCheckBoxLoc[ubCurNumber] +
      (AIM_SORT_PRICE_TEXT_X - AimSortCheckBoxLoc[ubCurNumber]) -
    ...
    ubWidth =
      StringPixLength(
        AimSortText[Enum352.AIMMEDICAL],
        AIM_SORT_FONT_SORT_TEXT(),
      ) +
      AimSortCheckBoxLoc[ubCurNumber] +
      (AIM_SORT_MEDICAL_X - AimSortCheckBoxLoc[ubCurNumber]) -
      3;
    ...
    ubWidth =
      StringPixLength(
        AimSortText[Enum352.EXPLOSIVES],
        AIM_SORT_FONT_SORT_TEXT(),
      ) +
      AimSortCheckBoxLoc[ubCurNumber] +
      (AIM_SORT_MEDICAL_X - AimSortCheckBoxLoc[ubCurNumber]) -
    ...
    ubWidth =
      StringPixLength(
        AimSortText[Enum352.AIMMECHANICAL],
        AIM_SORT_FONT_SORT_TEXT(),
      ) +
      AimSortCheckBoxLoc[ubCurNumber] +
      (AIM_SORT_MEDICAL_X - AimSortCheckBoxLoc[ubCurNumber]) -
    ...
    ubWidth =
      AimSortCheckBoxLoc[ubCurNumber] -
      StringPixLength(
        AimSortText[Enum352.ASCENDING],
        AIM_SORT_FONT_SORT_TEXT(),
      ) -
      6;
    // Mouse region for the Ascend Check Box
    MSYS_DefineRegion(
      gSelectedAscendBoxRegion,
      ubWidth,
      AimSortCheckBoxLoc[ubCurNumber + 1],
      AimSortCheckBoxLoc[ubCurNumber] + AIM_SORT_CHECKBOX_SIZE,
      AimSortCheckBoxLoc[ubCurNumber + 1] + AIM_SORT_CHECKBOX_SIZE,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
    ...
    ubWidth =
      AimSortCheckBoxLoc[ubCurNumber] -
      StringPixLength(
        AimSortText[Enum352.DESCENDING],
        AIM_SORT_FONT_SORT_TEXT(),
      ) -
      6;
  ...
  export function RenderAimSort(): void {
    ...
    DrawTextToScreen(
      AimSortText[Enum352.AIM_AIMMEMBERS],
      AIM_SORT_AIM_MEMBER_X,
      AIM_SORT_AIM_MEMBER_Y,
      AIM_SORT_AIM_MEMBER_WIDTH,
      AIM_MAINTITLE_FONT(),
      AIM_MAINTITLE_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    // Display sort title
    DrawTextToScreen(
      AimSortText[Enum352.SORT_BY],
      AIM_SORT_SORT_BY_TEXT_X,
      AIM_SORT_SORT_BY_TEXT_Y,
      0,
      AIM_SORT_FONT_TITLE(),
      AIM_SORT_SORT_BY_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      AimSortText[Enum352.PRICE],
      AIM_SORT_PRICE_TEXT_X,
      AIM_SORT_PRICE_TEXT_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      AimSortText[Enum352.AIMMARKSMANSHIP],
      AIM_SORT_MARKMNSHP_TEXT_X,
      AIM_SORT_MARKMNSHP_TEXT_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.EXPLOSIVES],
      AIM_SORT_EXPLOSIVES_X,
      AIM_SORT_EXPLOSIVES_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.AIMMECHANICAL],
      AIM_SORT_MECHANICAL_X,
      AIM_SORT_MECHANICAL_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.ASCENDING],
      AIM_SORT_ASCEND_TEXT_X,
      AIM_SORT_ASCEND_TEXT_Y,
      AIM_SORT_ASC_DESC_WIDTH,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.DESCENDING],
      AIM_SORT_DESCEND_TEXT_X,
      AIM_SORT_DESCEND_TEXT_Y,
      AIM_SORT_ASC_DESC_WIDTH,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_COLOR_SORT_TEXT,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.MUGSHOT_INDEX],
      AIM_SORT_MUGSHOT_TEXT_X,
      AIM_SORT_MUGSHOT_TEXT_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_LINK_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    DrawTextToScreen(
      AimSortText[Enum352.MERCENARY_FILES],
      AIM_SORT_MERC_STATS_TEXT_X,
      AIM_SORT_MERC_STATS_TEXT_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_LINK_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      AimSortText[Enum352.ALUMNI_GALLERY],
      AIM_SORT_ALUMNI_TEXT_X,
      AIM_SORT_ALUMNI_TEXT_Y,
      0,
      AIM_SORT_FONT_SORT_TEXT(),
      AIM_SORT_LINK_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
  ...
  function SelectToMugShotRegionCallBack(
  ...
  function SelectToStatsRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectToArchiveRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectPriceBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectExpBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectMarkBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectMedicalBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectExplosiveBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectMechanicalBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectAscendBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectDescendBoxRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function QsortCompare(pNum1: number, pNum2: number): INT32 {
    ...
    switch (gubCurrentSortMode) {
      ...
      case 0:
        return CompareValue(
          gMercProfiles[Num1].uiWeeklySalary,
          gMercProfiles[Num2].uiWeeklySalary,
        );
        break;
      // Experience			INT16	bExpLevel
      case 1:
        return CompareValue(
          gMercProfiles[Num1].bExpLevel,
          gMercProfiles[Num2].bExpLevel,
        );
        break;
      // Marksmanship		INT16	bMarksmanship
      case 2:
        return CompareValue(
          gMercProfiles[Num1].bMarksmanship,
          gMercProfiles[Num2].bMarksmanship,
        );
        break;
      // Medical					INT16	bMedical
      case 3:
        return CompareValue(
          gMercProfiles[Num1].bMedical,
          gMercProfiles[Num2].bMedical,
        );
        break;
      // Explosives			INT16	bExplosive
      case 4:
        return CompareValue(
          gMercProfiles[Num1].bExplosive,
          gMercProfiles[Num2].bExplosive,
        );
        break;
      // Mechanical			INT16	bMechanical
      case 5:
        return CompareValue(
          gMercProfiles[Num1].bMechanical,
          gMercProfiles[Num2].bMechanical,
        );
        break;
