namespace ja2 {
  ...
  export function EnterFlorist(): boolean {
    ...
    guiGalleryButton = CreateIconAndTextButton(
      ...
      sFloristText[Enum345.FLORIST_GALLERY],
  ...
  export function RenderFlorist(): void {
    ...
    DisplayWrappedString(
      ...
      sFloristText[Enum345.FLORIST_DROP_ANYWHERE],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    DisplayWrappedString(
      ...
      FLORIST_SENTENCE_FONT(),
      FLORIST_SENTENCE_COLOR,
      sFloristText[Enum345.FLORIST_PHONE_NUMBER],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    DisplayWrappedString(
      ...
      FLORIST_SENTENCE_FONT(),
      FLORIST_SENTENCE_COLOR,
      sFloristText[Enum345.FLORIST_STREET_ADDRESS],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    DisplayWrappedString(
      ...
      FLORIST_SENTENCE_FONT(),
      FLORIST_SENTENCE_COLOR,
      sFloristText[Enum345.FLORIST_WWW_ADDRESS],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  export function InitFloristDefaults(): boolean {
    ...
    if (guiCurrentLaptopMode == Enum95.LAPTOP_MODE_FLORIST) {
      ...
      MSYS_DefineRegion(
        gSelectedFloristTitleHomeLinkRegion,
        FLORIST_SMALL_TITLE_X,
        FLORIST_SMALL_TITLE_Y,
        FLORIST_SMALL_TITLE_X + FLORIST_SMALL_TITLE_WIDTH,
        FLORIST_SMALL_TITLE_Y + FLORIST_SMALL_TITLE_HEIGHT,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
  ...
  function SelectFloristTitleHomeLinkRegionCallBack(
