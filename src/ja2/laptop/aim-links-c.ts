namespace ja2 {
  ...
  const AIM_LINK_FUNERAL_LINK_Y =
    AIM_LINK_BOBBY_LINK_Y + AIM_LINK_LINK_OFFSET_Y;

  const AIM_LINK_INSURANCE_LINK_X = AIM_LINK_BOBBY_LINK_X;
  const AIM_LINK_INSURANCE_LINK_Y =
    AIM_LINK_FUNERAL_LINK_Y + AIM_LINK_LINK_OFFSET_Y;
  ...
  let gSelectedLinkRegion: MOUSE_REGION[] /* [AIM_LINK_NUM_LINKS] */ =
    createArrayFrom(AIM_LINK_NUM_LINKS, createMouseRegion);
  ...
  export function EnterAimLinks(): boolean {
    ...
    for (i = 0; i < AIM_LINK_NUM_LINKS; i++) {
      MSYS_DefineRegion(
        gSelectedLinkRegion[i],
        AIM_LINK_BOBBY_LINK_X,
        usPosY,
        AIM_LINK_BOBBY_LINK_X + AIM_LINK_LINK_WIDTH,
        usPosY + AIM_LINK_LINK_HEIGHT,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
  ...
  export function RenderAimLinks(): void {
    ...
    BltVideoObject(
      ...
      hPixHandle,
      0,
      AIM_LINK_FUNERAL_LINK_X,
      AIM_LINK_FUNERAL_LINK_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
    ...
    // Draw Link Title
    DrawTextToScreen(
      AimLinkText[Enum358.AIM_LINK_TITLE],
      AIM_LINK_TITLE_X,
      AIM_LINK_TITLE_Y,
      AIM_LINK_TITLE_WIDTH,
      AIM_LINK_TITLE_FONT(),
      AIM_LINK_TITLE_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  function SelectLinkRegionCallBack(
