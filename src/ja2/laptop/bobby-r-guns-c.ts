namespace ja2 {
  ...
  const BOBBYR_CATALOGUE_BUTTON_GAP =
    Math.trunc(
      (318 - NUM_CATALOGUE_BUTTONS * BOBBYR_CATALOGUE_BUTTON_WIDTH) /
        (NUM_CATALOGUE_BUTTONS + 1),
    ) +
    BOBBYR_CATALOGUE_BUTTON_WIDTH +
    1; // 80
  ...
  let gusItemNumberForItemsOnScreen: UINT16[] /* [BOBBYR_NUM_WEAPONS_ON_PAGE] */ =
    createArray(BOBBYR_NUM_WEAPONS_ON_PAGE, 0);

  let gfOnUsedPage: boolean;

  let gusOldItemNumOnTopOfPage: UINT16 = 65535;

  let guiBobbyRPageMenu: UINT32[] /* [NUM_CATALOGUE_BUTTONS] */ = createArray(
    NUM_CATALOGUE_BUTTONS,
    0,
  );
  ...
  let gSelectedBigImageRegion: MOUSE_REGION[] /* [BOBBYR_NUM_WEAPONS_ON_PAGE] */ =
    createArrayFrom(BOBBYR_NUM_WEAPONS_ON_PAGE, createMouseRegion);
  ...
  */
  ...
  export function DisplayBobbyRBrTitle(): boolean {
    ...
    // To Order Text
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_TO_ORDER],
      BOBBYR_TO_ORDER_TITLE_X,
      BOBBYR_TO_ORDER_TITLE_Y,
      0,
      BOBBYR_ORDER_TITLE_FONT(),
      BOBBYR_ORDER_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    ShadowVideoSurfaceRect(
      FRAME_BUFFER,
      BOBBYR_TO_ORDER_TEXT_X - 2,
      BOBBYR_TO_ORDER_TEXT_Y - 2,
    ...
    DisplayWrappedString(
      BOBBYR_TO_ORDER_TEXT_X,
      BOBBYR_TO_ORDER_TEXT_Y,
      BOBBYR_TO_ORDER_TEXT_WIDTH,
      2,
      BOBBYR_ORDER_TEXT_FONT(),
      BOBBYR_ORDER_TEXT_COLOR,
      BobbyRText[Enum350.BOBBYR_GUNS_CLICK_ON_ITEMS],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
  ...
  export function InitBobbyBrTitle(): boolean {
    ...
    MSYS_DefineRegion(
      gSelectedTitleImageLinkRegion,
      BOBBYR_BRTITLE_X,
      BOBBYR_BRTITLE_Y,
      BOBBYR_BRTITLE_X + BOBBYR_BRTITLE_WIDTH,
      BOBBYR_BRTITLE_Y + BOBBYR_BRTITLE_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
  ...
  function SelectTitleImageLinkRegionCallBack(
  ...
  export function InitBobbyMenuBar(): boolean {
    ...
    // Previous button
    guiBobbyRPreviousPageImage = LoadButtonImage(
      "LAPTOP\\PreviousButton.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiBobbyRPreviousPage = CreateIconAndTextButton(
      guiBobbyRPreviousPageImage,
      BobbyRText[Enum350.BOBBYR_GUNS_PREVIOUS_ITEMS],
      ...
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_PREVIOUS_BUTTON_X,
      BOBBYR_PREVIOUS_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    guiBobbyRPageMenuImage = LoadButtonImage(
      "LAPTOP\\CatalogueButton1.sti",
      -1,
      0,
      -1,
      1,
    ...
    // Next button
    guiBobbyRNextPageImage = LoadButtonImage(
      "LAPTOP\\NextButton.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiBobbyRNextPage = CreateIconAndTextButton(
      guiBobbyRNextPageImage,
      BobbyRText[Enum350.BOBBYR_GUNS_MORE_ITEMS],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_NEXT_BUTTON_X,
      BOBBYR_NEXT_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
      BtnBobbyRNextPreviousPageCallback,
    ...
    for (i = 0; i < NUM_CATALOGUE_BUTTONS; i++) {
      ...
      guiBobbyRPageMenu[i] = CreateIconAndTextButton(
        guiBobbyRPageMenuImage,
        BobbyRText[Enum350.BOBBYR_GUNS_GUNS + i],
        BOBBYR_GUNS_BUTTON_FONT(),
        BOBBYR_GUNS_TEXT_COLOR_ON,
        BOBBYR_GUNS_SHADOW_COLOR,
        BOBBYR_GUNS_TEXT_COLOR_OFF,
      ...
      MSYS_SetBtnUserData(
        guiBobbyRPageMenu[i],
        0,
        ubCatalogueButtonValues[bCurMode],
      );
    ...
    // Order Form button
    guiBobbyROrderFormImage = LoadButtonImage(
      "LAPTOP\\OrderFormButton.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiBobbyROrderForm = CreateIconAndTextButton(
      guiBobbyROrderFormImage,
      BobbyRText[Enum350.BOBBYR_GUNS_ORDER_FORM],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
    ...
    guiBobbyRHomeImage = LoadButtonImage(
    ...
    guiBobbyRHome = CreateIconAndTextButton(
      guiBobbyRHomeImage,
      BobbyRText[Enum350.BOBBYR_GUNS_HOME],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
  ...
  function BtnBobbyRNextPreviousPageCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    let bNewValue: UINT32;
  ...
  export function DisplayItemInfo(uiItemClass: UINT32): boolean {
    ...
    let pItemNumbers: INT16[] /* [BOBBYR_NUM_WEAPONS_ON_PAGE] */ = createArray(
    ...
    else CalcFirstIndexForPage(LaptopSaveInfo.BobbyRayInventory, uiItemClass);
    ...
    sTemp = swprintf(
      "%s %s",
      BobbyRText[Enum350.BOBBYR_GUNS_SUB_TOTAL],
      sDollarTemp,
    );
    DrawTextToScreen(
      sTemp,
      BOBBYR_ORDER_SUBTOTAL_X,
      BOBBYR_ORDER_SUBTOTAL_Y,
      0,
      BOBBYR_ORDER_TITLE_FONT(),
      BOBBYR_ORDER_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    if (gfOnUsedPage) {
      DrawTextToScreen(
        BobbyRText[Enum350.BOBBYR_GUNS_PERCENT_FUNCTIONAL],
        BOBBYR_PERCENT_FUNTCIONAL_X,
        BOBBYR_PERCENT_FUNTCIONAL_Y,
        0,
        BOBBYR_ITEM_DESC_TEXT_FONT(),
        BOBBYR_ORDER_TEXT_COLOR,
        FONT_MCOLOR_BLACK,
        false,
        LEFT_JUSTIFIED | TEXT_SHADOWED,
  ...
  function DisplayNonGunWeaponInfo(
    usIndex: UINT16,
    usTextPosY: UINT16,
    fUsed: boolean,
    usBobbyIndex: UINT16,
  ...
  function DisplayBigItemImage(usIndex: UINT16, PosY: UINT16): boolean {
    ...
    sCenX =
      PosX +
      Math.trunc(Math.abs(BOBBYR_GRID_PIC_WIDTH - usWidth) / 2) -
      pTrav.sOffsetX;
    sCenY = PosY + 8;
  ...
  function DisplayCostAndQty(
    ...
    // Display the cost
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_COST],
      BOBBYR_ITEM_COST_TEXT_X,
      usPosY,
      BOBBYR_ITEM_COST_TEXT_WIDTH,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
      BOBBYR_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      sTemp,
      BOBBYR_ITEM_COST_NUM_X,
      usPosY,
      BOBBYR_ITEM_COST_TEXT_WIDTH,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
      BOBBYR_ITEM_DESC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      RIGHT_JUSTIFIED,
    );
  ...
  */
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_WGHT],
    ...
    sTemp = swprintf(
      "%s",
      (GetWeightBasedOnMetricOption(Item[usIndex].ubWeight) / 10.0)
        .toFixed(2)
        .padStart(3),
    );
    DrawTextToScreen(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_IN_STOCK],
      BOBBYR_ITEM_STOCK_TEXT_X,
      usPosY,
      BOBBYR_ITEM_COST_TEXT_WIDTH,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
  ...
  function DisplayRof(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_ROF],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
      BOBBYR_STATIC_TEXT_COLOR,
    ...
    if (WeaponROF[usIndex] == -1)
      ...
      sTemp = swprintf(
        "%s/%s",
        WeaponROF[usIndex].toString().padStart(3),
        pMessageStrings[Enum333.MSG_MINUTE_ABBREVIATION],
      );

    DrawTextToScreen(
      sTemp,
      BOBBYR_ITEM_WEIGHT_NUM_X,
      usPosY,
      BOBBYR_ITEM_WEIGHT_NUM_WIDTH,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
      BOBBYR_ITEM_DESC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
  ...
  function DisplayDamage(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_DAMAGE],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
  ...
  function DisplayRange(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_RANGE],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
    ...
    sTemp = swprintf(
      "%s %s",
      Weapon[usIndex].usRange.toString().padStart(3),
      pMessageStrings[Enum333.MSG_METER_ABBREVIATION],
    );
    DrawTextToScreen(
      sTemp,
      BOBBYR_ITEM_WEIGHT_NUM_X,
  ...
  function DisplayMagazine(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_MAGAZINE],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
    ...
    sTemp = swprintf(
      "%s %s",
      Weapon[usIndex].ubMagSize.toString().padStart(3),
      pMessageStrings[Enum333.MSG_ROUNDS_ABBREVIATION],
    );
    DrawTextToScreen(
      sTemp,
      BOBBYR_ITEM_WEIGHT_NUM_X,
  ...
  function DisplayCaliber(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_CALIBRE],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
    ...
    if (
      StringPixLength(zTemp, BOBBYR_ITEM_DESC_TEXT_FONT()) >
      BOBBYR_ITEM_WEIGHT_NUM_WIDTH
    )
      zTemp = ReduceStringLength(
        zTemp,
        BOBBYR_GRID_PIC_WIDTH,
  ...
  function DisplayWeight(
    ...
    DrawTextToScreen(
      BobbyRText[Enum350.BOBBYR_GUNS_WEIGHT],
      BOBBYR_ITEM_WEIGHT_TEXT_X,
      usPosY,
      0,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
    ...
    sTemp = swprintf(
      "%s %s",
      (GetWeightBasedOnMetricOption(Item[usIndex].ubWeight) / 10)
        .toFixed(2)
        .padStart(3),
      GetWeightUnitString(),
    );
  ...
  function DisplayItemNameAndInfo(
    usPosY: UINT16,
    usIndex: UINT16,
    usBobbyIndex: UINT16,
    fUsed: boolean,
    ...
    if (
      StringPixLength(sText, BOBBYR_ITEM_NAME_TEXT_FONT()) >
      BOBBYR_GRID_PIC_WIDTH - 6
    )
      sText = ReduceStringLength(
        sText,
        BOBBYR_GRID_PIC_WIDTH - 6,
        BOBBYR_ITEM_NAME_TEXT_FONT(),
      );
    ...
    DrawTextToScreen(
      sText,
      BOBBYR_ITEM_NAME_X,
      usPosY + BOBBYR_ITEM_NAME_Y_OFFSET,
      0,
      BOBBYR_ITEM_NAME_TEXT_FONT(),
      BOBBYR_ITEM_NAME_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    if (ubPurchaseNumber != BOBBY_RAY_NOT_PURCHASED) {
      DrawTextToScreen(
        BobbyRText[Enum350.BOBBYR_GUNS_QTY_ON_ORDER],
        BOBBYR_ITEM_QTY_TEXT_X,
        usPosY,
        BOBBYR_ITEM_QTY_WIDTH,
        BOBBYR_ITEM_DESC_TEXT_FONT(),
        BOBBYR_STATIC_TEXT_COLOR,
        FONT_MCOLOR_BLACK,
        false,
    ...
    if (fUsed) {
      ...
      DrawTextToScreen(
        sTemp,
        BOBBYR_ITEM_NAME_X - 2,
        usPosY - BOBBYR_ORDER_NUM_Y_OFFSET,
        BOBBYR_ORDER_NUM_WIDTH,
        BOBBYR_ITEM_NAME_TEXT_FONT(),
        BOBBYR_ITEM_NAME_TEXT_COLOR,
        FONT_MCOLOR_BLACK,
        false,
    ...
    uiStartLoc =
      BOBBYR_ITEM_DESC_FILE_SIZE * usIndex + BOBBYR_ITEM_DESC_NAME_SIZE;
    sText = LoadEncryptedDataFromFile(
      BOBBYRDESCFILE,
      uiStartLoc,
      BOBBYR_ITEM_DESC_INFO_SIZE,
    );
    DisplayWrappedString(
      BOBBYR_ITEM_DESC_START_X,
      usPosY,
      BOBBYR_ITEM_DESC_START_WIDTH,
      2,
      BOBBYR_ITEM_DESC_TEXT_FONT(),
      BOBBYR_ITEM_DESC_TEXT_COLOR,
      sText,
...
*/
  ...
  export function SetFirstLastPagesForNew(uiClassMask: UINT32): void {
    ...
    for (i = 0; i < Enum225.MAXITEMS; i++) {
      ...
      if (LaptopSaveInfo.BobbyRayInventory[i].ubQtyOnHand != 0) {
        if (
          Item[LaptopSaveInfo.BobbyRayInventory[i].usItemIndex].usItemClass &
          uiClassMask
        ) {
          ubNumItems++;
  ...
  function CreateMouseRegionForBigImage(
    usPosY: UINT16,
    ubCount: UINT8,
    pItemNumbers: INT16[],
  ): void {
    ...
    for (i = 0; i < ubCount; i++) {
      ...
      MSYS_DefineRegion(
        gSelectedBigImageRegion[i],
        BOBBYR_GRID_PIC_X,
        usPosY,
        BOBBYR_GRID_PIC_X + BOBBYR_GRID_PIC_WIDTH,
        usPosY + BOBBYR_GRID_PIC_HEIGHT,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
      ...
      if (Item[pItemNumbers[i]].usItemClass == IC_AMMO) {
        ...
        ubItemCount = CheckPlayersInventoryForGunMatchingGivenAmmoID(
          pItemNumbers[i],
        );
        if (ubItemCount != 0) {
          zItemName = swprintf(
            "%s %d %s",
            BobbyRText[Enum350.BOBBYR_GUNS_NUM_GUNS_THAT_USE_AMMO_1],
            ubItemCount,
            BobbyRText[Enum350.BOBBYR_GUNS_NUM_GUNS_THAT_USE_AMMO_2],
          );
        } else zItemName = "";
      } else zItemName = "";
      ...
      SetRegionHelpEndCallback(
        gSelectedBigImageRegion[i],
        BobbyrRGunsHelpTextDoneCallBack,
      );
  ...
  function SelectBigImageRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function PurchaseBobbyRayItem(usItemNumber: UINT16): void {
    ...
    if (guiCurrentLaptopMode == Enum95.LAPTOP_MODE_BOBBY_R_USED) {
      ...
      if (
        ubPurchaseNumber == BOBBY_RAY_NOT_PURCHASED ||
  ...
  function CheckIfItemIsPurchased(usItemNumber: UINT16): UINT8 {
    ...
    for (i = 0; i < MAX_PURCHASE_AMOUNT; i++) {
      if (
        usItemNumber == BobbyRayPurchases[i].usBobbyItemIndex &&
  ...
  export function CalcBobbyRayCost(
    usIndex: UINT16,
    usBobbyIndex: UINT16,
    fUsed: boolean,
  ): UINT16 {
    ...
    if (fUsed)
      value =
        Item[LaptopSaveInfo.BobbyRayUsedInventory[usBobbyIndex].usItemIndex]
          .usPrice *
          (0.5 +
            (0.5 *
              LaptopSaveInfo.BobbyRayUsedInventory[usBobbyIndex]
                .ubItemQuality) /
              100) +
        0.5;
    else
      value =
        Item[LaptopSaveInfo.BobbyRayInventory[usBobbyIndex].usItemIndex]
          .usPrice;
  ...
  function CalculateTotalPurchasePrice(): UINT32 {
    ...
    for (i = 0; i < MAX_PURCHASE_AMOUNT; i++) {
      ...
      if (BobbyRayPurchases[i].ubNumberPurchased) {
        uiTotal +=
          CalcBobbyRayCost(
            BobbyRayPurchases[i].usItemIndex,
  ...
  function DisableBobbyRButtons(): void {
    ...
    if (gubNumPages == 0) DisableButton(guiBobbyRNextPage);
    else {
      if (gubCurPage >= gubNumPages - 1) DisableButton(guiBobbyRNextPage);
      else EnableButton(guiBobbyRNextPage);
    }

    // if it is the first page, disable the prev page buitton
    if (gubCurPage == 0) DisableButton(guiBobbyRPreviousPage);
    else EnableButton(guiBobbyRPreviousPage);
  ...
  */
  ...
  function CalcFirstIndexForPage(
    pInv: STORE_INVENTORY[],
    uiItemClass: UINT32,
  ): void {
    let i: UINT16;
  ...
  function CheckPlayersInventoryForGunMatchingGivenAmmoID(
    sItemID: INT16,
  ): UINT8 {
    let ubItemCount: UINT8 = 0;
    ...
    for (ubMercCount = ubFirstID; ubMercCount <= ubLastID; ubMercCount++) {
      if (Menptr[ubMercCount].bActive) {
        ...
        for (
          ubPocketCount = 0;
          ubPocketCount < Enum261.NUM_INV_SLOTS;
          ubPocketCount++
        ) {
          // if there is a weapon here
          if (
            Item[Menptr[ubMercCount].inv[ubPocketCount].usItem].usItemClass ==
            IC_GUN
          ) {
            // if the weapon uses the same kind of ammo as the one passed in, return true
            if (
              Weapon[Menptr[ubMercCount].inv[ubPocketCount].usItem].ubCalibre ==
