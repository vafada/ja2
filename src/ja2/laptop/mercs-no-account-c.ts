namespace ja2 {
  ...
  export function EnterMercsNoAccount(): boolean {
    ...
    guiOpenAccountBoxButtonImage = LoadButtonImage(
    ...
    guiOpenAccountBoxButton = CreateIconAndTextButton(
      ...
      MercNoAccountText[Enum342.MERC_NO_ACC_OPEN_ACCOUNT],
      FONT12ARIAL(),
    ...
    guiCancelBoxButton = CreateIconAndTextButton(
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      MERC_CANCEL_BUTTON_X,
      MERC_CANCEL_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
  ...
  export function RenderMercsNoAccount(): void {
    ...
    DisplayWrappedString(
      MERC_NA_SENTENCE_X,
      MERC_NA_SENTENCE_Y,
      MERC_NA_SENTENCE_WIDTH,
      2,
      MERC_NA_TEXT_FONT(),
      MERC_NA_TEXT_COLOR,
      MercNoAccountText[Enum342.MERC_NO_ACC_NO_ACCOUNT_OPEN_ONE],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  function BtnOpenAccountBoxButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        gusMercVideoSpeckSpeech =
          Enum111.SPECK_QUOTE_THANK_PLAYER_FOR_OPENING_ACCOUNT;
