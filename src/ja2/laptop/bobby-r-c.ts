namespace ja2 {
  ...
  const BOBBIES_FIRST_SENTENCE_Y =
    BOBBIES_STORE_PLAQUE_Y + BOBBIES_STORE_PLAQUE_HEIGHT - 3;
  ...
  const BOBBIES_MISC_SIGN_TEXT_OFFSET =
    BOBBIES_MISC_SIGN_Y + BOBBIES_CENTER_SIGN_OFFSET_Y;
  ...
  const BOBBIES_GUNS_SIGN_TEXT_OFFSET =
    BOBBIES_GUNS_SIGN_Y + BOBBIES_CENTER_SIGN_OFFSET_Y;
  ...
  const BOBBIES_AMMO_SIGN_TEXT_OFFSET =
    BOBBIES_AMMO_SIGN_Y + BOBBIES_CENTER_SIGN_OFFSET_Y;
  ...
  const BOBBIES_ARMOUR_SIGN_TEXT_OFFSET =
    BOBBIES_ARMOUR_SIGN_Y + BOBBIES_CENTER_SIGN_OFFSET_Y;
  ...
  const BOBBYR_UNDERCONSTRUCTION_X =
    LAPTOP_SCREEN_UL_X +
    Math.trunc(
      (LAPTOP_SCREEN_LR_X -
        LAPTOP_SCREEN_UL_X -
        BOBBYR_UNDERCONSTRUCTION_WIDTH) /
        2,
    );
  ...
  const BOBBYR_UNDER_CONSTRUCTION_TEXT_WIDTH =
...
*/
  ...
  let gSelectedBobbiesSignMenuRegion: MOUSE_REGION[] /* [BOBBIES_NUMBER_SIGNS] */ =
    createArrayFrom(BOBBIES_NUMBER_SIGNS, createMouseRegion);
  ...
  export function EnterBobbyR(): boolean {
    ...
    InitBobbiesMouseRegion(
      BOBBIES_NUMBER_SIGNS,
    ...
    if (!LaptopSaveInfo.fBobbyRSiteCanBeAccessed) {
      ...
      LaptopSaveInfo.ubHaveBeenToBobbyRaysAtLeastOnceWhileUnderConstruction =
        Enum99.BOBBYR_BEEN_TO_SITE_ONCE;
    }
  ...
  export function RenderBobbyR(): void {
    ...
    BltVideoObject(
      ...
      hPixHandle,
      0,
      BOBBIES_BOTTOMHINGE_X,
      BOBBIES_BOTTOMHINGE_Y,
      VO_BLT_SRCTRANSPARENCY,
      null,
    );
  ...
  */
    ...
    if (LaptopSaveInfo.fBobbyRSiteCanBeAccessed) {
      ...
      DrawTextToScreen(
        BobbyRaysFrontText[Enum351.BOBBYR_ADVERTISMENT_1],
      ...
      DrawTextToScreen(
        BobbyRaysFrontText[Enum351.BOBBYR_ADVERTISMENT_2],
        BOBBIES_2ND_SENTENCE_X,
        BOBBIES_2ND_SENTENCE_Y,
    ...
    DisplayWrappedString(
      BOBBIES_USED_SIGN_X,
      BOBBIES_USED_SIGN_TEXT_OFFSET,
      BOBBIES_USED_SIGN_WIDTH - 5,
      2,
      BOBBIES_SIGN_FONT(),
      BOBBIES_SIGN_COLOR,
      BobbyRaysFrontText[Enum351.BOBBYR_USED],
      BOBBIES_SIGN_BACKCOLOR,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      BOBBIES_MISC_SIGN_X,
      BOBBIES_MISC_SIGN_TEXT_OFFSET,
      BOBBIES_MISC_SIGN_WIDTH,
      2,
      BOBBIES_SIGN_FONT(),
      BOBBIES_SIGN_COLOR,
      BobbyRaysFrontText[Enum351.BOBBYR_MISC],
      BOBBIES_SIGN_BACKCOLOR,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      BOBBIES_GUNS_SIGN_X,
      BOBBIES_GUNS_SIGN_TEXT_OFFSET,
      BOBBIES_GUNS_SIGN_WIDTH,
      2,
      BOBBIES_SIGN_FONT(),
      BOBBIES_SIGN_COLOR,
      BobbyRaysFrontText[Enum351.BOBBYR_GUNS],
      BOBBIES_SIGN_BACKCOLOR,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      BOBBIES_AMMO_SIGN_X,
      BOBBIES_AMMO_SIGN_TEXT_OFFSET,
      BOBBIES_AMMO_SIGN_WIDTH,
      2,
      BOBBIES_SIGN_FONT(),
      BOBBIES_SIGN_COLOR,
      BobbyRaysFrontText[Enum351.BOBBYR_AMMO],
      BOBBIES_SIGN_BACKCOLOR,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      BOBBIES_ARMOUR_SIGN_X,
      BOBBIES_ARMOUR_SIGN_TEXT_OFFSET,
      BOBBIES_ARMOUR_SIGN_WIDTH,
      2,
      BOBBIES_SIGN_FONT(),
      BOBBIES_SIGN_COLOR,
      BobbyRaysFrontText[Enum351.BOBBYR_ARMOR],
      BOBBIES_SIGN_BACKCOLOR,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    if (LaptopSaveInfo.fBobbyRSiteCanBeAccessed) {
      ...
      SetFontShadow(BOBBIES_SENTENCE_BACKGROUNDCOLOR);
      DrawTextToScreen(
        BobbyRaysFrontText[Enum351.BOBBYR_ADVERTISMENT_3],
        BOBBIES_3RD_SENTENCE_X,
        BOBBIES_3RD_SENTENCE_Y,
        BOBBIES_3RD_SENTENCE_WIDTH,
        BOBBIES_SENTENCE_FONT(),
        BOBBIES_SENTENCE_COLOR,
        BOBBIES_SIGN_BACKCOLOR,
        false,
  ...
  function InitBobbiesMouseRegion(
    ubNumerRegions: UINT8,
    usMouseRegionPosArray: UINT16[],
  ...
  function RemoveBobbiesMouseRegion(
    ubNumberRegions: UINT8,
  ...
  function SelectBobbiesSignMenuRegionCallBack(
...
*/
  ...
  function HandleBobbyRUnderConstructionAni(fReset: boolean): void {
    ...
    if (fReset) HandleBobbyRUnderConstructionAni__usCount = 1;
    ...
    if (
      uiCurTime - HandleBobbyRUnderConstructionAni__uiLastTime >
        BOBBYR_UNDERCONSTRUCTION_ANI_DELAY ||
      fReDrawScreenFlag
    ) {
      // The undercontsruction graphic
      ...
      DrawTextToScreen(
        BobbyRaysFrontText[Enum351.BOBBYR_UNDER_CONSTRUCTION],
        BOBBYR_UNDER_CONSTRUCTION_TEXT_X,
        BOBBYR_UNDER_CONSTRUCTION_TEXT_Y,
        BOBBYR_UNDER_CONSTRUCTION_TEXT_WIDTH,
        FONT16ARIAL(),
        BOBBIES_SENTENCE_COLOR,
        BOBBIES_SIGN_BACKCOLOR,
        false,
      ...
      if (
        HandleBobbyRUnderConstructionAni__usCount >=
        BOBBYR_UNDERCONSTRUCTION_NUM_FRAMES
      )
  ...
  function InitBobbyRayNewInventory(): boolean {
    ...
    for (i = 0; i < Enum225.MAXITEMS; i++) {
      ...
      if (
        StoreInventory[i][Enum112.BOBBY_RAY_NEW] != 0 &&
        !(Item[i].fFlags & ITEM_NOT_BUYABLE) &&
        ItemIsLegal(i)
      ) {
    ...
    LaptopSaveInfo.BobbyRayInventory[usBobbyrIndex].usItemIndex =
      BOBBYR_NO_ITEMS;
  ...
  function InitBobbyRayUsedInventory(): boolean {
    ...
    for (i = 0; i < Enum225.MAXITEMS; i++) {
      // if Bobby Ray sells this, it can be sold, and it's allowed into this game (some depend on e.g. gun-nut option)
      if (
        StoreInventory[i][Enum112.BOBBY_RAY_USED] != 0 &&
        !(Item[i].fFlags & ITEM_NOT_BUYABLE) &&
        ItemIsLegal(i)
      ) {
        if (
    ...
    // remember how many entries in the list are valid
    LaptopSaveInfo.usInventoryListLength[Enum112.BOBBY_RAY_USED] =
      usBobbyrIndex;
    // also mark the end of the list of valid item entries
    LaptopSaveInfo.BobbyRayUsedInventory[usBobbyrIndex].usItemIndex =
      BOBBYR_NO_ITEMS;
  ...
  export function DailyUpdateOfBobbyRaysNewInventory(): void {
    ...
    SimulateBobbyRayCustomer(
      ...
      Boolean(Enum112.BOBBY_RAY_NEW),
    );

    // loop through all items BR can stock to see what needs reordering
    for (
      i = 0;
      i < LaptopSaveInfo.usInventoryListLength[Enum112.BOBBY_RAY_NEW];
      i++
    ) {
      ...
      if (LaptopSaveInfo.BobbyRayInventory[i].ubQtyOnOrder == 0) {
        ...
        if (
          ...
          Math.trunc(StoreInventory[usItemIndex][Enum112.BOBBY_RAY_NEW] / 2)
        ) {
          ...
          LaptopSaveInfo.BobbyRayInventory[i].ubQtyOnOrder =
            HowManyBRItemsToOrder(
              usItemIndex,
              LaptopSaveInfo.BobbyRayInventory[i].ubQtyOnHand,
              Enum112.BOBBY_RAY_NEW,
            );
  ...
  export function DailyUpdateOfBobbyRaysUsedInventory(): void {
    ...
    SimulateBobbyRayCustomer(
      ...
      Boolean(Enum112.BOBBY_RAY_USED),
    );

    for (
      i = 0;
      i < LaptopSaveInfo.usInventoryListLength[Enum112.BOBBY_RAY_USED];
      i++
    ) {
      ...
      if (LaptopSaveInfo.BobbyRayUsedInventory[i].ubQtyOnOrder == 0) {
        ...
        if (LaptopSaveInfo.BobbyRayUsedInventory[i].ubQtyOnHand == 0) {
          ...
          // remember value of the "previously eligible" flag
          fPrevElig =
            LaptopSaveInfo.BobbyRayUsedInventory[i].fPreviouslyEligible;

          // determine if any can/should be ordered, and how many
          LaptopSaveInfo.BobbyRayUsedInventory[i].ubQtyOnOrder =
            HowManyBRItemsToOrder(
              usItemIndex,
              LaptopSaveInfo.BobbyRayUsedInventory[i].ubQtyOnHand,
              Enum112.BOBBY_RAY_USED,
            );
  ...
  function HowManyBRItemsToOrder(
    usItemIndex: UINT16,
    ubCurrentlyOnHand: UINT8,
    ubBobbyRayNewUsed: UINT8,
  ): UINT8 {
    ...
    if (
      ItemTransactionOccurs(
        ...
        usItemIndex,
        DEALER_BUYING,
        Boolean(ubBobbyRayNewUsed),
      )
    ) {
      if (ubBobbyRayNewUsed == Enum112.BOBBY_RAY_NEW) {
        ubItemsOrdered = HowManyItemsToReorder(
          StoreInventory[usItemIndex][ubBobbyRayNewUsed],
          ubCurrentlyOnHand,
        );
      } else {
  ...
  function OrderBobbyRItem(usItemIndex: UINT16): void {
    ...
    uiArrivalTime =
      BOBBY_R_NEW_PURCHASE_ARRIVAL_TIME +
      Random(Math.trunc(BOBBY_R_NEW_PURCHASE_ARRIVAL_TIME / 2));
    uiArrivalTime += GetWorldTotalMin();
    AddStrategicEvent(
      Enum132.EVENT_UPDATE_BOBBY_RAY_INVENTORY,
      uiArrivalTime,
      usItemIndex,
    );
  }
  ...
  export function AddFreshBobbyRayInventory(usItemIndex: UINT16): void {
    ...
    if (sInventorySlot == -1) {
      AssertMsg(
        false,
        FormatString(
          "AddFreshBobbyRayInventory(), Item %d not found.  AM-0.",
          usItemIndex,
        ),
      );
      return;
  ...
  export function GetInventorySlotForItem(
    pInventoryArray: STORE_INVENTORY[],
    usItemIndex: UINT16,
    fUsed: boolean,
  ): INT16 {
    let i: INT16;
  ...
  function SimulateBobbyRayCustomer(
    pInventoryArray: STORE_INVENTORY[],
    fUsed: boolean,
  ): void {
    let i: INT16;
