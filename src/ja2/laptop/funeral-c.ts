namespace ja2 {
  ...
  let gSelectedFuneralLinkRegion: MOUSE_REGION[] /* [FUNERAL_NUMBER_OF_LINKS] */ =
    createArrayFrom(FUNERAL_NUMBER_OF_LINKS, createMouseRegion);
  ...
  export function EnterFuneral(): boolean {
    ...
    for (i = 0; i < FUNERAL_NUMBER_OF_LINKS; i++) {
      ...
      MSYS_DefineRegion(
        gSelectedFuneralLinkRegion[i],
        usPosX,
        FUNERAL_LINK_1_Y,
        usPosX + FUNERAL_LINK_1_WIDTH,
        FUNERAL_LINK_1_Y + FUNERAL_LINK_1_HEIGHT,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      gSelectedRipSignRegion,
      FUNERAL_CLOSED_RIP_SIGN_X,
      FUNERAL_CLOSED_RIP_SIGN_Y,
      FUNERAL_CLOSED_RIP_SIGN_X + FUNERAL_CLOSED_WIDTH,
      FUNERAL_CLOSED_RIP_SIGN_Y + FUNERAL_CLOSED_HEIGHT,
  ...
  export function RenderFuneral(): void {
    ...
    for (i = 0; i < FUNERAL_NUMBER_OF_LINKS; i++) {
      ...
      usStringHeight = IanWrappedStringHeight(
        0,
        0,
        ...
        0,
        sFuneralString[i + Enum344.FUNERAL_SEND_FLOWERS],
        0,
        false,
        0,
      );
      DisplayWrappedString(
        usPosX + FUNERAL_LINK_TEXT_OFFSET_X,
        Math.trunc(
    ...
    DisplayWrappedString(
      ...
      FUNERAL_TITLE_FONT(),
      FUNERAL_TITLE_COLOR,
      sFuneralString[Enum344.FUNERAL_INTRO_1],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      sFuneralString[Enum344.FUNERAL_INTRO_2],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      FUNERAL_SENTENCE_FONT(),
      FUNERAL_SENTENCE_COLOR,
      sFuneralString[Enum344.FUNERAL_INTRO_3],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      FUNERAL_SENTENCE_FONT(),
      FUNERAL_SENTENCE_COLOR,
      sFuneralString[Enum344.FUNERAL_INTRO_4],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      FUNERAL_SENTENCE_FONT(),
      FUNERAL_SENTENCE_COLOR,
      sFuneralString[Enum344.FUNERAL_INTRO_5],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  function DisplayFuneralRipTombStone(): void {
    ...
    DisplayWrappedString(
      ...
      FUNERAL_SMALL_FONT(),
      FUNERAL_SENTENCE_COLOR,
      sFuneralString[Enum344.FUNERAL_OUR_CONDOLENCES],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    ); // FUNERAL_TITLE_FONT
    ...
    DisplayWrappedString(
      ...
      FUNERAL_SMALL_FONT(),
      FUNERAL_SENTENCE_COLOR,
      sFuneralString[Enum344.FUNERAL_OUR_SYMPATHIES],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  function SelectFuneralLinkRegionCallBack(
    ...
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      if (uiUserData == 0) GoToWebPage(Enum98.FLORIST_BOOKMARK);
      else {
        RenderFuneral();
  ...
  function SelectRipSignRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
