namespace ja2 {
  ...
  let giIMPPersonalityQuizAnswerButtonImage: INT32[] /* [10] */ = createArray(
    10,
    0,
  );
  ...
  let iQuizAnswerList: INT32[] /* [MAX_NUMBER_OF_IMP_QUESTIONS] */ =
    createArray(MAX_NUMBER_OF_IMP_QUESTIONS, 0);
  ...
  function CreateIMPPersonalityQuizButtons(): void {
    ...
    // ths Done button
    giIMPPersonalityQuizButtonImage[0] = LoadButtonImage(
      "LAPTOP\\button_7.sti",
      -1,
      0,
      -1,
  ...
  */
    giIMPPersonalityQuizButton[0] = CreateIconAndTextButton(
      giIMPPersonalityQuizButtonImage[0],
      pImpButtonText[8],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + 197,
      LAPTOP_SCREEN_WEB_UL_Y + 302,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    // start over
    giIMPPersonalityQuizButtonImage[1] = LoadButtonImage(
      "LAPTOP\\button_5.sti",
      -1,
      0,
      -1,
...
*/
    ...
    giIMPPersonalityQuizButton[1] = CreateIconAndTextButton(
      giIMPPersonalityQuizButtonImage[1],
      pImpButtonText[7],
      FONT12ARIAL(),
      FONT_WHITE,
      DEFAULT_SHADOW,
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + BTN_FIRST_COLUMN_X,
      LAPTOP_SCREEN_WEB_UL_Y + 302,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      BtnGenericMouseMoveButtonCallback,
    ...
    giPreviousQuestionButtonImage = LoadButtonImage(
      "LAPTOP\\button_3.sti",
      -1,
      0,
      -1,
    ...
    giNextQuestionButtonImage = LoadButtonImage(
      "LAPTOP\\button_3.sti",
      -1,
      0,
      -1,
  ...
  function AddIMPPersonalityQuizAnswerButtons(iNumberOfButtons: INT32): void {
    ...
    for (iCounter = 0; iCounter < iNumberOfButtons; iCounter++) {
      switch (iCounter) {
        case 0:
          giIMPPersonalityQuizAnswerButtonImage[0] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 1:
          giIMPPersonalityQuizAnswerButtonImage[1] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 2:
          giIMPPersonalityQuizAnswerButtonImage[2] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 3:
          giIMPPersonalityQuizAnswerButtonImage[3] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 4:
          giIMPPersonalityQuizAnswerButtonImage[4] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          giIMPPersonalityQuizAnswerButton[4] = QuickCreateButton(
            ...
            LAPTOP_SCREEN_UL_X + BTN_SECOND_COLUMN_X,
            LAPTOP_SCREEN_WEB_UL_Y + 97,
            BUTTON_TOGGLE,
          ...
          break;
        case 5:
          giIMPPersonalityQuizAnswerButtonImage[5] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 6:
          giIMPPersonalityQuizAnswerButtonImage[6] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 7:
          giIMPPersonalityQuizAnswerButtonImage[7] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          break;
        case 8:
          giIMPPersonalityQuizAnswerButtonImage[8] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          giIMPPersonalityQuizAnswerButton[8] = QuickCreateButton(
            ...
            LAPTOP_SCREEN_UL_X + BTN_SECOND_COLUMN_X,
            LAPTOP_SCREEN_WEB_UL_Y + 268,
            BUTTON_TOGGLE,
            MSYS_PRIORITY_HIGHEST - 3,
            MSYS_NO_CALLBACK,
            BtnIMPPersonalityQuizAnswer8Callback,
          );

          break;
        case 9:
          giIMPPersonalityQuizAnswerButtonImage[9] = LoadButtonImage(
            "LAPTOP\\button_6.sti",
            -1,
            0,
            -1,
          ...
          giIMPPersonalityQuizAnswerButton[9] = QuickCreateButton(
            ...
            LAPTOP_SCREEN_UL_X + Math.trunc((276 - 46) / 2),
            LAPTOP_SCREEN_WEB_UL_Y + 147,
            BUTTON_TOGGLE,
            MSYS_PRIORITY_HIGHEST - 3,
            MSYS_NO_CALLBACK,
            BtnIMPPersonalityQuizAnswer9Callback,
          );
      ...
      SpecifyButtonUpTextColors(
        giIMPPersonalityQuizAnswerButton[iCounter],
        FONT_WHITE,
        FONT_BLACK,
      );
  ...
  function DestroyIMPPersonalityQuizAnswerButtons(
    iNumberOfButtons: INT32,
  ): void {
    let iCounter: INT32 = 0;
    for (iCounter = 0; iCounter < iNumberOfButtons; iCounter++) {
  ...
  function BtnIMPPersonalityQuizAnswer0Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  function BtnIMPPersonalityQuizAnswer1Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer2Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer3Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer4Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer5Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer6Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer7Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer8Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswer9Callback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizAnswerConfirmCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function BtnIMPPersonalityQuizStartOverCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP personality quiz answer button
  ...
  function ResetQuizAnswerButtons(): void {
    ...
    for (iCnt = 0; iCnt < iCounter; iCnt++) {
      ButtonList[giIMPPersonalityQuizAnswerButton[iCnt]].uiFlags &=
        ~BUTTON_CLICKED_ON;
    }
  ...
  function CompileQuestionsInStatsAndWhatNot(): void {
    ...
    for (
      iCurrentQuestion = 0;
      iCurrentQuestion < MAX_NUMBER_OF_IMP_QUESTIONS;
      iCurrentQuestion++
    ) {
      ...
      switch (iCounter) {
          ...
          if (iNumberOfIndents < 5) {
            ...
            if (iCurrentAnswer == iCounter) {
              RenderQtnLongIndentHighFrame(
                BTN_FIRST_COLUMN_X + INDENT_OFFSET,
                93,
              );
            }
          } else {
        ...
        case 3:
          ...
          if (giCurrentPersonalityQuizQuestion == 5) {
            ...
            if (iCurrentAnswer == iCounter) {
              // need to highlight
              RenderQtnShort2IndentHighFrame(
                BTN_FIRST_COLUMN_X + INDENT_OFFSET,
                243,
              );
            }
        ...
        case 4:
          ...
          if (
            giCurrentPersonalityQuizQuestion == 10 ||
            giCurrentPersonalityQuizQuestion == 5
          ) {
            // render longer frame
  ...
  */
  ...
  function ToggleQuestionNumberButtonOn(iAnswerNumber: INT32): void {
    if (
      ...
      // toggle this button on
      ButtonList[giIMPPersonalityQuizAnswerButton[iAnswerNumber]].uiFlags |=
        BUTTON_CLICKED_ON;
  ...
  function PreviousQuestionButtonCallback(
    btn: GUI_BUTTON,
    iReason: INT32,
  ): void {
    if (!(btn.uiFlags & BUTTON_ENABLED)) return;
