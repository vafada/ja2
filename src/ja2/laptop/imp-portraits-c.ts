namespace ja2 {
  ...
  function RenderPortrait(sX: INT16, sY: INT16): boolean {
    ...
    if (fCharacterIsMale) {
      ...
      VObjectDesc.ImageFile = FilenameForBPP(
        pPlayerSelectedBigFaceFileNames[iCurrentPortrait],
      );
      ...
      VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
      VObjectDesc.ImageFile = FilenameForBPP(
        pPlayerSelectedBigFaceFileNames[iCurrentPortrait + 8],
      );
      if (!(uiGraphicHandle = AddVideoObject(VObjectDesc))) {
        return false;
      }
  ...
  function CreateIMPPortraitButtons(): void {
    ...
    // next button
    giIMPPortraitButtonImage[0] = LoadButtonImage(
      "LAPTOP\\voicearrows.sti",
      -1,
      1,
      -1,
      3,
...
*/
    giIMPPortraitButton[0] = CreateIconAndTextButton(
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + 343,
      LAPTOP_SCREEN_WEB_UL_Y + 205,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    // previous button
    giIMPPortraitButtonImage[1] = LoadButtonImage(
      "LAPTOP\\voicearrows.sti",
      -1,
      0,
      -1,
    ...
    */
    ...
    // done button
    giIMPPortraitButtonImage[2] = LoadButtonImage(
      "LAPTOP\\button_5.sti",
      -1,
      0,
      -1,
...
*/
    giIMPPortraitButton[2] = CreateIconAndTextButton(
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      LAPTOP_SCREEN_UL_X + 187,
      LAPTOP_SCREEN_WEB_UL_Y + 330,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      BtnGenericMouseMoveButtonCallback,
  ...
  function BtnIMPPortraitPreviousCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    // btn callback for IMP attrbite begin button
