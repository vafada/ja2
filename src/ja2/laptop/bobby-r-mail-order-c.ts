namespace ja2 {
  ...
  function createBobbyROrderLocationStructFrom(
    psCityLoc: string,
    usOverNightExpress: UINT16,
    us2DaysService: UINT16,
    usStandardService: UINT16,
  ...
  let BobbyROrderLocations: BobbyROrderLocationStruct[] /* [] */ = [
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[0],
      20,
      15,
      10,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[1],
      295,
      150,
      85,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[2],
      200,
      100,
      50,
    ), // the only one that really matters
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[3],
      100,
      55,
      30,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[4],
      95,
      65,
      40,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[5],
      55,
      40,
      25,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[6],
      35,
      25,
      15,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[7],
      200,
      100,
      50,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[8],
      190,
      90,
      45,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[9],
      35,
      25,
      15,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[10],
      100,
      55,
      30,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[11],
      35,
      25,
      15,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[12],
      45,
      30,
      20,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[13],
      55,
      40,
      25,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[14],
      100,
      55,
      30,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[15],
      100,
      55,
      30,
    ),
    createBobbyROrderLocationStructFrom(
      pDeliveryLocationStrings[16],
      45,
      30,
      20,
    ),
  ...
  const BOBBYR_SUBTOTAL_Y =
    BOBBYR_GRID_FIRST_COLUMN_Y + BOBBYR_GRID_ROW_OFFSET * 10 + 3;
  ...
  const BOBBYR_SHIPMENT_BUTTON_X = Math.trunc(
  ...
  const BOBBYR_SCROLL_AREA_HEIGHT_MINUS_ARROWS =
  ...
  const BOBBYR_SCROLL_DOWN_ARROW_Y =
    BOBBYR_SCROLL_AREA_Y + BOBBYR_SCROLL_AREA_HEIGHT - 24;
  ...
  let gShippingSpeedAreas: UINT16[] /* [] */ = [
    585,
    218 + LAPTOP_SCREEN_WEB_DELTA_Y,
    585,
    238 + LAPTOP_SCREEN_WEB_DELTA_Y,
    585,
    258 + LAPTOP_SCREEN_WEB_DELTA_Y,
  ];
  ...
  let gSelectedShippingSpeedRegion: MOUSE_REGION[] /* [3] */ = createArrayFrom(
    3,
    createMouseRegion,
  );
  ...
  let gSelectedDropDownRegion: MOUSE_REGION[] /* [BOBBYR_ORDER_NUM_SHIPPING_CITIES] */ =
    createArrayFrom(BOBBYR_ORDER_NUM_SHIPPING_CITIES, createMouseRegion);
  ...
  export function EnterBobbyRMailOrder(): boolean {
    ...
    // Clear Order button
    guiBobbyRClearOrderImage = LoadButtonImage(
      "LAPTOP\\EraseOrderButton.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiBobbyRClearOrder = CreateIconAndTextButton(
      guiBobbyRClearOrderImage,
      BobbyROrderFormText[Enum349.BOBBYR_CLEAR_ORDER],
      BOBBYR_ORDER_TITLE_TEXT_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_CLEAR_ORDER_X,
      BOBBYR_CLEAR_ORDER_Y + 4,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
    ...
    // Accept Order button
    guiBobbyRAcceptOrderImage = LoadButtonImage(
      "LAPTOP\\AcceptOrderButton.sti",
      2,
      0,
      -1,
      1,
    ...
    guiBobbyRAcceptOrder = CreateIconAndTextButton(
      guiBobbyRAcceptOrderImage,
      BobbyROrderFormText[Enum349.BOBBYR_ACCEPT_ORDER],
      BOBBYR_ORDER_TITLE_TEXT_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_ACCEPT_ORDER_X,
      BOBBYR_ACCEPT_ORDER_Y + 4,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    guiBobbyRBackImage = LoadButtonImage(
      "LAPTOP\\CatalogueButton.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiBobbyRBack = CreateIconAndTextButton(
      guiBobbyRBackImage,
      BobbyROrderFormText[Enum349.BOBBYR_BACK],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_BACK_BUTTON_X,
      BOBBYR_BACK_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    guiBobbyRHomeImage = UseLoadedButtonImage(
      guiBobbyRBackImage,
      -1,
      0,
      -1,
    ...
    guiBobbyRHome = CreateIconAndTextButton(
      guiBobbyRHomeImage,
      BobbyROrderFormText[Enum349.BOBBYR_HOME],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_HOME_BUTTON_X,
      BOBBYR_HOME_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    giBobbyRGotoShipmentPageImage = UseLoadedButtonImage(
      guiBobbyRBackImage,
      -1,
      0,
      -1,
    ...
    guiBobbyRGotoShipmentPage = CreateIconAndTextButton(
      giBobbyRGotoShipmentPageImage,
      BobbyROrderFormText[Enum349.BOBBYR_GOTOSHIPMENT_PAGE],
      BOBBYR_GUNS_BUTTON_FONT(),
      BOBBYR_GUNS_TEXT_COLOR_ON,
      BOBBYR_GUNS_SHADOW_COLOR,
      BOBBYR_GUNS_TEXT_COLOR_OFF,
      BOBBYR_GUNS_SHADOW_COLOR,
      TEXT_CJUSTIFIED,
      BOBBYR_SHIPMENT_BUTTON_X,
      BOBBYR_SHIPMENT_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    for (i = 0; i < 3; i++) {
      MSYS_DefineRegion(
        ...
        gShippingSpeedAreas[i * 2],
        gShippingSpeedAreas[i * 2 + 1],
        gShippingSpeedAreas[i * 2] + SHIPPING_SPEED_LIGHT_WIDTH,
    ...
    MSYS_DefineRegion(
      ...
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
      SelectConfirmOrderRegionCallBack,
    );
    ...
    MSYS_DefineRegion(
      gSelectedActivateCityDroDownRegion,
      BOBBYR_SHIPPING_LOC_AREA_L_X,
      BOBBYR_SHIPPING_LOC_AREA_T_Y,
      BOBBYR_SHIPPING_LOC_AREA_R_X,
      BOBBYR_SHIPPING_LOC_AREA_B_Y,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
    ...
    MSYS_DefineRegion(
      ...
      MSYS_NO_CALLBACK,
      SelectCloseDroDownRegionCallBack,
    );
  ...
  export function HandleBobbyRMailOrder(): void {
    ...
    if (gubDropDownAction != Enum69.BR_DROP_DOWN_NO_ACTION) {
      ...
      else gubDropDownAction = Enum69.BR_DROP_DOWN_NO_ACTION;
    }
  }
  ...
  export function RenderBobbyRMailOrder(): void {
    ...
    // Output the title
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_ORDER_FORM],
      BOBBYR_ORDER_FORM_TITLE_X,
      BOBBYR_ORDER_FORM_TITLE_Y,
      BOBBYR_ORDER_FORM_TITLE_WIDTH,
      BOBBYR_ORDER_TITLE_TEXT_FONT(),
      BOBBYR_ORDER_TITLE_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
  ...
  */
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_SHIPPING_LOCATION],
      BOBBYR_SHIPPING_LOCATION_TEXT_X,
      BOBBYR_SHIPPING_LOCATION_TEXT_Y,
      0,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_SHIPPING_SPEED],
      BOBBYR_SHIPPING_SPEED_X,
    ...
    // Create a string for the weight ( %s ) ( where %s is the weight string, either kg or lbs )
    sTemp = swprintf(
      BobbyROrderFormText[Enum349.BOBBYR_COST],
      GetWeightUnitString(),
    );
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_OVERNIGHT_EXPRESS],
      BOBBYR_SHIPPING_SPEED_X,
      usPosY,
      0,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_BUSINESS_DAYS],
      BOBBYR_SHIPPING_SPEED_X,
      usPosY,
      0,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
    ...
    usPosY += BOBBYR_GRID_ROW_OFFSET;
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_STANDARD_SERVICE],
      BOBBYR_SHIPPING_SPEED_X,
      usPosY,
      0,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_USED_TEXT],
      BOBBYR_USED_WARNING_X,
      BOBBYR_USED_WARNING_Y + 1,
      0,
      BOBBYR_DISCLAIMER_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    sTemp = swprintf(
      "%s %s %s.",
      BobbyROrderFormText[Enum349.BOBBYR_MINIMUM_WEIGHT],
      (GetWeightBasedOnMetricOption(MIN_SHIPPING_WEIGHT) / 10.0)
        .toFixed(1)
        .padStart(2),
      GetWeightUnitString(),
    );
    DrawTextToScreen(
      sTemp,
      BOBBYR_USED_WARNING_X,
      BOBBYR_USED_WARNING_Y + usHeight + 1,
      0,
      BOBBYR_DISCLAIMER_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (guiSubTotal && gfCanAcceptOrder) {
        ...
        if (LaptopSaveInfo.iCurrentBalance < giGrandTotal) {
          ...
          if (
            gbSelectedCity == Enum70.BR_DRASSEN &&
            !StrategicMap[SECTOR_INFO_TO_STRATEGIC_INDEX(Enum123.SEC_B13)]
              .fEnemyControlled
          ) {
            ...
            zTemp = swprintf(
              BobbyROrderFormText[Enum349.BOBBYR_CONFIRM_DEST],
  ...
  export function DisplayPurchasedItems(
    fCalledFromOrderPage: boolean,
    usGridX: UINT16,
    usGridY: UINT16,
    pBobbyRayPurchase: BobbyRayPurchaseStruct[] | null,
    fJustDisplayTitles: boolean,
    iOrderNum: INT32,
  ): void {
    let i: UINT16;
    let j: UINT16;
    ...
    // Output the qty
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_QTY],
      usGridX + BOBBYR_GRID_FIRST_COLUMN_X,
      usGridY + BOBBYR_GRID_FIRST_COLUMN_Y - BOBBYR_GRID_TITLE_OFFSET,
      BOBBYR_GRID_FIRST_COLUMN_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    // Create a string for the weight ( %s ) ( where %s is the weight string, either kg or lbs )
    sTemp = swprintf(
      BobbyROrderFormText[Enum349.BOBBYR_WEIGHT],
      GetWeightUnitString(),
    );

    // Output the Weight
    DisplayWrappedString(
      usGridX + BOBBYR_GRID_SECOND_COLUMN_X,
      usGridY + BOBBYR_GRID_SECOND_COLUMN_Y - 30,
      BOBBYR_GRID_SECOND_COLUMN_WIDTH,
      2,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      sTemp,
    ...
    // Output the name
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_NAME],
      usGridX + BOBBYR_GRID_THIRD_COLUMN_X,
      usGridY + BOBBYR_GRID_THIRD_COLUMN_Y - BOBBYR_GRID_TITLE_OFFSET,
      BOBBYR_GRID_THIRD_COLUMN_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DisplayWrappedString(
      ...
      usGridY + BOBBYR_GRID_FOURTH_COLUMN_Y - 30,
      BOBBYR_GRID_FOURTH_COLUMN_WIDTH,
      2,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      BobbyROrderFormText[Enum349.BOBBYR_UNIT_PRICE],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    // Output the sub total, shipping and handling, and the grand total
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_SUB_TOTAL],
      usGridX + BOBBYR_SUBTOTAL_X,
      usGridY + BOBBYR_SUBTOTAL_Y,
      BOBBYR_SUBTOTAL_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_S_H],
      usGridX + BOBBYR_SUBTOTAL_X,
      usGridY + BOBBYR_SHIPPING_N_HANDLE_Y,
      BOBBYR_SUBTOTAL_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_GRAND_TOTAL],
      usGridX + BOBBYR_SUBTOTAL_X,
      usGridY + BOBBYR_GRAND_TOTAL_Y,
      BOBBYR_SUBTOTAL_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
    ...
    for (i = 0; i < MAX_PURCHASE_AMOUNT; i++) {
      ...
      if (pBobbyRayPurchase[i].ubNumberPurchased) {
        ...
        sTemp = swprintf(
          "%s",
          pBobbyRayPurchase[i].ubNumberPurchased.toString().padStart(3),
        );
        DrawTextToScreen(
          sTemp,
          usGridX + BOBBYR_GRID_FIRST_COLUMN_X - 2,
          usPosY,
          BOBBYR_GRID_FIRST_COLUMN_WIDTH,
          BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
          BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
          FONT_MCOLOR_BLACK,
          false,
          RIGHT_JUSTIFIED,
        );
        ...
        sTemp = swprintf(
          "%s",
          (
            (GetWeightBasedOnMetricOption(
              Item[pBobbyRayPurchase[i].usItemIndex].ubWeight,
            ) /
              10.0) *
        ...
        DrawTextToScreen(
          sTemp,
          usGridX + BOBBYR_GRID_SECOND_COLUMN_X - 2,
          usPosY,
          BOBBYR_GRID_SECOND_COLUMN_WIDTH,
          BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
          BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
        ...
        if (pBobbyRayPurchase[i].fUsed) {
          uiStartLoc =
            ...
            LaptopSaveInfo.BobbyRayUsedInventory[
              pBobbyRayPurchase[i].usBobbyItemIndex
            ].usItemIndex;
        } else {
          uiStartLoc =
            BOBBYR_ITEM_DESC_FILE_SIZE *
        ...
        if (pBobbyRayPurchase[i].fUsed) {
          sBack = LoadEncryptedDataFromFile(
            BOBBYRDESCFILE,
            uiStartLoc,
            BOBBYR_ITEM_DESC_NAME_SIZE,
          );
        ...
        if (
          StringPixLength(sText, BOBBYR_ORDER_DYNAMIC_TEXT_FONT()) >
          ...
          for (
            j = 0;
            i < usStringLength &&
            usPixLength < BOBBYR_GRID_THIRD_COLUMN_WIDTH - 16;
            j++
          ) {
            sBack += sText[j];
            OneChar = sBack[j];
            usPixLength += StringPixLength(
              OneChar,
              BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
            );
          }
        ...
        DrawTextToScreen(
          sText,
          usGridX + BOBBYR_GRID_THIRD_COLUMN_X + 2,
          usPosY,
          BOBBYR_GRID_THIRD_COLUMN_WIDTH,
          BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
          BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
        ...
        sTemp = swprintf(
          "%d",
          CalcBobbyRayCost(
            pBobbyRayPurchase[i].usItemIndex,
            pBobbyRayPurchase[i].usBobbyItemIndex,
        ...
        DrawTextToScreen(
          sTemp,
          usGridX + BOBBYR_GRID_FOURTH_COLUMN_X - 2,
          usPosY,
          BOBBYR_GRID_FOURTH_COLUMN_WIDTH,
          BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
          BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
        ...
        DrawTextToScreen(
          sTemp,
          usGridX + BOBBYR_GRID_FIFTH_COLUMN_X - 2,
          usPosY,
          BOBBYR_GRID_FIFTH_COLUMN_WIDTH,
          BOBBYR_ORDER_DYNAMIC_TEXT_FONT(),
          BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
  ...
  function DisplayShippingCosts(
    ...
    if (fCalledFromOrderPage) {
      ...
      switch (gpNewBobbyrShipments[iOrderNum].ubDeliveryMethod) {
        case 0:
          usStandardCost =
            BobbyROrderLocations[gpNewBobbyrShipments[iOrderNum].ubDeliveryLoc]
              .usOverNightExpress;
          break;
        case 1:
          usStandardCost =
      ...
      iShippingCost = Math.trunc(
        (gpNewBobbyrShipments[iOrderNum].uiPackageWeight / 10) *
          usStandardCost +
          0.5,
      );
    }
  ...
  function SelectShippingSpeedRegionCallBack(
  ...
  function DrawShippingSpeedLights(ubSelected: UINT8): boolean {
    if (ubSelected == 0)
      ColorFillVideoSurfaceArea(
        FRAME_BUFFER,
        gShippingSpeedAreas[0],
        gShippingSpeedAreas[1],
    ...
    if (ubSelected == 1)
      ColorFillVideoSurfaceArea(
        FRAME_BUFFER,
        gShippingSpeedAreas[2],
        gShippingSpeedAreas[3],
    ...
    if (ubSelected == 2)
      ColorFillVideoSurfaceArea(
        FRAME_BUFFER,
        gShippingSpeedAreas[4],
        gShippingSpeedAreas[5],
  ...
  function SelectConfirmOrderRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  /* static */ let CreateDestroyBobbyRDropDown__fMouseRegionsCreated: boolean =
    false;
      ...
      case Enum69.BR_DROP_DOWN_CREATE:
        {
          ...
          for (i = 0; i < BOBBYR_NUM_DISPLAYED_CITIES; i++) {
            MSYS_DefineRegion(
              gSelectedDropDownRegion[i],
              usPosX,
              usPosY + 4,
              usPosX + BOBBYR_DROP_DOWN_WIDTH - 6,
              usPosY + usFontHeight + 7,
              MSYS_PRIORITY_HIGH,
              Enum317.CURSOR_WWW,
              SelectDropDownMovementCallBack,
          ...
          for (i = 0; i < 2; i++) {
            MSYS_DefineRegion(
              gSelectedUpDownArrowOnScrollAreaRegion[i],
              usPosX,
              usPosY,
              usPosX + BOBBYR_SCROLL_ARROW_WIDTH,
              usPosY + BOBBYR_SCROLL_ARROW_HEIGHT,
              MSYS_PRIORITY_HIGH,
              Enum317.CURSOR_WWW,
              MSYS_NO_CALLBACK,
          ...
          usHeight = Math.trunc(
            BOBBYR_SCROLL_AREA_HEIGHT_MINUS_ARROWS /
              BOBBYR_ORDER_NUM_SHIPPING_CITIES,
          );
          for (i = 0; i < BOBBYR_ORDER_NUM_SHIPPING_CITIES - 1; i++) {
            MSYS_DefineRegion(
              gSelectedScrollAreaDropDownRegion[i],
              usPosX,
              usPosY,
              usPosX + BOBBYR_SCROLL_ARROW_WIDTH,
              usPosY + usHeight,
      ...
      case Enum69.BR_DROP_DOWN_DESTROY:
        {
          ...
          if (!CreateDestroyBobbyRDropDown__fMouseRegionsCreated) break;
          ...
          if (gbSelectedCity == -1)
            DrawTextToScreen(
              BobbyROrderFormText[Enum349.BOBBYR_SELECT_DEST],
              BOBBYR_CITY_START_LOCATION_X + BOBBYR_CITY_NAME_OFFSET,
              BOBBYR_SHIPPING_LOC_AREA_T_Y + 3,
              0,
              BOBBYR_DROPDOWN_FONT(),
              BOBBYR_ORDER_DROP_DOWN_SELEC_COLOR,
              FONT_MCOLOR_BLACK,
              false,
              LEFT_JUSTIFIED,
            );
      ...
      case Enum69.BR_DROP_DOWN_DISPLAY:
        {
          ...
          for (i = 10; i < BOBBYR_DROP_DOWN_WIDTH - 10; i += 10) {
            ...
            BltVideoObject(
              ...
              hImageHandle,
              1,
              i + BOBBYR_CITY_START_LOCATION_X,
              usPosY + BOBBYR_CITY_START_LOCATION_Y,
              VO_BLT_SRCTRANSPARENCY,
              null,
            );
            ...
            BltVideoObject(
              ...
              6,
              i + BOBBYR_CITY_START_LOCATION_X,
              CreateDestroyBobbyRDropDown__usHeight -
                10 +
                6 +
                BOBBYR_CITY_START_LOCATION_Y,
              VO_BLT_SRCTRANSPARENCY,
          ...
          for (
            i = 10;
            i < CreateDestroyBobbyRDropDown__usHeight - 10;
            i += 10
          ) {
            BltVideoObject(
              FRAME_BUFFER,
          ...
          BltVideoObject(
            ...
            hImageHandle,
            0,
            0 + BOBBYR_CITY_START_LOCATION_X,
            usPosY + BOBBYR_CITY_START_LOCATION_Y,
            VO_BLT_SRCTRANSPARENCY,
            null,
          );
  ...
  function SelectDropDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectActivateCityDroDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectDropDownMovementCallBack(
    pRegion: MOUSE_REGION,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
  ...
  function DrawSelectedCity(ubCityNumber: UINT8): void {
    ...
    if (
      gubCityAtTopOfList + BOBBYR_NUM_DISPLAYED_CITIES >
      BOBBYR_ORDER_NUM_SHIPPING_CITIES
    )
      gubCityAtTopOfList =
        BOBBYR_ORDER_NUM_SHIPPING_CITIES - BOBBYR_NUM_DISPLAYED_CITIES - 1;

    // Display the list of cities
    usPosY = BOBBYR_CITY_START_LOCATION_Y + 5;
    for (
      i = gubCityAtTopOfList;
      i < gubCityAtTopOfList + BOBBYR_NUM_DISPLAYED_CITIES;
      i++
    ) {
      DrawTextToScreen(
        BobbyROrderLocations[i].psCityLoc,
        BOBBYR_CITY_START_LOCATION_X + BOBBYR_CITY_NAME_OFFSET,
        usPosY,
        0,
        BOBBYR_DROPDOWN_FONT(),
    ...
    if (ubCityNumber != 255)
      usPosY =
        (usFontHeight + 2) * (ubCityNumber - gubCityAtTopOfList) +
        BOBBYR_CITY_START_LOCATION_Y;
    else
      usPosY =
        (usFontHeight + 2) * gubCityAtTopOfList + BOBBYR_CITY_START_LOCATION_Y;

    // display the name in the list
    ColorFillVideoSurfaceArea(
      FRAME_BUFFER,
      BOBBYR_CITY_START_LOCATION_X + 4,
      usPosY + 4,
      BOBBYR_CITY_START_LOCATION_X + BOBBYR_DROP_DOWN_WIDTH - 4,
      usPosY + usFontHeight + 6,
    ...
    if (ubCityNumber == 255)
      DrawTextToScreen(
        BobbyROrderLocations[0].psCityLoc,
        BOBBYR_CITY_START_LOCATION_X + BOBBYR_CITY_NAME_OFFSET,
        usPosY + 5,
        0,
        BOBBYR_DROPDOWN_FONT(),
      ...
      DrawTextToScreen(
        BobbyROrderLocations[ubCityNumber].psCityLoc,
        BOBBYR_CITY_START_LOCATION_X + BOBBYR_CITY_NAME_OFFSET,
        usPosY + 5,
        0,
        BOBBYR_DROPDOWN_FONT(),
  ...
  function DisplayShippingLocationCity(): void {
    ...
    if (gubDropDownAction == Enum69.BR_DROP_DOWN_DISPLAY) return;
    ...
    if (gbSelectedCity != -1) {
      sTemp = swprintf(
        "%d",
        Math.trunc(
          BobbyROrderLocations[gbSelectedCity].usOverNightExpress /
    ...
    DrawTextToScreen(
      sTemp,
      BOBBYR_SHIPPING_SPEED_NUMBER_X,
      usPosY,
      BOBBYR_SHIPPING_SPEED_NUMBER_WIDTH,
      BOBBYR_DROPDOWN_FONT(),
      BOBBYR_ORDER_DYNAMIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    if (gbSelectedCity != -1) {
      sTemp = swprintf(
        "%d",
        Math.trunc(
          BobbyROrderLocations[gbSelectedCity].us2DaysService /
            GetWeightBasedOnMetricOption(1),
        ),
      );
      sTemp = InsertCommasForDollarFigure(sTemp);
    ...
    if (gbSelectedCity != -1) {
      sTemp = swprintf(
        "%d",
        Math.trunc(
          BobbyROrderLocations[gbSelectedCity].usStandardService /
            GetWeightBasedOnMetricOption(1),
        ),
      );
      sTemp = InsertCommasForDollarFigure(sTemp);
  ...
  function SelectCloseDroDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      if (BobbyRayPurchases[i].ubNumberPurchased) {
        ...
        if (BobbyRayPurchases[i].fUsed) {
          ...
          if (
            ...
            LaptopSaveInfo.BobbyRayUsedInventory[
              BobbyRayPurchases[i].usBobbyItemIndex
            ].ubQtyOnHand -= BobbyRayPurchases[i].ubNumberPurchased;
          else
            LaptopSaveInfo.BobbyRayUsedInventory[
              BobbyRayPurchases[i].usBobbyItemIndex
            ].ubQtyOnHand = 0;
  ...
  function SelectTitleLinkRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectScrollAreaDropDownRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectScrollAreaDropDownMovementCallBack(
    pRegion: MOUSE_REGION,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      ...
      if (gfLeftButtonState) {
        ...
        if (ubCityNum > gbSelectedCity) {
          gbSelectedCity = ubCityNum;
          if (
            gbSelectedCity - gubCityAtTopOfList >=
            BOBBYR_NUM_DISPLAYED_CITIES
          )
            gubCityAtTopOfList =
              gbSelectedCity - BOBBYR_NUM_DISPLAYED_CITIES + 1;
        }
  ...
  function SelectUpDownArrowOnScrollAreaRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function DrawGoldRectangle(bCityNum: INT8): void {
    ...
    usHeight = Math.trunc(
      usTempHeight / (BOBBYR_ORDER_NUM_SHIPPING_CITIES + 1),
    );

    usPosY =
      usTempPosY +
      Math.trunc(
        (BOBBYR_SCROLL_AREA_HEIGHT - 2 * BOBBYR_SCROLL_ARROW_HEIGHT) /
          (BOBBYR_ORDER_NUM_SHIPPING_CITIES + 1),
      ) *
        bCityNum;

    temp =
      BOBBYR_SCROLL_AREA_Y +
      BOBBYR_SCROLL_AREA_HEIGHT -
      BOBBYR_SCROLL_ARROW_HEIGHT -
      usHeight -
      1;
  ...
  */
    ...
    uiTotalCost = Math.trunc((uiTotalWeight / 10) * usStandardCost + 0.5);
  ...
  */
  ...
  function PurchaseBobbyOrder(): void {
    ...
    if (
      gbSelectedCity == Enum70.BR_DRASSEN ||
      gbSelectedCity == Enum70.BR_MEDUNA
    ) {
      //					BobbyRayOrderStruct *pBobbyRayPurchase;
      //					UINT32	uiResetTimeSec;
      //		UINT8	i, ubCount;
  ...
  export function AddJohnsGunShipment(): void {
    let Temp: BobbyRayPurchaseStruct[] /* [MAX_PURCHASE_AMOUNT] */ =
      createArrayFrom(MAX_PURCHASE_AMOUNT, createBobbyRayPurchaseStruct);
    //	UINT8	cnt;
    let bDaysAhead: INT8;
  ...
  */
  ...
  function CalcPackageTotalWeight(): UINT32 {
    ...
    for (i = 0; i < MAX_PURCHASE_AMOUNT; i++) {
      ...
      if (BobbyRayPurchases[i].ubNumberPurchased) {
        // add the current weight to the total
        uiTotalWeight +=
          Item[BobbyRayPurchases[i].usItemIndex].ubWeight *
          BobbyRayPurchases[i].ubNumberPurchased;
      }
    }
  ...
  function DisplayPackageWeight(): void {
    ...
    DrawTextToScreen(
      BobbyROrderFormText[Enum349.BOBBYR_PACKAGE_WEIGHT],
      BOBBYR_PACKAXGE_WEIGHT_X + 8,
      BOBBYR_PACKAXGE_WEIGHT_Y + 4,
      BOBBYR_PACKAXGE_WEIGHT_WIDTH,
      BOBBYR_ORDER_STATIC_TEXT_FONT(),
      BOBBYR_ORDER_STATIC_TEXT_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    zTemp = swprintf(
      "%s %s",
      (GetWeightBasedOnMetricOption(uiTotalWeight) / 10.0)
        .toFixed(1)
        .padStart(3),
      GetWeightUnitString(),
    );
  ...
  function BtnBobbyRGotoShipmentPageCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  export function CreateBobbyRayOrderTitle(): boolean {
    ...
    MSYS_DefineRegion(
      gSelectedTitleLinkRegion,
      BOBBYR_BOBBY_RAY_TITLE_X,
      BOBBYR_BOBBY_RAY_TITLE_Y,
      BOBBYR_BOBBY_RAY_TITLE_X + BOBBYR_BOBBY_RAY_TITLE_WIDTH,
      BOBBYR_BOBBY_RAY_TITLE_Y + BOBBYR_BOBBY_RAY_TITLE_HEIGHT,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_WWW,
      MSYS_NO_CALLBACK,
  ...
  function AddNewBobbyRShipment(
    pPurchaseStruct: BobbyRayPurchaseStruct[],
    ubDeliveryLoc: UINT8,
    ubDeliveryMethod: UINT8,
    fPruchasedFromBobbyR: boolean,
    ...
    if (iFoundSpot == -1) {
      ...
      gpNewBobbyrShipments = gpNewBobbyrShipments.concat(
        createArrayFrom(1, createNewBobbyRayOrderStruct),
      );
    ...
    else gpNewBobbyrShipments[iFoundSpot].fDisplayedInShipmentPage = false;
    ...
    for (i = 0; i < MAX_PURCHASE_AMOUNT; i++) {
      ...
      if (pPurchaseStruct[i].ubNumberPurchased) {
        ...
        copyBobbyRayPurchaseStruct(
          gpNewBobbyrShipments[iFoundSpot].BobbyRayPurchase[ubItemCount],
          pPurchaseStruct[i],
        );
    ...
    else bDaysAhead = ubDeliveryMethod;

    // AddStrategicEvent( EVENT_BOBBYRAY_PURCHASE, uiResetTimeSec, cnt);
    AddFutureDayStrategicEvent(
      Enum132.EVENT_BOBBYRAY_PURCHASE,
      (8 + Random(4)) * 60,
      iFoundSpot,
      bDaysAhead,
    );
  ...
  export function NewWayOfSavingBobbyRMailOrdersToSaveGameFile(
    hFile: HWFILE,
  ): boolean {
    let iCnt: INT32;
    ...
    for (iCnt = 0; iCnt < giNumberOfNewBobbyRShipment; iCnt++) {
      ...
      uiNumBytesWritten = FileWrite(
        hFile,
        buffer,
        NEW_BOBBY_RAY_ORDER_STRUCT_SIZE,
      );
  ...
  export function NewWayOfLoadingBobbyRMailOrdersToSaveGameFile(
    hFile: HWFILE,
  ): boolean {
    let iCnt: INT32;
    ...
    if (giNumberOfNewBobbyRShipment == 0) {
      ...
      gpNewBobbyrShipments = createArrayFrom(
        giNumberOfNewBobbyRShipment,
        createNewBobbyRayOrderStruct,
      );
