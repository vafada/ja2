namespace ja2 {
  ...
  let AttitudeList: INT32[] /* [ATTITUDE_LIST_SIZE] */ = createArray(
    ATTITUDE_LIST_SIZE,
    0,
  );
  let iLastElementInAttitudeList: INT32 = 0;

  let SkillsList: INT32[] /* [ATTITUDE_LIST_SIZE] */ = createArray(
    ATTITUDE_LIST_SIZE,
    0,
  );
  let BackupSkillsList: INT32[] /* [ATTITUDE_LIST_SIZE] */ = createArray(
    ATTITUDE_LIST_SIZE,
    0,
  );
  let iLastElementInSkillsList: INT32 = 0;

  let PersonalityList: INT32[] /* [ATTITUDE_LIST_SIZE] */ = createArray(
    ATTITUDE_LIST_SIZE,
    0,
  );
  ...
  export function CreateACharacterFromPlayerEnteredStats(): void {
    ...
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bDexterity = iDexterity;
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bWisdom = iWisdom;
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bLeadership = iLeadership;

    // skills
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bMarksmanship = iMarksmanship;
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bMedical = iMedical;
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bMechanical = iMechanical;
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bExplosive = iExplosives;

    // personality
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].bPersonalityTrait = iPersonality;
...
if( iPersonality != NO_PERSONALITYTRAIT )
  ...
  */
  ...
  function CreatePlayerSkills(): void {
    ...
    while (
      iSkillA == iSkillB &&
      (iSkillB == Enum269.ELECTRONICS || iSkillB == Enum269.AMBIDEXT)
    ) {
...
iSkillB = NO_SKILLTRAIT;
  ...
  */
  ...
  function SelectMercFace(): void {
    ...
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].ubFaceIndex = 200 + iPortraitNumber;

    // eyes
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].usEyesX = sFacePositions[iPortraitNumber][0];
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].usEyesY = sFacePositions[iPortraitNumber][1];

    // mouth
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].usMouthX = sFacePositions[iPortraitNumber][2];
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].usMouthY = sFacePositions[iPortraitNumber][3];
  ...
  function SetMercSkinAndHairColors(): void {
    ...
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].HAIR = sHairStrings[sHairColor];
    gMercProfiles[
      PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
    ].SKIN = sSkinStrings[sSkinColor];
  }
  ...
  export function HandleMercStatsForChangesInFace(): void {
    ...
    if (fCharacterIsMale) {
      ...
      if (ShouldThisMercHaveABigBody()) {
        ...
        gMercProfiles[
          PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
        ].ubBodyType = Enum194.REGMALE;
      }
    } else {
      // female
      gMercProfiles[
        PLAYER_GENERATED_CHARACTER_ID + LaptopSaveInfo.iVoiceId
      ].ubBodyType = Enum194.REGFEMALE;
