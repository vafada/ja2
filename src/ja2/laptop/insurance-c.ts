namespace ja2 {
  ...
  const INSURANCE_BOTTOM_LINK_RED_BAR_X_2 =
    INSURANCE_BOTTOM_LINK_RED_BAR_X + INSURANCE_BOTTOM_LINK_RED_BAR_OFFSET;
  const INSURANCE_BOTTOM_LINK_RED_BAR_X_3 =
  ...
  const INSURANCE_LINK_TEXT_2_X =
    INSURANCE_LINK_TEXT_1_X + INSURANCE_BOTTOM_LINK_RED_BAR_OFFSET;
  const INSURANCE_LINK_TEXT_2_Y = INSURANCE_LINK_TEXT_1_Y;

  const INSURANCE_LINK_TEXT_3_X =
    INSURANCE_LINK_TEXT_2_X + INSURANCE_BOTTOM_LINK_RED_BAR_OFFSET;
  ...
  let gSelectedInsuranceLinkRegion: MOUSE_REGION[] /* [3] */ = createArrayFrom(
    3,
    createMouseRegion,
  );
  ...
  export function EnterInsurance(): boolean {
    ...
    for (i = 0; i < 3; i++) {
      MSYS_DefineRegion(
        ...
        usPosX + INSURANCE_BOTTOM_LINK_RED_BAR_WIDTH,
        INSURANCE_BOTTOM_LINK_RED_BAR_Y + 2,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
  ...
  export function RenderInsurance(): void {
    ...
    DrawTextToScreen(
      sText,
      INSURANCE_SUBTITLE_X + INSURANCE_BULLET_TEXT_OFFSET_X,
      INSURANCE_BULLET_TEXT_1_Y,
      0,
      INS_FONT_MED(),
      INS_FONT_COLOR,
    ...
    DrawTextToScreen(
      sText,
      INSURANCE_BOTTOM_SLOGAN_X,
      INSURANCE_BOTTOM_SLOGAN_Y,
    ...
    DisplaySmallRedLineWithShadow(
      INSURANCE_BOTTOM_LINK_RED_BAR_X,
    ...
    DisplayWrappedString(
      INSURANCE_LINK_TEXT_2_X,
      INSURANCE_LINK_TEXT_2_Y + 7,
      INSURANCE_LINK_TEXT_WIDTH,
      2,
      INS_FONT_MED(),
      INS_FONT_COLOR,
    ...
    // Display the red bar under the link at the bottom
    DisplaySmallRedLineWithShadow(
      INSURANCE_BOTTOM_LINK_RED_BAR_X_3,
      INSURANCE_BOTTOM_LINK_RED_BAR_Y,
    ...
    DisplayWrappedString(
      INSURANCE_LINK_TEXT_3_X,
      INSURANCE_LINK_TEXT_3_Y + 7,
      INSURANCE_LINK_TEXT_WIDTH,
      2,
      INS_FONT_MED(),
      INS_FONT_COLOR,
  ...
  export function InitInsuranceDefaults(): boolean {
    ...
    if (guiCurrentLaptopMode != Enum95.LAPTOP_MODE_INSURANCE) {
      ...
      MSYS_DefineRegion(
        ...
        INSURANCE_SMALL_TITLE_X + 85,
        INSURANCE_SMALL_TITLE_Y,
        INSURANCE_SMALL_TITLE_X + INSURANCE_SMALL_TITLE_WIDTH,
        INSURANCE_SMALL_TITLE_Y + INSURANCE_SMALL_TITLE_HEIGHT,
        MSYS_PRIORITY_HIGH,
        Enum317.CURSOR_WWW,
        MSYS_NO_CALLBACK,
  ...
  export function DisplayInsuranceDefaults(): void {
    ...
    WebPageTileBackground(
      4,
      4,
      INSURANCE_BACKGROUND_WIDTH,
      INSURANCE_BACKGROUND_HEIGHT,
  ...
  export function DisplaySmallRedLineWithShadow(
    usStartX: UINT16,
    usStartY: UINT16,
    EndX: UINT16,
    EndY: UINT16,
  ...
  export function GetInsuranceText(ubNumber: UINT8): string {
    ...
    if (ubNumber < Enum90.INS_MULTI_LINE_BEGINS) {
      ...
      uiStartLoc =
        ...
        (ubNumber - Enum90.INS_MULTI_LINE_BEGINS - 1);
      pString = LoadEncryptedDataFromFile(
        INSURANCE_TEXT_MULTI_FILE,
        uiStartLoc,
        INSURANCE_TEXT_MULTI_LINE_SIZE,
      );
    }
  ...
  function SelectInsuranceRegionCallBack(
  ...
  function SelectInsuranceTitleLinkRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
