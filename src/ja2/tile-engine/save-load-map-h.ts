namespace ja2 {
  ...
  export function readModifyMap(
    o: MODIFY_MAP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.usGridNo = buffer.readUInt16LE(offset);
    offset += 2;
    o.usImageType = buffer.readUInt16LE(offset);
    offset += 2;
    o.usSubImageIndex = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeModifyMap(
    o: MODIFY_MAP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
