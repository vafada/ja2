namespace ja2 {
  ...
  export function DebugLevelNodePage(): void {
    ...
    for (uiLoop = 1; uiLoop < 9; uiLoop++) {
      gprintf(
        0,
        LINE_HEIGHT * (uiLoop + 1),
        gzLevelString[uiLoop],
        guiLNCount[uiLoop],
      );
    }
    gprintf(
      0,
      LINE_HEIGHT * 12,
      "%d land nodes in excess of world max (25600)",
      guiLNCount[1] - WORLD_MAX,
    );
    gprintf(
      0,
      LINE_HEIGHT * 13,
      "Total # levelnodes %d, %d bytes each",
      guiLNCount[0],
      LEVEL_NODE_SIZE,
    );
    gprintf(
      0,
      LINE_HEIGHT * 14,
      "Total memory for levelnodes %d",
      guiLNCount[0] * LEVEL_NODE_SIZE,
    );
  }

  function TypeExistsInLevel(
    pStartNode: LEVELNODE | null,
    fType: UINT32,
  ): UINT16 {
    ...
    while (pStartNode != null) {
      if (
        pStartNode.usIndex != NO_TILE &&
        pStartNode.usIndex < Enum312.NUMBEROFTILES
      ) {
  ...
  function AdjustLevelShadeLevel(
    pStartNode: LEVELNODE | null,
    bShadeDiff: INT8,
  ): void {
    // Look through all objects and Search for type
  ...
  function SetIndexLevelNodeFlags(
    pStartNode: LEVELNODE | null,
    uiFlags: UINT32,
    usIndex: UINT16,
  ): void {
  ...
  function RemoveIndexLevelNodeFlags(
    pStartNode: LEVELNODE | null,
    uiFlags: UINT32,
    usIndex: UINT16,
  ): void {
  ...
  export function AddObjectToTail(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): LEVELNODE {
  ...
  export function TypeRangeExistsInObjectLayer(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): UINT16 {
    ...
    while (pObject != null) {
      ...
      if (
        pOldObject.usIndex != NO_TILE &&
        pOldObject.usIndex < Enum312.NUMBEROFTILES
      ) {
  ...
  export function TypeExistsInObjectLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pObject: LEVELNODE | null = null;
  ...
  function SetAllObjectShadeLevels(
    iMapIndex: UINT32,
    ubShadeLevel: UINT8,
  ): void {
    let pObject: LEVELNODE | null = null;
  ...
  function AdjustAllObjectShadeLevels(
    iMapIndex: UINT32,
    bShadeDiff: INT8,
  ): void {
    let pObject: LEVELNODE | null = null;
  ...
  export function RemoveAllObjectsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function ReplaceLandIndex(
    iMapIndex: UINT32,
    usOldIndex: UINT16,
    usNewIndex: UINT16,
  ): boolean {
  ...
  export function TypeExistsInLandLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pLand: LEVELNODE | null = null;
  ...
  export function TypeRangeExistsInLandLayer(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): UINT16 {
  ...
  function TypeRangeExistsInLandHead(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): UINT16 {
  ...
  function TypeRangeExistsInStructLayer(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): UINT16 {
  ...
  export function RemoveAllLandsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function InsertLandIndexAtLevel(
    iMapIndex: UINT32,
    usIndex: UINT16,
    ubLevel: UINT8,
  ): boolean {
  ...
  export function RemoveHigherLandLevels(
    iMapIndex: UINT32,
    fSrcType: UINT32,
    puiHigherTypes: Pointer<UINT32[]>,
    pubNumHigherTypes: Pointer<UINT8>,
  ): boolean {
    let pLand: LEVELNODE | null = null;
  ...
  export function AddStructToTail(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): LEVELNODE | null {
  ...
  export function ForceStructToTail(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): LEVELNODE | null {
  ...
  export function AddStructToTailCommon(
    iMapIndex: UINT32,
    usIndex: UINT16,
    fAddStructDBInfo: boolean,
  ): LEVELNODE | null {
    let pStruct: LEVELNODE | null = null;
          ...
          if (gTileDatabase[usIndex].pDBStructureRef != null) {
            if (
              AddStructureToWorld(
                iMapIndex,
                0,
                gTileDatabase[usIndex].pDBStructureRef,
                pNextStruct,
              ) == false
            ) {
              guiLevelNodes--;
    ...
    if (usIndex < Enum312.NUMBEROFTILES) {
      if (
        ...
        (<LEVELNODE>gpWorldLevelData[iMapIndex].pShadowHead).uiFlags |=
          LEVELNODE_BUDDYSHADOW;
      }

      // Check for special flag to stop burn-through on same-tile structs...
      if (gTileDatabase[usIndex].pDBStructureRef != null) {
        pDBStructure = (<DB_STRUCTURE_REF>(
          gTileDatabase[usIndex].pDBStructureRef
        )).pDBStructure;

        // Default to off....
        gpWorldLevelData[iMapIndex].ubExtFlags[0] &=
          ~MAPELEMENT_EXT_NOBURN_STRUCT;

        // If we are NOT a wall and NOT multi-tiles, set mapelement flag...
        if (
          !FindStructure(iMapIndex, STRUCTURE_WALLSTUFF) &&
  ...
  function RemoveStructFromTailCommon(
    iMapIndex: UINT32,
    fRemoveStructDBInfo: boolean,
  ): boolean {
    let pStruct: LEVELNODE | null = null;
    ...
    while (pStruct != null) {
      ...
      if (pStruct.pNext == null) {
        ...
        } else gpWorldLevelData[iMapIndex].pStructHead = pPrevStruct;
  ...
  export function RemoveStructFromLevelNode(
    iMapIndex: UINT32,
    pNode: LEVELNODE,
  ): boolean {
    let pStruct: LEVELNODE | null = null;
  ...
  export function RemoveAllStructsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function ReplaceStructIndex(
    iMapIndex: UINT32,
    usOldIndex: UINT16,
    usNewIndex: UINT16,
  ): boolean {
  ...
  export function AddWallToStructLayer(
    iMapIndex: INT32,
    usIndex: UINT16,
    fReplace: boolean,
  ): boolean {
      ...
      if (usCheckWallOrient > usWallOrientation) {
        if (
          ((usWallOrientation == Enum314.INSIDE_TOP_RIGHT ||
            ...
            (usCheckWallOrient == Enum314.INSIDE_TOP_LEFT ||
              usCheckWallOrient == Enum314.OUTSIDE_TOP_LEFT)) ||
          ((usWallOrientation == Enum314.INSIDE_TOP_LEFT ||
            usWallOrientation == Enum314.OUTSIDE_TOP_LEFT) &&
            (usCheckWallOrient == Enum314.INSIDE_TOP_RIGHT ||
              usCheckWallOrient == Enum314.OUTSIDE_TOP_RIGHT))
        ) {
          fInsertFound = true;
        }
      }
  ...
  export function TypeExistsInStructLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pStruct: LEVELNODE | null = null;
  ...
  function SetAllStructShadeLevels(
    iMapIndex: UINT32,
    ubShadeLevel: UINT8,
  ): void {
    let pStruct: LEVELNODE | null = null;
  ...
  function AdjustAllStructShadeLevels(
    iMapIndex: UINT32,
    bShadeDiff: INT8,
  ): void {
    let pStruct: LEVELNODE | null = null;
  ...
  function SetStructIndexFlagsFromTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
    uiFlags: UINT32,
  ...
  export function HideStructOfGivenType(
    iMapIndex: UINT32,
    fType: UINT32,
    fHide: boolean,
  ): boolean {
  ...
  function RemoveStructIndexFlagsFromTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
    uiFlags: UINT32,
  ...
  export function RemoveShadowFromLevelNode(
    iMapIndex: UINT32,
    pNode: LEVELNODE,
  ): boolean {
    let pShadow: LEVELNODE | null = null;
  ...
  function RemoveStructShadowPartner(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): boolean {
    let pShadow: LEVELNODE | null = null;
  ...
  export function RemoveAllShadowsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function TypeExistsInShadowLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pShadow: LEVELNODE | null = null;
  ...
  export function AddMercToHead(
    iMapIndex: UINT32,
    pSoldier: SOLDIERTYPE,
    fAddStructInfo: boolean,
  ): boolean {
  ...
  export function AddMercStructureInfoFromAnimSurface(
    sGridNo: INT16,
    pSoldier: SOLDIERTYPE,
    ...
    if (pStructureFileRef != null) {
      if (pSoldier.ubBodyType == Enum194.QUEENMONSTER) {
        ...
        fReturn = AddStructureToWorld(
          sGridNo,
          pSoldier.bLevel,
          pStructureFileRef.pDBStructureRef[0],
          pSoldier.pLevelNode,
        );
      } else {
        fReturn = AddStructureToWorld(
      ...
      if (fReturn == false) {
        ...
        ScreenMsg(
          MSG_FONT_RED,
          MSG_DEBUG,
          "FAILED: add struct info for merc %d (%s), at %d direction %d",
          pSoldier.ubID,
          pSoldier.name,
          sGridNo,
          pSoldier.bDirection,
        ...
        if (
          (<STRUCTURE>(<unknown>pSoldier.pLevelNode.pStructureData))
            .pDBStructureRef.pDBStructure.ubNumberOfTiles > 1
        ) {
          // If we have more than one tile
          pSoldier.uiStatusFlags |= SOLDIER_MULTITILE_Z;
        } else {
  ...
  export function OKToAddMercToWorld(
    pSoldier: SOLDIERTYPE,
    bDirection: INT8,
  ): boolean {
    let usAnimSurface: UINT16;
    ...
    // if ( pSoldier->uiStatusFlags & SOLDIER_MULTITILE )
    {
      ...
      pStructFileRef = GetAnimationStructureRef(
        pSoldier.ubID,
        usAnimSurface,
        pSoldier.usAnimState,
      );
  ...
  export function TypeExistsInRoofLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pRoof: LEVELNODE | null = null;
  ...
  export function TypeRangeExistsInRoofLayer(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): UINT16 {
  ...
  export function IndexExistsInRoofLayer(
    sGridNo: INT16,
    usIndex: UINT16,
  ): boolean {
    let pRoof: LEVELNODE | null = null;
  ...
  export function RemoveAllRoofsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function RemoveRoofIndexFlagsFromTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
    uiFlags: UINT32,
  ...
  export function SetRoofIndexFlagsFromTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
    uiFlags: UINT32,
  ...
  export function AddOnRoofToTail(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): LEVELNODE | null {
  ...
  export function RemoveOnRoofFromLevelNode(
    iMapIndex: UINT32,
    pNode: LEVELNODE,
  ): boolean {
    let pOnRoof: LEVELNODE | null = null;
  ...
  function SetAllOnRoofShadeLevels(
    iMapIndex: UINT32,
    ubShadeLevel: UINT8,
  ): void {
    let pOnRoof: LEVELNODE | null = null;
  ...
  function AdjustAllOnRoofShadeLevels(
    iMapIndex: UINT32,
    bShadeDiff: INT8,
  ): void {
    let pOnRoof: LEVELNODE | null = null;
  ...
  export function RemoveAllOnRoofsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
  ...
  export function AddTopmostToTail(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): LEVELNODE {
  ...
  export function AddTopmostToHead(
    iMapIndex: UINT32,
    usIndex: UINT16,
  ): boolean {
  ...
  export function RemoveTopmostFromLevelNode(
    iMapIndex: UINT32,
    pNode: LEVELNODE,
  ): boolean {
    let pTopmost: LEVELNODE | null = null;
  ...
  export function RemoveAllTopmostsOfTypeRange(
    iMapIndex: UINT32,
    fStartType: UINT32,
    fEndType: UINT32,
  ): boolean {
    ...
    while (pTopmost != null) {
      ...
      if (
        pOldTopmost.usIndex != NO_TILE &&
        pOldTopmost.usIndex < Enum312.NUMBEROFTILES
      ) {
  ...
  export function TypeExistsInTopmostLayer(
    iMapIndex: UINT32,
    fType: UINT32,
  ): UINT16 {
    let pTopmost: LEVELNODE | null = null;
  ...
  function SetMapElementShadeLevel(
    uiMapIndex: UINT32,
    ubShadeLevel: UINT8,
  ): boolean {
  ...
  */
  ...
  export function SetStructAframeFlags(
    iMapIndex: UINT32,
    uiFlags: UINT32,
  ): void {
    let pStruct: LEVELNODE | null = null;
  ...
  export function FindLevelNodeBasedOnStructure(
    sGridNo: INT16,
  ...
  export function FindShadow(
    ...
    if (
      usStructIndex < Enum312.FIRSTOSTRUCT1 ||
      usStructIndex >= Enum312.FIRSTSHADOW1
    ) {
      return null;
    }

    usShadowIndex =
      usStructIndex - Enum312.FIRSTOSTRUCT1 + Enum312.FIRSTSHADOW1;
  ...
  function RemoveWorldFlagsFromNewNode(
    sGridNo: UINT16,
    usIndex: UINT16,
  ): void {}

  export function SetWallLevelnodeFlags(
    sGridNo: UINT16,
    uiFlags: UINT32,
  ): void {
    let pStruct: LEVELNODE | null = null;
  ...
  export function RemoveWallLevelnodeFlags(
    sGridNo: UINT16,
    uiFlags: UINT32,
  ): void {
    let pStruct: LEVELNODE | null = null;
