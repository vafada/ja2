namespace ja2 {
  ...
  export function copyExplosionParams(
    destination: EXPLOSION_PARAMS,
    source: EXPLOSION_PARAMS,
  ) {
  ...
  export function readExplosionParams(
    o: EXPLOSION_PARAMS,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset += 2;
    o.sZ = buffer.readInt16LE(offset);
    offset += 2;
  ...
  export function writeExplosionParams(
    o: EXPLOSION_PARAMS,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function readExplosionType(
    o: EXPLOSIONTYPE,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset++; // padding
    o.sCurrentFrame = buffer.readInt16LE(offset);
    offset += 2;
    o.iID = buffer.readInt32LE(offset);
    offset += 4;
    o.iLightID = buffer.readInt32LE(offset);
    offset += 4;
    offset = readUIntArray(o.ubUnsed, buffer, offset, 1);
    offset += 2; // padding
    return offset;
  ...
  export function writeExplosionType(
    o: EXPLOSIONTYPE,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function readExplosionQueueElement(
    o: ExplosionQueueElement,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.uiWorldBombIndex = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiTimeStamp = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export function writeExplosionQueueElement(
    o: ExplosionQueueElement,
    buffer: Buffer,
    offset: number = 0,
  ): number {
