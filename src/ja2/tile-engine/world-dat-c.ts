namespace ja2 {
  ...
  export let gTilesets: TILESET[] /* [NUM_TILESETS] */ = createArrayFrom(
    Enum316.NUM_TILESETS,
    createTileset,
  );
  ...
  export function InitEngineTilesets(): void {
    ...
    gTilesets[Enum316.DEAD_AIRSTRIP].MovementCostFnc =
      SetTilesetThreeTerrainValues;
  ...
  export function SetTilesetOneTerrainValues(): void {
    ...
    gTileSurfaceArray[Enum313.DEEPWATERTEXTURE].ubTerrainID =
      Enum315.DEEP_WATER;
