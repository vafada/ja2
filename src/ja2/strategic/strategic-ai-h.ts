namespace ja2 {
  ...
  export function createArmyCompositionFrom(
    iReadability: INT32,
    bPriority: INT8,
    bElitePercentage: INT8,
    bTroopPercentage: INT8,
  ...
  export function copyArmyComposition(
    destination: ARMY_COMPOSITION,
    source: ARMY_COMPOSITION,
  ) {
  ...
  export function readArmyComposition(
    o: ARMY_COMPOSITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.iReadability = buffer.readInt32LE(offset);
    offset += 4;
  ...
  export function writeArmyComposition(
    o: ARMY_COMPOSITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function createPatrolGroupFrom(
    bSize: INT8,
    bPriority: INT8,
    ubSectorID: UINT8[],
    bFillPermittedAfterDayMod100: INT8,
  ...
  export function copyPatrolGroup(
    destination: PATROL_GROUP,
    source: PATROL_GROUP,
  ) {
    destination.bSize = source.bSize;
    destination.bPriority = source.bPriority;
    copyArray(destination.ubSectorID, source.ubSectorID);
    destination.bFillPermittedAfterDayMod100 =
      source.bFillPermittedAfterDayMod100;
  ...
  export function readPatrolGroup(
    o: PATROL_GROUP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writePatrolGroup(
    o: PATROL_GROUP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function createGarrisonGroupFrom(
    ubSectorID: UINT8,
    ubComposition: UINT8,
    bWeight: INT8,
    ubPendingGroupID: UINT8,
  ...
  export function copyGarrisonGroup(
    destination: GARRISON_GROUP,
    source: GARRISON_GROUP,
  ) {
  ...
  export function readGarrisonGroup(
    o: GARRISON_GROUP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeGarrisonGroup(
    o: GARRISON_GROUP,
    buffer: Buffer,
    offset: number = 0,
  ): number {
