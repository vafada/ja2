namespace ja2 {
  ...
  function InitNPCs(): void {
    ...
    SectorInfo[SECTOR(pProfile.sSectorX, pProfile.sSectorY)].uiFlags |=
  ...
  export function InitNewGame(fReset: boolean): boolean {
    ...
    if (gubScreenCount == 0) {
      ...
      AddEmail(
        IMP_EMAIL_INTRO,
        IMP_EMAIL_INTRO_LENGTH,
        Enum75.CHAR_PROFILE_SITE,
        GetWorldTotalMin(),
      );
...

      {
        ...
        AddFutureDayStrategicEvent(
          Enum132.EVENT_DAY3_ADD_EMAIL_FROM_SPECK,
          60 * 7,
          0,
...
*/
  ...
  // TEMP FUNCTION!
  function QuickSetupOfMercProfileItems(
    uiCount: UINT32,
    ubProfileIndex: UINT8,
  ): void {
    ...
    if (uiCount == 0) {
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK5POS] =
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.BIGPOCK4POS] =
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK1POS] =
        Enum225.SILENCER;
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK2POS] =
        Enum225.SNIPERSCOPE;
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK3POS] =
        Enum225.LASERSCOPE;
      gMercProfiles[ubProfileIndex].bInvStatus[Enum261.SMALLPOCK3POS] = 100;
      gMercProfiles[ubProfileIndex].bInvNumber[Enum261.SMALLPOCK3POS] = 1;
      ...
      gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK6POS] =
        Enum225.LOCKSMITHKIT;
    ...
    gMercProfiles[ubProfileIndex].inv[Enum261.HELMETPOS] =
    ...
    gMercProfiles[ubProfileIndex].inv[Enum261.SMALLPOCK4POS] =
  ...
  function QuickGameMemberHireMerc(ubCurrentSoldier: UINT8): boolean {
    ...
    AddTransactionToPlayersBook(
      ...
      ubCurrentSoldier,
      GetWorldTotalMin(),
      -gMercProfiles[ubCurrentSoldier].uiWeeklySalary,
    );
