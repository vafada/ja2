namespace ja2 {
  ...
  // Drassen
  export const LOYALTY_BONUS_CHILDREN_FREED_DOREEN_KILLED =
    10 * GAIN_PTS_PER_LOYALTY_PT; // +50% bonus for Drassen
  export const LOYALTY_BONUS_CHILDREN_FREED_DOREEN_SPARED =
    20 * GAIN_PTS_PER_LOYALTY_PT; // +50% bonus for Drassen
  // Cambria
  export const LOYALTY_BONUS_MARTHA_WHEN_JOEY_RESCUED =
    15 * GAIN_PTS_PER_LOYALTY_PT; // -25% for low Cambria sentiment
  export const LOYALTY_BONUS_KEITH_WHEN_HILLBILLY_SOLVED =
    15 * GAIN_PTS_PER_LOYALTY_PT; // -25% for low Cambria sentiment
  // Chitzena
  export const LOYALTY_BONUS_YANNI_WHEN_CHALICE_RETURNED_LOCAL =
    20 * GAIN_PTS_PER_LOYALTY_PT; // +75% higher in Chitzena
  export const LOYALTY_BONUS_YANNI_WHEN_CHALICE_RETURNED_GLOBAL =
    10 * GAIN_PTS_PER_LOYALTY_PT; // for ALL towns!
  // Alma
  export const LOYALTY_BONUS_AUNTIE_WHEN_BLOODCATS_KILLED =
    20 * GAIN_PTS_PER_LOYALTY_PT; // Alma's increases reduced by half due to low rebel sentiment
  export const LOYALTY_BONUS_MATT_WHEN_DYNAMO_FREED =
    20 * GAIN_PTS_PER_LOYALTY_PT; // Alma's increases reduced by half due to low rebel sentiment
  ...
  // Everywhere
  export const LOYALTY_BONUS_TERRORISTS_DEALT_WITH =
    5 * GAIN_PTS_PER_LOYALTY_PT;
  ...
  // --- LOYALTY PENALTIES ---
  // Cambria
  export const LOYALTY_PENALTY_MARTHA_HEART_ATTACK =
    20 * GAIN_PTS_PER_LOYALTY_PT;
  ...
  // Any mine
  export const LOYALTY_PENALTY_HEAD_MINER_ATTACKED =
  ...
  export function readTownLoyalty(
    o: TOWN_LOYALTY,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset++; // padding
    o.sChange = buffer.readInt16LE(offset);
    offset += 2;
  ...
  export function writeTownLoyalty(
    o: TOWN_LOYALTY,
    buffer: Buffer,
    offset: number = 0,
  ): number {
