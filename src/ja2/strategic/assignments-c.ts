namespace ja2 {
  ...
  function createRepairPassSlotsTypeFrom(
    ubChoices: UINT8,
    bSlot: INT8[],
  ...
  let gRepairPassSlotList: REPAIR_PASS_SLOTS_TYPE[] /* [NUM_REPAIR_PASS_TYPES] */ =
    [
      ...
      createRepairPassSlotsTypeFrom(/* hands and armor */ 5, [
        Enum261.HANDPOS,
      ...
      createRepairPassSlotsTypeFrom(/* headgear */ 2, [
        Enum261.HEAD1POS,
        Enum261.HEAD2POS,
        -1,
        -1,
      ...
      createRepairPassSlotsTypeFrom(/* pockets */ 12, [
        Enum261.BIGPOCK1POS,
        Enum261.BIGPOCK2POS,
        Enum261.BIGPOCK3POS,
        Enum261.BIGPOCK4POS,
        Enum261.SMALLPOCK1POS,
        Enum261.SMALLPOCK2POS,
        Enum261.SMALLPOCK3POS,
        Enum261.SMALLPOCK4POS,
        Enum261.SMALLPOCK5POS,
        Enum261.SMALLPOCK6POS,
        Enum261.SMALLPOCK7POS,
  ...
  let gAssignmentMenuRegion: MOUSE_REGION[] /* [MAX_ASSIGN_STRING_COUNT] */ =
    createArrayFrom(Enum148.MAX_ASSIGN_STRING_COUNT, createMouseRegion);
  let gTrainingMenuRegion: MOUSE_REGION[] /* [MAX_TRAIN_STRING_COUNT] */ =
    createArrayFrom(Enum149.MAX_TRAIN_STRING_COUNT, createMouseRegion);
  let gAttributeMenuRegion: MOUSE_REGION[] /* [MAX_ATTRIBUTE_STRING_COUNT] */ =
    createArrayFrom(Enum146.MAX_ATTRIBUTE_STRING_COUNT, createMouseRegion);
  let gSquadMenuRegion: MOUSE_REGION[] /* [MAX_SQUAD_MENU_STRING_COUNT] */ =
    createArrayFrom(Enum151.MAX_SQUAD_MENU_STRING_COUNT, createMouseRegion);
  let gContractMenuRegion: MOUSE_REGION[] /* [MAX_CONTRACT_MENU_STRING_COUNT] */ =
    createArrayFrom(Enum152.MAX_CONTRACT_MENU_STRING_COUNT, createMouseRegion);
  let gRemoveMercAssignRegion: MOUSE_REGION[] /* [MAX_REMOVE_MERC_COUNT] */ =
    createArrayFrom(Enum150.MAX_REMOVE_MERC_COUNT, createMouseRegion);
  let gEpcMenuRegion: MOUSE_REGION[] /* [MAX_EPC_MENU_STRING_COUNT] */ =
    createArrayFrom(Enum147.MAX_EPC_MENU_STRING_COUNT, createMouseRegion);
  let gRepairMenuRegion: MOUSE_REGION[] /* [20] */ = createArrayFrom(
    20,
    createMouseRegion,
  );

  // mouse region for vehicle menu
  let gVehicleMenuRegion: MOUSE_REGION[] /* [20] */ = createArrayFrom(
    20,
    createMouseRegion,
  );
...
*/
  ...
  let fSectorsWithSoldiers: boolean[][] /* [MAP_WORLD_X * MAP_WORLD_Y][4] */ =
    createArrayFrom(MAP_WORLD_X * MAP_WORLD_Y, () => createArray(4, false));
...
*/
  ...
  export function BuildSectorsWithSoldiersList(): void {
    ...
    for (
      ...
      if (pTeamSoldier.bActive) {
        fSectorsWithSoldiers[
          pTeamSoldier.sSectorX + pTeamSoldier.sSectorY * MAP_WORLD_X
        ][pTeamSoldier.bSectorZ] = true;
      }
    }
  }

  export function ChangeSoldiersAssignment(
    ...
    if (
      bAssignment == Enum117.DOCTOR ||
      bAssignment == Enum117.PATIENT ||
      bAssignment == Enum117.ASSIGNMENT_HOSPITAL
    ) {
      AddStrategicEvent(
        Enum132.EVENT_BANDAGE_BLEEDING_MERCS,
        GetWorldTotalMin() + 1,
        0,
      );
    }
  ...
  function BasicCanCharacterAssignment(
    pSoldier: SOLDIERTYPE,
    fNotInCombat: boolean,
  ): boolean {
...
*/
  ...
  function CanCharacterDoctorButDoesntHaveMedKit(
    pSoldier: SOLDIERTYPE,
  ): boolean {
  ...
  function CanCharacterDoctor(pSoldier: SOLDIERTYPE): boolean {
    ...
    // find med kit
    for (
      bPocket = Enum261.HANDPOS;
      bPocket <= Enum261.SMALLPOCK8POS;
      bPocket++
    ) {
  ...
  function HasCharacterFinishedRepairing(pSoldier: SOLDIERTYPE): boolean {
    ...
    if (pSoldier.bVehicleUnderRepairID != -1) {
      fCanStillRepair = CanCharacterRepairVehicle(
        pSoldier,
        pSoldier.bVehicleUnderRepairID,
      );
    }
    // check if we are repairing a robot
      ...
      fCanStillRepair = DoesCharacterHaveAnyItemsToRepair(
        pSoldier,
        FINAL_REPAIR_PASS,
      );
    }
  ...
  function DoesCharacterHaveAnyItemsToRepair(
    pSoldier: SOLDIERTYPE,
    bHighestPass: INT8,
  ): boolean {
    let bPocket: INT8;
    ...
    for (
      ...
      for (
        ubObjectInPocketCounter = 0;
        ubObjectInPocketCounter < ubItemsInPocket;
        ubObjectInPocketCounter++
      ) {
        // jammed gun?
        if (
          Item[pSoldier.inv[bPocket].usItem].usItemClass == IC_GUN &&
    ...
    for (
      ...
      for (
        ...
        if (
          IsItemRepairable(pObj.usItem, pObj.bStatus[ubObjectInPocketCounter])
        ) {
          return true;
        }
      }
      ...
      for (
        ...
        if (CanCharacterRepairAnotherSoldiersStuff(pSoldier, pOtherSoldier)) {
          ...
          for (
            ...
            if (
              Item[pOtherSoldier.inv[bPocket].usItem].usItemClass == IC_GUN &&
          ...
          for (
            ubPassType = Enum116.REPAIR_HANDS_AND_ARMOR;
            ubPassType <= bHighestPass;
            ubPassType++
          ) {
            bPocket = FindRepairableItemOnOtherSoldier(
              pOtherSoldier,
              ubPassType,
            );
            if (bPocket != NO_SLOT) {
  ...
  function CanCharacterRepairButDoesntHaveARepairkit(
    pSoldier: SOLDIERTYPE,
  ): boolean {
  ...
  function BasicCanCharacterTrainMilitia(pSoldier: SOLDIERTYPE): boolean {
    ...
    if (
      ...
      fSamSitePresent = IsThisSectorASAMSector(
        pSoldier.sSectorX,
        pSoldier.sSectorY,
        pSoldier.bSectorZ,
      );
  ...
  export function CanCharacterTrainMilitia(pSoldier: SOLDIERTYPE): boolean {
    if (
      BasicCanCharacterTrainMilitia(pSoldier) &&
      ...
      CountMilitiaTrainersInSoldiersSector(pSoldier) <
  ...
  export function DoesSectorMercIsInHaveSufficientLoyaltyToTrainMilitia(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    let bTownId: INT8 = 0;
    let fSamSitePresent: boolean = false;
  ...
  function CountMilitiaTrainersInSoldiersSector(pSoldier: SOLDIERTYPE): INT8 {
    ...
    for (
      ...
      pOtherSoldier = MercPtrs[bLoop];
      if (
        pSoldier != pOtherSoldier &&
        pOtherSoldier.bActive &&
        pOtherSoldier.bLife >= OKLIFE &&
  ...
  export function IsMilitiaTrainableFromSoldiersSectorMaxed(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    let bTownId: INT8 = 0;
    let fSamSitePresent: boolean = false;
  ...
  function CanCharacterTrainStat(
    pSoldier: SOLDIERTYPE,
    bStat: INT8,
    fTrainSelf: boolean,
    fTrainTeammate: boolean,
  ): boolean {
    ...
    switch (bStat) {
      ...
      case Enum118.MARKSMANSHIP:
        // marksmanship
        if (
          pSoldier.bMarksmanship == 0 ||
          (pSoldier.bMarksmanship < MIN_RATING_TO_TEACH && fTrainTeammate)
        ) {
          return false;
        } else if (
          pSoldier.bMarksmanship >= TRAINING_RATING_CAP &&
          fTrainSelf
        ) {
          return false;
        }
  ...
  */
  ...
  function CanCharacterSleep(
    pSoldier: SOLDIERTYPE,
    fExplainWhyNot: boolean,
  ): boolean {
  ...
  function CanCharacterBeAwakened(
    pSoldier: SOLDIERTYPE,
    fExplainWhyNot: boolean,
  ): boolean {
    let sString: string /* CHAR16[128] */;
  ...
  */
  ...
  function FindNumberInSectorWithAssignment(
    sX: INT16,
    sY: INT16,
    bAssignment: INT8,
  ): UINT8 {
    ...
    for (
      ...
      if (pTeamSoldier.bActive) {
        if (
          pTeamSoldier.sSectorX == sX &&
          pTeamSoldier.sSectorY == sY &&
  ...
  function GetNumberThatCanBeDoctored(
    pDoctor: SOLDIERTYPE,
    fThisHour: boolean,
    fSkipKitCheck: boolean,
    fSkipSkillCheck: boolean,
  ): UINT8 {
    let cnt: number;
    ...
    for (
      cnt = 0, pTeamSoldier = MercPtrs[cnt];
      cnt <= gTacticalStatus.Team[pSoldier.bTeam].bLastID;
      cnt++, pTeamSoldier = MercPtrs[cnt]
    ) {
      if (pTeamSoldier.bActive) {
  ...
  export function AnyDoctorWhoCanHealThisPatient(
    pPatient: SOLDIERTYPE,
    fThisHour: boolean,
  ): SOLDIERTYPE | null {
    let cnt: number;
    let pSoldier: SOLDIERTYPE = MercPtrs[0];
  ...
  export function CalculateHealingPointsForDoctor(
    pDoctor: SOLDIERTYPE,
    pusMaxPts: Pointer<UINT16>,
    fMakeSureKitIsInHand: boolean,
  ): UINT16 {
    ...
    usHealPts = Math.trunc(
      (EffectiveMedical(pDoctor) *
        Math.trunc(
          (EffectiveDexterity(pDoctor) + EffectiveWisdom(pDoctor)) / 2,
        ) *
    ...
    pusMaxPts.value = Math.trunc(
      (pDoctor.bMedical *
        Math.trunc((pDoctor.bDexterity + pDoctor.bWisdom) / 2) *
  ...
  export function CalculateRepairPointsForRepairman(
    pSoldier: SOLDIERTYPE,
    pusMaxPts: Pointer<UINT16>,
    fMakeSureKitIsInHand: boolean,
  ): UINT8 {
  ...
  function ToolKitPoints(pSoldier: SOLDIERTYPE): UINT16 {
    ...
    // add up kit points
    for (
      ubPocket = Enum261.HANDPOS;
      ubPocket <= Enum261.SMALLPOCK8POS;
      ubPocket++
    ) {
    ...
    for (
      ...
      if (pTeamSoldier.bActive) {
        if (
          ...
          if (
            pTeamSoldier.bAssignment == Enum117.DOCTOR &&
            pTeamSoldier.fMercAsleep == false
          ) {
            MakeSureMedKitIsInHand(pTeamSoldier);
            // character is in sector, check if can doctor, if so...heal people
            if (
              CanCharacterDoctor(pTeamSoldier) &&
              EnoughTimeOnAssignment(pTeamSoldier)
            ) {
  ...
  function UpdatePatientsWhoAreDoneHealing(): void {
    ...
    for (
      ...
      if (pTeamSoldier.bActive) {
        ...
        if (
          pTeamSoldier.bAssignment == Enum117.PATIENT &&
  ...
  function HealCharacters(
    ...
    ubTotalNumberOfPatients = GetNumberThatCanBeDoctored(
      pDoctor,
      HEALABLE_THIS_HOUR,
      false,
      false,
    ...
    if (ubTotalNumberOfPatients > 0) {
      ...
      usAvailableHealingPts = CalculateHealingPointsForDoctor(
        pDoctor,
        createPointer(
          () => usMax,
          (v) => (usMax = v),
      ...
      usEvenHealingAmount = Math.trunc(
        usRemainingHealingPts / ubTotalNumberOfPatients,
      );
      ...
      for (
        ...
        if (pTeamSoldier.bActive) {
          if (
            ...
            usRemainingHealingPts -= HealPatient(
              pTeamSoldier,
              pDoctor,
              usEvenHealingAmount,
            );
    ...
    if (GetNumberThatCanBeDoctored(pDoctor, HEALABLE_EVER, false, false) == 0) {
      ...
      // try again, but skip the skill check!
        ...
        GetNumberThatCanBeDoctored(pDoctor, HEALABLE_EVER, false, true) > 0
      ) {
...
*/
  ...
  function CanSoldierBeHealedByDoctor(
    pSoldier: SOLDIERTYPE,
    pDoctor: SOLDIERTYPE,
    ...
    if (
      pSoldier.bAssignment != Enum117.PATIENT &&
      pSoldier.bAssignment != Enum117.DOCTOR &&
    ...
    if (
      fThisHour &&
      EnoughTimeOnAssignment(pSoldier) == false &&
      fIgnoreAssignment == false
    ) {
      return false;
    }
    ...
    if (
      pSoldier.sSectorX != pDoctor.sSectorX ||
      pSoldier.sSectorY != pDoctor.sSectorY ||
    ...
    if (
      !fSkipSkillCheck &&
      pDoctor.bMedical < GetMinHealingSkillNeeded(pSoldier)
    ) {
      return false;
    }
  ...
  function HealPatient(
    pPatient: SOLDIERTYPE,
    pDoctor: SOLDIERTYPE,
    usHundredthsHealed: UINT16,
  ): UINT16 {
  ...
  */
    ...
    if (pPatient.bLife < OKLIFE) {
      ...
      bPointsToUse =
        POINT_COST_PER_HEALTH_BELOW_OKLIFE * (OKLIFE - pPatient.bLife);
      ...
      for (
        ...
        if (bMedFactor > 0) {
          ...
          // The medFactor here doesn't affect how much the doctor can heal (that's already factored into lower healing pts)
          // but it does effect how fast the medkit is used up!  First aid kits disappear at double their doctoring rate!
          bPointsUsed = UseKitPoints(
            pDoctor.inv[bPocket],
            bPointsToUse * bMedFactor,
            pDoctor,
          );
          ...
          pPatient.bLife += Math.trunc(
            bPointsHealed / POINT_COST_PER_HEALTH_BELOW_OKLIFE,
          );
  ...
  function CheckForAndHandleHospitalPatients(): void {
    ...
    if (
      fSectorsWithSoldiers[
        HOSPITAL_SECTOR_X + HOSPITAL_SECTOR_Y * MAP_WORLD_X
      ][0] == false
    ) {
    ...
    for (
      ...
      if (pTeamSoldier.bActive) {
        if (pTeamSoldier.bAssignment == Enum117.ASSIGNMENT_HOSPITAL) {
          if (
            pTeamSoldier.sSectorX == HOSPITAL_SECTOR_X &&
            pTeamSoldier.sSectorY == HOSPITAL_SECTOR_Y &&
            pTeamSoldier.bSectorZ == 0
          ) {
            // heal this character
  ...
  function HealHospitalPatient(
    pPatient: SOLDIERTYPE,
    usHealingPtsLeft: UINT16,
  ): void {
  ...
  */
    ...
    if (pPatient.bLife < OKLIFE) {
      ...
      // heal person the amount / POINT_COST_PER_HEALTH_BELOW_OKLIFE
      pPatient.bLife += Math.trunc(
        bPointsToUse / POINT_COST_PER_HEALTH_BELOW_OKLIFE,
      );
    }
...
*/
  ...
  function FindRepairableItemOnOtherSoldier(
    pSoldier: SOLDIERTYPE,
    ubPassType: UINT8,
  ): INT8 {
    let bLoop: INT8;
    ...
    for (bLoop = 0; bLoop < pPassList.ubChoices; bLoop++) {
      ...
      for (
        bLoop2 = 0;
        bLoop2 < pSoldier.inv[bSlotToCheck].ubNumberOfObjects;
        bLoop2++
      ) {
      ...
      for (bLoop2 = 0; bLoop2 < MAX_ATTACHMENTS; bLoop2++) {
        if (pObj.usAttachItem[bLoop2] != NOTHING) {
          if (
            IsItemRepairable(
              pObj.usAttachItem[bLoop2],
              pObj.bAttachStatus[bLoop2],
            )
          ) {
            return bSlotToCheck;
          }
  ...
  function DoActualRepair(
    pSoldier: SOLDIERTYPE,
    usItem: UINT16,
    pbStatus: Pointer<INT8>,
    pubRepairPtsLeft: Pointer<UINT8>,
  ): void {
    ...
    if (
      Item[usItem].fFlags & ITEM_ELECTRONIC &&
    ...
    } // not enough, partial fix only, if any at all
    else {
  ...
  function RepairObject(
    ...
    for (ubLoop = 0; ubLoop < ubItemsInPocket; ubLoop++) {
      ...
      if (IsItemRepairable(pObj.usItem, pObj.bStatus[ubLoop])) {
        ...
        DoActualRepair(
          pSoldier,
          pObj.usItem,
          createElementPointer(pObj.bStatus, ubLoop),
          pubRepairPtsLeft,
        );
    ...
    for (ubLoop = 0; ubLoop < MAX_ATTACHMENTS; ubLoop++) {
      if (pObj.usAttachItem[ubLoop] != NOTHING) {
        if (
          IsItemRepairable(
            pObj.usAttachItem[ubLoop],
            pObj.bAttachStatus[ubLoop],
          )
        ) {
          // repairable, try to repair it
          ...
          DoActualRepair(
            pSoldier,
            pObj.usAttachItem[ubLoop],
            createElementPointer(pObj.bAttachStatus, ubLoop),
            pubRepairPtsLeft,
          );
  ...
  function HandleRepairBySoldier(pSoldier: SOLDIERTYPE): void {
    ...
    let ubRepairPtsLeft__Pointer = createPointer(
      () => ubRepairPtsLeft,
      (v) => (ubRepairPtsLeft = v),
    );
    ...
    let fNothingLeftToRepair__Pointer = createPointer(
      () => fNothingLeftToRepair,
      (v) => (fNothingLeftToRepair = v),
    );
    let bLoop: INT8;
    let bLoopStart: INT8;
    let bLoopEnd: INT8;
    ...
    ubRepairPtsLeft = CalculateRepairPointsForRepairman(
      pSoldier,
      createPointer(
        () => usMax,
        (v) => (usMax = v),
    ...
    if (pSoldier.bVehicleUnderRepairID != -1) {
      if (CanCharacterRepairVehicle(pSoldier, pSoldier.bVehicleUnderRepairID)) {
        ...
        ubRepairPtsLeft -= RepairVehicle(
          pSoldier.bVehicleUnderRepairID,
          ubRepairPtsLeft,
          fNothingLeftToRepair__Pointer,
        );
      }
    }
    // check if we are repairing a robot
      ...
      if (CanCharacterRepairRobot(pSoldier)) {
        ...
        // robot
        ubRepairPtsLeft -= HandleRepairOfRobotBySoldier(
          pSoldier,
          ubRepairPtsLeft,
          fNothingLeftToRepair__Pointer,
        );
      ...
      fAnyOfSoldiersOwnItemsWereFixed = UnjamGunsOnSoldier(
        pSoldier,
        pSoldier,
        ubRepairPtsLeft__Pointer,
      );
      ...
      for (bLoop = 0; bLoop < 2; bLoop++) {
        ...
        for (bPocket = bLoopStart; bPocket <= bLoopEnd; bPocket++) {
          ...
          if (
            RepairObject(pSoldier, pSoldier, pObj, ubRepairPtsLeft__Pointer)
          ) {
      ...
      if (
        fAnyOfSoldiersOwnItemsWereFixed &&
        !DoesCharacterHaveAnyItemsToRepair(pSoldier, -1)
      ) {
        ScreenMsg(
          FONT_MCOLOR_LTYELLOW,
          MSG_INTERFACE,
    ...
    if (ubRepairPtsUsed > 0) {
      ...
      if (Random(100) < ubRepairPtsUsed * 5) {
        // CJC: added a x5 as this wasn't going down anywhere fast enough
  ...
  function HandleRestAndFatigueInSector(
    sMapX: INT16,
    sMapY: INT16,
    bMapZ: INT8,
  ): void {
    ...
    for (
      ...
      if (
        ...
        if (
          pTeamSoldier.sSectorX == sMapX &&
          pTeamSoldier.sSectorY == sMapY &&
...
*/
  ...
  function HandleTrainingInSector(sMapX: INT16, sMapY: INT16, bZ: INT8): void {
    ...
    let pStatTrainerList: SOLDIERTYPE[] /* Pointer<SOLDIERTYPE>[NUM_TRAINABLE_STATS] */ =
      createArray(Enum118.NUM_TRAINABLE_STATS, <SOLDIERTYPE>(<unknown>null)); // can't have more "best" trainers than trainable stats
    let sBestTrainingPts: INT16;
    let sTownTrainingPts: INT16;
    let TownTrainer: TOWN_TRAINER_TYPE[] /* [MAX_CHARACTER_COUNT] */ =
      createArrayFrom(MAX_CHARACTER_COUNT, createTownTrainerType);
    let ubTownTrainers: UINT8;
    let usMaxPts: UINT16 = 0;
    let usMaxPts__Pointer = createPointer(
      () => usMaxPts,
      (v) => (usMaxPts = v),
    );
    ...
    for (ubStat = 0; ubStat < Enum118.NUM_TRAINABLE_STATS; ubStat++) {
      ...
      for (
        uiCnt = 0, pTrainer = MercPtrs[uiCnt];
        uiCnt <= gTacticalStatus.Team[MercPtrs[0].bTeam].bLastID;
        uiCnt++, pTrainer = MercPtrs[uiCnt]
      ) {
        if (
          pTrainer.bActive &&
          pTrainer.sSectorX == sMapX &&
          pTrainer.sSectorY == sMapY &&
          pTrainer.bSectorZ == bZ
        ) {
          // if he's training teammates in this stat
          if (
            pTrainer.bAssignment == Enum117.TRAIN_TEAMMATE &&
    ...
    for (
      uiCnt = 0, pStudent = MercPtrs[uiCnt];
      uiCnt <= gTacticalStatus.Team[MercPtrs[0].bTeam].bLastID;
      uiCnt++, pStudent = MercPtrs[uiCnt]
    ) {
      // see if this merc is active and in the same sector
      if (
        pStudent.bActive &&
        pStudent.sSectorX == sMapX &&
        pStudent.sSectorY == sMapY &&
        pStudent.bSectorZ == bZ
      ) {
        // if he's training himself (alone, or by others), then he's a student
        if (
          pStudent.bAssignment == Enum117.TRAIN_SELF ||
          pStudent.bAssignment == Enum117.TRAIN_BY_OTHER
        ) {
          if (
            EnoughTimeOnAssignment(pStudent) &&
            pStudent.fMercAsleep == false
          ) {
            // figure out how much the grunt can learn in one training period
            sTotalTrainingPts = GetSoldierTrainingPts(
              pStudent,
              pStudent.bTrainStat,
              fAtGunRange,
              usMaxPts__Pointer,
    ...
    if (
      (StrategicMap[sMapX + sMapY * MAP_WORLD_X].bNameId !=
      ...
      for (
        ...
        if (
          ...
          if (
            pTrainer.bAssignment == Enum117.TRAIN_TOWN &&
            EnoughTimeOnAssignment(pTrainer) &&
            pTrainer.fMercAsleep == false
          ) {
            sTownTrainingPts = GetTownTrainPtsForCharacter(
              pTrainer,
              usMaxPts__Pointer,
            );
      ...
      for (uiCnt = 0; uiCnt < ubTownTrainers; uiCnt++) {
        ...
        if (sTownTrainingPts > 0) {
          fTrainingCompleted = TrainTownInSector(
            TownTrainer[uiCnt].pSoldier,
            sMapX,
            sMapY,
            sTownTrainingPts,
          );
  ...
  function TownTrainerQsortCompare(
    pArg1: TOWN_TRAINER_TYPE,
    pArg2: TOWN_TRAINER_TYPE,
  ): number {
  ...
  export function GetBonusTrainingPtsDueToInstructor(
    pInstructor: SOLDIERTYPE,
    pStudent: SOLDIERTYPE | null,
    bTrainStat: INT8,
    fAtGunRange: boolean,
    pusMaxPts: Pointer<UINT16>,
  ): INT16 {
    ...
    if (pStudent == null) {
      ...
      bOpinionFactor =
        gMercProfiles[pStudent.ubProfile].bMercOpinion[pInstructor.ubProfile];
      bOpinionFactor += Math.trunc(
        gMercProfiles[pInstructor.ubProfile].bMercOpinion[pStudent.ubProfile] /
          2,
      );
    }
    ...
    sTrainingPts = Math.trunc(
      ((bTrainerEffSkill - bTraineeSkill) *
        Math.trunc(
          bTraineeEffWisdom +
            (EffectiveWisdom(pInstructor) + EffectiveLeadership(pInstructor)) /
              2,
        )) /
    ...
    pusMaxPts.value = Math.trunc(
      ((bTrainerNatSkill - bTraineeSkill) *
        Math.trunc(
          bTraineeNatWisdom +
            (pInstructor.bWisdom + pInstructor.bLeadership) / 2,
        )) /
        INSTRUCTED_TRAINING_DIVISOR,
    );
    ...
    pusMaxPts.value += Math.trunc(
      ((bTrainingBonus + bOpinionFactor) * pusMaxPts.value) / 100,
    );
    ...
    sTrainingPts += Math.trunc(
      ((bTrainingBonus + bOpinionFactor) * sTrainingPts) / 100,
    );
  ...
  export function GetSoldierTrainingPts(
    pSoldier: SOLDIERTYPE,
    bTrainStat: INT8,
    fAtGunRange: boolean,
    pusMaxPts: Pointer<UINT16>,
    ...
    // calculate normal training pts - what it would be if his stats were "normal" (ignoring drugs, fatigue)
    pusMaxPts.value = Math.max(
      Math.trunc(
        (pSoldier.bWisdom * (TRAINING_RATING_CAP - bSkill)) /
    ...
    // calculate effective training pts
    sTrainingPts = Math.max(
      Math.trunc(
        (EffectiveWisdom(pSoldier) * (TRAINING_RATING_CAP - bSkill)) /
          SELF_TRAINING_DIVISOR,
      ),
      1,
    );
  ...
  export function GetSoldierStudentPts(
    pSoldier: SOLDIERTYPE,
    bTrainStat: INT8,
    fAtGunRange: boolean,
    pusMaxPts: Pointer<UINT16>,
    ...
    let usMaxTrainerPts__Pointer = createPointer(
      () => usMaxTrainerPts,
      (v) => (usMaxTrainerPts = v),
    );
    ...
    for (
      ...
      if (
        pTrainer.bActive &&
        pTrainer.sSectorX == pSoldier.sSectorX &&
        pTrainer.sSectorY == pSoldier.sSectorY &&
        pTrainer.bSectorZ == pSoldier.bSectorZ
      ) {
        // if he's training teammates in this stat
  ...
  function TrainTownInSector(
    ...
    // get town index
    ubTownId =
      StrategicMap[pTrainer.sSectorX + pTrainer.sSectorY * MAP_WORLD_X].bNameId;
  ...
  export function GetTownTrainPtsForCharacter(
    pTrainer: SOLDIERTYPE,
    pusMaxPts: Pointer<UINT16>,
  ): INT16 {
    let sTotalTrainingPts: INT16 = 0;
    ...
    // calculate normal training pts - what it would be if his stats were "normal" (ignoring drugs, fatigue)
    pusMaxPts.value =
      (pTrainer.bWisdom + pTrainer.bLeadership + 10 * pTrainer.bExpLevel) *
      TOWN_TRAINING_RATE;

    // calculate effective training points (this is hundredths of pts / hour)
    // typical: 300/hr, maximum: 600/hr
    sTotalTrainingPts =
      (EffectiveWisdom(pTrainer) +
        EffectiveLeadership(pTrainer) +
  ...
  */
  ...
  export function MakeSoldiersTacticalAnimationReflectAssignment(
    pSoldier: SOLDIERTYPE,
  ): void {
    ...
    if (pSoldier.bInSector && gfWorldLoaded && pSoldier.bLife >= OKLIFE) {
      ...
      if (pSoldier.bAssignment == Enum117.DOCTOR) {
        ...
        if (
          pSoldier.usAnimState != Enum193.WKAEUP_FROM_SLEEP &&
          !(pSoldier.bOldAssignment < Enum117.ON_DUTY)
        ) {
          // default: standing
  ...
  function AssignmentAborted(pSoldier: SOLDIERTYPE, ubReason: UINT8): void {
    ...
    ScreenMsg(
      FONT_MCOLOR_LTYELLOW,
      MSG_INTERFACE,
      gzLateLocalizedString[ubReason],
      pSoldier.name,
    );
  ...
  export function AssignmentDone(
    ...
    if (fSayQuote) {
      if (fMeToo == false && pSoldier.bAssignment == Enum117.TRAIN_TOWN) {
        ...
        if (pSoldier.bAssignment == Enum117.TRAIN_TOWN) {
          AddSectorForSoldierToListOfSectorsThatCompletedMilitiaTraining(
            pSoldier,
          );
        }
      }
    ...
    if (!(pSoldier.usQuoteSaidExtFlags & SOLDIER_QUOTE_SAID_DONE_ASSIGNMENT)) {
      ...
      if (fSayQuote) {
        if (
          pSoldier.bAssignment == Enum117.DOCTOR ||
          pSoldier.bAssignment == Enum117.REPAIR ||
          pSoldier.bAssignment == Enum117.PATIENT ||
          pSoldier.bAssignment == Enum117.ASSIGNMENT_HOSPITAL
        ) {
          TacticalCharacterDialogue(
            pSoldier,
            Enum202.QUOTE_ASSIGNMENT_COMPLETE,
          );
        }
      }
  ...
  function HandleHealingByNaturalCauses(pSoldier: SOLDIERTYPE): void {
    ...
    } // this includes being in a vehicle - that's neither very strenous, nor very restful
    else {
...
*/
  ...
  /* static */ let CreateDestroyMouseRegionsForAssignmentMenu__fCreated: boolean =
    false;
  /* static */ let CreateDestroyMouseRegionsForAssignmentMenu__fShowRemoveMenu: boolean =
    false;
  function CreateDestroyMouseRegionsForAssignmentMenu(): void {
    ...
    if (
      ...
      CreateDestroyMouseRegionsForAssignmentMenu__fShowRemoveMenu == true
    ) {
      if (CreateDestroyMouseRegionsForAssignmentMenu__fShowRemoveMenu == true) {
        // dead guy handle menu stuff
        CreateDestroyMouseRegionsForAssignmentMenu__fShowRemoveMenu =
      ...
      if (
        Menptr[gCharactersList[bSelectedAssignChar].usSolID].bLife == 0 ||
        Menptr[gCharactersList[bSelectedAssignChar].usSolID].bAssignment ==
          Enum117.ASSIGNMENT_POW
      ) {
        // dead guy handle menu stuff
        CreateDestroyMouseRegionsForAssignmentMenu__fShowRemoveMenu =
          fShowAssignmentMenu || fShowContractMenu;
    ...
    if (
      ...
      if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__EPC) {
        // grab height of font
        iFontHeight =
          GetLineSpace(ghEpcBox) + GetFontHeight(GetBoxFont(ghEpcBox));
        ...
        // grab height of font
        iFontHeight =
          GetLineSpace(ghAssignmentBox) +
          GetFontHeight(GetBoxFont(ghAssignmentBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghAssignmentBox);
        iCounter++
      ) {
        ...
        MSYS_DefineRegion(
          ...
          iBoxYPosition +
            ...
            iFontHeight * iCounter,
          iBoxXPosition + iBoxWidth,
          iBoxYPosition +
            GetTopMarginSize(ghAssignmentBox) +
            iFontHeight * (iCounter + 1),
          MSYS_PRIORITY_HIGHEST - 4,
          MSYS_NO_CURSOR,
  ...
  /* static */ let CreateDestroyMouseRegionForVehicleMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionForVehicleMenu(): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghVehicleBox) + GetFontHeight(GetBoxFont(ghVehicleBox));
      ...
      (fShowVehicleMenu == false || fShowAssignmentMenu == false) &&
      CreateDestroyMouseRegionForVehicleMenu__fCreated == true
    ) {
      CreateDestroyMouseRegionForVehicleMenu__fCreated = false;
      ...
      for (
        uiMenuLine = 0;
        uiMenuLine < GetNumberOfLinesOfTextInBox(ghVehicleBox);
        uiMenuLine++
      ) {
  ...
  function VehicleMenuMvtCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_GAIN_MOUSE) {
      if (iValue != Enum115.VEHICLE_MENU_CANCEL) {
        ...
        HighLightBoxLine(
          ghVehicleBox,
          GetNumberOfLinesOfTextInBox(ghVehicleBox) - 1,
        );
      }
  ...
  function DisplayRepairMenu(pSoldier: SOLDIERTYPE): boolean {
    ...
    if (pSoldier.bSectorZ == 0) {
      ...
      for (
        iVehicleIndex = 0;
        iVehicleIndex < ubNumberOfVehicles;
        iVehicleIndex++
      ) {
  ...
  */
  ...
  /* static */ let CreateDestroyMouseRegionForRepairMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionForRepairMenu(): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghRepairBox) + GetFontHeight(GetBoxFont(ghRepairBox));
    ...
    */
      ...
      (fShowRepairMenu == false || fShowAssignmentMenu == false) &&
      CreateDestroyMouseRegionForRepairMenu__fCreated == true
    ) {
      CreateDestroyMouseRegionForRepairMenu__fCreated = false;
      ...
      for (
        uiCounter = 0;
        uiCounter < GetNumberOfLinesOfTextInBox(ghRepairBox);
        uiCounter++
      ) {
  ...
  function RepairMenuBtnCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (
      ...
      if (
        iRepairWhat >= Enum114.REPAIR_MENU_VEHICLE1 &&
        iRepairWhat <= Enum114.REPAIR_MENU_VEHICLE3
      ) {
        // repair VEHICLE
  ...
  function RepairMenuMvtCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_GAIN_MOUSE) {
      if (iValue < Enum114.REPAIR_MENU_CANCEL) {
        ...
        HighLightBoxLine(
          ghRepairBox,
          GetNumberOfLinesOfTextInBox(ghRepairBox) - 1,
        );
      }
    } else if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      // unhighlight all strings in box
    ...
    if (pSoldier && pSoldier.bActive) {
      if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__EPC) {
        ...
        if (CanCharacterDoctor(pSoldier)) {
          ...
          UnSecondaryShadeStringInBox(
            ghAssignmentBox,
            Enum148.ASSIGN_MENU_DOCTOR,
          );
        } else {
  ...
  export function DetermineWhichAssignmentMenusCanBeShown(): void {
    ...
    */
    ...
    if (
      (Menptr[gCharactersList[bSelectedInfoChar].usSolID].bLife == 0 ||
        Menptr[gCharactersList[bSelectedInfoChar].usSolID].bAssignment ==
          Enum117.ASSIGNMENT_POW) &&
  ...
  /* static */ let CreateDestroyScreenMaskForAssignmentAndContractMenus__fCreated: boolean =
    false;
  ...
  function AssignmentScreenMaskBtnCallback(
  ...
  /* static */ let CreateDestroyMouseRegionsForContractMenu__fCreated: boolean =
    false;
  /* static */ let CreateDestroyMouseRegionsForContractMenu__fShowRemoveMenu: boolean =
    false;
  export function CreateDestroyMouseRegionsForContractMenu(): void {
    ...
    if (
      bSelectedContractChar != -1 ||
      CreateDestroyMouseRegionsForContractMenu__fShowRemoveMenu == true
    ) {
      if (CreateDestroyMouseRegionsForContractMenu__fShowRemoveMenu == true) {
        // dead guy handle menu stuff
        CreateDestroyMouseRegionsForContractMenu__fShowRemoveMenu =
          fShowContractMenu;
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghContractBox) + GetFontHeight(GetBoxFont(ghContractBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghContractBox);
        iCounter++
      ) {
        // add mouse region for each line of text..and set user data

        MSYS_DefineRegion(
          gContractMenuRegion[iCounter],
          iBoxXPosition,
          iBoxYPosition +
            GetTopMarginSize(ghContractBox) +
            iFontHeight * iCounter,
          iBoxXPosition + iBoxWidth,
          iBoxYPosition +
            GetTopMarginSize(ghContractBox) +
  ...
  /* static */ let CreateDestroyMouseRegionsForTrainingMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionsForTrainingMenu(): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghTrainingBox) + GetFontHeight(GetBoxFont(ghTrainingBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghTrainingBox);
        iCounter++
      ) {
        // add mouse region for each line of text..and set user data

        MSYS_DefineRegion(
          gTrainingMenuRegion[iCounter],
          iBoxXPosition,
          iBoxYPosition +
            GetTopMarginSize(ghTrainingBox) +
            iFontHeight * iCounter,
          iBoxXPosition + iBoxWidth,
          iBoxYPosition +
            GetTopMarginSize(ghTrainingBox) +
      ...
      (fShowAssignmentMenu == false || fShowTrainingMenu == false) &&
      CreateDestroyMouseRegionsForTrainingMenu__fCreated == true
    ) {
      // destroy
      for (
  ...
  /* static */ let CreateDestroyMouseRegionsForAttributeMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionsForAttributeMenu(): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghAttributeBox) +
        GetFontHeight(GetBoxFont(ghAttributeBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghAttributeBox);
        iCounter++
      ) {
        // add mouse region for each line of text..and set user data

        MSYS_DefineRegion(
          gAttributeMenuRegion[iCounter],
          iBoxXPosition,
          iBoxYPosition +
            GetTopMarginSize(ghAttributeBox) +
            iFontHeight * iCounter,
          iBoxXPosition + iBoxWidth,
          iBoxYPosition +
            GetTopMarginSize(ghAttributeBox) +
  ...
  /* static */ let CreateDestroyMouseRegionsForRemoveMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionsForRemoveMenu(): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghRemoveMercAssignBox) +
        GetFontHeight(GetBoxFont(ghRemoveMercAssignBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghRemoveMercAssignBox);
        iCounter++
      ) {
        // add mouse region for each line of text..and set user data
  ...
  /* static */ let CreateDestroyMouseRegionsForSquadMenu__fCreated: boolean =
    false;
  function CreateDestroyMouseRegionsForSquadMenu(fPositionBox: boolean): void {
    ...
    if (
      ...
      // grab height of font
      iFontHeight =
        GetLineSpace(ghSquadBox) + GetFontHeight(GetBoxFont(ghSquadBox));
      ...
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghSquadBox) - 1;
        iCounter++
      ) {
        // add mouse region for each line of text..and set user data
        MSYS_DefineRegion(
          gSquadMenuRegion[iCounter],
          iBoxXPosition,
          iBoxYPosition + GetTopMarginSize(ghSquadBox) + iFontHeight * iCounter,
          iBoxXPosition + iBoxWidth,
          iBoxYPosition +
            GetTopMarginSize(ghSquadBox) +
            iFontHeight * (iCounter + 1),
          MSYS_PRIORITY_HIGHEST - 2,
          MSYS_NO_CURSOR,
          SquadMenuMvtCallBack,
          SquadMenuBtnCallback,
        );
      ...
      (fShowAssignmentMenu == false || fShowSquadMenu == false) &&
      CreateDestroyMouseRegionsForSquadMenu__fCreated == true
    ) {
      // destroy
      for (
        iCounter = 0;
        iCounter < GetNumberOfLinesOfTextInBox(ghSquadBox);
        iCounter++
      ) {
  ...
  function AssignmentMenuMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // mvt callback handler for assignment region
  ...
  function RemoveMercMenuMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // mvt callback handler for assignment region
  ...
  function ContractMenuMvtCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function SquadMenuMvtCallBack(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_GAIN_MOUSE) {
      ...
      if (iValue != Enum151.SQUAD_MENU_CANCEL) {
        ...
        HighLightBoxLine(
          ghSquadBox,
          GetNumberOfLinesOfTextInBox(ghSquadBox) - 1,
        );
      }
    } else if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      // unhighlight all strings in box
  ...
  function RemoveMercMenuBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function BeginRemoveMercFromContract(pSoldier: SOLDIERTYPE): void {
    ...
    if (pSoldier.bLife > 0 && pSoldier.bAssignment != Enum117.ASSIGNMENT_POW) {
      if (
        ...
        GetWorldTotalMin() - pSoldier.uiTimeOfLastContractUpdate <
        60 * 48
      ) {
        ...
        if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__AIM_MERC) {
          ...
          if (WillMercRenew(pSoldier, false)) {
            HandleImportantMercQuote(
              pSoldier,
              Enum202.QUOTE_DEPART_COMMET_CONTRACT_NOT_RENEWED_OR_TERMINATED_UNDER_48,
            );
          }
        }
        ...
        if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__AIM_MERC) {
          ...
          if (WillMercRenew(pSoldier, false)) {
            HandleImportantMercQuote(
              pSoldier,
              Enum202.QUOTE_DEPARTING_COMMENT_CONTRACT_NOT_RENEWED_OR_48_OR_MORE,
            );
          }
        } else if (
          pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__MERC ||
      ...
      if (GetWorldTotalMin() - pSoldier.uiTimeOfLastContractUpdate < 60 * 3) {
        ...
        gMercProfiles[pSoldier.ubProfile].ubDaysOfMoraleHangover =
          3 + Random(4);
  ...
  function ContractMenuBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // btn callback handler for contract region
  ...
  function TrainingMenuMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // mvt callback handler for assignment region
  ...
  function AttributeMenuMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // mvt callback handler for assignment region
  ...
  */
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (
        bCanJoinSquad == CHARACTER_CAN_JOIN_SQUAD ||
  ...
  function TrainingMenuBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // btn callback handler for assignment region
    ...
    if (
      iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN ||
        ...
        case Enum149.TRAIN_MENU_TOWN:
          if (BasicCanCharacterTrainMilitia(pSoldier)) {
            ...
            if (bTownId != Enum135.BLANK_SECTOR) {
              ...
              if (
                DoesSectorMercIsInHaveSufficientLoyaltyToTrainMilitia(
                  pSoldier,
                ) == false
              ) {
                DoScreenIndependantMessageBox(
  ...
  function AttributesMenuBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // btn callback handler for assignment region
  ...
  function AssignmentMenuBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // btn callback handler for assignment region
  ...
  function CreateSquadBox(): void {
    ...
    for (uiCounter = 0; uiCounter <= uiMaxSquad; uiCounter++) {
      ...
      sString = swprintf(
        "%s ( %d/%d )",
        pSquadMenuStrings[uiCounter],
        NumberOfPeopleInSquad(uiCounter),
  ...
  function CreateEPCBox(): void {
    ...
    // create basic box
    ghEpcBox = CreatePopUpBox(
      SquadDimensions,
      AssignmentPosition,
      POPUP_BOX_FLAG_CLIP_TEXT |
        POPUP_BOX_FLAG_RESIZE |
        POPUP_BOX_FLAG_CENTER_TEXT,
    );
  ...
  function DisplayVehicleMenu(pSoldier: SOLDIERTYPE): boolean {
    ...
    for (iCounter = 0; iCounter < ubNumberOfVehicles; iCounter++) {
      if (pVehicleList[iCounter].fValid == true) {
        if (IsThisVehicleAccessibleToSoldier(pSoldier, iCounter)) {
          hStringHandle = AddMonoString(
            pVehicleStrings[pVehicleList[iCounter].ubVehicleType],
          );
  ...
  export function CreateContractBox(pCharacter: SOLDIERTYPE | null): void {
    ...
    if (pCharacter != null) {
      for (
        uiCounter = 0;
        uiCounter < Enum152.MAX_CONTRACT_MENU_STRING_COUNT;
        uiCounter++
      ) {
        switch (uiCounter) {
  ...
  function CreateAttributeBox(): void {
    ...
    for (
      uiCounter = 0;
      uiCounter < Enum146.MAX_ATTRIBUTE_STRING_COUNT;
      uiCounter++
    ) {
  ...
  function CreateTrainingBox(): void {
    ...
    if (giBoxY != 0) {
      TrainPosition.iY =
        giBoxY + Enum148.ASSIGN_MENU_TRAIN * GetFontHeight(MAP_SCREEN_FONT());
    }

    // create basic box
    ghTrainingBox = CreatePopUpBox(
      TrainDimensions,
      TrainPosition,
      POPUP_BOX_FLAG_CLIP_TEXT |
        POPUP_BOX_FLAG_CENTER_TEXT |
    ...
    for (
      uiCounter = 0;
      uiCounter < Enum149.MAX_TRAIN_STRING_COUNT;
      uiCounter++
    ) {
  ...
  function CreateAssignmentsBox(): void {
    ...
    // create basic box
    ghAssignmentBox = CreatePopUpBox(
    ...
    for (
      uiCounter = 0;
      uiCounter < Enum148.MAX_ASSIGN_STRING_COUNT;
      uiCounter++
    ) {
      // if we have a soldier, and this is the squad line
      if (
        uiCounter == Enum148.ASSIGN_MENU_ON_DUTY &&
        pSoldier != null &&
  ...
  export function CreateMercRemoveAssignBox(): void {
    ...
    let uiCounter: UINT32;
    // create basic box
    ghRemoveMercAssignBox = CreatePopUpBox(
      AssignmentDimensions,
      AssignmentPosition,
      POPUP_BOX_FLAG_CLIP_TEXT |
        POPUP_BOX_FLAG_CENTER_TEXT |
    ...
    for (
      uiCounter = 0;
      uiCounter < Enum150.MAX_REMOVE_MERC_COUNT;
      uiCounter++
    ) {
  ...
  export function CreateDestroyAssignmentPopUpBoxes(): boolean {
    ...
    if (
      ...
      vs_desc.fCreateFlags =
        VSURFACE_CREATE_FROMFILE | VSURFACE_SYSTEM_MEM_USAGE;
  ...
  export function DetermineBoxPositions(): void {
    ...
    if (fShowRepairMenu == true && ghRepairBox != -1) {
      CreateDestroyMouseRegionForRepairMenu();
      pNewPoint.iY +=
        (GetFontHeight(MAP_SCREEN_FONT()) + 2) * Enum148.ASSIGN_MENU_REPAIR;
    ...
    if (fShowTrainingMenu == true && ghTrainingBox != -1) {
      pNewPoint.iY +=
        (GetFontHeight(MAP_SCREEN_FONT()) + 2) * Enum148.ASSIGN_MENU_TRAIN;
  ...
  function RepositionMouseRegions(): void {
    ...
    if (fShowAssignmentMenu == true) {
      ...
      sDeltaY =
        gsAssignmentBoxesY -
        gAssignmentMenuRegion[0].RegionTopLeftY +
        GetTopMarginSize(ghAssignmentBox);
  ...
  function CheckAndUpdateTacticalAssignmentPopUpPositions(): void {
    ...
    if (fShowRepairMenu == true) {
      ...
      if (
        gsAssignmentBoxesX + pDimensions2.iRight + pDimensions.iRight >=
        640
      ) {
      ...
      if (
        ...
        gsAssignmentBoxesX =
          639 -
          (pDimensions2.iRight + pDimensions.iRight + pDimensions3.iRight);
        SetRenderFlags(RENDER_FLAG_FULL);
      }

      if (
        gsAssignmentBoxesY +
          pDimensions3.iBottom +
          GetFontHeight(MAP_SCREEN_FONT()) * Enum148.ASSIGN_MENU_TRAIN >=
        360
      ) {
  ...
  function PositionCursorForTacticalAssignmentBox(): void {
    ...
    if (gGameSettings.fOptions[Enum8.TOPTION_DONT_MOVE_MOUSE] == false) {
      SimulateMouseMovement(
        pPosition.iX + pDimensions.iRight - 6,
        pPosition.iY + Math.trunc(iFontHeight / 2) + 2,
      );
    }
  }
      ...
      if (pSoldier.bActive) {
        ...
        if (!pSoldier.fMercAsleep) {
          ...
          // if pretty tired, and not forced to stay awake
            ...
            pSoldier.bBreathMax < BREATHMAX_PRETTY_TIRED &&
            ...
            if (
              ...
              if (SetMercAsleep(pSoldier, false)) {
                if (
                  gGameSettings.fOptions[Enum8.TOPTION_SLEEPWAKE_NOTIFICATION]
                ) {
                  // if the first one
                  if (fReasonAdded == false) {
                    // tell player about it
                    AddReasonToWaitingListQueue(
                      Enum154.ASLEEP_GOING_AUTO_FOR_UPDATE,
                    );
                    TacticalCharacterDialogueWithSpecialEvent(
                      pSoldier,
                      0,
                      DIALOGUE_SPECIAL_EVENT_SHOW_UPDATE_MENU,
                      0,
                      0,
                    );
            ...
            if (SetMercAwake(pSoldier, false, false)) {
              ...
              if (
                ...
                if (
                  ...
                  if (fReasonAdded == false) {
                    AddReasonToWaitingListQueue(
                      Enum154.ASSIGNMENT_RETURNING_FOR_UPDATE,
                    );
                    fReasonAdded = true;
                  }
  ...
  function CanCharacterRepairVehicle(
    pSoldier: SOLDIERTYPE,
    iVehicleId: INT32,
  ): boolean {
  ...
  */
  ...
  function HandleRepairOfRobotBySoldier(
    pSoldier: SOLDIERTYPE,
    ubRepairPts: UINT8,
    pfNothingLeftToRepair: Pointer<boolean>,
  ): UINT8 {
  ...
  export function SetSoldierAssignment(
    pSoldier: SOLDIERTYPE,
    bAssignment: INT8,
    iParam1: INT32,
    iParam2: INT32,
    ...
    switch (bAssignment) {
      ...
      case Enum117.VEHICLE:
        if (
          CanCharacterVehicle(pSoldier) &&
          IsThisVehicleAccessibleToSoldier(pSoldier, iParam1)
        ) {
...
*/
  ...
  function HandleAssignmentExpansionAndHighLightForAssignMenu(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    if (fShowSquadMenu) {
...
*/
  ...
  function HandleShadingOfLinesForAttributeMenus(): void {
    ...
    for (bAttrib = 0; bAttrib < Enum146.ATTRIB_MENU_CANCEL; bAttrib++) {
      switch (gbTrainingMode) {
        case Enum117.TRAIN_SELF:
          fStatTrainable = CanCharacterTrainStat(
            pSoldier,
            bAttrib,
            true,
            false,
  ...
  function ResetAssignmentsForAllSoldiersInSectorWhoAreTrainingTown(
    pSoldier: SOLDIERTYPE,
  ): void {
    ...
    for (iCounter = 0; iCounter < iNumberOnTeam; iCounter++) {
      ...
      if (pCurSoldier.bActive && pCurSoldier.bLife >= OKLIFE) {
        if (pCurSoldier.bAssignment == Enum117.TRAIN_TOWN) {
          if (
            pCurSoldier.sSectorX == pSoldier.sSectorX &&
            pCurSoldier.sSectorY == pSoldier.sSectorY &&
            pSoldier.bSectorZ == 0
          ) {
  ...
  function ReportTrainersTraineesWithoutPartners(): void {
    ...
    for (iCounter = 0; iCounter < iNumberOnTeam; iCounter++) {
      ...
      if (
        pTeamSoldier.bAssignment == Enum117.TRAIN_TEAMMATE &&
        pTeamSoldier.bLife > 0
      ) {
        if (
          !ValidTrainingPartnerInSameSectorOnAssignmentFound(
            pTeamSoldier,
            Enum117.TRAIN_BY_OTHER,
    ...
    for (iCounter = 0; iCounter < iNumberOnTeam; iCounter++) {
      ...
      if (
        pTeamSoldier.bAssignment == Enum117.TRAIN_BY_OTHER &&
        pTeamSoldier.bLife > 0
      ) {
        if (
          !ValidTrainingPartnerInSameSectorOnAssignmentFound(
            pTeamSoldier,
            Enum117.TRAIN_TEAMMATE,
            pTeamSoldier.bTrainStat,
          )
        ) {
          AssignmentDone(pTeamSoldier, true, true);
  ...
  export function SetMercAsleep(
    pSoldier: SOLDIERTYPE,
    fGiveWarning: boolean,
  ): boolean {
  ...
  export function IsThereASoldierInThisSector(
    sSectorX: INT16,
    sSectorY: INT16,
    bSectorZ: INT8,
  ): boolean {
    if (
      fSectorsWithSoldiers[sSectorX + sSectorY * MAP_WORLD_X][bSectorZ] == true
    ) {
      return true;
    }
  ...
  export function SetTimeOfAssignmentChangeForMerc(
    pSoldier: SOLDIERTYPE,
  ): void {
  ...
  function EnoughTimeOnAssignment(pSoldier: SOLDIERTYPE): boolean {
    if (
      GetWorldTotalMin() - pSoldier.uiLastAssignmentChangeMin >=
  ...
  export function PlayerSoldierTooTiredToTravel(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    Assert(pSoldier);
    ...
    if (CanChangeSleepStatusForSoldier(pSoldier)) {
      ...
      if (
        ...
        if (
          ...
          pSoldier.bBreathMax < BREATHMAX_GOTTA_STOP_MOVING
        ) {
          return true;
        }
  ...
  function AssignMercToAMovementGroup(pSoldier: SOLDIERTYPE): boolean {
    ...
    // create group
    bGroupId = CreateNewPlayerGroupDepartingFromSector(
      pSoldier.sSectorX,
      pSoldier.sSectorY,
    );
  ...
  export function HandleSelectedMercsBeingPutAsleep(
    fWakeUp: boolean,
  ...
  export function IsAnyOneOnPlayersTeamOnThisAssignment(
    bAssignment: INT8,
  ): boolean {
    let iCounter: INT32 = 0;
    let pSoldier: SOLDIERTYPE;
    ...
    for (
      iCounter = gTacticalStatus.Team[OUR_TEAM].bFirstID;
          ...
          if (pSoldier.bAssignment == Enum117.ASSIGNMENT_HOSPITAL) {
            ...
            if (pDoctor != null) {
              ...
              if (iKitSlot != NO_SLOT) {
                ...
                if (usKitPts) {
                  uiKitPtsUsed = VirtualSoldierDressWound(
                    pDoctor,
                    pSoldier,
                    pKit,
                    usKitPts,
    ...
    for (
      ...
      if (pSoldier.bActive) {
        switch (pSoldier.bAssignment) {
          case Enum117.DOCTOR:
            fNothingToDo =
              !CanCharacterDoctor(pSoldier) ||
              GetNumberThatCanBeDoctored(
                pSoldier,
                HEALABLE_EVER,
                false,
                false,
          ...
          case Enum117.REPAIR:
            fNothingToDo =
              !CanCharacterRepair(pSoldier) ||
              HasCharacterFinishedRepairing(pSoldier);
            break;
          ...
          case Enum117.TRAIN_SELF:
            fNothingToDo = !CanCharacterTrainStat(
              pSoldier,
              pSoldier.bTrainStat,
              true,
              false,
  ...
  export function SetAssignmentForList(bAssignment: INT8, bParam: INT8): void {
    ...
    for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
      if (
        gCharactersList[iCounter].fValid &&
        fSelectedListOfMercsForMapScreen[iCounter] == true &&
        iCounter != bSelectedAssignChar &&
        !(
          Menptr[gCharactersList[iCounter].usSolID].uiStatusFlags &
          SOLDIER_VEHICLE
        )
      ) {
        ...
        switch (bAssignment) {
          ...
          case Enum117.VEHICLE:
            if (
              CanCharacterVehicle(pSoldier) &&
              IsThisVehicleAccessibleToSoldier(pSoldier, bParam)
            ) {
          ...
          case Enum117.REPAIR:
            ...
            */
              if (pSelectedSoldier.bVehicleUnderRepairID != -1) {
                fCanFixSpecificTarget = CanCharacterRepairVehicle(
                  pSoldier,
              ...
              if (fCanFixSpecificTarget) {
                ...
                SetSoldierAssignment(
                  pSoldier,
                  Enum117.REPAIR,
                  Number(pSelectedSoldier.fFixingSAMSite),
                  Number(pSelectedSoldier.fFixingRobot),
                  pSelectedSoldier.bVehicleUnderRepairID,
                );
                fItWorked = true;
              }
  ...
  function ValidTrainingPartnerInSameSectorOnAssignmentFound(
    pTargetSoldier: SOLDIERTYPE,
    bTargetAssignment: INT8,
    bTargetStat: INT8,
  ): boolean {
    let iCounter: INT32 = 0;
    let pSoldier: SOLDIERTYPE;
    ...
    Assert(
      bTargetAssignment == Enum117.TRAIN_TEAMMATE ||
        bTargetAssignment == Enum117.TRAIN_BY_OTHER,
    );
    ...
    for (
      ...
      if (pSoldier.bActive) {
        ...
        if (
          ...
          // are we training in the sector with gun range in Alma?
          if (
            pSoldier.sSectorX == GUN_RANGE_X &&
            pSoldier.sSectorY == GUN_RANGE_Y &&
          ...
          if (pSoldier.bAssignment == Enum117.TRAIN_TEAMMATE) {
            ...
            sTrainingPts = GetBonusTrainingPtsDueToInstructor(
              pSoldier,
              pTargetSoldier,
              bTargetStat,
              fAtGunRange,
  ...
  export function UnEscortEPC(pSoldier: SOLDIERTYPE): void {
    if (guiTacticalInterfaceFlags & INTERFACE_MAPSCREEN) {
      ...
      let usQuoteNum__Pointer = createPointer(
        () => usQuoteNum,
        (v) => (usQuoteNum = v),
      );
      let usFactToSetToTrue: UINT16 = 0;
      let usFactToSetToTrue__Pointer = createPointer(
        () => usFactToSetToTrue,
        (v) => (usFactToSetToTrue = v),
      );

      SetupProfileInsertionDataForSoldier(pSoldier);

      fGotInfo = GetInfoForAbandoningEPC(
        pSoldier.ubProfile,
        usQuoteNum__Pointer,
        usFactToSetToTrue__Pointer,
      );
      if (fGotInfo) {
      ...
      SpecialCharacterDialogueEvent(
        DIALOGUE_SPECIAL_EVENT_REMOVE_EPC,
        pSoldier.ubProfile,
        0,
        0,
        0,
      ...
      if (pSoldier.ubProfile == Enum268.JOHN) {
        ...
        if (pSoldier2) {
          ...
          if (fGotInfo) {
            // say quote usQuoteNum
            gMercProfiles[Enum268.MARY].ubMiscFlags |=
              PROFILE_MISC_FLAG_FORCENPCQUOTE;
        ...
        if (pSoldier2) {
          ...
          if (fGotInfo) {
            // say quote usQuoteNum
            gMercProfiles[Enum268.JOHN].ubMiscFlags |=
              PROFILE_MISC_FLAG_FORCENPCQUOTE;
            TacticalCharacterDialogue(pSoldier2, usQuoteNum);
            // the flag will be turned off in the remove-epc event
  ...
  function CanCharacterRepairAnotherSoldiersStuff(
    pSoldier: SOLDIERTYPE,
    pOtherSoldier: SOLDIERTYPE,
  ): boolean {
  ...
  function GetSelectedAssignSoldier(fNullOK: boolean): SOLDIERTYPE {
    ...
    if (guiTacticalInterfaceFlags & INTERFACE_MAPSCREEN) {
      // mapscreen version
      if (
        bSelectedAssignChar >= 0 &&
        bSelectedAssignChar < MAX_CHARACTER_COUNT &&
  ...
  */
  ...
  function RepairItemsOnOthers(
    ...
    for (
      ...
      while (pubRepairPtsLeft.value > 0) {
        ...
        for (
          ...
          if (CanCharacterRepairAnotherSoldiersStuff(pSoldier, pOtherSoldier)) {
            ...
            if (
              FindRepairableItemOnOtherSoldier(pOtherSoldier, ubPassType) !=
              NO_SLOT
            ) {
      ...
      if (
        fSomethingWasRepairedThisPass &&
        !DoesCharacterHaveAnyItemsToRepair(pSoldier, ubPassType)
      ) {
        ScreenMsg(
          FONT_MCOLOR_LTYELLOW,
          MSG_INTERFACE,
          sRepairsDoneString[1 + ubPassType],
          pSoldier.name,
        );
  ...
  function UnjamGunsOnSoldier(
    pOwnerSoldier: SOLDIERTYPE,
    pRepairSoldier: SOLDIERTYPE,
    pubRepairPtsLeft: Pointer<UINT8>,
  ): boolean {
    ...
    for (
      ...
      // the object a weapon? and jammed?
      if (
        Item[pOwnerSoldier.inv[bPocket].usItem].usItemClass == IC_GUN &&
