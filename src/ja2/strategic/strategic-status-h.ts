namespace ja2 {
  ...
  export function createStrategicStatus(): STRATEGIC_STATUS {
    return {
      ...
      usPlayerKills: 0,
      usEnemiesKilled: createArrayFrom(Enum189.NUM_WAYS_ENEMIES_KILLED, () =>
        createArray(Enum188.NUM_ENEMY_RANKS, 0),
      ),
  ...
  export function readStrategicStatus(
    o: STRATEGIC_STATUS,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    o.usLastDayOfPlayerActivity = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeStrategicStatus(
    o: STRATEGIC_STATUS,
    buffer: Buffer,
    offset: number = 0,
  ): number {
