...
*/
  ...
  let gSCamoXY: INV_REGION_DESC = createInvRegionDescFrom(
    INV_BODY_X,
    INV_BODY_Y,
  );
  ...
  let gubMAP_HandInvDispText: UINT8[] /* [NUM_INV_SLOTS] */ = createArray(
  ...
  export let giCharInfoButton: INT32[] /* [2] */ = [-1, -1];
  ...
  let gTeamListNameRegion: MOUSE_REGION[] /* [MAX_CHARACTER_COUNT] */ =
    createArrayFrom(MAX_CHARACTER_COUNT, createMouseRegion);
  ...
  let gpCharacterPreviousMercPath: (PathSt | null)[] /* [MAX_CHARACTER_COUNT] */ =
    createArray(MAX_CHARACTER_COUNT, null);
  ...
  function DisplayDestinationOfCurrentDestMerc(): void {
    ...
    sSector = GetLastSectorIdInCharactersPath(
    ...
    sString = swprintf(
      "%s%s",
      pMapVertIndex[Math.trunc(sSector / MAP_WORLD_X)],
  ...
  */
  ...
  function ContractListRegionBoxGlow(usCount: UINT16): void {
    ...
    if (
      ContractListRegionBoxGlow__iColorNum == 0 ||
      ContractListRegionBoxGlow__iColorNum == 10
    ) {
    ...
    else ContractListRegionBoxGlow__iColorNum--;
    ...
    // glow contract box
    usColor = Get16BPPColor(
      FROMRGB(
        GlowColorsA[ContractListRegionBoxGlow__iColorNum].ubRed,
        GlowColorsA[ContractListRegionBoxGlow__iColorNum].ubGreen,
        GlowColorsA[ContractListRegionBoxGlow__iColorNum].ubBlue,
      ),
    );
    ...
    RectangleDraw(
      ...
      usY + GetFontHeight(MAP_SCREEN_FONT()) + 2,
      usColor,
      pDestBuf,
    );
    InvalidateRegion(
      TIME_REMAINING_X - 1,
      usY,
      TIME_REMAINING_X + TIME_REMAINING_WIDTH + 1,
  ...
  */
  ...
  function GlowFace(): void {
    ...
    // increment color
    if (!GlowFace__fDelta) GlowFace__iColorNum++;
    else GlowFace__iColorNum--;

    // glow contract box
    usColor = Get16BPPColor(
      FROMRGB(
        GlowColorsA[GlowFace__iColorNum].ubRed,
        GlowColorsA[GlowFace__iColorNum].ubGreen,
        GlowColorsA[GlowFace__iColorNum].ubBlue,
      ),
    );
    pDestBuf = LockVideoSurface(
      FRAME_BUFFER,
  ...
  function GlowItem(): void {
    ...
    // increment color
    if (!GlowItem__fDelta) GlowItem__iColorNum++;
    else GlowItem__iColorNum--;
    ...
    usColor = Get16BPPColor(
      FROMRGB(
        GlowColorsA[GlowItem__iColorNum].ubRed,
        GlowColorsA[GlowItem__iColorNum].ubGreen,
        GlowColorsA[GlowItem__iColorNum].ubBlue,
      ),
    );
    pDestBuf = LockVideoSurface(
      FRAME_BUFFER,
  ...
  function GlowTrashCan(): void {
    ...
    usColor = Get16BPPColor(
      FROMRGB(
        GlowColorsA[GlowTrashCan__iColorNum].ubRed,
        GlowColorsA[GlowTrashCan__iColorNum].ubGreen,
        GlowColorsA[GlowTrashCan__iColorNum].ubBlue,
      ),
    );
    pDestBuf = LockVideoSurface(
      FRAME_BUFFER,
    ...
    RectangleDraw(
      ...
      TRASH_CAN_X,
      TRASH_CAN_Y,
      TRASH_CAN_X + TRASH_CAN_WIDTH,
      TRASH_CAN_Y + TRASH_CAN_HEIGHT,
      usColor,
      pDestBuf,
    );
    InvalidateRegion(
  ...
  export function DrawFace(sCharNumber: INT16): void {
    ...
    if (
      gCharactersList[bSelectedInfoChar].usSolID == DrawFace__sOldId &&
      fReDrawFace == false
    ) {
      // are the same, return
      return;
  ...
  function RenderIconsForUpperLeftCornerPiece(bCharNumber: INT8): void {
    ...
    if (
      Menptr[gCharactersList[bCharNumber].usSolID].ubWhatKindOfMercAmI ==
      Enum260.MERC_TYPE__AIM_MERC
    ) {
  ...
  function DrawCharStats(sCharNum: INT16): void {
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeStrengthTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeDexterityTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeAgilityTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeWisdomTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeLeadershipTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeLevelTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeMarksmanshipTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeExplosivesTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeMechanicalTime &&
    ...
    if (
      GetJA2Clock() <
        CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeMedicalTime &&
  ...
  function DrawCharHealth(sCharNum: INT16): void {
    ...
    if (pSoldier.bAssignment != Enum117.ASSIGNMENT_POW) {
      ...
      if (pSoldier.bLifeMax > 0) {
        uiHealthPercent = Math.trunc(
          (pSoldier.bLife * 100) / pSoldier.bLifeMax,
        );
      }
      ...
      if (
        GetJA2Clock() <
          CHANGE_STAT_RECENTLY_DURATION + pSoldier.uiChangeHealthTime &&
  ...
  function DrawCharacterInfo(sCharNumber: INT16): void {
    ...
    if (pSoldier.uiStatusFlags & SOLDIER_VEHICLE) {
      // vehicle
      sString =
        pShortVehicleStrings[pVehicleList[pSoldier.bVehicleID].ubVehicleType];
    } else {
      // soldier
    ...
    if (pSoldier.uiStatusFlags & SOLDIER_VEHICLE) {
      // vehicle
      sString =
        pVehicleStrings[pVehicleList[pSoldier.bVehicleID].ubVehicleType];
    } else {
      // soldier
    ...
    if (pSoldier.bAssignment == Enum117.VEHICLE) {
      // show vehicle type
      sString =
        pShortVehicleStrings[pVehicleList[pSoldier.iVehicleId].ubVehicleType];
    } else {
    ...
    if (
      pSoldier.bAssignment == Enum117.TRAIN_SELF ||
      pSoldier.bAssignment == Enum117.TRAIN_TEAMMATE ||
      pSoldier.bAssignment == Enum117.TRAIN_BY_OTHER
    ) {
    ...
    // train town?
      ...
      sString =
        pTownNames[GetTownIdForSector(pSoldier.sSectorX, pSoldier.sSectorY)];
    }
    // repairing?
    ...
    */
        // vehicle
        sString =
          pShortVehicleStrings[
            pVehicleList[pSoldier.bVehicleUnderRepairID].ubVehicleType
          ];
      } else {
        // items
    ...
    // in transit?
      ...
      // show ETA
      sString = ConvertMinTimeToETADayHourMinString(
        pSoldier.uiTimeSoldierWillArrive,
      );
    }
    // traveling ?
      ...
      uiArrivalTime =
        GetWorldTotalMin() +
        CalculateTravelTimeOfGroupId(GetSoldierGroupId(pSoldier));
    ...
    // what kind of merc
      ...
      if (iTimeRemaining >= 24 * 60) {
        ...
        sString = swprintf(
          "%s%s/%d%s",
          dTimeLeft.toFixed(1),
          gpStrategicString[Enum365.STR_PB_DAYS_ABBREVIATION],
        ...
        sString = swprintf(
          "%d%s/%d%s",
          iTimeRemaining,
          gpStrategicString[Enum365.STR_PB_HOURS_ABBREVIATION],
          pSoldier.iTotalContractLength,
          gpStrategicString[Enum365.STR_PB_DAYS_ABBREVIATION],
        );
      }
    } else if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__MERC) {
      let iBeenHiredFor: INT32 =
        Math.trunc(GetWorldTotalMin() / NUM_MIN_IN_DAY) -
        pSoldier.iStartContractTime;
    ...
    // center and draw
    ({ sX: usX, sY: usY } = FindFontCenterCoordinates(
      CHAR_TIME_REMAINING_X,
      CHAR_TIME_REMAINING_Y,
      CHAR_TIME_REMAINING_WID,
      CHAR_TIME_REMAINING_HEI(),
      sString,
      CHAR_FONT(),
    ));
    DrawString(sString, usX, usY, CHAR_FONT());
    ...
    if (pSoldier.ubWhatKindOfMercAmI == Enum260.MERC_TYPE__AIM_MERC) {
      ...
      if (pSoldier.bTypeOfLastContract == Enum161.CONTRACT_EXTEND_2_WEEK) {
        iDailyCost = Math.trunc(
          gMercProfiles[pSoldier.ubProfile].uiBiWeeklySalary / 14,
        );
      }
      if (pSoldier.bTypeOfLastContract == Enum161.CONTRACT_EXTEND_1_WEEK) {
        iDailyCost = Math.trunc(
          gMercProfiles[pSoldier.ubProfile].uiWeeklySalary / 7,
        );
      } else {
  ...
  */
    ...
    if (pSoldier.bAssignment != Enum117.ASSIGNMENT_POW) {
      if (pSoldier.bLife != 0) {
        sString = GetMoraleString(
          MercPtrs[gCharactersList[sCharNumber].usSolID],
        );
      } else {
        sString = "";
      }
  ...
  function CharacterIsInTransitAndHasItemPickedUp(
    bCharacterNumber: INT8,
  ): boolean {
    // valid character?
    ...
    if (
      Menptr[gCharactersList[bCharacterNumber].usSolID].bAssignment !=
      Enum117.IN_TRANSIT
    ) {
      // nope
      return false;
  ...
  export function GetPathTravelTimeDuringPlotting(pPath: PathSt | null): INT32 {
    ...
    if (fPlotForHelicopter == false) {
      ...
      if (
        Menptr[gCharactersList[bSelectedDestChar].usSolID].bAssignment ==
        Enum117.VEHICLE
      ) {
        ubGroupId =
          pVehicleList[
            Menptr[gCharactersList[bSelectedDestChar].usSolID].iVehicleId
          ].ubMovementGroup;
        ...
        Menptr[gCharactersList[bSelectedDestChar].usSolID].uiStatusFlags &
        SOLDIER_VEHICLE
      ) {
        ubGroupId =
          pVehicleList[
            Menptr[gCharactersList[bSelectedDestChar].usSolID].bVehicleID
          ].ubMovementGroup;
        pGroup = GetGroup(ubGroupId);
  ...
  /* static */ let HighLightAssignLine__uiOldHighlight: INT32 =
  ...
  function HighLightAssignLine(): void {
    ...
    if (
      HighLightAssignLine__iColorNum == 0 ||
      HighLightAssignLine__iColorNum == 10
    ) {
      HighLightAssignLine__fDelta = !HighLightAssignLine__fDelta;
    }
    if (!HighLightAssignLine__fDelta) HighLightAssignLine__iColorNum++;
    else HighLightAssignLine__iColorNum--;

    // usY=Y_START+(giHighLine*GetFontHeight((MAP_SCREEN_FONT)));
    usY =
      Y_OFFSET * giAssignHighLine - 1 + (Y_START + giAssignHighLine * Y_SIZE());
    ...
    for (usCount = 0; usCount < MAX_CHARACTER_COUNT; usCount++) {
      if (IsCharacterSelectedForAssignment(usCount) == true) {
        ...
        usColor = Get16BPPColor(
          FROMRGB(
            GlowColorsA[HighLightAssignLine__iColorNum].ubRed,
            GlowColorsA[HighLightAssignLine__iColorNum].ubGreen,
            GlowColorsA[HighLightAssignLine__iColorNum].ubBlue,
          ),
        );
        ...
        if (
          usCount == 0 ||
          (usCount != 0 ? !IsCharacterSelectedForAssignment(usCount - 1) : 0) ||
        ...
        if (
          ...
          (usCount != MAX_CHARACTER_COUNT - 1
            ? !IsCharacterSelectedForAssignment(usCount + 1)
            : 0) ||
  ...
  /* static */ let HighLightDestLine__uiOldHighlight: INT32 =
    MAX_CHARACTER_COUNT + 1;
  function HighLightDestLine(): void {
    ...
    if (
      HighLightDestLine__iColorNum == 0 ||
      HighLightDestLine__iColorNum == 10
    ) {
      HighLightDestLine__fDelta = !HighLightDestLine__fDelta;
    }
    if (!HighLightDestLine__fDelta) HighLightDestLine__iColorNum++;
    else HighLightDestLine__iColorNum--;
    ...
    for (usCount = 0; usCount < MAX_CHARACTER_COUNT; usCount++) {
      if (CharacterIsGettingPathPlotted(usCount) == true) {
        ...
        usColor = Get16BPPColor(
          FROMRGB(
            GlowColorsA[HighLightDestLine__iColorNum].ubRed,
            GlowColorsA[HighLightDestLine__iColorNum].ubGreen,
            GlowColorsA[HighLightDestLine__iColorNum].ubBlue,
          ),
        );

        if (
          usCount == 0 ||
          (usCount != 0 ? !CharacterIsGettingPathPlotted(usCount - 1) : 0) ||
          usCount == FIRST_VEHICLE
        ) {
          LineDraw(
            true,
        ...
        if (
          usCount == MAX_CHARACTER_COUNT - 1 ||
          (usCount != MAX_CHARACTER_COUNT - 1
            ? !CharacterIsGettingPathPlotted(usCount + 1)
            : 0) ||
          usCount == FIRST_VEHICLE - 1
        ) {
          LineDraw(
  ...
  /* static */ let HighLightSleepLine__uiOldHighlight: INT32 =
    MAX_CHARACTER_COUNT + 1;
  function HighLightSleepLine(): void {
    ...
    if (
      HighLightSleepLine__iColorNum == 0 ||
      HighLightSleepLine__iColorNum == 10
    ) {
      HighLightSleepLine__fDelta = !HighLightSleepLine__fDelta;
    }
    if (!HighLightSleepLine__fDelta) HighLightSleepLine__iColorNum++;
    else HighLightSleepLine__iColorNum--;
    ...
    for (usCount = 0; usCount < MAX_CHARACTER_COUNT; usCount++) {
      if (IsCharacterSelectedForSleep(usCount) == true) {
        ...
        usColor = Get16BPPColor(
          FROMRGB(
            GlowColorsA[HighLightSleepLine__iColorNum].ubRed,
            GlowColorsA[HighLightSleepLine__iColorNum].ubGreen,
            GlowColorsA[HighLightSleepLine__iColorNum].ubBlue,
          ),
        );

        if (
          usCount == 0 ||
          (usCount != 0 ? !IsCharacterSelectedForSleep(usCount - 1) : 0) ||
          usCount == FIRST_VEHICLE
        ) {
        ...
        if (
          usCount == MAX_CHARACTER_COUNT - 1 ||
          (usCount != MAX_CHARACTER_COUNT - 1
            ? !IsCharacterSelectedForSleep(usCount + 1)
            : 0) ||
          usCount == FIRST_VEHICLE - 1
        ) {
          LineDraw(
...
*/
  ...
  function DisplayCharacterList(): void {
    ...
    for (sCount = 0; sCount < MAX_CHARACTER_COUNT; sCount++) {
      ...
      if (gCharactersList[sCount].fValid == true) {
        ...
        DrawName(
          Menptr[gCharactersList[sCount].usSolID].name,
          sCount,
          MAP_SCREEN_FONT(),
        );
  ...
  export function MapScreenInit(): boolean {
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\group_confirm_tactical.sti",
    );
  ...
  export function MapScreenHandle(): UINT32 {
    ...
    if (!fInMapMode) {
      ...
      if (
        gsMercArriveSectorX < 1 ||
        gsMercArriveSectorY < 1 ||
        gsMercArriveSectorX > 16 ||
      ...
      if (
        giTimeCompressMode >= Enum130.TIME_COMPRESS_5MINS &&
      ...
      CHECKF(AddVideoSurface( &vs_desc, &guiCHARLIST ));*/
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\map_inv_2nd_gun_cover.sti",
        );
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\top_left_corner_icons.sti",
        );
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\merc_between_sector_icons.sti",
        );
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\merc_mvt_green_arrows.sti",
        );
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\secondary_gun_hidden.sti",
        );
        ...
        VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
        VObjectDesc.ImageFile = FilenameForBPP(
          "INTERFACE\\selectedchararrow.sti",
        );
      ...
      MSYS_DefineRegion(
        ...
        MSYS_PRIORITY_HIGH,
        MSYS_NO_CURSOR,
        ItemRegionMvtCallback,
        ItemRegionBtnCallback,
      );
      MSYS_DefineRegion(
        gCharInfoFaceRegion,
        PLAYER_INFO_FACE_START_X,
        PLAYER_INFO_FACE_START_Y,
        PLAYER_INFO_FACE_END_X,
        PLAYER_INFO_FACE_END_Y,
        MSYS_PRIORITY_HIGH,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
        FaceRegionBtnCallback,
      );
      ...
      MSYS_DefineRegion(
        ...
        INV_REGION_X,
        INV_REGION_Y,
        INV_REGION_X + INV_REGION_WIDTH,
        INV_REGION_Y + INV_REGION_HEIGHT,
        MSYS_PRIORITY_HIGH,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
        InvmaskRegionBtnCallBack,
      );
      // screen mask for animated cursors
      MSYS_DefineRegion(
        gMapScreenMaskRegion,
        0,
        0,
        640,
        480,
        ...
        MSYS_NO_CALLBACK,
        MapScreenMarkRegionBtnCallback,
      );
      ...
      giMapContractButtonImage = LoadButtonImage(
        "INTERFACE\\contractbutton.sti",
        -1,
        0,
        -1,
        1,
  ...
  */
  ...
  function DrawAssignment(
    ...
    sString = GetMapscreenMercAssignmentString(
      MercPtrs[gCharactersList[sCharNumber].usSolID],
    );
    ...
    if (fFlashAssignDone == true) {
      if (
        Menptr[gCharactersList[sCharNumber].usSolID]
  ...
  function DrawLocation(
    ...
    sString = GetMapscreenMercLocationString(
      MercPtrs[gCharactersList[sCharNumber].usSolID],
    );
  ...
  function DrawDestination(
    ...
    sString = GetMapscreenMercDestinationString(
      MercPtrs[gCharactersList[sCharNumber].usSolID],
    );
  ...
  function DrawTimeRemaining(
    ...
    sString = GetMapscreenMercDepartureString(
      MercPtrs[gCharactersList[sCharNumber].usSolID],
      createPointer(
        () => ubFontColor,
        (v) => (ubFontColor = v),
    ...
    if (sCharNumber < FIRST_VEHICLE) {
      ({ sX: usX, sY: usY } = FindFontCenterCoordinates(
        TIME_REMAINING_X + 1,
        Y_START + sCharNumber * Y_SIZE(),
        TIME_REMAINING_WIDTH,
        Y_SIZE(),
        sString,
        iFont,
      ));
  ...
  /* static */ let RenderMapCursorsIndexesAnims__sPrevHighlightedMapX: INT16 =
    -1;
  /* static */ let RenderMapCursorsIndexesAnims__sPrevHighlightedMapY: INT16 =
    -1;
  ...
  /* static */ let RenderMapCursorsIndexesAnims__fFlashCursorIsYellow: boolean =
    false;
  function RenderMapCursorsIndexesAnims(): void {
    ...
    if (gfBlitBattleSectorLocator) {
      HandleBlitOfSectorLocatorIcon(
        gubPBSectorX,
        gubPBSectorY,
        gubPBSectorZ,
        Enum156.LOCATOR_COLOR_RED,
      );
    }
    ...
    if (
      fDrawCursors &&
      GetMouseMapXY(gsHighlightSectorX__Pointer, gsHighlightSectorY__Pointer)
    ) {
      ...
      if (
        gsHighlightSectorX !=
          RenderMapCursorsIndexesAnims__sPrevHighlightedMapX ||
        gsHighlightSectorY !=
          RenderMapCursorsIndexesAnims__sPrevHighlightedMapY ||
        gfMapPanelWasRedrawn
      ) {
        if (
          RenderMapCursorsIndexesAnims__sPrevHighlightedMapX != -1 &&
          RenderMapCursorsIndexesAnims__sPrevHighlightedMapY != -1
        ) {
          RestoreMapSectorCursor(
            RenderMapCursorsIndexesAnims__sPrevHighlightedMapX,
            RenderMapCursorsIndexesAnims__sPrevHighlightedMapY,
          );
        }
    ...
    if (
      ...
      if (gsHighlightSectorX == sSelMapX && gsHighlightSectorY == sSelMapY) {
        ...
        if (uiDeltaTime > 300) {
          ...
          RenderMapCursorsIndexesAnims__fFlashCursorIsYellow =
            !RenderMapCursorsIndexesAnims__fFlashCursorIsYellow;
      ...
      if (
        ...
        RestoreMapSectorCursor(
          RenderMapCursorsIndexesAnims__sPrevSelectedMapX,
          RenderMapCursorsIndexesAnims__sPrevSelectedMapY,
        );
        fHighlightChanged = true;
      }
  ...
  function HandleMapUI(): UINT32 {
    ...
    let sMapX: INT16 = 0;
    let sMapX__Pointer = createPointer(
      () => sMapX,
      (v) => (sMapX = v),
    );
    let sMapY: INT16 = 0;
    let sMapY__Pointer = createPointer(
      () => sMapY,
      (v) => (sMapY = v),
    );
    let bMapZ: INT8 = 0;
    ...
    switch (uiNewEvent) {
      ...
      */
        ...
        */
          ...
          if (
            IsTheCursorAllowedToHighLightThisSector(sMapX, sMapY) == true &&
            SectorInfo[SECTOR(sMapX, sMapY)].ubTraversability[
            ...
            if (GetLengthOfPath(pTempCharacterPath) > 0) {
              ...
              CopyPathToAllSelectedCharacters(
                GetSoldierMercPathPtr(
                  MercPtrs[gCharactersList[bSelectedDestChar].usSolID],
                ),
              );
        ...
        */
          ...
          if (gfInChangeArrivalSectorMode) {
            if (
              ...
              if (
                StrategicMap[CALCULATE_STRATEGIC_INDEX(sMapX, sMapY)]
          ...
          if (
            ...
            sMapX == gubPBSectorX &&
            sMapY == gubPBSectorY &&
            iCurrentMapSectorZ == gubPBSectorZ
          ) {
          ...
          if (fShowAircraftFlag == true) {
            ...
            if (fWasAlreadySelected) {
              ...
              if (
                AnyMovableCharsInOrBetweenThisSector(
                  sMapX,
                  sMapY,
                  iCurrentMapSectorZ,
                )
              ...
              if (CHEATER_CHEAT_LEVEL()) {
                if ((gfAutoAmbush = !gfAutoAmbush))
                  ScreenMsg(
                    FONT_WHITE,
                    MSG_TESTVERSION,
                    "Enemy ambush test mode enabled.",
                  );
                else
                  ScreenMsg(
                    FONT_WHITE,
                    MSG_TESTVERSION,
                    "Enemy ambush test mode disabled.",
                  );
              }
            } else {
              ...
              if (CHEATER_CHEAT_LEVEL()) {
                if ((gfAutoAIAware = !gfAutoAIAware))
                  ScreenMsg(
                    FONT_WHITE,
                    MSG_TESTVERSION,
                    "Strategic AI awareness maxed.",
                  );
                else
                  ScreenMsg(
                    FONT_WHITE,
                    MSG_TESTVERSION,
                    "Strategic AI awareness normal.",
                  );
              }
  ...
  */
    ...
    if (!gfDontStartTransitionFromLaptop) {
      ...
      PlayJA2SampleFromFile(
        "SOUNDS\\Initial Power Up (8-11).wav",
        RATE_11025,
        HIGHVOLUME,
        1,
        MIDDLEPAN,
  ...
  export function GetMouseMapXY(
    psMapWorldX: Pointer<INT16>,
    psMapWorldY: Pointer<INT16>,
  ): boolean {
    let MousePos: POINT = createPoint();
  ...
  function GetMapXY(
    ...
    if (
      sMapX > MAP_VIEW_WIDTH + MAP_GRID_X - 1 ||
  ...
  */
    ...
    if (
      IsTheCursorAllowedToHighLightThisSector(sMapX, sMapY) == false &&
      fZoomFlag == false
    ) {
      return;
    }
  ...
  */
  ...
  /* static */ let PollLeftButtonInMapView__fLBBeenPressedInMapView: boolean =
    false;
  function PollLeftButtonInMapView(uiNewEvent: UINT32): UINT32 {
    ...
    if (gMapViewRegion.uiFlags & MSYS_MOUSE_IN_AREA) {
      ...
      } // L-button is NOT down at the moment
      else {
        if (PollLeftButtonInMapView__fLBBeenPressedInMapView) {
          ...
          if (giUIMessageOverlay != -1 && !gfInConfirmMapMoveMode) {
            ...
            if (!gfInChangeArrivalSectorMode) return uiNewEvent;
          }
  ...
  /* static */ let PollRightButtonInMapView__fRBBeenPressedInMapView: boolean =
    false;
  function PollRightButtonInMapView(uiNewEvent: UINT32): UINT32 {
    ...
    if (gMapViewRegion.uiFlags & MSYS_MOUSE_IN_AREA) {
      ...
      } // R-button is NOT down at the moment
      else {
        if (PollRightButtonInMapView__fRBBeenPressedInMapView) {
...
*/
  ...
  /* static */ let CreateDestroyMapInvButton__fOldShowInventoryFlag: boolean =
    false;
  export function CreateDestroyMapInvButton(): void {
    if (
      fShowInventoryFlag &&
      !CreateDestroyMapInvButton__fOldShowInventoryFlag
    ) {
      ...
      InitInvSlotInterface(
        ...
        MAPInvMoveCallback,
        MAPInvClickCallback,
        MAPInvMoveCamoCallback,
        MAPInvClickCamoCallback,
        false,
      );
  ...
  function BltCharInvPanel(): void {
    ...
    sString = swprintf(
      "%s",
      CalculateCarriedWeight(pSoldier).toString().padStart(3),
    );
    ({ sX: usX, sY: usY } = FindFontRightCoordinates(
      MAP_WEIGHT_X,
      MAP_WEIGHT_Y,
  ...
  function HandleCursorOverRifleAmmo(): void {
    ...
    if (gfCheckForMouseOverItem) {
      if (
        HandleCompatibleAmmoUI(
          Menptr[gCharactersList[bSelectedInfoChar].usSolID],
          gbCheckForMouseOverItemPos,
          true,
        )
      ) {
  ...
  function MAPInvClickCamoCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {}

  function MAPInvMoveCamoCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {}
  ...
  function MAPInvMoveCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    pSoldier = <SOLDIERTYPE>(
      GetSoldier(gCharactersList[bSelectedInfoChar].usSolID)
    );
  ...
  export function MAPInternalInitItemDescriptionBox(
    pObject: OBJECTTYPE,
    ubStatusIndex: UINT8,
    pSoldier: SOLDIERTYPE,
  ): boolean {
    ...
    fRet = InternalInitItemDescriptionBox(
      pObject,
      MAP_ITEMDESC_START_X,
      MAP_ITEMDESC_START_Y,
      ubStatusIndex,
      pSoldier,
    );
  ...
  function MAPInvClickCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (gpItemPointer == null) {
        ...
        if (
          ContinuePastBoobyTrapInMapScreen(gpItemPointer, pSoldier) == false
        ) {
          return;
        }
        ...
        if (
          uiHandPos == Enum261.HANDPOS ||
          uiHandPos == Enum261.SECONDHANDPOS ||
          uiHandPos == Enum261.HELMETPOS ||
          uiHandPos == Enum261.VESTPOS ||
          uiHandPos == Enum261.LEGPOS
        ) {
      ...
      MAPInvClickCallback__fRightDown
    ) {
      ...
      if (
        pSoldier.inv[uiHandPos].ubNumberOfObjects > 1 &&
        ItemSlotLimit(pSoldier.inv[uiHandPos].usItem, uiHandPos) > 0
      ) {
        if (!InItemStackPopup()) {
  ...
  export function MAPEndItemPointer(): void {
    if (gpItemPointer != null) {
      ...
      if (fShowInventoryFlag && bSelectedInfoChar >= 0) {
        ReevaluateItemHatches(
          MercPtrs[gCharactersList[bSelectedInfoChar].usSolID],
          false,
        );
      }
    }
  ...
  function RenderAttributeStringsForUpperLeftHandCorner(
    uiBufferToRenderTo: UINT32,
  ): void {
    let iCounter: INT32 = 0;
    let pSoldier: SOLDIERTYPE | null = null;
    ...
    DrawString(
      ...
      Math.trunc(
        220 - StringPixLength(pUpperLeftMapScreenStrings[0], CHAR_FONT()) / 2,
      ),
      6,
      CHAR_FONT(),
    );
    ...
    if (
      ...
      for (iCounter = 0; iCounter < 5; iCounter++) {
        DrawString(
          pShortAttributeStrings[iCounter],
          88,
          22 + iCounter * 10,
          CHAR_FONT(),
        );
        DrawString(
          pShortAttributeStrings[iCounter + 5],
          133,
          22 + iCounter * 10,
          CHAR_FONT(),
        );
  ...
  /* static */ let DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface__bOldDestChar: INT8 =
    -1;
  ...
  function DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface(
    sMapX: INT16,
    sMapY: INT16,
  ): void {
    ...
    if (
      DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface__bOldDestChar !=
      bSelectedDestChar
    ) {
      DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface__bOldDestChar =
        bSelectedDestChar;
      ...
      DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface__sPrevMapX =
        sMapX;
      DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface__sPrevMapY =
        sMapY;
  ...
  /* static */ let CheckToSeeIfMouseHasLeftMapRegionDuringPathPlotting__fInArea: boolean =
    false;
  ...
  function CreateMouseRegionsForTeamList(): void {
    ...
    for (sCounter = 0; sCounter < MAX_CHARACTER_COUNT; sCounter++) {
      ...
      // name region
      MSYS_DefineRegion(
        gTeamListNameRegion[sCounter],
        NAME_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        NAME_X + NAME_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        TeamListInfoRegionMvtCallBack,
        TeamListInfoRegionBtnCallBack,
      );

      // assignment region
      MSYS_DefineRegion(
        gTeamListAssignmentRegion[sCounter],
        ASSIGN_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        ASSIGN_X + ASSIGN_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
        MSYS_PRIORITY_NORMAL + 1,
        MSYS_NO_CURSOR,
        TeamListAssignmentRegionMvtCallBack,
        TeamListAssignmentRegionBtnCallBack,
      );

      // location region (same function as name regions, so uses the same callbacks)
      MSYS_DefineRegion(
        gTeamListLocationRegion[sCounter],
        LOC_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        LOC_X + LOC_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
      ...
      // destination region
      MSYS_DefineRegion(
        gTeamListDestinationRegion[sCounter],
        DEST_ETA_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        DEST_ETA_X + DEST_ETA_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
        MSYS_PRIORITY_NORMAL + 1,
        MSYS_NO_CURSOR,
        TeamListDestinationRegionMvtCallBack,
        TeamListDestinationRegionBtnCallBack,
      );

      // contract region
      MSYS_DefineRegion(
        gTeamListContractRegion[sCounter],
        TIME_REMAINING_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        TIME_REMAINING_X + TIME_REMAINING_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
        MSYS_PRIORITY_NORMAL + 1,
        MSYS_NO_CURSOR,
        TeamListContractRegionMvtCallBack,
        TeamListContractRegionBtnCallBack,
      );

      // contract region
      MSYS_DefineRegion(
        gTeamListSleepRegion[sCounter],
        SLEEP_X,
        Y_START + sCounter * (Y_SIZE() + 2) + sYAdd,
        SLEEP_X + SLEEP_WIDTH,
        145 + (sCounter + 1) * (Y_SIZE() + 2) + sYAdd,
        MSYS_PRIORITY_NORMAL + 1,
        MSYS_NO_CURSOR,
        TeamListSleepRegionMvtCallBack,
      ...
      SetRegionFastHelpText(
        gTeamListSleepRegion[sCounter],
        pMapScreenMouseRegionHelpText[5],
      );
      SetRegionFastHelpText(
        gTeamListLocationRegion[sCounter],
        pMapScreenMouseRegionHelpText[0],
      ...
      SetRegionFastHelpText(
        gTeamListContractRegion[sCounter],
        pMapScreenMouseRegionHelpText[3],
      );
    }
  ...
  function MapScreenMarkRegionBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  function TeamListInfoRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
  ...
  function TeamListInfoRegionMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
  ...
  function TeamListAssignmentRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (gCharactersList[iValue].fValid == true) {
        ...
        ChangeSelectedInfoChar(
          iValue,
          IsEntryInSelectedListSet(iValue) == false,
        );
  ...
  function TeamListAssignmentRegionMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
    ...
    if (iReason & MSYS_CALLBACK_REASON_MOVE) {
      if (gCharactersList[iValue].fValid == true) {
        ...
        if (
          !(
            Menptr[gCharactersList[iValue].usSolID].uiStatusFlags &
            SOLDIER_VEHICLE
          )
        ) {
          giAssignHighLine = iValue;
      ...
      if (
        gCharactersList[iValue].fValid == true &&
        !(
          Menptr[gCharactersList[iValue].usSolID].uiStatusFlags &
          SOLDIER_VEHICLE
        )
  ...
  function TeamListDestinationRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (gCharactersList[iValue].fValid == true) {
        ...
        DeselectSelectedListMercsWhoCantMoveWithThisGuy(
          Menptr[gCharactersList[iValue].usSolID],
        );
        ...
        if (CanChangeDestinationForCharSlot(iValue, true)) {
          ...
          if (
            Menptr[gCharactersList[iValue].usSolID].bAssignment ==
            Enum117.VEHICLE
          ) {
            // if he's in the helicopter
            if (
              Menptr[gCharactersList[iValue].usSolID].iVehicleId ==
          ...
          // set cursor
          SetUpCursorForStrategicMap();
        } // problem - this guy can't move
        else {
          // cancel destination highlight
          giDestHighLine = -1;
        }
      } // empty char list slot
      else {
        // reset selected characters
        ResetAllSelectedCharacterModes();
      }
  ...
  function TeamListDestinationRegionMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = -1;
  ...
  function TeamListSleepRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
  ...
  function TeamListSleepRegionMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = -1;
  ...
  function TeamListContractRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = 0;
  ...
  function TeamListContractRegionMvtCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let iValue: INT32 = -1;
  ...
  function PlotTemporaryPaths(): void {
    ...
    if (GetMouseMapXY(sMapX__Pointer, sMapY__Pointer)) {
      ...
      */
        ...
        DisplayThePotentialPathForCurrentDestinationCharacterForMapScreenInterface(
          sMapX,
          sMapY,
        );
  ...
  function ContractRegionBtnCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let pSoldier: SOLDIERTYPE;
  ...
  function ContractRegionMvtCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function HandleChangeOfInfoChar(): void {
    if (bSelectedInfoChar != HandleChangeOfInfoChar__bOldInfoChar) {
      ...
      if (HandleChangeOfInfoChar__bOldInfoChar != -1) {
        if (
          gCharactersList[HandleChangeOfInfoChar__bOldInfoChar].fValid == true
        ) {
          // set face in active
          SetAutoFaceInActiveFromSoldier(
            Menptr[
              gCharactersList[HandleChangeOfInfoChar__bOldInfoChar].usSolID
            ].ubID,
          );
        }
      }
  ...
  function EnableDisableTeamListRegionsAndHelpText(): void {
    ...
    for (bCharNum = 0; bCharNum < MAX_CHARACTER_COUNT; bCharNum++) {
      if (gCharactersList[bCharNum].fValid == false) {
        ...
        if (
          Menptr[gCharactersList[bCharNum].usSolID].uiStatusFlags &
          SOLDIER_VEHICLE
        ) {
          ...
          // POW or dead ?
          if (
            Menptr[gCharactersList[bCharNum].usSolID].bAssignment ==
              Enum117.ASSIGNMENT_POW ||
            Menptr[gCharactersList[bCharNum].usSolID].bLife == 0
          ) {
            // "Remove Merc"
            SetRegionFastHelpText(
              gTeamListAssignmentRegion[bCharNum],
              pRemoveMercStrings[0],
            );
            ...
            // "Plot Travel Route"
            SetRegionFastHelpText(
              gTeamListDestinationRegion[bCharNum],
              pMapScreenMouseRegionHelpText[2],
            );
          }
        }
    ...
    if (fPlotForHelicopter == true) {
      ...
      if (
        ...
        if (
          ...
          ppMovePath =
            Menptr[gCharactersList[bSelectedDestChar].usSolID].pMercPath;
        }
    ...
    for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
      if (gCharactersList[iCounter].fValid == true) {
        if (Menptr[gCharactersList[iCounter].usSolID].bLife >= OKLIFE) {
          if (fShowMapInventoryPool) {
            if (
              Menptr[gCharactersList[iCounter].usSolID].sSectorX == sSelMapX &&
            ...
            if (fShowInventoryFlag && gMPanelRegion.Cursor == EXTERN_CURSOR) {
              if (bSelectedInfoChar != -1) {
                if (gCharactersList[bSelectedInfoChar].fValid == true) {
                  if (
                    Menptr[gCharactersList[iCounter].usSolID].sSectorX ==
                      Menptr[gCharactersList[bSelectedInfoChar].usSolID]
                        .sSectorX &&
...
*/
  ...
  function CreateDestroyTrashCanRegion(): void {
    if (fShowInventoryFlag && CreateDestroyTrashCanRegion__fCreated == false) {
      ...
      MSYS_DefineRegion(
        ...
        MSYS_NO_CURSOR,
        TrashCanMoveCallback,
        TrashCanBtnCallback,
      );

      // done inventory button define
      giMapInvButtonDoneImage = LoadButtonImage(
        "INTERFACE\\done_button2.sti",
        -1,
        0,
        -1,
        1,
      ...
      giMapInvDoneButton = QuickCreateButton(
        giMapInvButtonDoneImage,
        INV_BTN_X,
        INV_BTN_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST - 1,
        BtnGenericMouseMoveButtonCallback,
        DoneInventoryMapBtnCallback,
      );
      ...
      SetRegionFastHelpText(
        gTrashCanRegion,
        pMiscMapScreenMouseRegionHelpText[1],
      );
  ...
  function InvmaskRegionBtnCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function StartConfirmMapMoveMode(sMapY: INT16): void {
    let ubPosition: UINT8 =
      sMapY < 8 ? MSG_MAP_UI_POSITION_LOWER : MSG_MAP_UI_POSITION_UPPER;
  ...
  function HandleContractTimeFlashForMercThatIsAboutLeave(): void {
    ...
    if (
      iCurrentTime - giFlashContractBaseTime >=
      DELAY_PER_FLASH_FOR_DEPARTING_PERSONNEL
    ) {
  ...
  function AnyMercsLeavingRealSoon(): boolean {
    ...
    for (uiCounter = 0; uiCounter < MAX_CHARACTER_COUNT; uiCounter++) {
      if (gCharactersList[uiCounter].fValid == true) {
        if (
          Menptr[gCharactersList[uiCounter].usSolID].iEndofContractTime -
            uiTimeInMin <=
  ...
  function CharacterIsInLoadedSectorAndWantsToMoveInventoryButIsNotAllowed(
    bCharId: INT8,
  ): boolean {
    ...
    if (
      Menptr[usSoldierId].sSectorX != gWorldSectorX ||
  ...
  */
      ...
      if (
        ...
        CharacterIsInLoadedSectorAndWantsToMoveInventoryButIsNotAllowed(
          bSelectedInfoChar,
        ) ||
  ...
  /* static */ let CreateDestroyMapCharacterScrollButtons__fCreated: boolean =
    false;
  function CreateDestroyMapCharacterScrollButtons(): void {
    if (
      ...
      giCharInfoButtonImage[0] = LoadButtonImage(
      ...
      giCharInfoButton[0] = QuickCreateButton(
        ...
        MSYS_PRIORITY_HIGHEST - 5,
        BtnGenericMouseMoveButtonCallback,
        PrevInventoryMapBtnCallback,
      );
      // set the button image
      giCharInfoButtonImage[1] = LoadButtonImage(
        "INTERFACE\\map_screen_bottom_arrows.sti",
        12,
        5,
        -1,
      ...
      giCharInfoButton[1] = QuickCreateButton(
        ...
        MSYS_PRIORITY_HIGHEST - 5,
        BtnGenericMouseMoveButtonCallback,
        NextInventoryMapBtnCallback,
      );

      SetButtonFastHelpText(
        giCharInfoButton[0],
        pMapScreenPrevNextCharButtonHelpText[0],
      );
      SetButtonFastHelpText(
        giCharInfoButton[1],
        pMapScreenPrevNextCharButtonHelpText[1],
      );
  ...
  export function TellPlayerWhyHeCantCompressTime(): void {
    ...
    // KM:  Except if we are in a creature lair and haven't loaded the sector yet (no battle yet)
      ...
      if (OnlyHostileCivsInSector()) {
        ...
        pSectorString = GetSectorIDString(
          gWorldSectorX,
          gWorldSectorY,
          gbWorldSectorZ,
          true,
  ...
  function AddTeamPanelSortButtonsForMapScreen(): void {
    ...
    let iImageIndex: INT32[] /* [MAX_SORT_METHODS] */ = [0, 1, 5, 2, 3, 4]; // sleep image is out or order (last)

    filename = GetMLGFilename(Enum326.MLG_GOLDPIECEBUTTONS);

    for (iCounter = 0; iCounter < MAX_SORT_METHODS; iCounter++) {
      giMapSortButtonImage[iCounter] = LoadButtonImage(
        filename,
        -1,
        iImageIndex[iCounter],
        -1,
        iImageIndex[iCounter] + 6,
        -1,
      );
      ...
      giMapSortButton[iCounter] = QuickCreateButton(
        ...
        gMapSortButtons[iCounter].iX,
        gMapSortButtons[iCounter].iY,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST - 5,
        BtnGenericMouseMoveButtonCallback,
        MapSortBtnCallback,
      ...
      SetButtonFastHelpText(
        giMapSortButton[iCounter],
        wMapScreenSortButtonHelpText[iCounter],
      );
    }
    return;
  }
  ...
  function SortListOfMercsInTeamPanel(fRetainSelectedMercs: boolean): void {
    ...
    let pSelectedSoldier: (SOLDIERTYPE | null)[] /* [MAX_CHARACTER_COUNT] */ =
      createArray(MAX_CHARACTER_COUNT, null);
      ...
      switch (giSortStateForMapScreenList) {
        case 0:
          ...
          for (iCounterA = 0; iCounterA < FIRST_VEHICLE; iCounterA++) {
            ...
            if (
              Menptr[gCharactersList[iCounterA].usSolID].name.localeCompare(
                Menptr[gCharactersList[iCounter].usSolID].name,
              ) > 0 &&
              iCounterA < iCounter
            ) {
        ...
        case 1:
          ...
          for (iCounterA = 0; iCounterA < FIRST_VEHICLE; iCounterA++) {
            ...
            if (
              Menptr[gCharactersList[iCounterA].usSolID].bAssignment >
              ...
              if (
                ...
                if (
                  Menptr[gCharactersList[iCounterA].usSolID].iVehicleId >
        ...
        case 2:
          ...
          for (iCounterA = 0; iCounterA < FIRST_VEHICLE; iCounterA++) {
            ...
            if (
              Menptr[gCharactersList[iCounterA].usSolID].fMercAsleep == true &&
        ...
        case 4:
          ...
          if (
            GetLengthOfMercPath(MercPtrs[gCharactersList[iCounter].usSolID]) ==
            0
          ) {
            sEndSectorA = 9999;
          } else {
            sEndSectorA = GetLastSectorIdInCharactersPath(
          ...
          for (iCounterA = 0; iCounterA < FIRST_VEHICLE; iCounterA++) {
            ...
            if (
              GetLengthOfMercPath(
                MercPtrs[gCharactersList[iCounterA].usSolID],
              ) == 0
            ) {
              sEndSectorB = 9999;
            } else {
              sEndSectorB = GetLastSectorIdInCharactersPath(
                Menptr[gCharactersList[iCounterA].usSolID],
              );
            }
        ...
        case 5:
          iExpiryTime = GetContractExpiryTime(
            Menptr[gCharactersList[iCounter].usSolID],
          );
          ...
          for (iCounterA = 0; iCounterA < FIRST_VEHICLE; iCounterA++) {
            ...
            iExpiryTimeA = GetContractExpiryTime(
              Menptr[gCharactersList[iCounterA].usSolID],
            );
  ...
  function CheckForAndRenderNewMailOverlay(): void {
    if (fNewMailFlag) {
      if (GetJA2Clock() % 1000 < 667) {
        if (
          ButtonList[guiMapBottomExitButtons[Enum144.MAP_EXIT_TO_LAPTOP]]
  ...
  export function MapCharacterHasAccessibleInventory(
    bCharNumber: INT8,
  ): boolean {
    let pSoldier: SOLDIERTYPE;
  ...
  export function ChangeSelectedMapSector(
    sMapX: INT16,
    sMapY: INT16,
    bMapZ: INT8,
  ): void {
  ...
  function CanChangeDestinationForCharSlot(
    bCharNumber: INT8,
    ...
    if (
      CanEntireMovementGroupMercIsInMove(
        pSoldier,
        createPointer(
          () => bErrorNumber,
          (v) => (bErrorNumber = v),
  ...
  export function CanChangeSleepStatusForSoldier(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    // valid soldier?
    Assert(pSoldier);
  ...
  function ChangeMapScreenMaskCursor(usCursor: UINT16): void {
    ...
    if (usCursor == Enum317.CURSOR_CHECKMARK) fCheckCursorWasSet = true;
    else fCheckCursorWasSet = false;
  ...
  */
  ...
  export function ChangeSelectedInfoChar(
    bCharNumber: INT8,
    fResetSelectedList: boolean,
  ): void {
    ...
    if (bSelectedInfoChar != bCharNumber) {
      ...
      if (fShowInventoryFlag) {
        ...
        if (
          bCharNumber == -1 ||
          !MapCharacterHasAccessibleInventory(bCharNumber)
        ) {
    ...
    for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
      if (fSelectedListOfMercsForMapScreen[iCounter] == true) {
        ...
        if (GetSoldierMercPathPtr(pSoldier) != pPath) {
          if (pSoldier.uiStatusFlags & SOLDIER_VEHICLE) {
            pVehicleList[pSoldier.bVehicleID].pMercPath = CopyPaths(
              pPath,
              pVehicleList[pSoldier.bVehicleID].pMercPath,
            );
          } else if (pSoldier.bAssignment == Enum117.VEHICLE) {
            pVehicleList[pSoldier.iVehicleId].pMercPath = CopyPaths(
              pPath,
  ...
  export function CancelPathsOfAllSelectedCharacters(): void {
    ...
    for (bCounter = 0; bCounter < MAX_CHARACTER_COUNT; bCounter++) {
      ...
      if (
        gCharactersList[bCounter].fValid == true &&
        IsEntryInSelectedListSet(bCounter)
      ) {
  ...
  function ConvertMinTimeToETADayHourMinString(uiTimeInMin: UINT32): string {
    ...
    uiHour = Math.trunc(
      (uiTimeInMin - uiDay * NUM_MIN_IN_DAY) / NUM_MIN_IN_HOUR,
    );
  ...
  function AnyMovableCharsInOrBetweenThisSector(
    sSectorX: INT16,
    sSectorY: INT16,
    bSectorZ: INT8,
  ): boolean {
  ...
  function RequestGiveSkyriderNewDestination(): boolean {
    ...
    if (CanHelicopterFly() == true) {
      ...
      gpHelicopterPreviousMercPath = CopyPaths(
      ...
      return true;
    } // not allowed to reroute the chopper right now
    else {
      // tell player why not
      ExplainWhySkyriderCantFly();
  ...
  function HandleNewDestConfirmation(sMapX: INT16, sMapY: INT16): void {
    ...
    if (fPlotForHelicopter) {
      ...
      if (
        NumEnemiesInSector(sMapX, sMapY) == 0 ||
        WhatPlayerKnowsAboutEnemiesInSector(sMapX, sMapY) ==
  ...
  function RandomAwakeSelectedMercConfirmsStrategicMove(): void {
    ...
    if (ubNumMercs > 0) {
      ...
      DoMercBattleSound(
        MercPtrs[ubSelectedMercID[ubChosenMerc]],
        Random(2) ? Enum259.BATTLE_SOUND_OK1 : Enum259.BATTLE_SOUND_OK2,
      );
  ...
  function HandleMilitiaRedistributionClick(): void {
    ...
    if (iCurrentMapSectorZ == 0) {
      ...
      fTownStillHidden =
        (bTownId == Enum135.TIXA && !fFoundTixa) ||
        (bTownId == Enum135.ORTA && !fFoundOrta);

      if (bTownId != Enum135.BLANK_SECTOR && !fTownStillHidden) {
        if (
          MilitiaTrainingAllowedInSector(sSelMapX, sSelMapY, iCurrentMapSectorZ)
        ) {
          if (fShowTownInfo == true) {
            fShowTownInfo = false;
          }
        ...
        IsThisSectorASAMSector(sSelMapX, sSelMapY, 0) &&
  ...
  function CanMoveBullseyeAndClickedOnIt(sMapX: INT16, sMapY: INT16): boolean {
    ...
    if (
      ...
      if (gTacticalStatus.fDidGameJustStart == false) {
        ...
        if (
          sMapX == gsMercArriveSectorX &&
          sMapY == gsMercArriveSectorY &&
          iCurrentMapSectorZ == 0
        ) {
          return true;
        }
  ...
  function HandlePostAutoresolveMessages(): void {
    ...
    if (gsCiviliansEatenByMonsters >= 1) {
      AdjustLoyaltyForCivsEatenByMonsters(
        SECTORX(gsEnemyGainedControlOfSectorID),
        SECTORY(gsEnemyGainedControlOfSectorID),
        gsCiviliansEatenByMonsters,
      );
  ...
  export function GetMapscreenMercAssignmentString(
    pSoldier: SOLDIERTYPE,
  ): string {
    let sString: string;
  ...
  export function GetMapscreenMercLocationString(
    pSoldier: SOLDIERTYPE,
  ): string {
    let sString: string;
    ...
    if (pSoldier.bAssignment == Enum117.IN_TRANSIT) {
      ...
      if (pSoldier.bAssignment == Enum117.ASSIGNMENT_POW) {
        ...
        pTempString = swprintf(
          "%s%s%s",
          pMapVertIndex[pSoldier.sSectorY],
          pMapHortIndex[pSoldier.sSectorX],
          pMapDepthIndex[pSoldier.bSectorZ],
        );
  ...
  export function GetMapscreenMercDestinationString(
    pSoldier: SOLDIERTYPE,
  ): string {
    let sString: string;
    ...
    sString = swprintf(
      "%s%s",
      pMapVertIndex[iSectorY],
      pMapHortIndex[iSectorX],
    );

    return sString;
  }

  export function GetMapscreenMercDepartureString(
    pSoldier: SOLDIERTYPE,
    ubFontColor: Pointer<UINT8>,
  ): string {
    let sString: string;
    ...
    if (
      ...
      if (iMinsRemaining >= MAP_TIME_UNDER_THIS_DISPLAY_AS_HOURS) {
        ...
        if (
          iMinsRemaining <= MINS_TO_FLASH_CONTRACT_TIME &&
          fFlashContractFlag == true
        ) {
  ...
  export function RememberPreviousPathForAllSelectedChars(): void {
    ...
    for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
      if (fSelectedListOfMercsForMapScreen[iCounter] == true) {
        ...
        gpCharacterPreviousMercPath[iCounter] = CopyPaths(
          GetSoldierMercPathPtr(MercPtrs[gCharactersList[iCounter].usSolID]),
  ...
  function RestorePreviousPaths(): void {
    ...
    if (fPlotForHelicopter == true) {
      ppMovePath = createPropertyPointer(
        pVehicleList[iHelicopterVehicleId],
        "pMercPath",
      );
      ubGroupId = pVehicleList[iHelicopterVehicleId].ubMovementGroup;
      ...
      if (gpHelicopterPreviousMercPath != null) {
        gpHelicopterPreviousMercPath = MoveToBeginningOfPathList(
          gpHelicopterPreviousMercPath,
        );
        ...
        if (ppMovePath.value) {
          ...
          ppMovePath.value = ClearStrategicPathList(
            ppMovePath.value,
            ubGroupId,
          );
          // will need to rebuild waypoints
      ...
      for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
        ...
        if (fSelectedListOfMercsForMapScreen[iCounter] == true) {
          ...
          if (pSoldier.uiStatusFlags & SOLDIER_VEHICLE) {
            ppMovePath = createPropertyPointer(
              pVehicleList[pSoldier.bVehicleID],
              "pMercPath",
            );
            ubGroupId = pVehicleList[pSoldier.bVehicleID].ubMovementGroup;
          } else if (pSoldier.bAssignment == Enum117.VEHICLE) {
            ppMovePath = createPropertyPointer(
              pVehicleList[pSoldier.iVehicleId],
              "pMercPath",
            );
          ...
          if (gpCharacterPreviousMercPath[iCounter]) {
            gpCharacterPreviousMercPath[iCounter] = MoveToBeginningOfPathList(
              gpCharacterPreviousMercPath[iCounter],
            );
  ...
  function ClearPreviousPaths(): void {
    ...
    for (iCounter = 0; iCounter < MAX_CHARACTER_COUNT; iCounter++) {
      if (fSelectedListOfMercsForMapScreen[iCounter] == true) {
        gpCharacterPreviousMercPath[iCounter] = ClearStrategicPathList(
          gpCharacterPreviousMercPath[iCounter],
          0,
        );
      }
    }
    gpHelicopterPreviousMercPath = ClearStrategicPathList(
      gpHelicopterPreviousMercPath,
      0,
    );
  }
  ...
  function SelectAllCharactersInSquad(bSquadNumber: INT8): void {
    ...
    for (bCounter = 0; bCounter < MAX_CHARACTER_COUNT; bCounter++) {
      ...
      if (gCharactersList[bCounter].fValid == true) {
        ...
        if (
          pSoldier.bAssignment == bSquadNumber ||
