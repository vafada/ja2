namespace ja2 {
  ...
  export function copyMeanwhileDefinition(
    destination: MEANWHILE_DEFINITION,
    source: MEANWHILE_DEFINITION,
  ) {
  ...
  export function readMeanwhileDefinition(
    o: MEANWHILE_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset += 2;
    o.usTriggerEvent = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeMeanwhileDefinition(
    o: MEANWHILE_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
