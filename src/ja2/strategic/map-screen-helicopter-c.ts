namespace ja2 {
  ...
  export function HandleHeliEnteringSector(sX: INT16, sY: INT16): boolean {
    ...
    if (ubNumEnemies > 0) {
      ...
      if (
        WhatPlayerKnowsAboutEnemiesInSector(sX, sY) == Enum159.KNOWS_NOTHING
      ) {
          ...
          if (!EndOfHelicoptersPath()) {
            ...
            if (Random(2)) {
              HeliCharacterDialogue(
                pSkyRider,
                ENEMIES_SPOTTED_EN_ROUTE_IN_FRIENDLY_SECTOR_A,
              );
            } else {
              HeliCharacterDialogue(
                pSkyRider,
                ENEMIES_SPOTTED_EN_ROUTE_IN_FRIENDLY_SECTOR_B,
              );
            }
          }

          // make their presence appear on the map while Skyrider remains in the sector
          SectorInfo[SECTOR(sX, sY)].uiFlags |=
...
*/
  ...
  function LocationOfNearestRefuelPoint(
    fNotifyPlayerIfNoSafeLZ: boolean,
  ): INT32 {
  ...
  function DistanceToNearestRefuelPoint(sX: INT16, sY: INT16): INT32 {
    ...
    iDistance = FindStratPath(
      CALCULATE_STRATEGIC_INDEX(sX, sY),
      CALCULATE_STRATEGIC_INDEX(
        ubRefuelList[iClosestLocation][0],
...
*/
  ...
  */
  ...
  function GetCostOfPassageForHelicopter(sX: INT16, sY: INT16): INT32 {
    ...
    if (
      StrategicMap[CALCULATE_STRATEGIC_INDEX(sX, sY)].fEnemyAirControlled ==
      false
    ) {
  ...
  */
  ...
  function StartHoverTime(): void {
    ...
    AddStrategicEvent(
      Enum132.EVENT_HELICOPTER_HOVER_TOO_LONG,
      GetWorldTotalMin() + TIME_DELAY_FOR_HOVER_WAIT,
      0,
    );
  ...
  export function HandleHeliHoverLong(): void {
    ...
    if (fHoveringHelicopter) {
      ...
      AddStrategicEvent(
        Enum132.EVENT_HELICOPTER_HOVER_WAY_TOO_LONG,
        uiStartHoverTime + TIME_DELAY_FOR_HOVER_WAIT_TOO_LONG,
        0,
      );
  ...
  export function SetUpHelicopterForMovement(): void {
    ...
    if (pVehicleList[iHelicopterVehicleId].ubMovementGroup == 0) {
      ...
      pVehicleList[iHelicopterVehicleId].ubMovementGroup =
        CreateNewVehicleGroupDepartingFromSector(
          pVehicleList[iHelicopterVehicleId].sSectorX,
          pVehicleList[iHelicopterVehicleId].sSectorY,
      ...
      for (
        iCounter = 0;
        iCounter <
        iSeatingCapacities[pVehicleList[iHelicopterVehicleId].ubVehicleType];
        iCounter++
      ) {
  ...
  function HeliCharacterDialogue(
    ...
    return CharacterDialogue(
      Enum268.SKYRIDER,
      usQuoteNum,
      uiExternalStaticNPCFaces[Enum203.SKYRIDER_EXTERNAL_FACE],
  ...
  export function IsRefuelSiteInSector(sMapX: INT16, sMapY: INT16): boolean {
    ...
    for (iCounter = 0; iCounter < Enum137.NUMBER_OF_REFUEL_SITES; iCounter++) {
      if (
        ubRefuelList[iCounter][0] == sMapX &&
        ubRefuelList[iCounter][1] == sMapY
      ) {
        return true;
      }
    }
  ...
  export function UpdateRefuelSiteAvailability(): void {
    ...
    for (iCounter = 0; iCounter < Enum137.NUMBER_OF_REFUEL_SITES; iCounter++) {
      ...
      if (
        ...
        (iCounter == Enum137.ESTONI_REFUELING_SITE &&
          CheckFact(Enum170.FACT_ESTONI_REFUELLING_POSSIBLE, 0) == false)
      ) {
  ...
  export function HandleSkyRiderMonologueEvent(
    uiEventCode: UINT32,
    uiSpecialCode: UINT32,
  ): void {
    ...
    switch (uiEventCode) {
      ...
      case Enum136.SKYRIDER_MONOLOGUE_EVENT_ESTONI_REFUEL:
        SetExternMapscreenSpeechPanelXY(
          DEFAULT_EXTERN_PANEL_X_POS,
          DEFAULT_EXTERN_PANEL_Y_POS,
        );
  ...
  function HandleSkyRiderMonologueAboutEstoniRefuel(
    uiSpecialCode: UINT32,
  ): void {
    ...
    switch (uiSpecialCode) {
      case 0:
        CharacterDialogueWithSpecialEvent(
          Enum268.SKYRIDER,
          SPIEL_ABOUT_ESTONI_AIRSPACE,
          uiExternalStaticNPCFaces[Enum203.SKYRIDER_EXTERNAL_FACE],
          DIALOGUE_EXTERNAL_NPC_UI,
          false,
          false,
          DIALOGUE_SPECIAL_EVENT_SKYRIDERMAPSCREENEVENT,
          Enum136.SKYRIDER_MONOLOGUE_EVENT_ESTONI_REFUEL,
          1,
        );
  ...
  function HandleSkyRiderMonologueAboutDrassenSAMSite(
    uiSpecialCode: UINT32,
  ): void {
    switch (uiSpecialCode) {
      case 0:
        ...
        CharacterDialogueWithSpecialEvent(
          ...
          true,
          DIALOGUE_SPECIAL_EVENT_SKYRIDERMAPSCREENEVENT,
          Enum136.SKYRIDER_MONOLOGUE_EVENT_DRASSEN_SAM_SITE,
          1,
        );
        ...
        if (SAMSitesUnderPlayerControl(SAM_2_X, SAM_2_Y) == false) {
          CharacterDialogue(
            Enum268.SKYRIDER,
            SECOND_HALF_OF_MENTION_DRASSEN_SAM_SITE,
            uiExternalStaticNPCFaces[Enum203.SKYRIDER_EXTERNAL_FACE],
            DIALOGUE_EXTERNAL_NPC_UI,
            false,
            false,
          ...
          if (
            CheckFact(Enum170.FACT_SKYRIDER_USED_IN_MAPSCREEN, Enum268.SKYRIDER)
          ) {
            CharacterDialogue(
              Enum268.SKYRIDER,
              SAM_SITE_TAKEN,
  ...
  function HandleSkyRiderMonologueAboutCambriaHospital(
    uiSpecialCode: UINT32,
  ): void {
    switch (uiSpecialCode) {
      case 0:
        ...
        CharacterDialogueWithSpecialEvent(
          ...
          true,
          DIALOGUE_SPECIAL_EVENT_SKYRIDERMAPSCREENEVENT,
          Enum136.SKYRIDER_MONOLOGUE_EVENT_CAMBRIA_HOSPITAL,
          1,
        );
  ...
  function HandleSkyRiderMonologueAboutOtherSAMSites(
    uiSpecialCode: UINT32,
  ): void {
    ...
    switch (uiSpecialCode) {
      case 0:
        // do quote 21
        gpCurrentTalkingFace =
          gFacesData[uiExternalStaticNPCFaces[Enum203.SKYRIDER_EXTERNAL_FACE]];
        gubCurrentTalkingID = Enum268.SKYRIDER;

        // if special event data 2 is true, then do dialogue, else this is just a trigger for an event
        CharacterDialogue(
          Enum268.SKYRIDER,
          SPIEL_ABOUT_OTHER_SAM_SITES,
          uiExternalStaticNPCFaces[Enum203.SKYRIDER_EXTERNAL_FACE],
          DIALOGUE_EXTERNAL_NPC_UI,
          false,
          false,
        ...
        CharacterDialogueWithSpecialEvent(
          ...
          false,
          DIALOGUE_SPECIAL_EVENT_SKYRIDERMAPSCREENEVENT,
          Enum136.SKYRIDER_MONOLOGUE_EVENT_OTHER_SAM_SITES,
          1,
        );
  ...
  export function CheckAndHandleSkyriderMonologues(): void {
    ...
    if (
      GetWorldTotalMin() - guiTimeOfLastSkyriderMonologue >=
      ...
      if (guiHelicopterSkyriderTalkState == 0) {
        ...
        if (
          StrategicMap[
            CALCULATE_STRATEGIC_INDEX(HOSPITAL_SECTOR_X, HOSPITAL_SECTOR_Y)
          ].fEnemyControlled
        ) {
          HandleSkyRiderMonologueEvent(
            Enum136.SKYRIDER_MONOLOGUE_EVENT_CAMBRIA_HOSPITAL,
  ...
  /* static */ let HandleAnimationOfSectors__fOldShowDrassenSAMHighLight: boolean =
    false;
  /* static */ let HandleAnimationOfSectors__fOldShowCambriaHospitalHighLight: boolean =
    false;
  /* static */ let HandleAnimationOfSectors__fOldShowEstoniRefuelHighLight: boolean =
    false;
  /* static */ let HandleAnimationOfSectors__fOldShowOtherSAMHighLight: boolean =
    false;
  export function HandleAnimationOfSectors(): void {
    ...
    if (fShowEstoniRefuelHighLight) {
      ...
      HandleBlitOfSectorLocatorIcon(
        ubRefuelList[Enum137.ESTONI_REFUELING_SITE][0],
        ubRefuelList[Enum137.ESTONI_REFUELING_SITE][1],
        0,
        Enum156.LOCATOR_COLOR_RED,
      );
      fSkipSpeakersLocator = true;
...
*/
  ...
  export function HandleHelicopterOnGroundGraphic(): void {
    ...
    for (ubSite = 0; ubSite < Enum137.NUMBER_OF_REFUEL_SITES; ubSite++) {
      ...
      if (
        ubRefuelList[ubSite][0] == gWorldSectorX &&
        ubRefuelList[ubSite][1] == gWorldSectorY
      ) {
  ...
  function IsHelicopterOnGroundAtRefuelingSite(
    ubRefuelingSite: UINT8,
  ): boolean {
    ...
    if (
      ubRefuelList[ubRefuelingSite][0] ==
        pVehicleList[iHelicopterVehicleId].sSectorX &&
      ubRefuelList[ubRefuelingSite][1] ==
        pVehicleList[iHelicopterVehicleId].sSectorY
    ) {
      return true;
    }
...
*/
  ...
  function HandleSAMSiteAttackOfHelicopterInSector(
    sSectorX: INT16,
    sSectorY: INT16,
  ): boolean {
    ...
    if (PreRandom(100) < ubChance) {
      ...
      // third hit!
        ...
        // play sound
        if (
          PlayJA2StreamingSampleFromFile(
            "stsounds\\blah2.wav",
            RATE_11025,
            HIGHVOLUME,
            1,
            MIDDLEPAN,
            HeliCrashSoundStopCallback,
          ) == SOUND_ERROR
        ) {
  ...
  export function IsSkyriderIsFlyingInSector(
    sSectorX: INT16,
    sSectorY: INT16,
  ): boolean {
    let pGroup: GROUP;
  ...
  export function IsGroupTheHelicopterGroup(pGroup: GROUP): boolean {
    if (
      iHelicopterVehicleId != -1 &&
      VehicleIdIsValid(iHelicopterVehicleId) &&
  ...
  export function GetNumSafeSectorsInPath(): INT16 {
    ...
    iHeliSector = CALCULATE_STRATEGIC_INDEX(
      pVehicleList[iHelicopterVehicleId].sSectorX,
      pVehicleList[iHelicopterVehicleId].sSectorY,
    );
    ...
    if (pNode != null) {
      ...
      if (
        pNode.uiSectorId == iHeliSector &&
        pNode.pNext != null &&
        !GroupBetweenSectorsAndSectorXYIsInDifferentDirection(
          pGroup,
          GET_X_FROM_STRATEGIC_INDEX(pNode.pNext.uiSectorId),
          GET_Y_FROM_STRATEGIC_INDEX(pNode.pNext.uiSectorId),
        )
      ) {
        pNode = pNode.pNext;
      }
    ...
    if (iTotalAccumulatedCostByPlayer > 0) {
      ...
      if (LaptopSaveInfo.iCurrentBalance >= iTotalAccumulatedCostByPlayer) {
        ...
        if (LaptopSaveInfo.iCurrentBalance > 0) {
          ...
          gMercProfiles[Enum268.SKYRIDER].iBalance =
  ...
  function MakeHeliReturnToBase(): void {
    ...
    if (CheckForArrivalAtRefuelPoint()) {
      ...
      // null out path
      pVehicleList[iHelicopterVehicleId].pMercPath = ClearStrategicPathList(
      ...
      pVehicleList[iHelicopterVehicleId].pMercPath = AppendStrategicPath(
        MoveToBeginningOfPathList(
          BuildAStrategicPath(
            null,
            GetLastSectorIdInVehiclePath(iHelicopterVehicleId),
            CALCULATE_STRATEGIC_INDEX(
              ubRefuelList[iLocation][0],
