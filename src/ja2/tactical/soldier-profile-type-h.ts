namespace ja2 {
  ...
  export const BUDDY_MERC = (prof: MERCPROFILESTRUCT, bud: number) =>
    prof.bBuddy[0] == bud || prof.bBuddy[1] == bud || prof.bBuddy[2] == bud;
  export const HATED_MERC = (prof: MERCPROFILESTRUCT, hat: number) =>
  ...
  export function readMercProfileStruct(
    o: MERCPROFILESTRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.zName = readStringNL(buffer, "utf16le", offset, offset + 60);
    offset += 60;
    o.zNickname = readStringNL(buffer, "utf16le", offset, offset + 20);
    offset += 20;
    o.uiAttnSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiCurseSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiDieSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiGoodSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiGruntSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiGrunt2Sound = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiOkSound = buffer.readUInt32LE(offset);
    offset += 4;
    o.ubFaceIndex = buffer.readUInt8(offset++);
    o.PANTS = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.VEST = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.SKIN = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.HAIR = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    ...
    o.sExpLevelGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sLifeGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sAgilityGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sDexterityGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sWisdomGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sMarksmanshipGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sMedicalGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sMechanicGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sExplosivesGain = buffer.readInt16LE(offset);
    offset += 2;

    o.ubBodyType = buffer.readUInt8(offset++);
    o.bMedical = buffer.readInt8(offset++);

    o.usEyesX = buffer.readUInt16LE(offset);
    offset += 2;
    o.usEyesY = buffer.readUInt16LE(offset);
    offset += 2;
    o.usMouthX = buffer.readUInt16LE(offset);
    offset += 2;
    o.usMouthY = buffer.readUInt16LE(offset);
    offset += 2;
    offset += 2; // padding
    o.uiEyeDelay = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiMouthDelay = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiBlinkFrequency = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiExpressionFrequency = buffer.readUInt32LE(offset);
    offset += 4;
    o.sSectorX = buffer.readUInt16LE(offset);
    offset += 2;
    o.sSectorY = buffer.readUInt16LE(offset);
    offset += 2;

    o.uiDayBecomesAvailable = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.usKills = buffer.readUInt16LE(offset);
    offset += 2;
    o.usAssists = buffer.readUInt16LE(offset);
    offset += 2;
    o.usShotsFired = buffer.readUInt16LE(offset);
    offset += 2;
    o.usShotsHit = buffer.readUInt16LE(offset);
    offset += 2;
    o.usBattlesFought = buffer.readUInt16LE(offset);
    offset += 2;
    o.usTimesWounded = buffer.readUInt16LE(offset);
    offset += 2;
    o.usTotalDaysServed = buffer.readUInt16LE(offset);
    offset += 2;

    o.sLeadershipGain = buffer.readInt16LE(offset);
    offset += 2;
    o.sStrengthGain = buffer.readInt16LE(offset);
    offset += 2;

    o.uiBodyTypeSubFlags = buffer.readUInt32LE(offset);
    offset += 4;

    o.sSalary = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.uiWeeklySalary = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiBiWeeklySalary = buffer.readUInt32LE(offset);
    offset += 4;
    o.bMedicalDeposit = buffer.readInt8(offset++);
    o.bAttitude = buffer.readInt8(offset++);
    o.bBaseMorale = buffer.readInt8(offset++);
    offset++; // padding
    o.sMedicalDepositAmount = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.usOptionalGearCost = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    offset += 2;
    o.bFriendlyOrDirectDefaultResponseUsedRecently = Boolean(
    ...
    o.iBalance = buffer.readInt32LE(offset);
    offset += 4;
    o.sTrueSalary = buffer.readInt16LE(offset);
    offset += 2;
    o.ubCivilianGroup = buffer.readUInt8(offset++);
    o.ubNeedForSleep = buffer.readUInt8(offset++);
    o.uiMoney = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.uiPrecedentQuoteSaid = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiProfileChecksum = buffer.readUInt32LE(offset);
    offset += 4;
    o.sPreCombatGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.ubTimeTillNextHatedComplaint = buffer.readUInt8(offset++);
    o.ubSuspiciousDeath = buffer.readUInt8(offset++);

    o.iMercMercContractLength = buffer.readInt32LE(offset);
    offset += 4;

    o.uiTotalCostToDate = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export function writeMercProfileStruct(
    o: MERCPROFILESTRUCT,
    buffer: Buffer,
    offset: number = 0,
  ) {
    ...
    offset = buffer.writeInt8(
      Number(o.bFriendlyOrDirectDefaultResponseUsedRecently),
      offset,
    );
    offset = buffer.writeInt8(
      Number(o.bRecruitDefaultResponseUsedRecently),
      offset,
    );
    offset = buffer.writeInt8(
      Number(o.bThreatenDefaultResponseUsedRecently),
      offset,
    );
