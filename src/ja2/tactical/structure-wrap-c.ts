namespace ja2 {
  ...
  function GetWallLevelNodeOfSameOrientationAtGridno(
    sGridNo: INT16,
    ubOrientation: INT8,
  ): LEVELNODE | null {
    let pNode: LEVELNODE;
  ...
  export function GetWallLevelNodeAndStructOfSameOrientationAtGridno(
    sGridNo: INT16,
    ubOrientation: INT8,
  ): { pNode: LEVELNODE | null; pStructure: STRUCTURE | null } {
    let pNode: LEVELNODE;
    let pStructure: STRUCTURE | null;
  ...
  export function DoesGridnoContainHiddenStruct(
    sGridNo: INT16,
    pfVisible: Pointer<boolean>,
  ): boolean {
  ...
  export function IsHiddenStructureVisible(
    sGridNo: INT16,
    usIndex: UINT16,
  ): boolean {
  ...
  export function WallOrClosedDoorExistsOfTopLeftOrientation(
    sGridNo: INT16,
  ): boolean {
    let pStructure: STRUCTURE | null;
  ...
  export function WallOrClosedDoorExistsOfTopRightOrientation(
    sGridNo: INT16,
  ): boolean {
    let pStructure: STRUCTURE | null;
  ...
  export function OpenRightOrientedDoorWithDoorOnRightOfEdgeExists(
    sGridNo: INT16,
  ): boolean {
    let pStructure: STRUCTURE | null;
  ...
  export function OpenLeftOrientedDoorWithDoorOnLeftOfEdgeExists(
    sGridNo: INT16,
  ): boolean {
    let pStructure: STRUCTURE | null;
  ...
  function FindCuttableWireFenceAtGridNo(sGridNo: INT16): STRUCTURE | null {
    ...
    if (
      pStructure != null &&
      pStructure.ubWallOrientation != Enum314.NO_ORIENTATION &&
      !(pStructure.fFlags & STRUCTURE_OPEN)
    ) {
      return pStructure;
    }
  ...
  export function CutWireFence(sGridNo: INT16): boolean {
    ...
    if (pStructure) {
      pStructure = SwapStructureForPartnerAndStoreChangeInMap(
        sGridNo,
        pStructure,
      );
      if (pStructure) {
  ...
  export function IsRepairableStructAtGridNo(
    sGridNo: INT16,
    pubID: Pointer<UINT8> | null,
  ): UINT8 {
    let ubMerc: UINT8;
    ...
    // then for SAM site....
    if (
      DoesSAMExistHere(gWorldSectorX, gWorldSectorY, gbWorldSectorZ, sGridNo)
    ) {
      return 3;
    }
  ...
  export function IsRefuelableStructAtGridNo(
    sGridNo: INT16,
    pubID: Pointer<UINT8> | null,
  ): boolean {
    let ubMerc: UINT8;
  ...
  export function SetOpenableStructureToClosed(
    sGridNo: INT16,
    ubLevel: UINT8,
  ): boolean {
    let pStructure: STRUCTURE | null;
