    ...
    for (
      ...
      if (
        ...
        if (pTeamSoldier.ubMilitiaKills > 0) {
          ubMilitiaRank = SoldierClassToMilitiaRank(
            pTeamSoldier.ubSoldierClass,
          );
          ...
          if (ubPromotions) {
            if (ubPromotions == 2) {
              ...
              pTeamSoldier.ubSoldierClass == Enum262.SOLDIER_CLASS_GREEN_MILITIA
            ) {
              gbGreenToRegPromotions++;
              gbMilitiaPromotions++;
            } else if (
              pTeamSoldier.ubSoldierClass == Enum262.SOLDIER_CLASS_REG_MILITIA
            ) {
