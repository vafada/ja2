namespace ja2 {
  ...
  export const AMMO_DAMAGE_ADJUSTMENT_BUCKSHOT = (x: number) =>
    Math.trunc(x / 4);
  export const NUM_BUCKSHOT_PELLETS = 9;

  // hollow point bullets do lots of damage to people
  export const AMMO_DAMAGE_ADJUSTMENT_HP = (x: number) =>
    Math.trunc((x * 17) / 10);
  // but they SUCK at penetrating armour
  export const AMMO_ARMOUR_ADJUSTMENT_HP = (x: number) =>
    Math.trunc((x * 3) / 2);
  // armour piercing bullets are good at penetrating armour
  export const AMMO_ARMOUR_ADJUSTMENT_AP = (x: number) =>
    Math.trunc((x * 3) / 4);
  ...
  export function createWeaponTypeFrom(
    ubWeaponClass: UINT8,
    ubWeaponType: UINT8,
    ubCalibre: UINT8,
    ubReadyTime: UINT8,
  ...
  export function createMagTypeFrom(
    ubCalibre: UINT8,
    ubMagSize: UINT8,
    ubAmmoType: UINT8,
  ): MAGTYPE {
  ...
  export function createArmourTypeFrom(
    ubArmourClass: UINT8,
    ubProtection: UINT8,
    ubDegradePercent: UINT8,
  ): ARMOURTYPE {
  ...
  export function createExplosiveTypeFrom(
    ubType: UINT8,
    ubDamage: UINT8,
    ubStunDamage: UINT8,
    ubRadius: UINT8,
