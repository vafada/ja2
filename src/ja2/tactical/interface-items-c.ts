namespace ja2 {
  ...
  const ITEM_PROS_AND_CONS = (usItem: number) =>
  ...
  let gInvRegions: MOUSE_REGION[] /* [NUM_INV_SLOTS] */ = createArrayFrom(
    Enum261.NUM_INV_SLOTS,
    createMouseRegion,
  );

  export let gInvDesc: MOUSE_REGION = createMouseRegion();

  export let gpItemPointer: OBJECTTYPE /* Pointer<OBJECTTYPE> */ = <OBJECTTYPE>(
    (<unknown>null)
  );
  ...
  export let gpItemDescObject: OBJECTTYPE /* Pointer<OBJECTTYPE> */ = <
    OBJECTTYPE
  >(<unknown>null);
  ...
  export let gItemDescAttachmentRegions: MOUSE_REGION[] /* [4] */ =
    createArrayFrom(4, createMouseRegion);
  let gProsAndConsRegions: MOUSE_REGION[] /* [2] */ = createArrayFrom(
    2,
    createMouseRegion,
  );

  let guiMoneyButtonBtn: UINT32[] /* [MAX_ATTACHMENTS] */ = createArray(
    MAX_ATTACHMENTS,
    0,
  );
  ...
  let gusOriginalAttachItem: UINT16[] /* [MAX_ATTACHMENTS] */ = createArray(
    MAX_ATTACHMENTS,
    0,
  );
  let gbOriginalAttachStatus: UINT8[] /* [MAX_ATTACHMENTS] */ = createArray(
    MAX_ATTACHMENTS,
    0,
  );
  ...
  let gItemPopupRegions: MOUSE_REGION[] /* [8] */ = createArrayFrom(
    8,
    createMouseRegion,
  );
  let gKeyRingRegions: MOUSE_REGION[] /* [NUMBER_KEYS_ON_KEYRING] */ =
    createArrayFrom(NUMBER_KEYS_ON_KEYRING, createMouseRegion);
  ...
  function createInvDescStatsFrom(
    sX: INT16,
    sY: INT16,
    sValDx: INT16,
  ): INV_DESC_STATS {
  ...
  export function createInvAttachXYFrom(
    sX: INT16,
    sY: INT16,
    sHeight: INT16,
    sWidth: INT16,
  ...
  function createInvHelpTextFrom(
    iXPosition: INT32[],
    iYPosition: INT32[],
    iWidth: INT32[],
    sString1: string[],
  ...
  let gSMInvRegion: MOUSE_REGION[] /* [NUM_INV_SLOTS] */ = createArrayFrom(
    Enum261.NUM_INV_SLOTS,
    createMouseRegion,
  );
  let gKeyRingPanel: MOUSE_REGION = createMouseRegion();
  let gSMInvCamoRegion: MOUSE_REGION = createMouseRegion();
  let gbCompatibleAmmo: boolean[] /* INT8[NUM_INV_SLOTS] */ = createArray(
    Enum261.NUM_INV_SLOTS,
    false,
  );
  export let gbInvalidPlacementSlot: boolean[] /* INT8[NUM_INV_SLOTS] */ =
    createArray(Enum261.NUM_INV_SLOTS, false);
  export let us16BPPItemCyclePlacedItemColors: UINT16[] /* [20] */ =
    createArray(20, 0);
  let guiBodyInvVO: UINT32[][] /* [4][2] */ = createArrayFrom(4, () =>
    createArray(2, 0),
  );
  let guiGoldKeyVO: UINT32;
  export let gbCompatibleApplyItem: boolean /* INT8 */ = false;

  function AttemptToAddSubstring(
    zDest: string /* STR16 */,
    zTemp: string /* STR16 */,
    uiStringLength: UINT32,
    uiPixLimit: UINT32,
  ): { result: boolean; zDest: string; uiStringLength: UINT32 } {
    ...
    if (zDest != "") {
      uiRequiredStringLength += StringPixLength(
        COMMA_AND_SPACE,
        ITEMDESC_FONT(),
      );
    }
  ...
  function GenerateProsString(pObject: OBJECTTYPE, uiPixLimit: UINT32): string {
    ...
    if (Item[usItem].ubWeight <= EXCEPTIONAL_WEIGHT) {
      ...
      ({
        ...
        result,
        uiStringLength,
      } = AttemptToAddSubstring(zItemPros, zTemp, uiStringLength, uiPixLimit));
      if (!result) {
        return zItemPros;
      }
    }
    ...
    if (
      BaseAPsToShootOrStab(DEFAULT_APS, DEFAULT_AIMSKILL, gpItemDescObject) <=
      EXCEPTIONAL_AP_COST
    ) {
    ...
    if (
      Weapon[usItem].ubShotsPerBurst >= EXCEPTIONAL_BURST_SIZE ||
      usItem == Enum225.G11
    ) {
  ...
  function GenerateConsString(pObject: OBJECTTYPE, uiPixLimit: UINT32): string {
    ...
    if (ubWeight >= BAD_WEIGHT) {
      ...
      ({
        ...
        result,
        uiStringLength,
      } = AttemptToAddSubstring(zItemCons, zTemp, uiStringLength, uiPixLimit));
      if (!result) {
        return zItemCons;
      }
    }
  ...
  export function InitInvSlotInterface(
    pRegionDesc: INV_REGION_DESC[],
    pCamoRegion: INV_REGION_DESC,
    INVMoveCallback: MOUSE_CALLBACK,
    INVClickCallback: MOUSE_CALLBACK,
    INVMoveCammoCallback: MOUSE_CALLBACK,
    INVClickCammoCallback: MOUSE_CALLBACK,
    fSetHighestPrioity: boolean,
  ): boolean {
    let cnt: INT32;
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_figure_large_male.sti",
    );
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_figure_large_male_H.sti",
    );
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_normal_male.sti",
    );
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_normal_male_H.sti",
    );
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_figure_female.sti",
    );
    ...
    VObjectDesc.fCreateFlags = VOBJECT_CREATE_FROMFILE;
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_figure_female_H.sti",
    );
    ...
    for (cnt = 0; cnt < Enum261.NUM_INV_SLOTS; cnt++) {
      ...
      MSYS_DefineRegion(
        ...
        fSetHighestPrioity ? MSYS_PRIORITY_HIGHEST : MSYS_PRIORITY_HIGH,
        MSYS_NO_CURSOR,
        INVMoveCallback,
        INVClickCallback,
      );
  ...
  export function InitKeyRingInterface(
    KeyRingClickCallback: MOUSE_CALLBACK,
  ): void {
    MSYS_DefineRegion(
      gKeyRingPanel,
      KEYRING_X,
      KEYRING_Y,
      KEYRING_X + KEYRING_WIDTH,
      KEYRING_X + KEYRING_HEIGHT,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
    ...
    SetRegionFastHelpText(
      gKeyRingPanel,
      TacticalStr[Enum335.KEYRING_HELP_TEXT],
    );
  }

  export function InitMapKeyRingInterface(
    KeyRingClickCallback: MOUSE_CALLBACK,
  ): void {
    MSYS_DefineRegion(
      gKeyRingPanel,
      MAP_KEYRING_X,
      MAP_KEYRING_Y,
      MAP_KEYRING_X + KEYRING_WIDTH,
      MAP_KEYRING_Y + KEYRING_HEIGHT,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
      KeyRingClickCallback,
  ...
  export function RenderInvBodyPanel(
    ...
    BltVideoObjectFromIndex(
      guiSAVEBUFFER,
      guiBodyInvVO[pSoldier.ubBodyType][bSubImageIndex],
      0,
      sX,
      sY,
  ...
  export function HandleRenderInvSlots(
    pSoldier: SOLDIERTYPE,
    fDirtyLevel: UINT8,
  ): void {
    let cnt: INT32;
    ...
    if (InItemDescriptionBox() || InItemStackPopup() || InKeyRingPopup()) {
      ...
      for (cnt = 0; cnt < Enum261.NUM_INV_SLOTS; cnt++) {
        if (fDirtyLevel == DIRTYLEVEL2) {
          HandleRenderInvSlots__pStr = GetHelpTextForItem(
            pSoldier.inv[cnt],
            pSoldier,
          );
  ...
  function INVRenderINVPanelItem(
    pSoldier: SOLDIERTYPE,
    sPocket: INT16,
    fDirtyLevel: UINT8,
  ): void {
    ...
    */
    ...
    if (
      pSoldier.bNewItemCount[sPocket] > 0 &&
    ...
    INVRenderItem(
      ...
      sX,
      sY,
      gSMInvData[sPocket].sWidth,
      gSMInvData[sPocket].sHeight,
      fRenderDirtyLevel,
      null,
      0,
      fOutline,
    ...
    if (guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE) {
      if (
        ShouldSoldierDisplayHatchOnItem(pSoldier.ubProfile, sPocket) &&
    ...
    if (fHatchItOut) {
      ...
      DrawHatchOnInventory(
        ...
        sX,
        sY,
        gSMInvData[sPocket].sWidth - 1,
        gSMInvData[sPocket].sHeight - 1,
      );
    }
    ...
    if (pObject.usItem != NOTHING) {
      ...
      DrawItemUIBarEx(
        ...
        ITEM_BAR_WIDTH,
        ITEM_BAR_HEIGHT,
        Get16BPPColor(STATUS_BAR()),
        Get16BPPColor(STATUS_BAR_SHADOW()),
        true,
        guiSAVEBUFFER,
      );
    }
  ...
  function CompatibleAmmoForGun(
    pTryObject: OBJECTTYPE,
    pTestObject: OBJECTTYPE,
  ): boolean {
    if (Item[pTryObject.usItem].usItemClass & IC_AMMO) {
      // CHECK
      if (
        Weapon[pTestObject.usItem].ubCalibre ==
  ...
  function CompatibleGunForAmmo(
    ...
    if (Item[pTryObject.usItem].usItemClass & IC_GUN) {
      // CHECK
      if (
        Weapon[pTryObject.usItem].ubCalibre ==
  ...
  function CompatibleItemForApplyingOnMerc(pTestObject: OBJECTTYPE): boolean {
    ...
    if (
      usItem == Enum225.CAMOUFLAGEKIT ||
      usItem == Enum225.ADRENALINE_BOOSTER ||
      usItem == Enum225.REGEN_BOOSTER ||
      usItem == Enum225.SYRINGE_3 ||
      usItem == Enum225.SYRINGE_4 ||
      usItem == Enum225.SYRINGE_5 ||
      usItem == Enum225.ALCOHOL ||
      usItem == Enum225.WINE ||
      usItem == Enum225.BEER ||
      usItem == Enum225.CANTEEN ||
      usItem == Enum225.JAR_ELIXIR
    ) {
      return true;
    } else {
      return false;
  ...
  function SoldierContainsAnyCompatibleStuff(
    pSoldier: SOLDIERTYPE,
    pTestObject: OBJECTTYPE,
  ): boolean {
    let cnt: INT32;
  ...
  export function HandleAnyMercInSquadHasCompatibleStuff(
    ubSquad: UINT8,
    pObject: OBJECTTYPE | null,
    fReset: boolean,
  ): void {
        ...
        if (!fReset) {
          if (
            SoldierContainsAnyCompatibleStuff(
              Squad[iCurrentTacticalSquad][iCounter],
              <OBJECTTYPE>pObject,
            )
          ) {
            // Get face and set value....
            gFacesData[
              Squad[iCurrentTacticalSquad][iCounter].iFaceIndex
  ...
  export function HandleCompatibleAmmoUIForMapScreen(
    pSoldier: SOLDIERTYPE,
    bInvPos: INT32,
    fOn: boolean,
    fFromMerc: boolean,
    ...
    if (!(Item[pTestObject.usItem].fFlags & ITEM_HIDDEN_ADDON)) {
      ...
      for (cnt = 0; cnt < Enum261.NUM_INV_SLOTS; cnt++) {
        ...
        if (
          ValidAttachment(pObject.usItem, pTestObject.usItem) ||
  ...
  export function HandleCompatibleAmmoUIForMapInventory(
    pSoldier: SOLDIERTYPE,
    bInvPos: INT32,
    iStartSlotNumber: INT32,
    fOn: boolean,
    fFromMerc: boolean,
  ): boolean {
  ...
  export function InternalHandleCompatibleAmmoUI(
    pSoldier: SOLDIERTYPE,
    pTestObject: OBJECTTYPE | null,
    fOn: boolean,
  ): boolean {
    let fFound: boolean = false;
    let cnt: INT32;
  ...
  export function HandleCompatibleAmmoUI(
    pSoldier: SOLDIERTYPE,
    bInvPos: INT8,
    fOn: boolean,
  ): boolean {
  ...
  function GetSlotInvHeightWidth(ubPos: UINT8): {
    sWidth: INT16;
    sHeight: INT16;
  } {
    let sWidth: INT16;
  ...
  export function HandleNewlyAddedItems(
    pSoldier: SOLDIERTYPE,
    fDirtyLevel: Pointer<UINT8>,
  ): void {
    let cnt: UINT32;
    let sX: INT16;
    let sY: INT16;
    ...
    for (cnt = 0; cnt < Enum261.NUM_INV_SLOTS; cnt++) {
      ...
      if (pSoldier.bNewItemCount[cnt] > 0) {
        ...
        INVRenderItem(
          ...
          sX,
          sY,
          gSMInvData[cnt].sWidth,
          gSMInvData[cnt].sHeight,
          DIRTYLEVEL2,
          null,
          0,
          true,
  ...
  export function InitItemInterface(): void {
    ...
    for (cnt = 0, cnt2 = 0; cnt2 < 20; cnt += 3, cnt2++) {
      us16BPPItemCyclePlacedItemColors[cnt2] = Get16BPPColor(
        FROMRGB(
          ubRGBItemCyclePlacedItemColors[cnt],
          ubRGBItemCyclePlacedItemColors[cnt + 1],
  ...
  export function INVRenderItem(
    ...
    sHeight: INT16,
    fDirtyLevel: UINT8,
    pubHighlightCounter: Pointer<UINT8> | null,
    ubStatusIndex: UINT8,
    fOutline: boolean,
    sOutlineColor: INT16,
  ): void {
    ...
    if (ubStatusIndex < RENDER_ITEM_ATTACHMENT1) {
      ...
      pItem =
        Item[pObject.usAttachItem[ubStatusIndex - RENDER_ITEM_ATTACHMENT1]];
    }
    ...
    if (fDirtyLevel == DIRTYLEVEL2) {
      ...
      sCenY =
        sY + Math.trunc(Math.abs(sHeight - usHeight) / 2) - pTrav.sOffsetY;
    ...
    if (fDirtyLevel != DIRTYLEVEL0) {
      if (ubStatusIndex < RENDER_ITEM_ATTACHMENT1) {
        ...
        if (
          ...
          pObject.usItem != Enum225.ROCKET_LAUNCHER
        ) {
          sNewY = sY + sHeight - 10;
          sNewX = sX + 1;
          ...
          if (pObject.bGunAmmoStatus < 0) {
            ...
            ({ sX: sNewX, sY: sNewY } = VarFindFontCenterCoordinates(
              sX,
              sY,
              sWidth,
              sHeight,
        ...
        if (
          pSoldier &&
          pObject == pSoldier.inv[Enum261.HANDPOS] &&
    ...
    if (pubHighlightCounter != null) {
      ...
      if (pubHighlightCounter.value) {
        ...
        if (ubStatusIndex < RENDER_ITEM_ATTACHMENT1) {
          ...
          INVRenderItem__pStr = swprintf(
            "%s",
            ShortItemNames[
              pObject.usAttachItem[ubStatusIndex - RENDER_ITEM_ATTACHMENT1]
            ],
          );
        }

        ({ pStr: INVRenderItem__pStr, pStr2: INVRenderItem__pStr2 } =
          WrapString(INVRenderItem__pStr, WORD_WRAP_INV_WIDTH, ITEM_FONT()));
        ...
        if (fLineSplit) {
          ({ sX: sFontX2, sY: sFontY2 } = VarFindFontCenterCoordinates(
            sX,
            sY,
            sWidth,
            sHeight,
            ITEM_FONT(),
            INVRenderItem__pStr2,
          ));
          sFontY2 = sY + 13;
  ...
  export function CycleItemDescriptionItem(): void {
    ...
    InternalInitItemDescriptionBox(
      gpItemDescSoldier.inv[Enum261.HANDPOS],
      214,
      INV_INTERFACE_START_Y + 1,
      gubItemDescStatusIndex,
      gpItemDescSoldier,
    );
  }

  export function InitItemDescriptionBox(
    pSoldier: SOLDIERTYPE,
    ubPosition: UINT8,
    sX: INT16,
    sY: INT16,
    ...
    return InternalInitItemDescriptionBox(
      pObject,
      sX,
      sY,
      ubStatusIndex,
  ...
  export function InitKeyItemDescriptionBox(
    pSoldier: SOLDIERTYPE,
    ubPosition: UINT8,
    sX: INT16,
    sY: INT16,
    ...
    CreateKeyObject(
      pObject,
      pSoldier.pKeyRing[ubPosition].ubNumber,
  ...
  export function InternalInitItemDescriptionBox(
    pObject: OBJECTTYPE,
    sX: INT16,
    sY: INT16,
    ubStatusIndex: UINT8,
    ...
    if (guiCurrentItemDescriptionScreen == ScreenIds.MAP_SCREEN) {
      ...
      giMapInvDescButtonImage = LoadButtonImage(
        "INTERFACE\\itemdescdonebutton.sti",
        -1,
        0,
        -1,
        1,
    ...
    if (
      ...
      pStr = swprintf(
        "%d/%d",
        gpItemDescObject.ubGunShotsLeft,
      ...
      switch (pObject.ubGunAmmoType) {
        ...
        case Enum286.AMMO_SUPER_AP:
          ...
          giItemDescAmmoButtonImages = LoadButtonImage(
            ubString,
            8,
            5,
            -1,
      ...
      if (
        ...
        SetButtonFastHelpText(
          giItemDescAmmoButton,
          Message[Enum334.STR_EJECT_AMMO],
        );

      ({ sX: usX, sY: usY } = FindFontCenterCoordinates(
        ITEMDESC_AMMO_TEXT_X,
        ITEMDESC_AMMO_TEXT_Y,
        ITEMDESC_AMMO_TEXT_WIDTH,
        GetFontHeight(TINYFONT1()),
        pStr,
        TINYFONT1(),
      ));
      ...
      for (cnt = 0; cnt < MAX_ATTACHMENTS; cnt++) {
        ...
        if (guiCurrentItemDescriptionScreen == ScreenIds.MAP_SCREEN)
          MSYS_DefineRegion(
            ...
            gsInvDescY + gMapItemDescAttachmentsXY[cnt].sY,
            gsInvDescX +
              gMapItemDescAttachmentsXY[cnt].sX +
              gMapItemDescAttachmentsXY[cnt].sWidth,
            gsInvDescY +
              gMapItemDescAttachmentsXY[cnt].sY +
          ...
          MSYS_DefineRegion(
            gItemDescAttachmentRegions[cnt],
            gsInvDescX + gItemDescAttachmentsXY[cnt].sX,
            gsInvDescY + gItemDescAttachmentsXY[cnt].sY,
            gsInvDescX +
              gItemDescAttachmentsXY[cnt].sX +
              gItemDescAttachmentsXY[cnt].sBarDx +
              gItemDescAttachmentsXY[cnt].sWidth,
            gsInvDescY +
              gItemDescAttachmentsXY[cnt].sY +
        ...
        if (gpItemDescObject.usAttachItem[cnt] != NOTHING) {
          ...
          SetRegionFastHelpText(
            gItemDescAttachmentRegions[cnt],
            Message[Enum334.STR_ATTACHMENTS],
          );
          SetRegionHelpEndCallback(
            gItemDescAttachmentRegions[cnt],
            HelpTextDoneCallback,
      ...
      if (guiCurrentItemDescriptionScreen == ScreenIds.MAP_SCREEN) {
        ...
        for (cnt = 0; cnt < MAX_ATTACHMENTS - 1; cnt++) {
          guiMoneyButtonBtn[cnt] = CreateIconAndTextButton(
            ...
            DEFAULT_SHADOW,
            TEXT_CJUSTIFIED,
            gMapMoneyButtonLoc.x + gMoneyButtonOffsets[cnt].x,
            gMapMoneyButtonLoc.y + gMoneyButtonOffsets[cnt].y,
            BUTTON_TOGGLE,
            MSYS_PRIORITY_HIGHEST,
            DEFAULT_MOVE_CALLBACK(),
        ...
        guiMoneyDoneButtonImage = UseLoadedButtonImage(
          guiMoneyButtonImage,
          -1,
          3,
          -1,
        ...
        for (cnt = 0; cnt < MAX_ATTACHMENTS - 1; cnt++) {
          guiMoneyButtonBtn[cnt] = CreateIconAndTextButton(
            ...
            DEFAULT_SHADOW,
            TEXT_CJUSTIFIED,
            gMoneyButtonLoc.x + gMoneyButtonOffsets[cnt].x,
            gMoneyButtonLoc.y + gMoneyButtonOffsets[cnt].y,
            BUTTON_TOGGLE,
            MSYS_PRIORITY_HIGHEST,
            DEFAULT_MOVE_CALLBACK(),
            BtnMoneyButtonCallback,
    ...
    if (
      gpItemPointer != null &&
      gfItemDescHelpTextOffset == false &&
      CheckFact(Enum170.FACT_ATTACHED_ITEM_BEFORE, 0) == false
    ) {
      ...
      if (
        !(Item[pObject.usItem].fFlags & ITEM_HIDDEN_ADDON) &&
  ...
  function ReloadItemDesc(): boolean {
    ...
    if (
      ...
      gpItemDescObject.usItem == Enum225.MONEY
    ) {
      if (
        (itemInfo = LoadItemInfo(Enum225.MONEY_FOR_PLAYERS_ACCOUNT)) ===
        undefined
      ) {
        return false;
      }
  ...
  */
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      ItemDescAmmoCallback__fRightDown
    ) {
  ...
  /* static */ let ItemDescAttachmentsCallback__Object2: OBJECTTYPE =
    createObjectType();
  function ItemDescAttachmentsCallback(
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (gpItemPointer != null) {
        ...
        if (
          ...
          EnoughPoints(gpItemPointerSoldier, AP_RELOAD_GUN, 0, true)
        ) {
          if (
            Item[gpItemPointer.usItem].fFlags & ITEM_INSEPARABLE &&
            ValidAttachment(gpItemPointer.usItem, gpItemDescObject.usItem)
          ) {
            DoScreenIndependantMessageBox(
              Message[Enum334.STR_PERMANENT_ATTACHMENT],
              MSG_BOX_FLAG_YESNO,
      ...
      ItemDescAttachmentsCallback__fRightDown
    ) {
      ...
      if (gpItemDescObject.usAttachItem[uiItemPos] != NOTHING) {
        ...
        if (
          CreateItem(
            gpItemDescObject.usAttachItem[uiItemPos],
            gpItemDescObject.bAttachStatus[uiItemPos],
            ItemDescAttachmentsCallback__Object2,
          )
        ) {
  ...
  export function RenderItemDescriptionBox(): void {
    ...
    if (
      ...
      sCenX =
        MAP_ITEMDESC_ITEM_X() +
        Math.trunc(Math.abs(ITEMDESC_ITEM_WIDTH - usWidth) / 2) -
        pTrav.sOffsetX;
      sCenY =
        MAP_ITEMDESC_ITEM_Y() +
        Math.trunc(Math.abs(ITEMDESC_ITEM_HEIGHT - usHeight) / 2) -
        pTrav.sOffsetY;
      ...
      if (gpItemDescObject.usItem == Enum225.MONEY) {
        ...
        BltVideoObjectFromIndex(
          guiSAVEBUFFER,
          guiMoneyGraphicsForDescBox,
          0,
          gMapMoneyButtonLoc.x + gMoneyButtonOffsets[0].x,
          gMapMoneyButtonLoc.y + gMoneyButtonOffsets[0].y,
          VO_BLT_SRCTRANSPARENCY,
          null,
        );
      }
      ...
      DrawItemUIBarEx(
        gpItemDescObject,
        gubItemDescStatusIndex,
        MAP_ITEMDESC_ITEM_STATUS_X(),
        MAP_ITEMDESC_ITEM_STATUS_Y(),
        ITEMDESC_ITEM_STATUS_WIDTH,
        ITEMDESC_ITEM_STATUS_HEIGHT_MAP,
        Get16BPPColor(DESC_STATUS_BAR()),
        Get16BPPColor(DESC_STATUS_BAR_SHADOW()),
        true,
        guiSAVEBUFFER,
      );
      ...
      if (gpItemPointer) {
        if (
          Item[gpItemPointer.usItem].fFlags & ITEM_HIDDEN_ADDON ||
          (!ValidItemAttachment(
            gpItemDescObject,
            gpItemPointer.usItem,
            false,
          ) &&
      ...
      for (cnt = 0; cnt < MAX_ATTACHMENTS; cnt++) {
        if (gpItemDescObject.usAttachItem[cnt] != NOTHING) {
          ...
          if (guiCurrentItemDescriptionScreen == ScreenIds.MAP_SCREEN) {
            ...
            DrawItemUIBarEx(
              gpItemDescObject,
              DRAW_ITEM_STATUS_ATTACHMENT1 + cnt,
              sCenX,
              sCenY,
              ITEM_BAR_WIDTH,
              ITEM_BAR_HEIGHT,
        ...
        if (fHatchOutAttachments) {
          DrawHatchOnInventory(
            guiSAVEBUFFER,
            gsInvDescX + gMapItemDescAttachmentsXY[cnt].sX,
            gsInvDescY + gMapItemDescAttachmentsXY[cnt].sY - 2,
            gMapItemDescAttachmentsXY[cnt].sWidth +
              gMapItemDescAttachmentsXY[cnt].sBarDx,
            gMapItemDescAttachmentsXY[cnt].sHeight + 2,
          );
        }
      }
      ...
      if (Item[gpItemDescObject.usItem].usItemClass & IC_GUN) {
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          for (
            cnt = 0;
            cnt < Weapon[gpItemDescObject.usItem].ubShotsPerBurst;
            cnt++
          ) {
            BltVideoObjectFromIndex(
              guiSAVEBUFFER,
              guiBullet,
              0,
              MAP_BULLET_BURST_X() + cnt * (BULLET_WIDTH + 1),
              MAP_BULLET_BURST_Y(),
              VO_BLT_SRCTRANSPARENCY,
              null,
            );
      ...
      DisplayWrappedString(
        MAP_ITEMDESC_DESC_START_X(),
        MAP_ITEMDESC_DESC_START_Y(),
        MAP_ITEMDESC_DESC_WIDTH,
        2,
        ITEMDESC_FONT(),
        FONT_BLACK,
        gzItemDesc,
      ...
      if (ITEM_PROS_AND_CONS(gpItemDescObject.usItem)) {
        if (
          (gpItemDescObject.usItem == Enum225.ROCKET_RIFLE ||
            gpItemDescObject.usItem == Enum225.AUTO_ROCKET_RIFLE) &&
          gpItemDescObject.ubImprintID < NO_PROFILE
        ) {
          // add name noting imprint
          RenderItemDescriptionBox__pStr = swprintf(
            "%s %s (%s)",
        ...
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          MAP_ITEMDESC_CALIBER_X(),
          MAP_ITEMDESC_CALIBER_Y(),
          MAP_ITEMDESC_CALIBER_WIDTH,
          ITEM_STATS_HEIGHT,
        ...
        SetFontShadow(ITEMDESC_FONTSHADOW3);
        mprintf(
          MAP_ITEMDESC_PROS_START_X(),
          MAP_ITEMDESC_PROS_START_Y(),
          gzProsLabel,
        );
        ...
        gzItemPros = GenerateProsString(
          gpItemDescObject,
          MAP_ITEMDESC_DESC_WIDTH -
            sProsConsIndent -
            StringPixLength(DOTDOTDOT, ITEMDESC_FONT()),
        );
        if (gzItemPros != "") {
          SetFontForeground(FONT_BLACK);
          SetFontShadow(ITEMDESC_FONTSHADOW2);
          DisplayWrappedString(
            MAP_ITEMDESC_PROS_START_X() + sProsConsIndent,
            MAP_ITEMDESC_PROS_START_Y(),
            ITEMDESC_DESC_WIDTH - sProsConsIndent,
            2,
            ITEMDESC_FONT(),
            FONT_BLACK,
            gzItemPros,
        ...
        SetFontShadow(ITEMDESC_FONTSHADOW3);
        mprintf(
          MAP_ITEMDESC_CONS_START_X(),
          MAP_ITEMDESC_CONS_START_Y(),
          gzConsLabel,
        );

        gzItemCons = GenerateConsString(
          gpItemDescObject,
          MAP_ITEMDESC_DESC_WIDTH -
            sProsConsIndent -
            StringPixLength(DOTDOTDOT, ITEMDESC_FONT()),
        ...
        if (gzItemCons != "") {
          ...
          SetFontShadow(ITEMDESC_FONTSHADOW2);
          DisplayWrappedString(
            MAP_ITEMDESC_CONS_START_X() + sProsConsIndent,
            MAP_ITEMDESC_CONS_START_Y(),
            ITEMDESC_DESC_WIDTH - sProsConsIndent,
            2,
            ITEMDESC_FONT(),
    ...
    */
      ...
      if (Item[gpItemDescObject.usItem].usItemClass & IC_WEAPON) {
        ...
        mprintf(
          gMapWeaponStats[0].sX + gsInvDescX,
          gMapWeaponStats[0].sY + gsInvDescY,
          "%s",
          sTempString,
        );
        // mprintf( gMapWeaponStats[ 2 ].sX + gsInvDescX, gMapWeaponStats[ 2 ].sY + gsInvDescY, L"%s", gMapWeaponStats[ 2 ].zDesc );
        if (
          Item[gpItemDescObject.usItem].usItemClass &
          (IC_GUN | IC_LAUNCHER)
        ) {
          mprintf(
            gMapWeaponStats[3].sX + gsInvDescX,
            gMapWeaponStats[3].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[3],
          );
        }
        if (
          !(Item[gpItemDescObject.usItem].usItemClass & IC_LAUNCHER) &&
          gpItemDescObject.usItem != Enum225.ROCKET_LAUNCHER
        ) {
          mprintf(
            gMapWeaponStats[4].sX + gsInvDescX,
            gMapWeaponStats[4].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[4],
          );
        }
        mprintf(
          gMapWeaponStats[5].sX + gsInvDescX,
          gMapWeaponStats[5].sY + gsInvDescY,
          "%s",
          gWeaponStatsDesc[5],
        );
        if (Item[gpItemDescObject.usItem].usItemClass & IC_GUN) {
          // equals sign
          mprintf(
            gMapWeaponStats[7].sX + gsInvDescX,
            gMapWeaponStats[7].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[7],
          );
        }
        mprintf(
          gMapWeaponStats[1].sX + gsInvDescX,
          gMapWeaponStats[1].sY + gsInvDescY,
          "%s",
          gWeaponStatsDesc[1],
        );
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          mprintf(
            gMapWeaponStats[8].sX + gsInvDescX,
            gMapWeaponStats[8].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[8],
          );
        }
        ...
        RenderItemDescriptionBox__pStr = swprintf(
          "%s%%",
          gpItemDescObject.bStatus[gubItemDescStatusIndex]
            .toString()
            .padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gMapWeaponStats[1].sX + gsInvDescX + gMapWeaponStats[1].sValDx + 6,
          gMapWeaponStats[1].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        RenderItemDescriptionBox__pStr = swprintf(
          "%s",
          fWeight.toFixed(1).padStart(1),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gMapWeaponStats[0].sX + gsInvDescX + gMapWeaponStats[0].sValDx + 6,
          gMapWeaponStats[0].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        if (
          ...
          RenderItemDescriptionBox__pStr = swprintf(
            "%s",
            Math.trunc(GunRange(gpItemDescObject) / 10)
              .toString()
              .padStart(2),
          );
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gMapWeaponStats[3].sX + gsInvDescX + gMapWeaponStats[3].sValDx,
            gMapWeaponStats[3].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        if (
          ...
          RenderItemDescriptionBox__pStr = swprintf(
            "%s",
            Weapon[gpItemDescObject.usItem].ubImpact.toString().padStart(2),
          );
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gMapWeaponStats[4].sX + gsInvDescX + gMapWeaponStats[4].sValDx,
            gMapWeaponStats[4].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        ubAttackAPs = BaseAPsToShootOrStab(
          DEFAULT_APS,
          DEFAULT_AIMSKILL,
          gpItemDescObject,
        );
        ...
        RenderItemDescriptionBox__pStr = swprintf(
          "%s",
          ubAttackAPs.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gMapWeaponStats[5].sX + gsInvDescX + gMapWeaponStats[5].sValDx,
          gMapWeaponStats[5].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          if (
            Weapon[gpItemDescObject.usItem].ubShotsPerBurst >=
              EXCEPTIONAL_BURST_SIZE ||
            gpItemDescObject.usItem == Enum225.G11
          ) {
            SetFontForeground(ITEMDESC_FONTHIGHLIGHT);
          } else {
            SetFontForeground(5);
          ...
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gMapWeaponStats[6].sX + gsInvDescX + gMapWeaponStats[6].sValDx,
            gMapWeaponStats[6].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
            BLOCKFONT2(),
        ...
        RenderItemDescriptionBox__pStr = InsertCommasForDollarFigure(
          RenderItemDescriptionBox__pStr,
        );
        RenderItemDescriptionBox__pStr = InsertDollarSignInToString(
          RenderItemDescriptionBox__pStr,
        );
        uiStringLength = StringPixLength(
          RenderItemDescriptionBox__pStr,
        ...
        mprintf(
          gMapMoneyStats[0].sX + gsInvDescX,
          gMapMoneyStats[0].sY + gsInvDescY,
          "%s",
          gMoneyStatsDesc[Enum373.MONEY_DESC_AMOUNT],
        );
        // Display the 'REmaining'
        mprintf(
          gMapMoneyStats[2].sX + gsInvDescX,
          gMapMoneyStats[2].sY + gsInvDescY,
          "%s",
          gMoneyStatsDesc[Enum373.MONEY_DESC_AMOUNT_2_SPLIT],
        );

        // Display the 'Amt removing'
        mprintf(
          gMapMoneyStats[1].sX + gsInvDescX,
          gMapMoneyStats[1].sY + gsInvDescY,
          "%s",
          gMoneyStatsDesc[Enum373.MONEY_DESC_REMAINING],
        );
        // Display the 'REmaining amount'
        mprintf(
          gMapMoneyStats[3].sX + gsInvDescX,
          gMapMoneyStats[3].sY + gsInvDescY,
          "%s",
          gMoneyStatsDesc[Enum373.MONEY_DESC_TO_SPLIT],
        );
        ...
        RenderItemDescriptionBox__pStr = swprintf(
          "%ld",
          gpItemDescObject.uiMoneyAmount,
        );
        RenderItemDescriptionBox__pStr = InsertCommasForDollarFigure(
          RenderItemDescriptionBox__pStr,
        );
        ...
        if (Item[gpItemDescObject.usItem].usItemClass & IC_AMMO) {
          mprintf(
            gMapWeaponStats[2].sX + gsInvDescX,
            gMapWeaponStats[2].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[2],
          );
        } else {
        ...
        if (Item[gpItemDescObject.usItem].usItemClass & IC_AMMO) {
          ...
          RenderItemDescriptionBox__pStr = swprintf(
            "%d/%d",
            gpItemDescObject.ubShotsLeft[0],
          ...
          ({ sX: sStrX, sY: usY } = FindFontRightCoordinates(
            gMapWeaponStats[2].sX + gsInvDescX + gMapWeaponStats[2].sValDx + 6,
            gMapWeaponStats[2].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        if (
          InKeyRingPopup() == true ||
          Item[gpItemDescObject.usItem].usItemClass & IC_KEY
        ) {
          SetFontForeground(6);
          ...
          RenderItemDescriptionBox__pStr = swprintf(
            "%s",
            sKeyDescriptionStrings[1],
          );
          mprintf(
            gMapWeaponStats[4].sX + gsInvDescX,
            gMapWeaponStats[4].sY + gsInvDescY + GetFontHeight(BLOCKFONT()) + 2,
            RenderItemDescriptionBox__pStr,
          );

          SetFontForeground(5);
          sTempString = GetShortSectorString(
            SECTORX(KeyTable[gpItemDescObject.ubKeyID].usSectorFound),
            SECTORY(KeyTable[gpItemDescObject.ubKeyID].usSectorFound),
          );
          ...
          RenderItemDescriptionBox__pStr = swprintf(
            "%d",
            KeyTable[gpItemDescObject.ubKeyID].usDateFound,
          );
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gMapWeaponStats[4].sX + gsInvDescX,
            gMapWeaponStats[4].sY + gsInvDescY + GetFontHeight(BLOCKFONT()) + 2,
      ...
      if (gpItemDescObject.usItem == Enum225.MONEY) {
        ...
        BltVideoObjectFromIndex(
          ...
          guiMoneyGraphicsForDescBox,
          0,
          gsInvDescX + gItemDescAttachmentsXY[0].sX - 1,
          gsInvDescY + gItemDescAttachmentsXY[0].sY - 2,
          VO_BLT_SRCTRANSPARENCY,
          null,
        );
      }
      ...
      DrawItemUIBarEx(
        ...
        ITEMDESC_ITEM_STATUS_Y(),
        ITEMDESC_ITEM_STATUS_WIDTH,
        ITEMDESC_ITEM_STATUS_HEIGHT,
        Get16BPPColor(DESC_STATUS_BAR()),
        Get16BPPColor(DESC_STATUS_BAR_SHADOW()),
        true,
        guiSAVEBUFFER,
      ...
      for (cnt = 0; cnt < MAX_ATTACHMENTS; cnt++) {
        ...
        if (fHatchOutAttachments) {
          ...
          DrawHatchOnInventory(
            guiSAVEBUFFER,
            gsInvDescX + gItemDescAttachmentsXY[cnt].sX,
            gsInvDescY + gItemDescAttachmentsXY[cnt].sY - 2,
            gItemDescAttachmentsXY[cnt].sWidth +
              gItemDescAttachmentsXY[cnt].sBarDx,
            gItemDescAttachmentsXY[cnt].sHeight + 2,
          );
        }
      }
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          for (
            ...
            BltVideoObjectFromIndex(
              ...
              guiBullet,
              0,
              BULLET_BURST_X() + cnt * (BULLET_WIDTH + 1),
              BULLET_BURST_Y(),
              VO_BLT_SRCTRANSPARENCY,
              null,
            );
      ...
      DisplayWrappedString(
        ITEMDESC_DESC_START_X(),
        ITEMDESC_DESC_START_Y(),
        ITEMDESC_DESC_WIDTH,
        2,
        ITEMDESC_FONT(),
        FONT_BLACK,
      ...
      if (ITEM_PROS_AND_CONS(gpItemDescObject.usItem)) {
        ...
        if (gzItemCons != "") {
          ...
          SetFontShadow(ITEMDESC_FONTSHADOW2);
          DisplayWrappedString(
            ITEMDESC_CONS_START_X() + sProsConsIndent,
            ITEMDESC_CONS_START_Y(),
            ITEMDESC_DESC_WIDTH - sProsConsIndent,
            2,
            ITEMDESC_FONT(),
            FONT_BLACK,
      ...
      if (Item[gpItemDescObject.usItem].usItemClass & IC_WEAPON) {
        ...
        sTempString = swprintf(gWeaponStatsDesc[0], GetWeightUnitString());
        mprintf(
          gWeaponStats[0].sX + gsInvDescX,
          gWeaponStats[0].sY + gsInvDescY,
          sTempString,
        );
        ...
        if (
          ...
          mprintf(
            gWeaponStats[3].sX + gsInvDescX,
            gWeaponStats[3].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[3],
          );
        }
        if (
          ...
          mprintf(
            gWeaponStats[4].sX + gsInvDescX,
            gWeaponStats[4].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[4],
          );
        }
        mprintf(
          gWeaponStats[5].sX + gsInvDescX,
          gWeaponStats[5].sY + gsInvDescY,
          "%s",
          gWeaponStatsDesc[5],
        );
        if (Item[gpItemDescObject.usItem].usItemClass & IC_GUN) {
          mprintf(
            gWeaponStats[7].sX + gsInvDescX,
            gWeaponStats[7].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[7],
          );
        }
        mprintf(
          gWeaponStats[1].sX + gsInvDescX,
          gWeaponStats[1].sY + gsInvDescY,
          "%s",
          gWeaponStatsDesc[1],
        );
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          mprintf(
            gWeaponStats[8].sX + gsInvDescX,
            gWeaponStats[8].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[8],
          );
        }
        ...
        RenderItemDescriptionBox__pStr = swprintf(
          "%s%%",
          gpItemDescObject.bGunStatus.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gWeaponStats[1].sX + gsInvDescX + gWeaponStats[1].sValDx,
          gWeaponStats[1].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gWeaponStats[0].sX + gsInvDescX + gWeaponStats[0].sValDx,
          gWeaponStats[0].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        if (
          ...
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gWeaponStats[3].sX + gsInvDescX + gWeaponStats[3].sValDx,
            gWeaponStats[3].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        if (
          ...
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gWeaponStats[4].sX + gsInvDescX + gWeaponStats[4].sValDx,
            gWeaponStats[4].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gWeaponStats[5].sX + gsInvDescX + gWeaponStats[5].sValDx,
          gWeaponStats[5].sY + gsInvDescY,
          ITEM_STATS_WIDTH,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        if (Weapon[gpItemDescObject.usItem].ubShotsPerBurst > 0) {
          ...
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gWeaponStats[6].sX + gsInvDescX + gWeaponStats[6].sValDx,
            gWeaponStats[6].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
            BLOCKFONT2(),
        ...
        if (gfAddingMoneyToMercFromPlayersAccount)
          mprintf(
            gMoneyButtonLoc.x + gMoneyButtonOffsets[4].x,
            gMoneyButtonLoc.y + gMoneyButtonOffsets[4].y,
            gzMoneyAmounts[5],
          );
        else
          mprintf(
        ...
        if (gfAddingMoneyToMercFromPlayersAccount) {
          // Display the 'Removing'
          mprintf(
            gMoneyStats[0].sX + gsInvDescX,
            gMoneyStats[0].sY + gsInvDescY,
            "%s",
            gMoneyStatsDesc[Enum373.MONEY_DESC_PLAYERS],
          );
          // Display the 'REmaining'
          mprintf(
            gMoneyStats[2].sX + gsInvDescX,
            gMoneyStats[2].sY + gsInvDescY,
            "%s",
            gMoneyStatsDesc[Enum373.MONEY_DESC_AMOUNT_2_WITHDRAW],
          );
        } else {
          // Display the 'Removing'
          mprintf(
        ...
        if (gfAddingMoneyToMercFromPlayersAccount) {
          // Display the 'Amt removing'
          mprintf(
            gMoneyStats[1].sX + gsInvDescX,
            gMoneyStats[1].sY + gsInvDescY,
            "%s",
            gMoneyStatsDesc[Enum373.MONEY_DESC_BALANCE],
          );
          // Display the 'REmaining amount'
          mprintf(
            gMoneyStats[3].sX + gsInvDescX,
            gMoneyStats[3].sY + gsInvDescY,
            "%s",
            gMoneyStatsDesc[Enum373.MONEY_DESC_TO_WITHDRAW],
          );
        } else {
          // Display the 'Amt removing'
          mprintf(
        ...
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gMoneyStats[1].sX + gsInvDescX + gMoneyStats[1].sValDx,
          gMoneyStats[1].sY + gsInvDescY,
          ITEM_STATS_WIDTH - 3,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          gMoneyStats[3].sX + gsInvDescX + gMoneyStats[3].sValDx,
          gMoneyStats[3].sY + gsInvDescY,
          ITEM_STATS_WIDTH - 3,
          ITEM_STATS_HEIGHT,
          RenderItemDescriptionBox__pStr,
        ...
        if (Item[gpItemDescObject.usItem].usItemClass & IC_AMMO) {
          // Status
          mprintf(
            gWeaponStats[2].sX + gsInvDescX,
            gWeaponStats[2].sY + gsInvDescY,
            "%s",
            gWeaponStatsDesc[2],
          );
        } else {
        ...
        if (Item[gpItemDescObject.usItem].usItemClass & IC_AMMO) {
          ...
          ({ sX: usX, sY: usY } = FindFontRightCoordinates(
            gWeaponStats[2].sX + gsInvDescX + gWeaponStats[2].sValDx,
            gWeaponStats[2].sY + gsInvDescY,
            ITEM_STATS_WIDTH,
            ITEM_STATS_HEIGHT,
            RenderItemDescriptionBox__pStr,
        ...
        if (
          ...
          mprintf(
            gWeaponStats[4].sX + gsInvDescX,
            gWeaponStats[4].sY + gsInvDescY + GetFontHeight(BLOCKFONT()) + 2,
            RenderItemDescriptionBox__pStr,
          );
  ...
  export function DeleteItemDescriptionBox(): void {
        ...
        for (cnt = 0; cnt < MAX_ATTACHMENTS; cnt++) {
          if (gusOriginalAttachItem[cnt] != NOTHING) {
            ...
            for (cnt2 = 0; cnt2 < MAX_ATTACHMENTS; cnt2++) {
              if (
                gusOriginalAttachItem[cnt] ==
                  gpItemDescObject.usAttachItem[cnt2] &&
                gpItemDescObject.bAttachStatus[cnt2] ==
                  gbOriginalAttachStatus[cnt]
              ) {
                fFound = true;
              }
            }
        ...
        if (fAllFound) {
          ...
          for (cnt = 0; cnt < MAX_ATTACHMENTS; cnt++) {
            if (gpItemDescObject.usAttachItem[cnt] != NOTHING) {
              ...
              for (cnt2 = 0; cnt2 < MAX_ATTACHMENTS; cnt2++) {
                if (
                  gpItemDescObject.usAttachItem[cnt] ==
                    gusOriginalAttachItem[cnt2] &&
                  gbOriginalAttachStatus[cnt2] ==
                    gpItemDescObject.bAttachStatus[cnt]
                ) {
                  fFound = true;
                }
              }
    ...
    if (gpItemDescObject.usItem == Enum225.MONEY) {
      ...
      if (
        gRemoveMoney.uiMoneyRemaining == 0 &&
        !gfAddingMoneyToMercFromPlayersAccount
      ) {
  ...
  export function InternalBeginItemPointer(
    pSoldier: SOLDIERTYPE,
    pObject: OBJECTTYPE,
    bHandPos: INT8,
  ): void {
  ...
  export function BeginItemPointer(
    pSoldier: SOLDIERTYPE,
    ubHandPos: UINT8,
  ): void {
    let fOk: boolean;
  ...
  export function BeginKeyRingItemPointer(
    pSoldier: SOLDIERTYPE,
    ubKeyRingPosition: UINT8,
  ): void {
    let fOk: boolean;
    ...
    if (_KeyDown(SHIFT)) {
      // Remove all from soldier's slot
      fOk = RemoveKeysFromSlot(
        pSoldier,
        ubKeyRingPosition,
        pSoldier.pKeyRing[ubKeyRingPosition].ubNumber,
        gItemPointer,
      );
    } else {
  ...
  function SoldierCanSeeCatchComing(
    pSoldier: SOLDIERTYPE,
    sSrcGridNo: INT16,
  ): boolean {
    return true;
  ...
  export function DrawItemTileCursor(): void {
    ...
    if (
      ...
      if (!fGiveItem) {
          ...
          if (gfUIFullTargetFound) {
            ...
            if (
              ...
              if (sDist <= PASSING_ITEM_DISTANCE_OKLIFE) {
                ...
                if (
                  SoldierCanSeeCatchComing(
                    pSoldier,
                    gpItemPointerSoldier.sGridNo,
                  )
                ) {
        ...
        // If we are tossing...
        if (
          (sDist <= 1 && gfUIMouseOnValidCatcher == 0) ||
          gfUIMouseOnValidCatcher == 4
        ) {
          ...
          // ( sDist > PASSING_ITEM_DISTANCE_OKLIFE )
            ...
            if (fRecalc && usMapPos != gpItemPointerSoldier.sGridNo) {
              if (gfUIMouseOnValidCatcher) {
                switch (
                  gAnimControl[MercPtrs[gubUIValidCatcherID].usAnimState]
                    .ubHeight
                ) {
                  case ANIM_STAND:
                    sEndZ = 150;
  ...
  function IsValidAmmoToReloadRobot(
    pSoldier: SOLDIERTYPE,
    pObject: OBJECTTYPE,
  ): boolean {
    if (!CompatibleAmmoForGun(pObject, pSoldier.inv[Enum261.HANDPOS])) {
      ...
      ScreenMsg(
        ...
        MSG_UI_FEEDBACK,
        TacticalStr[Enum335.ROBOT_NEEDS_GIVEN_CALIBER_STR],
        AmmoCaliber[Weapon[pSoldier.inv[Enum261.HANDPOS].usItem].ubCalibre],
      );
  ...
  export function HandleItemPointerClick(usMapPos: UINT16): boolean {
    ...
    if (
      AM_AN_EPC(gpItemPointerSoldier) ||
      gpItemPointerSoldier.bLife < OKLIFE ||
      gpItemPointerSoldier.bOverTerrainType == Enum315.DEEP_WATER
    ) {
      return false;
    }
    ...
    if (gfUIFullTargetFound) {
      ...
      if (
        gAnimControl[MercPtrs[gusUIFullTargetID].usAnimState].uiFlags &
        ANIM_MOVING
      ) {
        return false;
      }
    ...
    */
      ...
      if (EnoughPoints(gpItemPointerSoldier, sAPCost, 0, true)) {
        ...
        if (MercPtrs[ubSoldierID].uiStatusFlags & SOLDIER_ROBOT) {
            ...
            if (sActionGridNo != -1 && gbItemPointerSrcSlot != NO_SLOT) {
              ...
              if (gpItemPointerSoldier.sGridNo != sActionGridNo) {
                ...
                EVENT_InternalGetNewSoldierPath(
                  gpItemPointerSoldier,
                  sActionGridNo,
                  gpItemPointerSoldier.usUIMovementMode,
                  0,
                  false,
                );
              } else {
          ...
          // if (gbItemPointerSrcSlot != NO_SLOT )
          {
            ...
            if (
              MercPtrs[ubSoldierID].ubProfile < FIRST_RPC ||
    ...
    if (
      sDist <= 1 &&
      !(gfUIFullTargetFound && gusUIFullTargetID != gpItemPointerSoldier.ubID)
    ) {
            ...
            case ANIM_STAND:
              ...
              if (gpItemPointerSoldier.pTempObject != null) {
                ...
                EVENT_SetSoldierDesiredDirection(
                  gpItemPointerSoldier,
                  GetDirectionFromGridNo(usMapPos, gpItemPointerSoldier),
                );

                EVENT_InitNewSoldierAnim(
                  gpItemPointerSoldier,
                  Enum193.DROP_ADJACENT_OBJECT,
                  0,
                  false,
                );
              }
      ...
      if (
        ...
        // OK, do the transfer...
        {
...

          {
            ...
            if (
              !EnoughPoints(pSoldier, 3, 0, true) ||
            ...
            if (AutoPlaceObject(pSoldier, gpItemPointer, true)) {
              ScreenMsg(
                FONT_MCOLOR_LTYELLOW,
                MSG_INTERFACE,
                pMessageStrings[Enum333.MSG_ITEM_PASSED_TO_MERC],
              ...
              // OK, make guys turn towards each other and do animation...
              {
                ...
                ubFacingDirection = GetDirectionFromGridNo(
                  gpItemPointerSoldier.sGridNo,
                  pSoldier,
                );
                ...
                if (
                  gAnimControl[gpItemPointerSoldier.usAnimState].ubEndHeight ==
                    ANIM_STAND &&
              ...
              ScreenMsg(
                FONT_MCOLOR_LTYELLOW,
                MSG_INTERFACE,
                pMessageStrings[Enum333.MSG_NO_ROOM_TO_PASS_ITEM],
                ShortItemNames[usItem],
                pSoldier.name,
              );
              return false;
        ...
        if (gfBadThrowItemCTGH) {
          ScreenMsg(
            FONT_MCOLOR_LTYELLOW,
            MSG_UI_FEEDBACK,
            TacticalStr[Enum335.CANNOT_THROW_TO_DEST_STR],
          );
          return false;
        }
        ...
        if (gfUIFullTargetFound) {
          ...
          if (
            ...
            // How's our direction?
            if (
              SoldierCanSeeCatchComing(pSoldier, gpItemPointerSoldier.sGridNo)
            ) {
              ...
              // Get direction
              ubDirection = GetDirectionFromGridNo(
                gpItemPointerSoldier.sGridNo,
                pSoldier,
              );
        ...
        DebugMsg(
          ...
          DBG_LEVEL_3,
          FormatString(
            "INcremtning ABC: Throw item to %d",
            gTacticalStatus.ubAttackBusyCount,
          ),
        );
  ...
  function ItemCursorInLobRange(usMapPos: UINT16): boolean {
    ...
    if (
      GetRangeFromGridNoDiff(usMapPos, gpItemPointerSoldier.sGridNo) >
      MIN_LOB_RANGE
    ) {
      return false;
    } else {
  ...
  export function InitItemStackPopup(
    pSoldier: SOLDIERTYPE,
    ubPosition: UINT8,
    sInvX: INT16,
    sInvY: INT16,
    ...
    ({ sWidth: sItemSlotWidth, sHeight: sItemSlotHeight } =
      GetSlotInvHeightWidth(ubPosition));
    ...
    sCenX =
      sX - (Math.trunc(gsItemPopupWidth / 2) + Math.trunc(sItemSlotWidth / 2));
    sCenY = sY;
    ...
    for (cnt = 0; cnt < gubNumItemPopups; cnt++) {
      ...
      SetRegionFastHelpText(
        gItemPopupRegions[cnt],
        ItemNames[pSoldier.inv[ubPosition].usItem],
      );
  ...
  export function InitKeyRingPopup(
    pSoldier: SOLDIERTYPE,
    sInvX: INT16,
    sInvY: INT16,
    sInvWidth: INT16,
    ...
    for (cnt = 0; cnt < NUMBER_KEYS_ON_KEYRING; cnt++) {
      ...
      MSYS_DefineRegion(
        gKeyRingRegions[cnt],
        gsKeyRingPopupInvX +
          (cnt % sKeyRingItemWidth) * usPopupWidth +
          sOffSetX, // top left
        sInvY +
          sOffSetY +
          Math.trunc((cnt / sKeyRingItemWidth) * usPopupHeight), // top right
        gsKeyRingPopupInvX +
          ((cnt % sKeyRingItemWidth) + 1) * usPopupWidth +
          sOffSetX, // bottom left
        sInvY +
          (Math.trunc(cnt / sKeyRingItemWidth) + 1) * usPopupHeight +
          sOffSetY, // bottom right
        MSYS_PRIORITY_HIGHEST,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
        KeyRingSlotInvClickCallback,
      );
      // Add region
  ...
  export function RenderKeyRingPopup(fFullRender: boolean): void {
    ...
    for (cnt = 0; cnt < NUMBER_KEYS_ON_KEYRING; cnt++) {
      BltVideoObjectFromIndex(
        ...
        guiItemPopupBoxes,
        0,
        gsKeyRingPopupInvX + (cnt % sKeyRingItemWidth) * usWidth + sOffSetX,
        gsKeyRingPopupInvY +
          sOffSetY +
          Math.trunc((cnt / sKeyRingItemWidth) * usHeight),
        VO_BLT_SRCTRANSPARENCY,
        null,
      );
      ...
      if (
        gpItemPopupSoldier.pKeyRing[cnt].ubKeyID != INVALID_KEY_NUMBER &&
        ...
        pObject.usItem =
          FIRST_KEY +
          LockTable[gpItemPopupSoldier.pKeyRing[cnt].ubKeyID].usKeyItem;
  ...
  export function LoadTileGraphicForItem(
    pItem: INVTYPE,
    puiVo: Pointer<UINT32>,
  ): boolean {
  ...
  function ItemPopupRegionCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let uiItemPos: UINT32;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (gpItemPointer != null) {
        if (
          !PlaceObjectAtObjectIndex(gpItemPointer, gpItemPopupObject, uiItemPos)
        ) {
          if (guiTacticalInterfaceFlags & INTERFACE_MAPSCREEN) {
            MAPEndItemPointer();
          } else {
  ...
  function ItemPopupFullRegionCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let uiItemPos: UINT32;
  ...
  export function SetItemPickupMenuDirty(
    fDirtyLevel: UINT8 /* boolean */,
  ): void {
    gItemPickupMenu.fDirtyLevel = fDirtyLevel;
  }

  export function InitializeItemPickupMenu(
    pSoldier: SOLDIERTYPE,
    sGridNo: INT16,
    pItemPool: ITEM_POOL | null,
    sScreenX: INT16,
    sScreenY: INT16,
    bZLevel: INT8,
  ): boolean {
    ...
    gItemPickupMenu.pfSelectedArray = createArray(
      gItemPickupMenu.ubTotalItems,
      false,
    );
    ...
    gItemPickupMenu.iUpButtonImages = LoadButtonImage(
      ubString,
      -1,
      5,
      -1,
    ...
    gItemPickupMenu.iDownButtonImages = UseLoadedButtonImage(
      gItemPickupMenu.iUpButtonImages,
      -1,
      7,
      -1,
      12,
    ...
    gItemPickupMenu.iAllButtonImages = UseLoadedButtonImage(
      gItemPickupMenu.iUpButtonImages,
      -1,
      6,
      -1,
    ...
    gItemPickupMenu.iCancelButtonImages = UseLoadedButtonImage(
      gItemPickupMenu.iUpButtonImages,
      -1,
      8,
      -1,
    ...
    gItemPickupMenu.iOKButtonImages = UseLoadedButtonImage(
      gItemPickupMenu.iUpButtonImages,
      -1,
      4,
      -1,
    ...
    if (
      ...
      gItemPickupMenu.iUpButton = QuickCreateButton(
        gItemPickupMenu.iUpButtonImages,
        sX + ITEMPICK_UP_X,
        sY + gItemPickupMenu.sButtomPanelStartY + ITEMPICK_UP_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST,
        DEFAULT_MOVE_CALLBACK(),
        ItemPickupScrollUp,
      ...
      gItemPickupMenu.iDownButton = QuickCreateButton(
        ...
        sX + ITEMPICK_DOWN_X,
        sY + gItemPickupMenu.sButtomPanelStartY + ITEMPICK_DOWN_Y,
        BUTTON_TOGGLE,
        MSYS_PRIORITY_HIGHEST,
        DEFAULT_MOVE_CALLBACK(),
        ItemPickupScrollDown,
      );

      SetButtonFastHelpText(
        gItemPickupMenu.iDownButton,
        ItemPickupHelpPopup[3],
      );
    }
    ...
    gItemPickupMenu.iOKButton = QuickCreateButton(
      ...
      sX + ITEMPICK_OK_X,
      sY + gItemPickupMenu.sButtomPanelStartY + ITEMPICK_OK_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGHEST,
      DEFAULT_MOVE_CALLBACK(),
      ItemPickupOK,
    ...
    gItemPickupMenu.iAllButton = QuickCreateButton(
      ...
      sX + ITEMPICK_ALL_X,
      sY + gItemPickupMenu.sButtomPanelStartY + ITEMPICK_ALL_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGHEST,
      DEFAULT_MOVE_CALLBACK(),
      ItemPickupAll,
    ...
    gItemPickupMenu.iCancelButton = QuickCreateButton(
      ...
      sX + ITEMPICK_CANCEL_X,
      sY + gItemPickupMenu.sButtomPanelStartY + ITEMPICK_CANCEL_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGHEST,
      DEFAULT_MOVE_CALLBACK(),
      ItemPickupCancel,
    ...
    SetButtonFastHelpText(
      gItemPickupMenu.iCancelButton,
      ItemPickupHelpPopup[4],
    );
  ...
  function SetupPickupPage(bPage: INT8): void {
    ...
    for (cnt = 0; cnt < iEnd; ) {
      ...
      if (cnt >= iStart) {
        ...
        SetRegionFastHelpText(
          gItemPickupMenu.Regions[cnt - iStart],
          SetupPickupPage__pStr,
        );
      }
  ...
  function CalculateItemPickupMenuDimensions(): void {
    ...
    for (cnt = 0; cnt < gItemPickupMenu.bNumSlotsPerPage; cnt++) {
      ...
      ({ usWidth, usHeight } = GetVideoObjectETRLESubregionProperties(
        gItemPickupMenu.uiPanelVo,
        usSubRegion,
      ));
  ...
  export function SetPickUpMenuDirtyLevel(
    fDirtyLevel: UINT8 /* boolean */,
  ): void {
    gItemPickupMenu.fDirtyLevel = fDirtyLevel;
    ...
    if (gItemPickupMenu.fDirtyLevel == DIRTYLEVEL2) {
      ...
      for (cnt = 0; cnt < gItemPickupMenu.bNumSlotsPerPage; cnt++) {
        if (gItemPickupMenu.ItemPoolSlots[cnt] != null) {
          ...
          pObject =
            gWorldItems[
              (<ITEM_POOL>gItemPickupMenu.ItemPoolSlots[cnt]).iItemIndex
            ].o;
          pItem = Item[pObject.usItem];
          ...
          // else
          {
            if (
              gItemPickupMenu.pfSelectedArray[
                cnt + gItemPickupMenu.ubScrollAnchor
              ]
            ) {
              ...
              Blt8BPPDataTo16BPPBufferOutline(
                pDestBuf,
                uiDestPitchBYTES,
                gTileDatabase[usItemTileIndex].hTileSurface,
                sCenX,
                sCenY,
                gTileDatabase[usItemTileIndex].usRegionIndex,
                Get16BPPColor(FROMRGB(255, 255, 0)),
                true,
              );
            } else {
              // SetFontForeground( FONT_BLACK );
          ...
          if (pObject.ubNumberOfObjects > 1) {
            ...
            ({ sX: sFontX, sY: sFontY } = VarFindFontRightCoordinates(
              sCenX,
              sCenY,
              42,
              1,
          ...
          sCenY =
            ITEMPICK_TEXT_Y + gItemPickupMenu.sY + ITEMPICK_TEXT_YSPACE * cnt;
  ...
  function ItemPickupOK(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      // Tell our soldier to pickup this item!
      SoldierGetItemFromWorld(
        gItemPickupMenu.pSoldier,
        ITEM_PICKUP_SELECTION,
        gItemPickupMenu.sGridNo,
        gItemPickupMenu.bZLevel,
        gItemPickupMenu.pfSelectedArray,
      );
    } else if (reason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      btn.uiFlags &= ~BUTTON_CLICKED_ON;
  ...
  function ItemPickMenuMouseMoveCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let uiItemPos: UINT32;
    ...
    if (iReason & MSYS_CALLBACK_REASON_MOVE) {
      ...
      if (bPos < gItemPickupMenu.ubTotalItems) {
        ...
        if (!ItemPickMenuMouseMoveCallback__bChecked) {
          ...
          pTempItemPool = <ITEM_POOL>(
            gItemPickupMenu.ItemPoolSlots[
              gItemPickupMenu.bCurSelect - gItemPickupMenu.ubScrollAnchor
            ]
          );

          copyObjectType(
            gItemPickupMenu.CompAmmoObject,
          ...
          HandleAnyMercInSquadHasCompatibleStuff(
            CurrentSquad(),
            gWorldItems[pTempItemPool.iItemIndex].o,
            false,
          );
  ...
  function ItemPickupBackgroundClick(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function ItemPickMenuMouseClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let uiItemPos: INT32;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (
        uiItemPos + gItemPickupMenu.ubScrollAnchor <
        gItemPickupMenu.ubTotalItems
      ) {
  ...
  export function GetHelpTextForItem(
    pObject: OBJECTTYPE,
    pSoldier: SOLDIERTYPE | null,
  ): string {
    ...
    if (usItem == Enum225.MONEY) {
      ...
      if (
        !gGameOptions.fGunNut &&
        Item[usItem].usItemClass == IC_GUN &&
        usItem != Enum225.ROCKET_LAUNCHER &&
        usItem != Enum225.ROCKET_RIFLE
      ) {
        pStr = swprintf(
          "%s (%s)",
          ItemNames[usItem],
      ...
      if (
        (pObject.usItem == Enum225.ROCKET_RIFLE ||
          pObject.usItem == Enum225.AUTO_ROCKET_RIFLE) &&
  ...
  function readItemCursorSaveInfo(
    o: ITEM_CURSOR_SAVE_INFO,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  function writeItemCursorSaveInfo(
    o: ITEM_CURSOR_SAVE_INFO,
    buffer: Buffer,
    offset: number = 0,
  ): number {
