namespace ja2 {
  ...
  let gusHeliSeats: UINT8[] /* [MAX_MERC_IN_HELI] */ = createArray(
    MAX_MERC_IN_HELI,
    0,
  );
    ...
    if (gfHandleHeli) {
      ...
      if (_KeyDown(ESC)) {
        ...
        for (cnt = gbCurDrop; cnt < gbNumHeliSeatsOccupied; cnt++) {
          // Add merc to sector
          MercPtrs[gusHeliSeats[cnt]].ubStrategicInsertionCode =
      ...
      if (uiClock - guiHeliLastUpdate > ME_SCRIPT_DELAY) {
          ...
          if (!gfIngagedInDrop) {
            ...
            if (gbCurDrop < bEndVal) {
              ...
              EVENT_InitNewSoldierAnim(
                MercPtrs[gusHeliSeats[gbCurDrop]],
                Enum193.HELIDROP,
                0,
                false,
              );
              ...
              MercPtrs[gusHeliSeats[gbCurDrop]].ubStrategicInsertionCode =
                Enum175.INSERTION_CODE_NORTH;
              ...
              if (gfFirstGuyDown) {
                ...
                SetCurrentSquad(
                  MercPtrs[gusHeliSeats[gbCurDrop]].bAssignment,
                  true,
                );
              }
              ScreenMsg(
        ...
        switch (ubScriptCode) {
          ...
          case Enum233.HELI_SHOW_HELI:
            ...
            AniParams.uiFlags =
              ANITILE_CACHEDTILE | ANITILE_FORWARD | ANITILE_LOOPING;
  ...
  function HandleFirstHeliDropOfGame(): void {
    ...
    CharacterDialogueWithSpecialEvent(
      ...
      false,
      false,
      DIALOGUE_SPECIAL_EVENT_ENABLE_AI,
      0,
      0,
    );
  }
