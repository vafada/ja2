namespace ja2 {
  ...
  export function copyBasicSoldierCreateStruct(
    destination: BASIC_SOLDIERCREATE_STRUCT,
    source: BASIC_SOLDIERCREATE_STRUCT,
  ) {
  ...
  export function readBasicSoldierCreateStruct(
    o: BASIC_SOLDIERCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.fDetailedPlacement = Boolean(buffer.readUInt8(offset++));
    offset++; // padding
    o.usStartingGridNo = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeBasicSoldierCreateStruct(
    o: BASIC_SOLDIERCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function copySoldierCreateStruct(
    destination: SOLDIERCREATE_STRUCT,
    source: SOLDIERCREATE_STRUCT,
  ) {
  ...
  export function readSoldierCreateStruct(
    o: SOLDIERCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeSoldierCreateStruct(
    o: SOLDIERCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
