namespace ja2 {
  export function HandleRPCDescription(): void {
    ...
    // Are we a SAM site?
    if (
      gTacticalStatus.ubGuideDescriptionToUse == 27 ||
        ...
        if (RPC_RECRUITED(pTeamSoldier)) {
          if (
            ...
            if (
              ...
              pTeamSoldier.ubProfile == Enum268.CARLOS ||
    ...
    if (
      ...
      for (
        ...
        if (
          ...
          if (
            pSoldier.uiXRayActivatedTime &&
            uiTime > pSoldier.uiXRayActivatedTime + XRAY_TIME
          ) {
