namespace ja2 {
  ...
  export function readBullet(
    o: BULLET,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.iBullet = buffer.readInt32LE(offset);
    offset += 4;
    ...
    o.sGridNo = buffer.readUInt32LE(offset);
    offset += 4;
    o.sUnused = buffer.readInt16LE(offset);
    offset += 2;
    o.usLastStructureHit = buffer.readUInt16LE(offset);
    offset += 2;
    o.qCurrX = buffer.readInt32LE(offset);
    offset += 4;
    o.qCurrY = buffer.readInt32LE(offset);
    offset += 4;
    o.qCurrZ = buffer.readInt32LE(offset);
    offset += 4;
    o.qIncrX = buffer.readInt32LE(offset);
    offset += 4;
    o.qIncrY = buffer.readInt32LE(offset);
    offset += 4;
    o.qIncrZ = buffer.readInt32LE(offset);
    offset += 4;
    o.ddHorizAngle = buffer.readDoubleLE(offset);
    offset += 8;
    o.iCurrTileX = buffer.readInt32LE(offset);
    offset += 4;
    o.iCurrTileY = buffer.readInt32LE(offset);
    offset += 4;
    o.bLOSIndexX = buffer.readInt8(offset++);
    o.bLOSIndexY = buffer.readInt8(offset++);
    o.fCheckForRoof = Boolean(buffer.readUInt8(offset++));
    offset++; // padding
    o.iCurrCubesZ = buffer.readInt32LE(offset);
    offset += 4;
    o.iLoop = buffer.readInt32LE(offset);
    offset += 4;
    ...
    offset += 3; // padding
    o.uiLastUpdate = buffer.readUInt32LE(offset);
    offset += 4;
    o.ubTilesPerUpdate = buffer.readUInt8(offset++);
    offset++; // padding
    o.usClockTicksPerUpdate = buffer.readUInt16LE(offset);
    offset += 2;
    offset += 4; // pFirer (pointer)
    o.sTargetGridNo = buffer.readUInt32LE(offset);
    offset += 4;
    o.sHitBy = buffer.readInt16LE(offset);
    offset += 2;
    offset += 2; // padding
    o.iImpact = buffer.readInt32LE(offset);
    offset += 4;
    o.iImpactReduction = buffer.readInt32LE(offset);
    offset += 4;
    o.iRange = buffer.readInt32LE(offset);
    offset += 4;
    o.iDistanceLimit = buffer.readInt32LE(offset);
    offset += 4;
