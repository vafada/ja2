namespace ja2 {
  ...
  let gusOverlayPopupBoxWidth__Pointer = createPointer(
    () => gusOverlayPopupBoxWidth,
    (v) => (gusOverlayPopupBoxWidth = v),
  );
  let gusOverlayPopupBoxHeight: UINT16;
  let gusOverlayPopupBoxHeight__Pointer = createPointer(
    () => gusOverlayPopupBoxHeight,
    (v) => (gusOverlayPopupBoxHeight = v),
  );
  let gpOverrideMercBox: MercPopUpBox = createMercPopUpBox();

  export let giUIMessageOverlay: INT32 = -1;
  let gusUIMessageWidth: UINT16;
  let gusUIMessageWidth__Pointer = createPointer(
    () => gusUIMessageWidth,
    (v) => (gusUIMessageWidth = v),
  );
  let gusUIMessageHeight: UINT16;
  let gusUIMessageHeight__Pointer = createPointer(
    () => gusUIMessageHeight,
    (v) => (gusUIMessageHeight = v),
  );
  ...
  let iIconImages: INT32[] /* [NUM_ICON_IMAGES] */ = createArray(
    Enum208.NUM_ICON_IMAGES,
    0,
  );
  ...
  let iActionIcons: INT32[] /* [NUM_ICONS] */ = createArray(
    Enum209.NUM_ICONS,
    0,
  );
  ...
  export let fInterfacePanelDirty__Pointer = createPointer(
    () => fInterfacePanelDirty,
    (v) => (fInterfacePanelDirty = v),
  );
  ...
  export function InitializeTacticalInterface(): boolean {
    ...
    iIconImages[Enum208.WALK_IMAGES] = LoadButtonImage(
      "INTERFACE\\newicons3.sti",
      -1,
      3,
      4,
    ...
    iIconImages[Enum208.SNEAK_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      6,
      7,
      8,
    ...
    iIconImages[Enum208.RUN_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      0,
      1,
    ...
    iIconImages[Enum208.CRAWL_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      9,
      10,
    ...
    iIconImages[Enum208.LOOK_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      12,
      13,
    ...
    iIconImages[Enum208.TALK_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      21,
      22,
    ...
    iIconImages[Enum208.HAND_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      18,
      19,
    ...
    iIconImages[Enum208.CANCEL_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      15,
      16,
    ...
    iIconImages[Enum208.TARGETACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      24,
      25,
    ...
    iIconImages[Enum208.KNIFEACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      27,
      28,
    ...
    iIconImages[Enum208.AIDACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      30,
      31,
    ...
    iIconImages[Enum208.PUNCHACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      33,
      34,
    ...
    iIconImages[Enum208.BOMBACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      36,
      37,
    ...
    iIconImages[Enum208.TOOLKITACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      39,
      40,
    ...
    iIconImages[Enum208.WIRECUTACTIONC_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.WALK_IMAGES],
      -1,
      42,
      43,
    ...
    iIconImages[Enum208.OPEN_DOOR_IMAGES] = LoadButtonImage(
      "INTERFACE\\door_op2.sti",
      -1,
      9,
      10,
      11,
    ...
    iIconImages[Enum208.EXAMINE_DOOR_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      12,
      13,
      14,
    ...
    iIconImages[Enum208.LOCKPICK_DOOR_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      21,
      22,
    ...
    iIconImages[Enum208.BOOT_DOOR_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      25,
      26,
    ...
    iIconImages[Enum208.CROWBAR_DOOR_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      0,
      1,
    ...
    iIconImages[Enum208.USE_KEY_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      3,
      4,
    ...
    iIconImages[Enum208.USE_KEYRING_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      6,
      7,
    ...
    iIconImages[Enum208.EXPLOSIVE_DOOR_IMAGES] = UseLoadedButtonImage(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      -1,
      15,
      16,
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\communicationpopup_2.sti",
    );
  ...
  export function PopupMovementMenu(pUIEvent: UI_EVENT): void {
    ...
    iActionIcons[Enum209.RUN_ICON] = QuickCreateButton(
      iIconImages[Enum208.RUN_IMAGES],
      iMenuAnchorX + 20,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.RUN_ICON],
      pTacticalPopupButtonStrings[Enum209.RUN_ICON],
    );
    ...
    iActionIcons[Enum209.WALK_ICON] = QuickCreateButton(
      iIconImages[Enum208.WALK_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
    ...
    if (pSoldier.uiStatusFlags & SOLDIER_VEHICLE) {
      SetButtonFastHelpText(
        iActionIcons[Enum209.WALK_ICON],
        TacticalStr[Enum335.DRIVE_POPUPTEXT],
      );
    } else {
      SetButtonFastHelpText(
        iActionIcons[Enum209.WALK_ICON],
        pTacticalPopupButtonStrings[Enum209.WALK_ICON],
      );
    }
    ...
    iActionIcons[Enum209.SNEAK_ICON] = QuickCreateButton(
      iIconImages[Enum208.SNEAK_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY + 20,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.SNEAK_ICON],
      pTacticalPopupButtonStrings[Enum209.SNEAK_ICON],
    );
    ...
    iActionIcons[Enum209.CRAWL_ICON] = QuickCreateButton(
      iIconImages[Enum208.CRAWL_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.CRAWL_ICON],
      pTacticalPopupButtonStrings[Enum209.CRAWL_ICON],
    );
    ...
    iActionIcons[Enum209.LOOK_ICON] = QuickCreateButton(
      iIconImages[Enum208.LOOK_IMAGES],
      iMenuAnchorX,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.LOOK_ICON],
    ...
    iActionIcons[Enum209.ACTIONC_ICON] = QuickCreateButton(
      iIconImages[uiActionImages],
      iMenuAnchorX,
      iMenuAnchorY + 20,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    iActionIcons[Enum209.TALK_ICON] = QuickCreateButton(
      iIconImages[Enum208.TALK_IMAGES],
      iMenuAnchorX,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.TALK_ICON],
      pTacticalPopupButtonStrings[Enum209.TALK_ICON],
    );
    ...
    iActionIcons[Enum209.HAND_ICON] = QuickCreateButton(
      iIconImages[Enum208.HAND_IMAGES],
      iMenuAnchorX + 20,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    SetButtonFastHelpText(
      iActionIcons[Enum209.HAND_ICON],
      pTacticalPopupButtonStrings[Enum209.HAND_ICON],
    );
    ...
    iActionIcons[CANCEL_ICON] = QuickCreateButton(
      iIconImages[Enum208.CANCEL_IMAGES],
      iMenuAnchorX + 20,
      iMenuAnchorY + 20,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
  ...
  export function RenderMovementMenu(): void {
    if (gfInMovementMenu) {
      ...
      InvalidateRegion(
        giMenuAnchorX,
        giMenuAnchorY,
        giMenuAnchorX + BUTTON_PANEL_WIDTH,
  ...
  /* static */
  let HandleUpDownArrowBackgrounds__uiOldShowUpDownArrows: UINT32 =
    ARROWS_HIDE_UP | ARROWS_HIDE_DOWN;

  function HandleUpDownArrowBackgrounds(): void {
    // Check for change in mode
    if (
      guiShowUPDownArrows !=
        HandleUpDownArrowBackgrounds__uiOldShowUpDownArrows ||
      gfUIRefreshArrows
    ) {
  ...
  export function RenderArrows(): void {
    ...
    if (
      guiShowUPDownArrows & ARROWS_HIDE_UP &&
      guiShowUPDownArrows & ARROWS_HIDE_DOWN
    ) {
      return;
    }
  ...
  function GetArrowsBackground(): void {
    ...
    if (gusSelectedSoldier != NO_SOLDIER) {
      ...
      if (
        guiShowUPDownArrows & ARROWS_SHOW_UP_ABOVE_YG ||
      ...
      if (
        guiShowUPDownArrows & ARROWS_SHOW_DOWN_BELOW_YG ||
      ...
      giDownArrowRect = RegisterBackgroundRect(
        BGND_FLAG_PERMANENT,
        null,
        gsDownArrowX,
        gsDownArrowY,
        gsDownArrowX + sArrowWidth,
        gsDownArrowY + sArrowHeight,
      );
      giUpArrowRect = RegisterBackgroundRect(
        BGND_FLAG_PERMANENT,
        null,
        gsUpArrowX,
        gsUpArrowY,
        gsUpArrowX + sArrowWidth,
        gsUpArrowY + sArrowHeight,
      );
    }
  }

  export function GetSoldierAboveGuyPositions(
  ...
  export function DrawSelectedUIAboveGuy(usSoldierID: UINT16): void {
    ...
    if (!pSoldier.fShowLocator) {
      ...
      if (
        gfUIHandleSelectionAboveGuy &&
        pSoldier.ubID == gsSelectedGuy &&
        pSoldier.ubID != gusSelectedSoldier &&
        !gfIgnoreOnSelectedGuy
      ) {
    ...
    if (
      ...
      if (
        ...
        pSoldier.ubID == gubUIValidCatcherID
      ) {
  ...
  function RenderOverlayMessage(pBlitter: VIDEO_OVERLAY): void {
    ...
    InvalidateRegion(
      pBlitter.sX,
      pBlitter.sY,
      pBlitter.sX + gusOverlayPopupBoxWidth,
      pBlitter.sY + gusOverlayPopupBoxHeight,
    );
  }

  function BeginOverlayMessage(
    uiFont: UINT32,
    ...
    SetPrepareMercPopupFlags(
      MERC_POPUP_PREPARE_FLAGS_TRANS_BACK | MERC_POPUP_PREPARE_FLAGS_MARGINS,
    );

    // Prepare text box
    iOverlayMessageBox = PrepareMercPopupBox(
      iOverlayMessageBox,
      Enum324.BASIC_MERC_POPUP_BACKGROUND,
      Enum325.RED_MERC_POPUP_BORDER,
      SlideString,
      200,
      50,
      0,
      0,
      gusOverlayPopupBoxWidth__Pointer,
      gusOverlayPopupBoxHeight__Pointer,
    );
    ...
    if (giPopupSlideMessageOverlay == -1) {
      ...
      VideoOverlayDesc.sRight =
        VideoOverlayDesc.sLeft + gusOverlayPopupBoxWidth;
      VideoOverlayDesc.sBottom =
  ...
  export function DirtyMercPanelInterface(
    pSoldier: SOLDIERTYPE,
    ubDirtyLevel: UINT8,
  ): void {
  ...
  export function InitDoorOpenMenu(
    pSoldier: SOLDIERTYPE,
    ...
    gOpenDoorMenu.sY =
      sScreenY - Math.trunc((BUTTON_PANEL_HEIGHT - sHeight) / 2);
  ...
  function PopupDoorOpenMenu(fClosingDoor: boolean): void {
    ...
    iActionIcons[Enum209.USE_KEYRING_ICON] = QuickCreateButton(
      iIconImages[Enum208.USE_KEYRING_IMAGES],
      iMenuAnchorX + 20,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.USE_KEYRING_ICON],
        AP_UNLOCK_DOOR,
      );
    }
    ...
    iActionIcons[Enum209.USE_CROWBAR_ICON] = QuickCreateButton(
      iIconImages[Enum208.CROWBAR_DOOR_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.USE_CROWBAR_ICON],
        AP_USE_CROWBAR,
      );
    }
    ...
    if (
      FindUsableObj(gOpenDoorMenu.pSoldier, Enum225.CROWBAR) == NO_SLOT ||
      fClosingDoor
    ) {
    ...
    iActionIcons[Enum209.LOCKPICK_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum208.LOCKPICK_DOOR_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY + 20,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.LOCKPICK_DOOR_ICON],
        AP_PICKLOCK,
      );
    }
    ...
    if (
      !EnoughPoints(gOpenDoorMenu.pSoldier, AP_PICKLOCK, BP_PICKLOCK, false) ||
      fClosingDoor ||
      AM_AN_EPC(gOpenDoorMenu.pSoldier)
    ) {
    ...
    iActionIcons[Enum209.EXPLOSIVE_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum208.EXPLOSIVE_DOOR_IMAGES],
      iMenuAnchorX + 40,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.EXPLOSIVE_DOOR_ICON],
        AP_EXPLODE_DOOR,
      );
    }
    ...
    iActionIcons[Enum209.OPEN_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum208.OPEN_DOOR_IMAGES],
      iMenuAnchorX,
      iMenuAnchorY,
      BUTTON_NO_TOGGLE,
    ...
    if (fClosingDoor) {
      if (
        ...
        zDisp = swprintf(
          "%s ( %d )",
          pTacticalPopupButtonStrings[CANCEL_ICON + 1],
          AP_OPEN_DOOR,
        );
      }
    } else {
      if (
        ...
        zDisp = swprintf(
          "%s ( %d )",
          pTacticalPopupButtonStrings[Enum209.OPEN_DOOR_ICON],
          AP_OPEN_DOOR,
        );
      }
    }
    ...
    if (
      !EnoughPoints(gOpenDoorMenu.pSoldier, AP_OPEN_DOOR, BP_OPEN_DOOR, false)
    ) {
      DisableButton(iActionIcons[Enum209.OPEN_DOOR_ICON]);
    }

    // Create button based on what is in our hands at the moment!
    iActionIcons[Enum209.EXAMINE_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum208.EXAMINE_DOOR_IMAGES],
      iMenuAnchorX,
      iMenuAnchorY + 20,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.EXAMINE_DOOR_ICON],
        AP_EXAMINE_DOOR,
      );
    }
    ...
    iActionIcons[Enum209.BOOT_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum208.BOOT_DOOR_IMAGES],
      iMenuAnchorX,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.BOOT_DOOR_ICON],
        AP_BOOT_DOOR,
      );
    }
    ...
    iActionIcons[Enum209.UNTRAP_DOOR_ICON] = QuickCreateButton(
      iIconImages[Enum209.UNTRAP_DOOR_ICON],
      iMenuAnchorX + 20,
      iMenuAnchorY + 40,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGHEST - 1,
    ...
    if (
      ...
      zDisp = swprintf(
        "%s ( %d )",
        pTacticalPopupButtonStrings[Enum209.UNTRAP_DOOR_ICON],
        AP_UNTRAP_DOOR,
      );
    }
  ...
  export function RenderOpenDoorMenu(): void {
    if (gfInOpenDoorMenu) {
      ...
      InvalidateRegion(
        gOpenDoorMenu.sX,
        gOpenDoorMenu.sY,
        gOpenDoorMenu.sX + BUTTON_PANEL_WIDTH,
  ...
  function RenderUIMessage(pBlitter: VIDEO_OVERLAY): void {
    ...
    InvalidateRegion(
      pBlitter.sX,
      pBlitter.sY,
      pBlitter.sX + gusUIMessageWidth,
      pBlitter.sY + gusUIMessageHeight,
    );
  }

  export function InternalBeginUIMessage(
    fUseSkullIcon: boolean,
    pFontString: string /* Pointer<UINT16> */,
    ...args: any[]
  ): void {
    let VideoOverlayDesc: VIDEO_OVERLAY_DESC = createVideoOverlayDesc();
    ...
    if (fUseSkullIcon) {
      SetPrepareMercPopupFlags(
        MERC_POPUP_PREPARE_FLAGS_MARGINS | MERC_POPUP_PREPARE_FLAGS_SKULLICON,
      );
    } else {
      SetPrepareMercPopupFlags(
        MERC_POPUP_PREPARE_FLAGS_MARGINS | MERC_POPUP_PREPARE_FLAGS_STOPICON,
      );
    }

    // Prepare text box
    iUIMessageBox = PrepareMercPopupBox(
      iUIMessageBox,
      Enum324.BASIC_MERC_POPUP_BACKGROUND,
      ...
      0,
      0,
      gusUIMessageWidth__Pointer,
      gusUIMessageHeight__Pointer,
    );
  ...
  export function BeginUIMessage(
    pFontString: string /* Pointer<UINT16> */,
    ...args: any[]
  ): void {
    let MsgString: string /* wchar_t[512] */;
  ...
  export function BeginMapUIMessage(
    ubPosition: UINT8,
    pFontString: string /* Pointer<UINT16> */,
    ...args: any[]
  ): void {
    ...
    if (giUIMessageOverlay == -1) {
      // Set Overlay
      VideoOverlayDesc.sLeft =
        20 +
        MAP_VIEW_START_X +
        Math.trunc((MAP_VIEW_WIDTH - gusUIMessageWidth) / 2);

      VideoOverlayDesc.sTop =
        MAP_VIEW_START_Y +
        Math.trunc((MAP_VIEW_HEIGHT - gusUIMessageHeight) / 2);
  ...
  const PLAYER_TEAM_TIMER_INTTERUPT_GRACE = Math.trunc(
    15000 / PLAYER_TEAM_TIMER_SEC_PER_TICKS,
  );
  const PLAYER_TEAM_TIMER_GRACE_PERIOD = 1000;
  const PLAYER_TEAM_TIMER_TICKS_PER_OK_MERC = Math.trunc(
    15000 / PLAYER_TEAM_TIMER_SEC_PER_TICKS,
  );
  const PLAYER_TEAM_TIMER_TICKS_PER_NOTOK_MERC = Math.trunc(
    5000 / PLAYER_TEAM_TIMER_SEC_PER_TICKS,
  );
  const PLAYER_TEAM_TIMER_TICKS_FROM_END_TO_START_BEEP = Math.trunc(
    5000 / PLAYER_TEAM_TIMER_SEC_PER_TICKS,
  );
  const PLAYER_TEAM_TIMER_TIME_BETWEEN_BEEPS = 500;
  const PLAYER_TEAM_TIMER_TICKS_PER_ENEMY = Math.trunc(
    2000 / PLAYER_TEAM_TIMER_SEC_PER_TICKS,
  );

  export function AddTopMessage(
    ubType: UINT8,
    pzString: string /* Pointer<UINT16> */,
  ): boolean {
    let cnt: UINT32;
  ...
  function CreateTopMessage(
    uiSurface: UINT32,
    ubType: UINT8,
    psString: string /* Pointer<UINT16> */,
  ): void {
    let uiBAR: UINT32;
    ...
    if (gGameOptions.fTurnTimeLimit) {
      if (
        ubType == Enum216.PLAYER_TURN_MESSAGE ||
        ubType == Enum216.PLAYER_INTERRUPT_MESSAGE
      ) {
        fDoLimitBar = true;
      }
    }
    ...
    if (fDoLimitBar) {
      dNumStepsPerEnemy =
        PROG_BAR_LENGTH / gTacticalStatus.usTactialTurnLimitMax;
  ...
  function CheckForAndHandleEndPlayerTimeLimit(): void {
    if (gTacticalStatus.fInTopMessage) {
      if (gGameOptions.fTurnTimeLimit) {
        if (
          gTacticalStatus.ubTopMessageType == Enum216.PLAYER_TURN_MESSAGE ||
          gTacticalStatus.ubTopMessageType == Enum216.PLAYER_INTERRUPT_MESSAGE
        ) {
          if (
            gTacticalStatus.usTactialTurnLimitCounter ==
  ...
  export function HandleTopMessages(): void {
    ...
    if (gTacticalStatus.fInTopMessage) {
      ...
      if (
        gTacticalStatus.ubTopMessageType == Enum216.COMPUTER_TURN_MESSAGE ||
        gTacticalStatus.ubTopMessageType ==
          Enum216.COMPUTER_INTERRUPT_MESSAGE ||
        gTacticalStatus.ubTopMessageType == Enum216.MILITIA_INTERRUPT_MESSAGE ||
        gTacticalStatus.ubTopMessageType == Enum216.AIR_RAID_TURN_MESSAGE
      ) {
        // OK, update timer.....
        if (
          TIMECOUNTERDONE(
            giTimerTeamTurnUpdate,
            PLAYER_TEAM_TIMER_SEC_PER_TICKS,
          )
        ) {
          giTimerTeamTurnUpdate = RESETTIMECOUNTER(
            PLAYER_TEAM_TIMER_SEC_PER_TICKS,
          );
        ...
        if (
          ...
          if (!gfUserTurnRegionActive && !AreWeInAUIMenu()) {
            // Check Grace period...
            if (
              GetJA2Clock() - gTacticalStatus.uiTactialTurnLimitClock >
              ...
              if (
                ...
                if (gTacticalStatus.fTactialTurnLimitStartedBeep) {
                  if (
                    GetJA2Clock() - gTopMessage.uiTimeSinceLastBeep >
                ...
                if (
                  !gTacticalStatus.fTactialTurnLimitStartedBeep &&
                  gTacticalStatus.usTactialTurnLimitMax -
                    gTacticalStatus.usTactialTurnLimitCounter <
  ...
  export function InitEnemyUIBar(
    ubNumEnemies: UINT8,
    ubDoneEnemies: UINT8,
  ): void {
    // OK, set value
    ...
    gTacticalStatus.usTactialTurnLimitCounter =
      ubDoneEnemies * PLAYER_TEAM_TIMER_TICKS_PER_ENEMY;
    gTacticalStatus.usTactialTurnLimitMax =
  ...
  export function InitPlayerUIBar(fInterrupt: UINT8 /* boolean */): void {
    ...
    if (!gGameOptions.fTurnTimeLimit) {
      if (fInterrupt == 1) {
        AddTopMessage(
          Enum216.PLAYER_INTERRUPT_MESSAGE,
    ...
    if (!fInterrupt || gTacticalStatus.usTactialTurnLimitMax == 0) {
      ...
      gTacticalStatus.usTactialTurnLimitMax =
        bNumOK * PLAYER_TEAM_TIMER_TICKS_PER_OK_MERC +
        bNumNotOK * PLAYER_TEAM_TIMER_TICKS_PER_NOTOK_MERC;
    } else {
      if (
        gTacticalStatus.usTactialTurnLimitCounter >
        PLAYER_TEAM_TIMER_INTTERUPT_GRACE
      ) {
        gTacticalStatus.usTactialTurnLimitCounter -=
          PLAYER_TEAM_TIMER_INTTERUPT_GRACE;
      }
  ...
  function MovementMenuBackregionCallback(
  ...
  function DoorMenuBackregionCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  export function GetSoldierHealthString(
    pSoldier: SOLDIERTYPE,
  ...
  function CalculateAimCubeUIPhysics(): void {
    ...
    if (gCubeUIData.fActiveHeightBar) {
      ...
      gCubeUIData.ubPowerIndex = Math.trunc(
        (gCubeUIData.dForce / gCubeUIData.dMaxForce) * 10,
      );
    }

    if (gCubeUIData.fActivePowerBar) {
      gCubeUIData.dForce =
        gCubeUIData.dMaxForce * (gCubeUIData.ubPowerIndex / 10);
      ...
      gCubeUIData.dDegrees = CalculateLaunchItemAngle(
        gCubeUIData.pSoldier,
        gCubeUIData.sGridNo,
        ubHeight,
        gCubeUIData.dForce,
        gCubeUIData.pSoldier.inv[Enum261.HANDPOS],
        createPropertyPointer(gCubeUIData, "sTargetGridNo"),
      );
    }
  }
  ...
  function SetupAimCubeAI(): void {
    if (gfInAimCubeUI) {
      ...
      (<LEVELNODE>(
        gpWorldLevelData[gCubeUIData.sTargetGridNo].pTopmostHead
      )).ubShadeLevel = DEFAULT_SHADE_LEVEL;
      (<LEVELNODE>(
        gpWorldLevelData[gCubeUIData.sTargetGridNo].pTopmostHead
      )).ubNaturalShadeLevel = DEFAULT_SHADE_LEVEL;
  ...
  export function RenderAimCubeUI(): void {
    ...
    if (gfInAimCubeUI) {
      ...
      if (gCubeUIData.fShowHeight) {
        ...
        ({ sScreenX, sScreenY } = GetGridNoScreenPos(
          gCubeUIData.sGridNo,
          gCubeUIData.ubLevel,
        ));
  ...
  export function BeginPhysicsTrajectoryUI(
    sGridNo: INT16,
    bLevel: INT8,
    fBadCTGT: boolean,
  ): void {
  ...
  export function SetupPhysicsTrajectoryUI(): void {
    if (gfDisplayPhysicsUI && gfUIHandlePhysicsTrajectory) {
      if (gbPhysicsImpactPointLevel == 0) {
        ...
        (<LEVELNODE>(
          gpWorldLevelData[gsPhysicsImpactPointGridNo].pTopmostHead
        )).ubShadeLevel = DEFAULT_SHADE_LEVEL;
        (<LEVELNODE>(
          gpWorldLevelData[gsPhysicsImpactPointGridNo].pTopmostHead
        )).ubNaturalShadeLevel = DEFAULT_SHADE_LEVEL;
        ...
        (<LEVELNODE>(
          gpWorldLevelData[gsPhysicsImpactPointGridNo].pOnRoofHead
        )).ubShadeLevel = DEFAULT_SHADE_LEVEL;
        (<LEVELNODE>(
          gpWorldLevelData[gsPhysicsImpactPointGridNo].pOnRoofHead
        )).ubNaturalShadeLevel = DEFAULT_SHADE_LEVEL;
  ...
  export function BeginMultiPurposeLocator(
    sGridNo: INT16,
    bLevel: INT8,
    fSlideTo: boolean,
  ): void {
