namespace ja2 {
  ...
  export function copyAnimationSurfaceCacheType(
    destination: AnimationSurfaceCacheType,
    source: AnimationSurfaceCacheType,
  ) {
  ...
  export function readAnimationSurfaceCacheType(
    o: AnimationSurfaceCacheType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.usCachedSurfaces = <UINT16[]>(<unknown>null);
  ...
  export function writeAnimationSurfaceCacheType(
    o: AnimationSurfaceCacheType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
