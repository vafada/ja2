namespace ja2 {
  ...
  function createShopKeeperInterfaceRGBColorFrom(
    ubRed: UINT8,
    ubGreen: UINT8,
    ubBlue: UINT8,
  ): SKIRGBCOLOR {
  ...
  const SKI_TACTICAL_BACKGROUND_START_WIDTH =
    640 - SKI_TACTICAL_BACKGROUND_START_X;
  ...
  const MAX_SUBOBJECTS_PER_OBJECT = () =>
    Math.max(MAX_OBJECTS_PER_SLOT, 2 + MAX_ATTACHMENTS); // (2nd part is main item, ammo/payload, and 4 attachments)
  ...
  let gpTempDealersInventory: INVENTORY_IN_SLOT[] = <INVENTORY_IN_SLOT[]>(
    (<unknown>null)
  );

  let ArmsDealerOfferArea: INVENTORY_IN_SLOT[] /* [SKI_NUM_TRADING_INV_SLOTS] */ =
    createArrayFrom(SKI_NUM_TRADING_INV_SLOTS, createInventoryInSlot);
  let PlayersOfferArea: INVENTORY_IN_SLOT[] /* [SKI_NUM_TRADING_INV_SLOTS] */ =
    createArrayFrom(SKI_NUM_TRADING_INV_SLOTS, createInventoryInSlot);

  let gSubObject: OBJECTTYPE[] /* [MAX_SUBOBJECTS_PER_OBJECT] */ =
    createArrayFrom(MAX_SUBOBJECTS_PER_OBJECT(), createObjectType);
...
*/
  ...
  let gDealersInventoryMouseRegions: MOUSE_REGION[] /* [SKI_NUM_ARMS_DEALERS_INV_SLOTS] */ =
    createArrayFrom(SKI_NUM_ARMS_DEALERS_INV_SLOTS, createMouseRegion);
  ...
  let gDealersOfferSlotsMouseRegions: MOUSE_REGION[] /* [SKI_NUM_TRADING_INV_SLOTS] */ =
    createArrayFrom(SKI_NUM_TRADING_INV_SLOTS, createMouseRegion);
  ...
  export function ShopKeeperScreenHandle(): UINT32 {
    ...
    if (gfRenderScreenOnNextLoop) gubSkiDirtyLevel = Enum253.SKI_DIRTY_LEVEL2;
  ...
  function EnterShopKeeperInterface(): boolean {
    ...
    AssertMsg(
      CanMercInteractWithSelectedShopkeeper(MercPtrs[gusSelectedSoldier]),
    ...
    if (
      (guiCornerWhereTacticalIsStillSeenImage = AddVideoSurface(vs_desc)) === -1
    ) {
      return false;
    }
  ...
  */
    ...
    for (
      ubCnt = gTacticalStatus.Team[OUR_TEAM].bFirstID;
      ubCnt <= gTacticalStatus.Team[OUR_TEAM].bLastID;
      ubCnt++
    ) {
    ...
    guiSKI_InvPageUpButtonImage = LoadButtonImage(
      "INTERFACE\\TradeScrollArrows.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiSKI_InvPageDownButtonImage = UseLoadedButtonImage(
    ...
    guiSKI_InvPageUpButton = QuickCreateButton(
      guiSKI_InvPageUpButtonImage,
      SKI_PAGE_UP_ARROWS_X,
      SKI_PAGE_UP_ARROWS_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGHEST,
      DEFAULT_MOVE_CALLBACK(),
      BtnSKI_InvPageUpButtonCallback,
    );
    ...
    guiSKI_InvPageDownButton = QuickCreateButton(
      ...
      SKI_PAGE_DOWN_ARROWS_X,
      SKI_PAGE_DOWN_ARROWS_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGHEST,
      DEFAULT_MOVE_CALLBACK(),
      BtnSKI_InvPageDownButtonCallback,
    );
    SpecifyDisabledButtonStyle(
    ...
    guiSKI_TransactionButtonImage = LoadButtonImage(
      "INTERFACE\\TradeButtons.sti",
      -1,
      0,
      -1,
      1,
    ...
    guiSKI_DoneButtonImage = UseLoadedButtonImage(
      guiSKI_TransactionButtonImage,
      -1,
      0,
      -1,
      1,
  ...
  */
    ...
    guiSKI_TransactionButton = CreateIconAndTextButton(
      ...
      DEFAULT_SHADOW,
      TEXT_CJUSTIFIED,
      SKI_TRANSACTION_BUTTON_X,
      SKI_TRANSACTION_BUTTON_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH,
      DEFAULT_MOVE_CALLBACK(),
    ...
    if (
      ArmsDealerInfo[gbSelectedArmsDealerID].ubTypeOfArmsDealer ==
      Enum198.ARMS_DEALER_REPAIRS
    )
      SetButtonFastHelpText(
        guiSKI_TransactionButton,
        SkiMessageBoxText[Enum370.SKI_REPAIR_TRANSACTION_BUTTON_HELP_TEXT],
      );
    else
      SetButtonFastHelpText(
        guiSKI_TransactionButton,
        SkiMessageBoxText[Enum370.SKI_TRANSACTION_BUTTON_HELP_TEXT],
      );

    // Done button
    guiSKI_DoneButton = CreateIconAndTextButton(
      guiSKI_DoneButtonImage,
      SKI_Text[Enum367.SKI_TEXT_DONE],
      SKI_BUTTON_FONT(),
      SKI_BUTTON_COLOR,
      DEFAULT_SHADOW,
      SKI_BUTTON_COLOR,
    ...
    SetButtonFastHelpText(
      guiSKI_DoneButton,
      SkiMessageBoxText[Enum370.SKI_DONE_BUTTON_HELP_TEXT],
    );

    // Blanket the entire screen
    MSYS_DefineRegion(
      gSKI_EntireScreenMouseRegions,
      0,
      0,
      639,
      339,
  ...
  */
    ...
    MSYS_DefineRegion(
      gSkiInventoryMovementAreaMouseRegions,
      SKI_ITEM_MOVEMENT_AREA_X,
      SKI_ITEM_MOVEMENT_AREA_Y,
      SKI_ITEM_MOVEMENT_AREA_X + SKI_ITEM_MOVEMENT_AREA_WIDTH,
      SKI_ITEM_MOVEMENT_AREA_Y + SKI_ITEM_MOVEMENT_AREA_HEIGHT,
      MSYS_PRIORITY_HIGH - 1,
      Enum317.CURSOR_NORMAL,
      MSYS_NO_CALLBACK,
      MSYS_NO_CALLBACK,
    ); // SelectSkiInventoryMovementAreaRegionCallBack
    ...
    MSYS_DefineRegion(
      gArmsDealersFaceMouseRegions,
      SKI_FACE_X,
      SKI_FACE_Y,
      SKI_FACE_X + SKI_FACE_WIDTH,
      SKI_FACE_Y + SKI_FACE_HEIGHT,
      MSYS_PRIORITY_HIGH - 1,
      Enum317.CURSOR_NORMAL,
      MSYS_NO_CALLBACK,
    ...
    if (gItemToAdd.fActive) {
      ...
      if (
        ArmsDealerInfo[gbSelectedArmsDealerID].ubTypeOfArmsDealer !=
          Enum198.ARMS_DEALER_REPAIRS ||
        CountNumberOfItemsInThePlayersOfferArea() <
          SKI_NUM_ARMS_DEALERS_INV_SLOTS
      ) {
        // if we're supposed to store the original pocket #, but that pocket still holds more of these
        if (
          bSlotNum != -1 &&
          gpSMCurrentMerc.inv[bSlotNum].ubNumberOfObjects > 0
        ) {
        ...
        if (
          OfferObjectToDealer(
            gItemToAdd.ItemObject,
            gpSMCurrentMerc.ubProfile,
            bSlotNum,
          )
        ) {
          fAddedOK = true;
    ...
    MSYS_DefineRegion(
      ...
      SKI_DROP_ITEM_TO_GROUND_START_X,
      SKI_DROP_ITEM_TO_GROUND_START_Y,
      639,
      339,
      MSYS_PRIORITY_HIGH,
      Enum317.CURSOR_NORMAL,
  ...
  function InitShopKeepersFace(ubMercID: UINT8): boolean {
    let pSoldier: SOLDIERTYPE | null = FindSoldierByProfileID(
    ...
    SetAutoFaceActive(
      ...
      giShopKeeperFaceIndex,
      SKI_FACE_X,
      SKI_FACE_Y,
    );

    // Set it so the face cannot be set InActive
    gFacesData[giShopKeeperFaceIndex].uiFlags |=
  ...
  function RenderShopKeeperInterface(): boolean {
    ...
    // Display the Title
    DrawTextToScreen(
      SKI_Text[Enum367.SKI_TEXT_MERCHADISE_IN_STOCK],
      SKI_MAIN_TITLE_X,
      SKI_MAIN_TITLE_Y,
      SKI_MAIN_TITLE_WIDTH,
      SKI_TITLE_FONT(),
      SKI_TITLE_COLOR,
      FONT_MCOLOR_BLACK,
      false,
    ...
    if (
      ...
      DisplayWrappedString(
        SKI_TOTAL_COST_X,
        SKI_TOTAL_COST_Y,
        SKI_TOTAL_COST_WIDTH,
        2,
        SKI_LABEL_FONT(),
        SKI_TITLE_COLOR,
        SKI_Text[Enum367.SKI_TEXT_REPAIR_COST],
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
      ...
      DisplayWrappedString(
        ...
        SKI_LABEL_FONT(),
        SKI_TITLE_COLOR,
        SKI_Text[Enum367.SKI_TEXT_TOTAL_COST],
        FONT_MCOLOR_BLACK,
        false,
        CENTER_JUSTIFIED,
      );
    ...
    DisplayWrappedString(
      SKI_TOTAL_VALUE_X,
      SKI_TOTAL_VALUE_Y,
      SKI_TOTAL_VALUE_WIDTH,
      2,
      SKI_LABEL_FONT(),
      SKI_TITLE_COLOR,
      SKI_Text[Enum367.SKI_TEXT_TOTAL_VALUE],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      SKI_PLAYERS_CURRENT_BALANCE_X,
      SKI_PLAYERS_CURRENT_BALANCE_Y,
      SKI_PLAYERS_CURRENT_BALANCE_WIDTH,
      2,
      SKI_LABEL_FONT(),
      SKI_TITLE_COLOR,
      SkiMessageBoxText[Enum370.SKI_PLAYERS_CURRENT_BALANCE],
      FONT_MCOLOR_BLACK,
      false,
      CENTER_JUSTIFIED,
    );
    ...
    DrawTextToScreen(
      zMoney,
      SKI_PLAYERS_CURRENT_BALANCE_X,
      SKI_PLAYERS_CURRENT_BALANCE_OFFSET_TO_VALUE,
      SKI_PLAYERS_CURRENT_BALANCE_WIDTH,
      FONT10ARIAL(),
      SKI_ITEM_PRICE_COLOR,
      FONT_MCOLOR_BLACK,
      true,
      CENTER_JUSTIFIED,
    );
    ...
    if (gfRenderScreenOnNextLoop) {
      ...
      SrcRect.iRight =
        SKI_TACTICAL_BACKGROUND_START_X + SKI_TACTICAL_BACKGROUND_START_WIDTH;
      SrcRect.iBottom =
        SKI_TACTICAL_BACKGROUND_START_Y + SKI_TACTICAL_BACKGROUND_START_HEIGHT;
  ...
  function BtnSKI_InvPageUpButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
  ...
  function BtnSKI_InvPageDownButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
...
*/
  function BtnSKI_TransactionButtonCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
  ...
  function CreateSkiInventorySlotMouseRegions(): void {
    ...
    for (y = 0; y < SKI_NUM_ARMS_DEALERS_INV_ROWS; y++) {
      ...
      for (x = 0; x < SKI_NUM_ARMS_DEALERS_INV_COLS; x++) {
        MSYS_DefineRegion(
          gDealersInventoryMouseRegions[ubCnt],
          usPosX,
          usPosY,
          usPosX + SKI_INV_SLOT_WIDTH,
          usPosY + SKI_INV_SLOT_HEIGHT,
          MSYS_PRIORITY_HIGH,
          Enum317.CURSOR_NORMAL,
        ...
        if (
          ...
          // Small Faces
          MSYS_DefineRegion(
            gRepairmanInventorySmallFaceMouseRegions[ubCnt],
            usPosX + SKI_SMALL_FACE_OFFSET_X,
            usPosY,
            usPosX + SKI_SMALL_FACE_OFFSET_X + SKI_SMALL_FACE_WIDTH,
            usPosY + SKI_SMALL_FACE_HEIGHT,
            MSYS_PRIORITY_HIGH + 1,
            Enum317.CURSOR_NORMAL,
            null,
            null,
    ...
    for (y = 0; y < SKI_NUM_TRADING_INV_ROWS; y++) {
      ...
      for (x = 0; x < SKI_NUM_TRADING_INV_COLS; x++) {
        MSYS_DefineRegion(
          gDealersOfferSlotsMouseRegions[ubCnt],
          usPosX,
          usPosY,
          usPosX + SKI_INV_SLOT_WIDTH,
          usPosY + SKI_INV_SLOT_HEIGHT,
        ...
        if (
          ...
          // Small Faces
          MSYS_DefineRegion(
            gDealersOfferSlotsSmallFaceMouseRegions[ubCnt],
            usPosX + SKI_SMALL_FACE_OFFSET_X,
            usPosY,
            usPosX + SKI_SMALL_FACE_OFFSET_X + SKI_SMALL_FACE_WIDTH,
            usPosY + SKI_SMALL_FACE_HEIGHT,
          ...
          MSYS_SetRegionUserData(
            gDealersOfferSlotsSmallFaceMouseRegions[ubCnt],
            1,
            Enum252.ARMS_DEALER_OFFER_AREA,
          );
        }
    ...
    for (y = 0; y < SKI_NUM_TRADING_INV_ROWS; y++) {
      ...
      for (x = 0; x < SKI_NUM_TRADING_INV_COLS; x++) {
        // Trading Slots
        MSYS_DefineRegion(
          gPlayersOfferSlotsMouseRegions[ubCnt],
          usPosX,
          usPosY,
          usPosX + SKI_INV_SLOT_WIDTH,
          usPosY + SKI_INV_SLOT_HEIGHT,
      ...
      */
        // Small Faces
        MSYS_DefineRegion(
          gPlayersOfferSlotsSmallFaceMouseRegions[ubCnt],
          usPosX + SKI_SMALL_FACE_OFFSET_X,
          usPosY,
          usPosX + SKI_SMALL_FACE_OFFSET_X + SKI_SMALL_FACE_WIDTH,
          usPosY + SKI_SMALL_FACE_HEIGHT,
  ...
  function SelectDealersInventoryRegionCallBack(
    ...
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      if (
        ubSelectedInvSlot >= gSelectArmsDealerInfo.uiNumDistinctInventoryItems
      )
        return;
      ...
      if (
        ...
        if (
          !(
            gpTempDealersInventory[ubSelectedInvSlot].uiFlags &
          ...
          if (
            ...
            ubLocation = AddItemToArmsDealerOfferArea(
            ...
            if (ubLocation != -1) {
              ...
              gpTempDealersInventory[ubSelectedInvSlot].ubLocationOfObject =
                Enum252.ARMS_DEALER_OFFER_AREA;
              gpTempDealersInventory[ubSelectedInvSlot].bSlotIdInOtherLocation =
                ubLocation;
              ...
              if (gfKeyState[SHIFT]) {
                gpTempDealersInventory[
                  ubSelectedInvSlot
                ].ItemObject.ubNumberOfObjects = 0;
              } else {
                gpTempDealersInventory[ubSelectedInvSlot].ItemObject
                  .ubNumberOfObjects--;
              }
        ...
        } // some of this item are already in dealer's offer area
        else {
  ...
  function SelectDealersInventoryMovementRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubSelectedInvSlot: UINT8 = MSYS_GetRegionUserData(pRegion, 0);
  ...
  function SelectDealersOfferSlotsMovementRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubSelectedInvSlot: UINT8 = MSYS_GetRegionUserData(pRegion, 0);
    ...
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      gpHighLightedItemObject =
        ArmsDealerOfferArea[ubSelectedInvSlot].ItemObject;
      HandleCompatibleAmmoUI(gpSMCurrentMerc, -1, true);
    } else if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
      // if there is nothing in the slot, exit
      if (ArmsDealerOfferArea[ubSelectedInvSlot].fActive == false) return;
  ...
  function SelectPlayersOfferSlotsMovementRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubSelectedInvSlot: UINT8 = MSYS_GetRegionUserData(pRegion, 0);
  ...
  function SelectDealersOfferSlotsRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubSelectedInvSlot: UINT8 = MSYS_GetRegionUserData(pRegion, 0);
      ...
      if (ArmsDealerOfferArea[ubSelectedInvSlot].fActive) {
        ...
        if (
          ...
          if (gMoveingItem.sItemIndex == 0) {
            ...
            if (
              ArmsDealerOfferArea[ubSelectedInvSlot].ItemObject
                .ubNumberOfObjects > MAX_OBJECTS_PER_SLOT
            ) {
            ...
            copyInventoryInSlot(
              TempSlot,
              ArmsDealerOfferArea[ubSelectedInvSlot],
            );
            copyInventoryInSlot(
              ArmsDealerOfferArea[ubSelectedInvSlot],
              gMoveingItem,
          ...
          } // multiple items there, SHIFT isn't being pressed
          else {
            // remove only one at a time
            ArmsDealerOfferArea[ubSelectedInvSlot].ItemObject
              .ubNumberOfObjects--;
            gpTempDealersInventory[
              ArmsDealerOfferArea[ubSelectedInvSlot].bSlotIdInOtherLocation
  ...
  function SelectPlayersOfferSlotsRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubSelectedInvSlot: UINT8 = MSYS_GetRegionUserData(pRegion, 0);
    ...
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
      ...
      if (gMoveingItem.sItemIndex == 0) {
      ...
      } // we have something in the cursor
      else {
        // Drop the item into the current slot
        ...
        if (PlayersOfferArea[ubSelectedInvSlot].fActive) {
          ...
          // if the slot is overloaded (holds more objects than we have room for valid statuses of)
          if (
            PlayersOfferArea[ubSelectedInvSlot].ItemObject.ubNumberOfObjects >
          ...
          copyInventoryInSlot(
            PlayersOfferArea[ubSelectedInvSlot],
            gMoveingItem,
          );
          copyInventoryInSlot(gMoveingItem, TempSlot);
          ...
          if (
            Item[PlayersOfferArea[ubSelectedInvSlot].sItemIndex].usItemClass ==
            IC_MONEY
          ) {
            // Since money is always evaluated
            PlayersOfferArea[ubSelectedInvSlot].uiFlags |=
              ARMS_INV_PLAYERS_ITEM_HAS_VALUE;
          ...
          if (
            ...
            OfferObjectToDealer(
              ...
              gMoveingItem.ubIdOfMercWhoOwnsTheItem,
  ...
  function SelectSkiInventoryMovementAreaRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function InitializeShopKeeper(fResetPage: boolean): void {
    ...
    gArmsDealerStatus[gbSelectedArmsDealerID].uiTimePlayerLastInSKI =
      GetWorldTotalMin();
    ...
    */
    ...
    gSelectArmsDealerInfo.ubNumberOfPages = Math.trunc(
      gSelectArmsDealerInfo.uiNumDistinctInventoryItems /
        SKI_NUM_ARMS_DEALERS_INV_SLOTS,
    );
    ...
    if (gSelectArmsDealerInfo.uiNumDistinctInventoryItems == 0)
      ...
      if (fResetPage) {
        if (gSelectArmsDealerInfo.uiNumDistinctInventoryItems == 0)
          gSelectArmsDealerInfo.ubCurrentPage = 0;
        else gSelectArmsDealerInfo.ubCurrentPage = 1;
      }
  ...
  function DisplayArmsDealerCurrentInventoryPage(): void {
    ...
    if (gpTempDealersInventory != null) {
      if (gubSkiDirtyLevel != Enum253.SKI_DIRTY_LEVEL0) {
        ...
        RestoreExternBackgroundRect(
          SKI_ARMS_DEALERS_INV_START_X,
          SKI_ARMS_DEALERS_INV_START_Y,
          370,
          107,
        );
        ...
        DrawTextToScreen(
          SKI_Text[Enum367.SKI_TEXT_PAGE],
          SKI_PAGE_X,
          SKI_PAGE_Y + 3,
          SKI_PAGE_WIDTH,
          SKI_LABEL_FONT(),
      ...
      for (
        usCnt = gSelectArmsDealerInfo.ubFirstItemIndexOnPage;
        ...
        if (gpTempDealersInventory[usCnt].sItemIndex != 0) {
          ...
          if (
            !(
              gDealersInventoryMouseRegions[sItemCount].uiFlags &
              MSYS_REGION_ENABLED
            )
          ) {
          ...
          // if the dealer repairs
            ...
            if (
              ArmsDealerInfo[gbSelectedArmsDealerID].uiFlags &
              ARMS_INV_ITEM_NOT_REPAIRED_YET
            )
              fDisplayHatchOnItem = true;
            else fDisplayHatchOnItem = false;
          } // non-repairman
          else {
            // check if none left
            if (
              gpTempDealersInventory[usCnt].ItemObject.ubNumberOfObjects == 0
            ) {
              fDisplayHatchOnItem = true;
            } else {
          ...
          DisplayInvSlot(
            usCnt,
            gpTempDealersInventory[usCnt].sItemIndex,
            usPosX,
            usPosY,
          ...
          if (gubSkiDirtyLevel == Enum253.SKI_DIRTY_LEVEL2) {
            SetSkiRegionHelpText(
              gpTempDealersInventory[usCnt],
              gDealersInventoryMouseRegions[sItemCount],
              Enum252.ARMS_DEALER_INVENTORY,
            );
  ...
  function DisplayInvSlot(
    ...
    sCenX =
      usPosX +
      7 +
      Math.trunc(Math.abs(SKI_INV_WIDTH - 3 - usWidth) / 2) -
      pTrav.sOffsetX;
    sCenY =
      usPosY +
      Math.trunc(Math.abs(SKI_INV_HEIGHT - usHeight) / 2) -
      pTrav.sOffsetY;
    ...
    DrawItemUIBarEx(
      ...
      2,
      20,
      Get16BPPColor(FROMRGB(140, 136, 119)),
      Get16BPPColor(FROMRGB(140, 136, 119)),
      true,
      guiRENDERBUFFER,
    ); // guiSAVEBUFFER
    ...
    if (ubItemArea == Enum252.PLAYERS_OFFER_AREA) {
      ...
      if (
        PlayersOfferArea[ubSlotNum].uiFlags & ARMS_INV_PLAYERS_ITEM_HAS_VALUE
      ) {
      ...
      if (
        ...
        if (fHatchedOut && pItemObject.ubNumberOfObjects == 0) {
          ...
          uiItemCost = CalcShopKeeperItemPrice(
            DEALER_SELLING,
            true,
            usItemIndex,
        ...
        DrawTextToScreen(
          zTemp,
          usPosX + SKI_INV_PRICE_OFFSET_X,
          usPosY + SKI_INV_PRICE_OFFSET_Y,
          SKI_INV_SLOT_WIDTH,
          SKI_ITEM_DESC_FONT(),
          SKI_ITEM_PRICE_COLOR,
          FONT_MCOLOR_BLACK,
        ...
        // if the item belongs to a merc
        if (
          gpTempDealersInventory[ubSlotNum].ubIdOfMercWhoOwnsTheItem !=
          NO_PROFILE
        ) {
          // Display the face of the merc
          fDisplayMercFace = true;
      ...
      if (
        ...
        uiItemCost = CalculateObjectItemRepairCost(
          gbSelectedArmsDealerID,
          pItemObject,
        );
      } else
    ...
    if (
      ...
      (pItemObject.ubNumberOfObjects == 1 &&
        DealerItemIsSafeToStack(usItemIndex) &&
        ubItemArea == Enum252.ARMS_DEALER_INVENTORY &&
        gpTempDealersInventory[ubSlotNum].uiFlags & ARMS_INV_ITEM_SELECTED)
    ) {
      zTemp = swprintf("x%d", pItemObject.ubNumberOfObjects);
      DrawTextToScreen(
        zTemp,
        usPosX + SKI_ITEM_NUMBER_TEXT_OFFSET_X,
        usPosY + SKI_ITEM_NUMBER_TEXT_OFFSET_Y,
        SKI_ITEM_NUMBER_TEXT_WIDTH,
        SKIT_NUMBER_FONT(),
        SKI_ITEM_PRICE_COLOR,
        FONT_MCOLOR_BLACK,
        false,
    ...
    if (ItemHasAttachments(pItemObject)) {
      ...
      DrawTextToScreen(
        zTemp,
        usPosX + SKI_ATTACHMENT_SYMBOL_X_OFFSET,
        usPosY + SKI_ATTACHMENT_SYMBOL_Y_OFFSET,
        0,
        TINYFONT1(),
        FONT_GREEN,
        FONT_MCOLOR_BLACK,
    ...
    if (pItemObject.bGunAmmoStatus < 0) {
      ...
      ({ sX: sCenX, sY: sCenY } = VarFindFontCenterCoordinates(
        usPosX,
        usPosY,
        SKI_INV_SLOT_WIDTH,
        SKI_INV_HEIGHT,
  ...
  function DetermineArmsDealersSellingInventory(): boolean {
    ...
    gpTempDealersInventory = createArrayFrom(
      gSelectArmsDealerInfo.uiNumDistinctInventoryItems,
      createInventoryInSlot,
    );
    if (gpTempDealersInventory == null) {
      Assert(0);
      return false;
    ...
    for (usItemIndex = 1; usItemIndex < Enum225.MAXITEMS; usItemIndex++) {
      ...
      if (
        gArmsDealersInventory[gbSelectedArmsDealerID][usItemIndex]
          .ubTotalItems > 0
      ) {
            ...
            if (pSpecialItem.Info.bItemCondition < 0) {
              ...
              if (pSpecialItem.uiRepairDoneTime <= GetWorldTotalMin()) {
                if (RepairIsDone(usItemIndex, ubElement)) {
                  ...
                  gpTempDealersInventory[guiNextFreeInvSlot].uiFlags |=
                    ARMS_INV_ITEM_REPAIRED;
                }
              } else {
                gpTempDealersInventory[guiNextFreeInvSlot].uiFlags |=
                  ARMS_INV_ITEM_NOT_REPAIRED_YET;
  ...
  function AddItemsToTempDealerInventory(
    usItemIndex: UINT16,
    pSpclItemInfo: SPECIAL_ITEM_INFO,
    sSpecialItemElement: INT16,
    ubHowMany: UINT8,
    ubOwner: UINT8,
  ): void {
    let ubCnt: UINT8;
    ...
    if (ubHowMany == 1) {
      ...
      StoreObjectsInNextFreeDealerInvSlot(
        usItemIndex,
        pSpclItemInfo,
        sSpecialItemElement,
        1,
  ...
  function StoreObjectsInNextFreeDealerInvSlot(
    usItemIndex: UINT16,
    pSpclItemInfo: SPECIAL_ITEM_INFO,
    sSpecialItemElement: INT16,
    ubHowMany: UINT8,
    ...
    Assert(
      guiNextFreeInvSlot < gSelectArmsDealerInfo.uiNumDistinctInventoryItems,
    );
    ...
    MakeObjectOutOfDealerItems(
      usItemIndex,
      pSpclItemInfo,
      pDealerInvSlot.ItemObject,
      Math.min(ubHowMany, MAX_OBJECTS_PER_SLOT),
    );
  ...
  function RepairIsDone(usItemIndex: UINT16, ubElement: UINT8): boolean {
    ...
    RepairItem.ubIdOfMercWhoOwnsTheItem =
      gArmsDealersInventory[gbSelectedArmsDealerID][usItemIndex].SpecialItem[
        ubElement
      ].ubOwnerProfileId;
    ...
    MakeObjectOutOfDealerItems(
      ...
      RepairItem.ItemObject,
      1,
    );

    if (
      CanDealerRepairItem(gbSelectedArmsDealerID, RepairItem.ItemObject.usItem)
    ) {
    ...
    for (ubCnt = 0; ubCnt < MAX_ATTACHMENTS; ubCnt++) {
      ...
      */
        if (
          CanDealerRepairItem(
            gbSelectedArmsDealerID,
            RepairItem.ItemObject.usAttachItem[ubCnt],
          )
        ) {
          // fix it up
    ...
    bSlotNum = AddItemToPlayersOfferArea(
      RepairItem.ubIdOfMercWhoOwnsTheItem,
      RepairItem,
      -1,
    );
  ...
  export function DrawHatchOnInventory(
    uiSurface: UINT32,
    usPosX: UINT16,
    usPosY: UINT16,
    usWidth: UINT16,
    ...
    Blt16BPPBufferPixelateRect(
      ...
      uiDestPitchBYTES,
      ClipRect,
      DrawHatchOnInventory__Pattern,
    );
    UnLockVideoSurface(uiSurface);
  }

  function CalcShopKeeperItemPrice(
    fDealerSelling: boolean,
    fUnitPriceOnly: boolean,
    usItemID: UINT16,
    dModifier: FLOAT,
    pItemObject: OBJECTTYPE,
  ): UINT32 {
    ...
    switch (Item[usItemID].usItemClass) {
      case IC_GUN:
        ...
        uiUnitPrice += Math.trunc(
          CalcValueOfItemToDealer(
            gbSelectedArmsDealerID,
            usItemID,
            fDealerSelling,
          ) *
    ...
    if (gpSMCurrentMerc.ubProfile == Enum268.FLO) {
      ...
      switch (Item[usItemID].usItemClass) {
        case IC_GUN:
        case IC_AMMO:
          uiDiscountValue = Math.trunc(
            (uiUnitPrice * FLO_DISCOUNT_PERCENTAGE) / 100,
          );
  ...
  */
  ...
  function ItemConditionModifier(usItemIndex: UINT16, bStatus: INT8): FLOAT {
    ...
    if (Item[usItemIndex].usItemClass == IC_AMMO) {
      ...
      dConditionModifier =
        bStatus / Magazine[Item[usItemIndex].ubClassIndex].ubMagSize;
    } // non-ammo
    else {
  ...
  function DisplayArmsDealerOfferArea(): void {
    ...
    if (gubSkiDirtyLevel != Enum253.SKI_DIRTY_LEVEL0) {
      ...
      RestoreExternBackgroundRect(
        usPosX,
        usPosY,
        SKI_ARMS_DEALERS_TRADING_INV_WIDTH,
    ...
    for (sCnt = 0; sCnt < SKI_NUM_TRADING_INV_SLOTS; sCnt++) {
      if (ArmsDealerOfferArea[sCnt].fActive) {
        // hatch it out if region is disabled
        if (
          !(gDealersOfferSlotsMouseRegions[sCnt].uiFlags & MSYS_REGION_ENABLED)
        ) {
          fDisplayHatchOnItem = true;
        ...
        // Display the inventory slot
        uiTotalCost += DisplayInvSlot(
          sCnt,
          ArmsDealerOfferArea[sCnt].sItemIndex,
          usPosX,
          usPosY,
    ...
    if (gubSkiDirtyLevel == Enum253.SKI_DIRTY_LEVEL2) {
      ...
      RestoreExternBackgroundRect(
        SKI_ARMS_DEALER_TOTAL_COST_X,
        SKI_ARMS_DEALER_TOTAL_COST_Y,
      ...
      DrawTextToScreen(
        zTemp,
        SKI_ARMS_DEALER_TOTAL_COST_X,
        SKI_ARMS_DEALER_TOTAL_COST_Y + 5,
        SKI_INV_SLOT_WIDTH,
        SKI_LABEL_FONT(),
        SKI_ITEM_PRICE_COLOR,
        FONT_MCOLOR_BLACK,
  ...
  function AddItemToArmsDealerOfferArea(
    pInvSlot: INVENTORY_IN_SLOT,
    ...
    for (bCnt = 0; bCnt < SKI_NUM_TRADING_INV_SLOTS; bCnt++) {
      ...
      if (ArmsDealerOfferArea[bCnt].fActive == false) {
        ...
        ArmsDealerOfferArea[bCnt].bSlotIdInOtherLocation =
          bSlotIdInOtherLocation;
        ArmsDealerOfferArea[bCnt].ubIdOfMercWhoOwnsTheItem =
          pInvSlot.ubIdOfMercWhoOwnsTheItem;
        ArmsDealerOfferArea[bCnt].fActive = true;

        SetSkiRegionHelpText(
          ArmsDealerOfferArea[bCnt],
          gDealersOfferSlotsMouseRegions[bCnt],
          Enum252.ARMS_DEALER_OFFER_AREA,
        );
        SetSkiFaceRegionHelpText(
          ArmsDealerOfferArea[bCnt],
  ...
  function RemoveItemFromArmsDealerOfferArea(
    bSlotId: INT8,
    fKeepItem: boolean,
  ): boolean {
    //	UINT16	usCnt;
    ...
    //	for( usCnt=0; usCnt<SKI_NUM_TRADING_INV_SLOTS; usCnt++)
    {
      ...
      if (ArmsDealerOfferArea[bSlotId].fActive) {
        // bSlotIdInOtherLocation == bSlotIdInOtherLocation )
        // if there are more then 1 item
        //			if( ArmsDealerOfferArea[ usCnt ].ItemObject.ubNumberOfObjects > 1 )
        if (fKeepItem) {
          gpTempDealersInventory[
            ArmsDealerOfferArea[bSlotId].bSlotIdInOtherLocation
          ].ItemObject.ubNumberOfObjects +=
        ...
        gpTempDealersInventory[
          ArmsDealerOfferArea[bSlotId].bSlotIdInOtherLocation
        ].uiFlags &= ~ARMS_INV_ITEM_SELECTED;
  ...
  function SetSkiRegionHelpText(
    pInv: INVENTORY_IN_SLOT | null,
    pRegion: MOUSE_REGION,
    ubScreenArea: UINT8,
  ): void {
  ...
  function SetSkiFaceRegionHelpText(
    pInv: INVENTORY_IN_SLOT | null,
    pRegion: MOUSE_REGION,
    ubScreenArea: UINT8,
  ): void {
    ...
    if (pInv != null && pInv.ubIdOfMercWhoOwnsTheItem != NO_PROFILE) {
      ...
      zHelpText = swprintf(
        "%s%s %s",
        gMercProfiles[pInv.ubIdOfMercWhoOwnsTheItem].zNickname,
        pMessageStrings[Enum333.MSG_DASH_S],
        zTempText,
      );
    } else {
      zHelpText = "";
  ...
  function AddItemToPlayersOfferArea(
    ubProfileID: UINT8,
    pInvSlot: INVENTORY_IN_SLOT,
    bSlotIdInOtherLocation: INT8,
  ): INT8 {
    ...
    if (bSlotIdInOtherLocation != -1) {
      ...
      if (
        GetPtrToOfferSlotWhereThisItemIs(ubProfileID, bSlotIdInOtherLocation) !=
        null
      )
        return -1;
    }
    ...
    for (bCnt = 0; bCnt < SKI_NUM_TRADING_INV_SLOTS; bCnt++) {
      ...
      if (PlayersOfferArea[bCnt].fActive == false) {
        ...
        SetSkiRegionHelpText(
          PlayersOfferArea[bCnt],
          gPlayersOfferSlotsMouseRegions[bCnt],
          Enum252.PLAYERS_OFFER_AREA,
        );
        SetSkiFaceRegionHelpText(
          PlayersOfferArea[bCnt],
          gPlayersOfferSlotsSmallFaceMouseRegions[bCnt],
          Enum252.PLAYERS_OFFER_AREA,
        );
        ...
        if (Item[PlayersOfferArea[bCnt].sItemIndex].usItemClass == IC_MONEY) {
          ...
          PlayersOfferArea[bCnt].uiItemPrice =
            PlayersOfferArea[bCnt].ItemObject.uiMoneyAmount;
        }
        gubSkiDirtyLevel = Enum253.SKI_DIRTY_LEVEL2;
  ...
  function DisplayPlayersOfferArea(): void {
    ...
    if (gubSkiDirtyLevel == Enum253.SKI_DIRTY_LEVEL2) {
      // Restore the area before blitting the new data on
      RestoreExternBackgroundRect(
        SKI_PLAYERS_TRADING_INV_X,
        SKI_PLAYERS_TRADING_INV_Y,
        SKI_PLAYERS_TRADING_INV_WIDTH,
        SKI_PLAYERS_TRADING_INV_HEIGHT,
      );
    }
    ...
    for (sCnt = 0; sCnt < SKI_NUM_TRADING_INV_SLOTS; sCnt++) {
      if (PlayersOfferArea[sCnt].fActive) {
        ...
        if (Item[PlayersOfferArea[sCnt].sItemIndex].usItemClass == IC_MONEY) {
          ...
          if (
            PlayersOfferArea[sCnt].bSlotIdInOtherLocation != -1 &&
            PlayersOfferArea[sCnt].ubIdOfMercWhoOwnsTheItem != NO_PROFILE
          ) {
            let sSoldierID: INT16;

            sSoldierID = GetSoldierIDFromMercID(
              PlayersOfferArea[sCnt].ubIdOfMercWhoOwnsTheItem,
            );
            Assert(sSoldierID != -1);

            PlayersOfferArea[sCnt].ItemObject.uiMoneyAmount =
              Menptr[sSoldierID].inv[
                PlayersOfferArea[sCnt].bSlotIdInOtherLocation
              ].uiMoneyAmount;
            PlayersOfferArea[sCnt].uiItemPrice =
              PlayersOfferArea[sCnt].ItemObject.uiMoneyAmount;
          }
        } // not money
        else {
          ...
          if (
            ...
            if (
              WillShopKeeperRejectObjectsFromPlayer(
                gbSelectedArmsDealerID,
                sCnt,
              ) == false
            ) {
        ...
        DisplayInvSlot(
          sCnt,
          PlayersOfferArea[sCnt].sItemIndex,
          usPosX,
          usPosY,
    ...
    if (gubSkiDirtyLevel == Enum253.SKI_DIRTY_LEVEL2) {
      ...
      // Restore the previous area
      RestoreExternBackgroundRect(
        SKI_PLAYERS_TOTAL_VALUE_X,
        SKI_PLAYERS_TOTAL_VALUE_Y,
        SKI_PLAYERS_TOTAL_VALUE_WIDTH,
        SKI_PLAYERS_TOTAL_VALUE_HEIGHT,
      );
  ...
  function GetPtrToOfferSlotWhereThisItemIs(
    ubProfileID: UINT8,
    bInvPocket: INT8,
  ): INVENTORY_IN_SLOT | null {
    let ubCnt: UINT8 = 0;

    for (ubCnt = 0; ubCnt < SKI_NUM_TRADING_INV_SLOTS; ubCnt++) {
      if (
        PlayersOfferArea[ubCnt].bSlotIdInOtherLocation == bInvPocket &&
      ...
      if (
        ArmsDealerOfferArea[ubCnt].bSlotIdInOtherLocation == bInvPocket &&
  ...
  export function ShouldSoldierDisplayHatchOnItem(
    ubProfileID: UINT8,
    sSlotNum: INT16,
  ): boolean {
    ...
    for (uiCnt = 0; uiCnt < SKI_NUM_TRADING_INV_SLOTS; uiCnt++) {
      if (ArmsDealerOfferArea[uiCnt].fActive) {
        ...
        if (
          ...
          uiTotal += CalculateObjectItemRepairCost(
            gbSelectedArmsDealerID,
            ArmsDealerOfferArea[uiCnt].ItemObject,
          );
        else
          uiTotal += CalcShopKeeperItemPrice(
            DEALER_SELLING,
            false,
            ArmsDealerOfferArea[uiCnt].sItemIndex,
            ArmsDealerInfo[gbSelectedArmsDealerID].dSellModifier,
            ArmsDealerOfferArea[uiCnt].ItemObject,
          );
      }
  ...
  function CalculateTotalPlayersValue(): UINT32 {
    ...
    for (ubCnt = 0; ubCnt < SKI_NUM_TRADING_INV_SLOTS; ubCnt++) {
      if (
        PlayersOfferArea[ubCnt].fActive &&
        ...
        else uiTotal += PlayersOfferArea[ubCnt].uiItemPrice;
      }
    }
  ...
  function PerformTransaction(uiMoneyFromPlayersAccount: UINT32): void {
    let uiPlayersTotalMoneyValue: UINT32 =
      CalculateTotalPlayersValue() + uiMoneyFromPlayersAccount;
    let uiArmsDealersItemsCost: UINT32 = CalculateTotalArmsDealerCost();
    let uiMoneyInPlayersOfferArea: UINT32 =
      CalculateHowMuchMoneyIsInPlayersOfferArea();
    ...
    if (
      IsMoneyTheOnlyItemInThePlayersOfferArea() &&
      ...
      if (
        ...
        uiAvailablePlayerOfferSlots =
          ...
          CountNumberOfValuelessItemsInThePlayersOfferArea();
      ...
      if (uiArmsDealersItemsCost > uiPlayersTotalMoneyValue) {
        ...
        if (
          uiArmsDealersItemsCost >
          uiPlayersTotalMoneyValue + LaptopSaveInfo.iCurrentBalance
        ) {
          // tell player he can't possibly afford this
          SpecialCharacterDialogueEvent(
            DIALOGUE_SPECIAL_EVENT_SHOPKEEPER,
            6,
            0,
            0,
            giShopKeeperFaceIndex,
            DIALOGUE_SHOPKEEPER_UI,
          );
          SpecialCharacterDialogueEvent(
            DIALOGUE_SPECIAL_EVENT_SKIP_A_FRAME,
            0,
            0,
            0,
            giShopKeeperFaceIndex,
          ...
          SpecialCharacterDialogueEvent(
            ...
            0,
            uiArmsDealersItemsCost -
              (LaptopSaveInfo.iCurrentBalance + uiPlayersTotalMoneyValue),
            0,
            giShopKeeperFaceIndex,
            DIALOGUE_SHOPKEEPER_UI,
          );
          ...
          if (uiPlayersTotalMoneyValue)
            SpecialCharacterDialogueEvent(
              DIALOGUE_SPECIAL_EVENT_SHOPKEEPER,
              1,
              uiArmsDealersItemsCost - uiPlayersTotalMoneyValue,
              0,
              giShopKeeperFaceIndex,
              DIALOGUE_SHOPKEEPER_UI,
            );
      ...
      if (
        ...
        if (
          uiMoneyFromPlayersAccount + uiMoneyInPlayersOfferArea >=
          uiArmsDealersItemsCost
        ) {
          ...
          if (
            ...
            if (iChangeToGiveToPlayer > 0) {
              ...
              if (uiArmsDealersItemsCost > 0) {
                StartShopKeeperTalking(
                  Enum254.SK_QUOTES_PLAYER_HAS_TOO_MUCH_MONEY_FOR_TRANSACTION,
                );
              }
            } else
              StartShopKeeperTalking(
                Enum254.SK_QUOTES_PLAYER_HAS_EXACTLY_ENOUGH_MONEY_FOR_TRANSACTION,
              );
          }
        ...
        iChangeToGiveToPlayer =
          CalculateTotalPlayersValue() - uiArmsDealersItemsCost;
        ...
        if (
          ...
          if (
            ...
            if (gbSelectedArmsDealerID != Enum197.ARMS_DEALER_JAKE) {
              ...
              StartShopKeeperTalking(
                Enum254.SK_QUOTES_CANT_AFFORD_TO_BUY_OR_TOO_MUCH_TO_REPAIR,
              );
              gfResetShopKeepIdleQuote = true;
  ...
  function MoveAllArmsDealersItemsInOfferAreaToPlayersOfferArea(): void {
    ...
    for (uiCnt = 0; uiCnt < SKI_NUM_TRADING_INV_SLOTS; uiCnt++) {
      ...
      if (ArmsDealerOfferArea[uiCnt].fActive) {
        bSlotID = AddItemToPlayersOfferArea(
          NO_PROFILE,
          ArmsDealerOfferArea[uiCnt],
          -1,
        );
        ...
        if (bSlotID != -1) {
          ...
          if (
            gbSelectedArmsDealerID == Enum197.ARMS_DEALER_FRANZ &&
            ArmsDealerOfferArea[uiCnt].sItemIndex == Enum225.VIDEO_CAMERA
          ) {
            // set a special flag
        ...
        RemoveItemFromDealersInventory(
          ArmsDealerOfferArea[uiCnt],
          ArmsDealerOfferArea[uiCnt].bSlotIdInOtherLocation,
        );

        // Remove the items from the Shopkeepers Offer area
        if (!RemoveItemFromArmsDealerOfferArea(uiCnt, false))
          // ArmsDealerOfferArea[uiCnt].bSlotIdInOtherLocation
          Assert(0);
  ...
  function RemoveItemFromDealersInventory(
    pInvSlot: INVENTORY_IN_SLOT,
    ubSlot: UINT8,
  ): boolean {
    let sInvSlot: INT16;
    ...
    for (uiCnt = 0; uiCnt < SKI_NUM_TRADING_INV_SLOTS; uiCnt++) {
      ...
      if (PlayersOfferArea[uiCnt].fActive) {
        ...
        if (PlayersOfferArea[uiCnt].uiFlags & ARMS_INV_PLAYERS_ITEM_HAS_VALUE) {
          ...
          // if the item is money
          if (
            Item[PlayersOfferArea[uiCnt].sItemIndex].usItemClass == IC_MONEY
          ) {
            ...
            if (
              ...
              AddObjectToArmsDealerInventory(
                gbSelectedArmsDealerID,
  ...
  export function BeginSkiItemPointer(
    ubSource: UINT8,
    bSlotNum: INT8,
    fOfferToDealerFirst: boolean,
  ): void {
  ...
  */
    ...
    switch (ubSource) {
      ...
      case Enum252.ARMS_DEALER_OFFER_AREA:
        ...
        if (gMoveingItem.ubIdOfMercWhoOwnsTheItem != -1) {
          gpItemPointerSoldier = <SOLDIERTYPE>(
            FindSoldierByProfileID(gMoveingItem.ubIdOfMercWhoOwnsTheItem, true)
          );
          // make sure the soldier is not null
          if (gpItemPointerSoldier == null) {
            gpItemPointerSoldier = gpSMCurrentMerc;
          }
        } else gpItemPointerSoldier = gpSMCurrentMerc;
      ...
      case Enum252.PLAYERS_OFFER_AREA:
        ...
        // if the slot is overloaded (holds more objects than we have room for valid statuses of)
        if (
          PlayersOfferArea[bSlotNum].ItemObject.ubNumberOfObjects >
          MAX_OBJECTS_PER_SLOT
        ) {
      ...
      case Enum252.PLAYERS_INVENTORY:
        ...
        if (
          ...
          // Reset the cursor
          SetSkiCursor(Enum317.CURSOR_NORMAL);
        } // not supposed to offer it, or dealer has no more room
        else {
  ...
  function AddInventoryToSkiLocation(
    pInv: INVENTORY_IN_SLOT,
    ubSpotLocation: UINT8,
    ubWhere: UINT8,
  ): INT8 {
    ...
    switch (ubWhere) {
      ...
      case Enum252.ARMS_DEALER_OFFER_AREA:
        ...
        if (ArmsDealerOfferArea[ubSpotLocation].fActive == false) {
          ...
          SetSkiRegionHelpText(
            ArmsDealerOfferArea[ubSpotLocation],
      ...
      case Enum252.PLAYERS_OFFER_AREA:
        ...
        if (PlayersOfferArea[ubSpotLocation].fActive == false) {
          ...
          // if the item is money
          if (
            Item[PlayersOfferArea[ubSpotLocation].sItemIndex].usItemClass ==
            IC_MONEY
          ) {
            // Since money is always evaluated
            PlayersOfferArea[ubSpotLocation].uiFlags |=
              ARMS_INV_PLAYERS_ITEM_HAS_VALUE;
          ...
          SetSkiRegionHelpText(
            PlayersOfferArea[ubSpotLocation],
            gPlayersOfferSlotsMouseRegions[ubSpotLocation],
            Enum252.PLAYERS_OFFER_AREA,
          );
          SetSkiFaceRegionHelpText(
            PlayersOfferArea[ubSpotLocation],
        ...
        // that slot is full
          ...
          // add it elsewhere
          bSlotAddedTo = AddItemToPlayersOfferArea(
            pInv.ubIdOfMercWhoOwnsTheItem,
            pInv,
  ...
  function HandleShopKeeperDialog(ubInit: UINT8): void {
    ...
    if (ubInit == 1) {
      ...
      if (
        gbSelectedArmsDealerID == Enum197.ARMS_DEALER_ARNIE &&
        RepairmanIsFixingItemsButNoneAreDoneYet(Enum268.ARNIE)
      ) {
    ...
    // if the player has requested to leave
      ...
      if (
        uiCurTime - uiLastTime >
        guiRandomQuoteDelayTime + Random(guiRandomQuoteDelayTime)
      ) {
        ...
        if (Chance(35)) {
          ...
          if (
            ...
            if (CountNumberOfItemsInTheArmsDealersOfferArea() > 0) {
              sRandomQuoteToUse =
                Enum254.SK_QUOTES_RANDOM_QUOTE_WHILE_ITEMS_CHOSEN_TO_SELL_OR_REPAIR;
            }
          } // non-repairman
          else {
            // if there is any items in the player's area with value to this dealer other than just money
            if (
              CalculateTotalPlayersValue() -
                CalculateHowMuchMoneyIsInPlayersOfferArea() >
              0
            ) {
              ...
              if (CountNumberOfItemsInTheArmsDealersOfferArea() > 0) {
                sRandomQuoteToUse =
                  Enum254.SK_QUOTES_RANDOM_QUOTE_WHILE_ITEMS_CHOSEN_TO_TRADE;
              } else {
                sRandomQuoteToUse =
                  Enum254.SK_QUOTES_RANDOM_QUOTE_WHILE_ITEMS_CHOSEN_TO_SELL_OR_REPAIR;
              }
          ...
          if (sRandomQuoteToUse == -1 || Chance(33)) {
            if (Chance(50))
              sRandomQuoteToUse =
                Enum254.SK_QUOTES_RANDOM_QUOTE_WHILE_PLAYER_DECIDING_1;
            else
              sRandomQuoteToUse =
                Enum254.SK_QUOTES_RANDOM_QUOTE_WHILE_PLAYER_DECIDING_2;
          }
          ...
          if (!gfCommonQuoteUsedThisSession[sRandomQuoteToUse]) {
            ...
            guiRandomQuoteDelayTime +=
              SKI_DEALERS_RANDOM_QUOTE_DELAY_INCREASE_RATE;
          }
        }
  ...
  function StartShopKeeperTalking(usQuoteNum: UINT16): boolean {
    ...
    if (
      gfSKIScreenExit ||
      gfRemindedPlayerToPickUpHisStuff ||
      gfUserHasRequestedToLeave
    ) {
      return false;
    }
  ...
  function IsGunOrAmmoOfSameTypeSelected(pItemObject: OBJECTTYPE): boolean {
    ...
    if (Item[gpHighLightedItemObject.usItem].usItemClass == IC_AMMO) {
      ...
      if (Item[pItemObject.usItem].usItemClass == IC_GUN) {
        // of the same caliber
        if (
          Weapon[pItemObject.usItem].ubCalibre ==
    ...
    // else if the item is a gun
      ...
      if (Item[pItemObject.usItem].usItemClass == IC_AMMO) {
        // of the same caliber
        if (
          Weapon[gpHighLightedItemObject.usItem].ubCalibre ==
  ...
  export function InitShopKeeperSubTitledText(
    ...
    if (gGameSettings.fOptions[Enum8.TOPTION_SUBTITLES]) {
      ...
      giPopUpBoxId = PrepareMercPopupBox(
        giPopUpBoxId,
      ...
      if (!(gShopKeeperSubTitleMouseRegion.uiFlags & MSYS_REGION_EXISTS)) {
        MSYS_DefineRegion(
          gShopKeeperSubTitleMouseRegion,
          gusPositionOfSubTitlesX,
          SKI_POSITION_SUBTITLES_Y,
          gusPositionOfSubTitlesX + usActualWidth,
          SKI_POSITION_SUBTITLES_Y + usActualHeight,
          MSYS_PRIORITY_HIGH,
          Enum317.CURSOR_NORMAL,
          MSYS_NO_CALLBACK,
  ...
  // Mouse Call back for the Arms traders inventory slot
  function ShopKeeperSubTitleRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectArmsDealersFaceRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function CreateSkiAtmButtons(): void {
    ...
    guiSKI_AtmNumButtonImage = LoadButtonImage(
      "INTERFACE\\TradeScreenAtm.sti",
      1,
      2,
      -1,
      3,
    ...
    guiSKI_AtmOkButtonImage = UseLoadedButtonImage(
      guiSKI_AtmNumButtonImage,
      4,
      5,
      -1,
      6,
    ...
    guiSKI_AtmSideMenuButtonImage = UseLoadedButtonImage(
      guiSKI_AtmNumButtonImage,
      7,
      8,
      -1,
    ...
    for (ubCnt = Enum368.SKI_ATM_1; ubCnt <= Enum368.SKI_ATM_9; ubCnt++) {
      guiSKI_AtmButton[ubCnt] = CreateIconAndTextButton(
        ...
        MSYS_PRIORITY_HIGH + 2,
        DEFAULT_MOVE_CALLBACK(),
        BtnSKI_AtmButtonCallback,
      );

      SpecifyDisabledButtonStyle(
        guiSKI_AtmButton[ubCnt],
    ...
    usPosX = SKI_ATM_BUTTON_X;
    guiSKI_AtmButton[Enum368.SKI_ATM_0] = CreateIconAndTextButton(
      guiSKI_AtmOkButtonImage,
      SkiAtmText[Enum368.SKI_ATM_0],
      SKI_ATM_BUTTON_FONT(),
      SKI_ATM_BUTTON_COLOR,
      NO_SHADOW,
      SKI_ATM_BUTTON_COLOR,
    ...
    MSYS_SetBtnUserData(
      guiSKI_AtmButton[Enum368.SKI_ATM_0],
      0,
      Enum368.SKI_ATM_0,
    );
    ...
    guiSKI_AtmButton[Enum368.SKI_ATM_OK] = CreateIconAndTextButton(
      guiSKI_AtmOkButtonImage,
      SkiAtmText[Enum368.SKI_ATM_OK],
      SKI_ATM_BUTTON_FONT(),
      SKI_ATM_BUTTON_COLOR,
      NO_SHADOW,
      SKI_ATM_BUTTON_COLOR,
    ...
    MSYS_SetBtnUserData(
      guiSKI_AtmButton[Enum368.SKI_ATM_OK],
      0,
      Enum368.SKI_ATM_OK,
    );
    ...
    usPosY = SKI_ATM_BUTTON_Y;
    for (
      ubCnt = Enum368.SKI_ATM_TAKE;
      ubCnt <= Enum368.SKI_ATM_CLEAR;
      ubCnt++
    ) {
      guiSKI_AtmButton[ubCnt] = CreateIconAndTextButton(
        guiSKI_AtmSideMenuButtonImage,
        SkiAtmText[ubCnt],
        SKI_ATM_BUTTON_FONT(),
        SKI_ATM_BUTTON_COLOR,
        NO_SHADOW,
  ...
  function HandleAtmOK(): void {
    ...
    if (gubCurrentSkiAtmMode == Enum250.SKI_ATM_TAKE_MODE) {
      ...
      if (iAmountToTransfer > GetFundsOnMerc(gpSMCurrentMerc)) {
        ...
        if (uiFundsOnCurrentMerc == 0) gzSkiAtmTransferString = "";
        else {
      ...
      if (iAmountToTransfer > LaptopSaveInfo.iCurrentBalance) {
        if (LaptopSaveInfo.iCurrentBalance == 0) gzSkiAtmTransferString = "";
        else {
          // Set the amount to transfer
          gzSkiAtmTransferString = swprintf(
            "%d",
  ...
  function AddNumberToSkiAtm(ubNumber: UINT8): void {
    ...
    if (gzSkiAtmTransferString.length >= 9) return;
  ...
  function DisplaySkiAtmTransferString(): void {
    ...
    ColorFillVideoSurfaceArea(
      FRAME_BUFFER,
      SKI_TRANSFER_STRING_X,
      SKI_TRANSFER_STRING_Y,
  ...
  function HandleCurrentModeText(ubMode: UINT8): void {
    ...
    if (ubMode != ubLastMode) {
      ...
      if (
        ubLastMode != Enum250.SKI_ATM_ERR_TAKE_MODE &&
        ubLastMode != Enum250.SKI_ATM_ERR_GIVE_MODE
      ) {
    ...
    switch (ubMode) {
      ...
      case Enum250.SKI_ATM_TAKE_MODE:
        ...
        else zTemp = gzSkiAtmText[Enum369.SKI_ATM_MODE_TEXT_SELECT_FROM_MERC];
        break;
      ...
      case Enum250.SKI_ATM_GIVE_MODE:
        ...
        if (gzSkiAtmTransferString[0] == "\0")
          zTemp = gzSkiAtmText[Enum369.SKI_ATM_MODE_TEXT_ENTER_AMOUNT];
        else zTemp = gzSkiAtmText[Enum369.SKI_ATM_MODE_TEXT_SELECT_TO_MERC];
        break;

      case Enum250.SKI_ATM_ERR_TAKE_MODE:
      case Enum250.SKI_ATM_ERR_GIVE_MODE:
        zTemp =
          gzSkiAtmText[Enum369.SKI_ATM_MODE_TEXT_SELECT_INUSUFFICIENT_FUNDS];
        break;
      ...
      case Enum250.SKI_ATM_DISPLAY_PLAYERS_BALANCE:
        ...
        zTemp = swprintf(
          "%s: %s",
          gzSkiAtmText[Enum369.SKI_ATM_MODE_TEXT_BALANCE],
          zMoney,
        );
        break;
    }
    ...
    InvalidateRegion(
      SKI_ATM_PANEL_X,
      SKI_ATM_PANEL_Y,
      SKI_ATM_PANEL_X + SKI_ATM_PANEL_WIDTH,
  ...
  function ToggleSkiAtmButtons(): void {
    switch (gubCurrentSkiAtmMode) {
      case Enum250.SKI_ATM_DISABLED_MODE:
        ButtonList[guiSKI_AtmButton[Enum368.SKI_ATM_TAKE]].uiFlags &=
          ~BUTTON_CLICKED_ON;
        ButtonList[guiSKI_AtmButton[Enum368.SKI_ATM_GIVE]].uiFlags &=
          ~BUTTON_CLICKED_ON;
        ButtonList[guiSKI_AtmButton[Enum368.SKI_ATM_CANCEL]].uiFlags &=
          ~BUTTON_CLICKED_ON;
        break;
      case Enum250.SKI_ATM_TAKE_MODE:
      case Enum250.SKI_ATM_ERR_TAKE_MODE:
  ...
  function EnableDisableEvaluateAndTransactionButtons(): void {
    ...
    let uiPlayersOfferAreaTotalMoney: UINT32 =
      CalculateHowMuchMoneyIsInPlayersOfferArea();
  ...
  */
    ...
    */
    ...
    if (
      uiArmsDealerTotalCost >
      uiPlayersOfferAreaTotalCost + LaptopSaveInfo.iCurrentBalance
    ) {
      DisableButton(guiSKI_TransactionButton);
    } else if (
  ...
  */
      ...
      uiPlayersOfferAreaTotalMoney > 0 &&
      uiArmsDealerTotalCost == 0
    ) {
      DisableButton(guiSKI_TransactionButton);
    }
  ...
  export function AddItemToPlayersOfferAreaAfterShopKeeperOpen(
    pItemObject: OBJECTTYPE,
    bPreviousInvPos: INT8,
  ): void {
...
*/
  ...
  function MovePlayersItemsToBeRepairedToArmsDealersInventory(): void {
    ...
    for (uiCnt = 0; uiCnt < SKI_NUM_TRADING_INV_SLOTS; uiCnt++) {
      ...
      if (ArmsDealerOfferArea[uiCnt].fActive) {
        ...
        GiveObjectToArmsDealerForRepair(
          gbSelectedArmsDealerID,
          ArmsDealerOfferArea[uiCnt].ItemObject,
          ArmsDealerOfferArea[uiCnt].ubIdOfMercWhoOwnsTheItem,
        );
        ArmsDealerOfferArea[uiCnt].sSpecialItemElement =
  ...
  function GetInvSlotOfUnfullMoneyInMercInventory(pSoldier: SOLDIERTYPE): INT8 {
    ...
    for (ubCnt = 0; ubCnt < Enum261.NUM_INV_SLOTS; ubCnt++) {
      ...
      if (
        pSoldier.inv[ubCnt].usItem == Enum225.MONEY &&
  ...
  function ClearArmsDealerOfferSlot(ubSlotToClear: INT32): void {
    ...
    if (
      ...
      SetRegionFastHelpText(
        gDealersOfferSlotsSmallFaceMouseRegions[ubSlotToClear],
        "",
      );
    }
  }
  ...
  function ClearPlayersOfferSlot(ubSlotToClear: INT32): void {
    ...
    SetRegionFastHelpText(
      gPlayersOfferSlotsSmallFaceMouseRegions[ubSlotToClear],
      "",
    );
  ...
  function EvaluateItemAddedToPlayersOfferArea(
    bSlotID: INT8,
    fFirstOne: boolean,
  ): void {
    ...
    if (
      PlayersOfferArea[bSlotID].uiFlags &
      ARMS_INV_PLAYERS_ITEM_HAS_BEEN_EVALUATED
    ) {
      return;
    }
    ...
    if (
      ...
      gbSelectedArmsDealerID != Enum197.ARMS_DEALER_DEVIN
    ) {
    ...
    if (
      WillShopKeeperRejectObjectsFromPlayer(gbSelectedArmsDealerID, bSlotID) ==
      false
    ) {
      // if the dealer repairs
      if (
        ...
        let uiNumberOfItemsInForRepairs: UINT32 =
          CountTotalItemsRepairDealerHasInForRepairs(gbSelectedArmsDealerID);
        let uiNumberOfItemsAlreadyEvaluated: UINT32 =
          CountNumberOfItemsInTheArmsDealersOfferArea();
        ...
        if (
          uiNumberOfItemsAlreadyEvaluated +
            ubNumberOfItemsAddedToRepairDuringThisEvaluation +
            uiNumberOfItemsInForRepairs >
        ...
        if (
          PlayersOfferArea[bSlotID].ItemObject.bStatus[0] < 100 ||
          fRocketRifleWasEvaluated
        ) {
          let bSlotAddedTo: INT8;

          // Move the item to the Dealer's Offer Area
          bSlotAddedTo = AddItemToArmsDealerOfferArea(
            PlayersOfferArea[bSlotID],
            PlayersOfferArea[bSlotID].bSlotIdInOtherLocation,
          );
          ...
          */
            ...
            ArmsDealerOfferArea[bSlotAddedTo].uiFlags &=
              ~ARMS_INV_ITEM_SELECTED;
            ...
            if (
              Item[ArmsDealerOfferArea[bSlotAddedTo].sItemIndex].usItemClass !=
              IC_AMMO
            ) {
              if (
                ArmsDealerOfferArea[bSlotAddedTo].ItemObject.bStatus[0] <
            ...
            if (
              ...
              if (
                !(
                  gArmsDealerStatus[gbSelectedArmsDealerID]
    ...
    } // dealer doesn't handle this type of object
    else {
      if (
        ArmsDealerInfo[gbSelectedArmsDealerID].ubTypeOfArmsDealer ==
        Enum198.ARMS_DEALER_REPAIRS
        ...
        if (
          Item[PlayersOfferArea[bSlotID].sItemIndex].fFlags & ITEM_REPAIRABLE
        ) {
    ...
    if (fFirstOne && CanShopkeeperOverrideDialogue()) {
      ...
      switch (uiEvalResult) {
        ...
        case Enum251.EVAL_RESULT_OK_BUT_REALLY_DAMAGED:
          sQuoteNum =
            Enum254.SK_QUOTES_EVALUATION_RESULT_SOME_REALLY_DAMAGED_ITEMS;
          break;
        ...
        case Enum251.EVAL_RESULT_NORMAL:
          ...
          if (guiLastTimeDealerSaidNormalEvaluationQuote == 0)
            ...
            GetJA2Clock() - guiLastTimeDealerSaidNormalEvaluationQuote >
            25000
          )
          ...
          else ubChanceToSayNormalQuote = 0;
  ...
  export function DoSkiMessageBox(
    ubStyle: UINT8,
  ...
  export function ConfirmDontHaveEnoughForTheDealerMessageBoxCallBack(
    bExitValue: UINT8,
  ): void {
  ...
  export function ConfirmToDeductMoneyFromPlayersAccountMessageBoxCallBack(
    bExitValue: UINT8,
  ): void {
    ...
    if (bExitValue == MSG_BOX_RETURN_YES) {
      ...
      let uiArmsDealersItemsCost: UINT32 = CalculateTotalArmsDealerCost();
      let iMoneyToDeduct: INT32 =
        uiArmsDealersItemsCost - uiPlayersOfferAreaValue;
      ...
      AddTransactionToPlayersBook(
        Enum80.PURCHASED_ITEM_FROM_DEALER,
        ArmsDealerInfo[gbSelectedArmsDealerID].ubShopKeeperID,
        GetWorldTotalMin(),
        -iMoneyToDeduct,
      );
  ...
  function WillShopKeeperRejectObjectsFromPlayer(
    bDealerId: INT8,
    bSlotId: INT8,
  ): boolean {
    ...
    if (Item[PlayersOfferArea[bSlotId].sItemIndex].usItemClass == IC_MONEY) {
      ...
      CanDealerTransactItem(
        gbSelectedArmsDealerID,
        PlayersOfferArea[bSlotId].sItemIndex,
        true,
      )
    ) {
      fRejected = false;
  ...
  function CanShopkeeperOverrideDialogue(): boolean {
    ...
    if (
      giShopKeepDialogueEventinProgress <
      Enum254.SK_QUOTES_PLAYER_REQUESTED_EVALUATION
    ) {
      ...
      if (PlayersOfferArea[bSlotId].fActive) {
        ...
        if (!(PlayersOfferArea[bSlotId].uiFlags & ARMS_INV_JUST_PURCHASED)) {
          ...
          if (
            ...
            sBoxStartX =
              SKI_PLAYERS_TRADING_INV_X +
              (bSlotId % SKI_NUM_TRADING_INV_COLS) * SKI_INV_OFFSET_X;
            sBoxStartY =
              SKI_PLAYERS_TRADING_INV_Y +
              Math.trunc(bSlotId / SKI_NUM_TRADING_INV_COLS) * SKI_INV_OFFSET_Y;
  ...
  function HandleCheckIfEnoughOnTheTable(): void {
    ...
    if (iDifference > DELAY_FOR_SHOPKEEPER_IDLE_QUOTE) {
      ...
      if (iRand > CHANCE_FOR_SHOPKEEPER_IDLE_QUOTE) {
        ...
        if (
          uiArmsDealersItemsCost > uiPlayersOfferAreaValue &&
          uiPlayersOfferAreaValue
        ) {
          StartShopKeeperTalking(
            Enum254.SK_QUOTES_EVAULATION_PLAYER_DOESNT_HAVE_ENOUGH_VALUE,
          );
        }
      }
  ...
  function InitShopKeeperItemDescBox(
    pObject: OBJECTTYPE,
    ubPocket: UINT8,
    ubFromLocation: UINT8,
  ): void {
    let sPosX: INT16;
    let sPosY: INT16;
    ...
    switch (ubFromLocation) {
      case Enum252.ARMS_DEALER_INVENTORY:
        {
          let ubSelectedInvSlot: UINT8 =
            ubPocket - gSelectArmsDealerInfo.ubFirstItemIndexOnPage;

          sPosX =
            SKI_ARMS_DEALERS_INV_START_X +
            (SKI_INV_OFFSET_X *
              (ubSelectedInvSlot % SKI_NUM_ARMS_DEALERS_INV_COLS) -
              Math.trunc(358 / 2)) +
            Math.trunc(SKI_INV_SLOT_WIDTH / 2);

          sPosY =
            SKI_ARMS_DEALERS_INV_START_Y +
            (Math.trunc(
              (SKI_INV_OFFSET_Y * ubSelectedInvSlot) /
                SKI_NUM_ARMS_DEALERS_INV_COLS,
            ) +
              1) -
            Math.trunc(128 / 2) +
            Math.trunc(SKI_INV_SLOT_HEIGHT / 2);
      ...
      case Enum252.ARMS_DEALER_OFFER_AREA:
        {
          sPosX =
            SKI_ARMS_DEALERS_TRADING_INV_X +
            (SKI_INV_OFFSET_X *
              (ubPocket % Math.trunc(SKI_NUM_TRADING_INV_SLOTS / 2)) -
              Math.trunc(358 / 2)) +
            Math.trunc(SKI_INV_SLOT_WIDTH / 2);

          sPosY =
            SKI_ARMS_DEALERS_TRADING_INV_Y +
            (Math.trunc(
              (SKI_INV_OFFSET_Y * ubPocket) /
                Math.trunc(SKI_NUM_TRADING_INV_SLOTS / 2),
            ) +
              1) -
            Math.trunc(128 / 2) +
            Math.trunc(SKI_INV_SLOT_HEIGHT / 2);
  ...
  export function StartSKIDescriptionBox(): void {
    ...
    if (gfSMDisableForItems) DrawHatchOnInventory(FRAME_BUFFER, 0, 0, 640, 338);
    else DrawHatchOnInventory(FRAME_BUFFER, 0, 0, 640, 480);
  ...
  */
  ...
  function OfferObjectToDealer(
    pComplexObject: OBJECTTYPE,
    ...
    if (
      ...
      } = CountSubObjectsInObject(pComplexObject));
    ...
    */
      ...
      for (
        ubSubObject = 0;
        ubSubObject < MAX_SUBOBJECTS_PER_OBJECT();
        ubSubObject++
      ) {
        ...
        if (gSubObject[ubSubObject].usItem != Enum225.NONE) {
          ...
          if (ubSubObject == 0 && ubTotalSubObjects == 1) {
            ...
            fSuccess = AddObjectForEvaluation(
              gSubObject[ubSubObject],
              ubOwnerProfileId,
              bOwnerSlotId,
              fFirstOne,
            );
          } // attachments, bullets/payload
          else {
  ...
  function SplitComplexObjectIntoSubObjects(pComplexObject: OBJECTTYPE): void {
      ...
      if (Item[pComplexObject.usItem].usItemClass == IC_GUN) {
        ...
        if (pComplexObject.usGunAmmoItem != Enum225.NONE) {
          ...
          if (Item[pComplexObject.usGunAmmoItem].usItemClass == IC_AMMO) {
            ...
            CreateItem(
              pComplexObject.usGunAmmoItem,
              pComplexObject.bGunAmmoStatus,
              pNextObj,
            );
    ...
    */
      ...
      for (ubCnt = 0; ubCnt < pComplexObject.ubNumberOfObjects; ubCnt++) {
        CreateItem(
          pComplexObject.usItem,
          pComplexObject.bStatus[ubCnt],
          pNextObj,
        );
  ...
  function CountSubObjectsInObject(pComplexObject: OBJECTTYPE): {
    ubTotalSubObjects: UINT8;
    ubRepairableSubObjects: UINT8;
    ubNonRepairableSubObjects: UINT8;
  } {
    let ubSubObject: UINT8;
    ...
    for (
      ...
      if (gSubObject[ubSubObject].usItem != Enum225.NONE) {
        ...
        if (
          gSubObject[ubSubObject].bStatus[0] != 100 &&
          CanDealerRepairItem(
            gbSelectedArmsDealerID,
            gSubObject[ubSubObject].usItem,
          )
        ) {
          ubRepairableSubObjects++;
        } else {
  ...
  function AddObjectForEvaluation(
    pObject: OBJECTTYPE,
    ubOwnerProfileId: UINT8,
    bOwnerSlotId: INT8,
    fFirstOne: boolean,
    ...
    bAddedToSlotID = AddItemToPlayersOfferArea(
      ubOwnerProfileId,
      InvSlot,
      bOwnerSlotId,
    );
  ...
  function ShopkeeperAutoPlaceObject(
  ...
  // This is because the OBJECTTYPEs used within Shopkeeper may contain an illegal ubNumberOfObjects
  function ShopkeeperAddItemToPool(
    sGridNo: INT16,
    pObject: OBJECTTYPE,
    bVisible: INT8,
    ubLevel: UINT8,
  ...
  function IfMercOwnedCopyItemToMercInv(pInv: INVENTORY_IN_SLOT): void {
    ...
    if (
      pInv.bSlotIdInOtherLocation != -1 &&
      pInv.ubIdOfMercWhoOwnsTheItem != NO_PROFILE
    ) {
      ...
      CopyObj(
        pInv.ItemObject,
        Menptr[sSoldierID].inv[pInv.bSlotIdInOtherLocation],
      );
    }
  }

  function IfMercOwnedRemoveItemFromMercInv(pInv: INVENTORY_IN_SLOT): void {
    IfMercOwnedRemoveItemFromMercInv2(
      pInv.ubIdOfMercWhoOwnsTheItem,
      pInv.bSlotIdInOtherLocation,
    );
  }

  function IfMercOwnedRemoveItemFromMercInv2(
    ubOwnerProfileId: UINT8,
    bOwnerSlotId: INT8,
  ): void {
    let sSoldierID: INT16;
  ...
  function SKITryToReturnInvToOwnerOrCurrentMerc(
    pInv: INVENTORY_IN_SLOT,
  ): boolean {
  ...
  function SKITryToAddInvToMercsInventory(
    pInv: INVENTORY_IN_SLOT,
    pSoldier: SOLDIERTYPE,
  ): boolean {
    ...
    fNewItem = Boolean(
      pInv.uiFlags & (ARMS_INV_JUST_PURCHASED | ARMS_INV_ITEM_REPAIRED),
    );
  ...
  export function CanMercInteractWithSelectedShopkeeper(
    pSoldier: SOLDIERTYPE,
  ): boolean {
    ...
    pShopkeeper = FindSoldierByProfileID(
      ArmsDealerInfo[gbSelectedArmsDealerID].ubShopKeeperID,
      false,
    );
  ...
  function ExitSKIRequested(): void {
    ...
    if (!gfRemindedPlayerToPickUpHisStuff) {
      ...
      if (fPlayerOwnedStuffOnTable) {
        ...
        ShutUpShopKeeper();
        StartShopKeeperTalking(
          Enum254.SK_QUOTES_PRESSED_DONE_STILL_HAS_STUFF_IN_OFFER_AREA,
        );
    ...
    if (!gfUserHasRequestedToLeave) {
      ...
      else usQuoteNum = Enum254.SK_QUOTES_PRESSED_DONE_HASNT_MADE_TRANSACTION;
  ...
  function ReturnItemToPlayerSomehow(
    pInvSlot: INVENTORY_IN_SLOT,
    pDropSoldier: SOLDIERTYPE,
  ): void {
    // if the item doesn't have a duplicate copy in its owner merc's inventory slot
    if (pInvSlot.bSlotIdInOtherLocation == -1) {
      ...
      if (!SKITryToReturnInvToOwnerOrCurrentMerc(pInvSlot)) {
        ...
        ShopkeeperAddItemToPool(
          pDropSoldier.sGridNo,
          pInvSlot.ItemObject,
          VISIBLE,
          pDropSoldier.bLevel,
          0,
  ...
  function GivePlayerSomeChange(uiAmount: UINT32): void {
    ...
    if (
      gbSelectedArmsDealerID == Enum197.ARMS_DEALER_JAKE &&
  ...
  function HandlePossibleRepairDelays(): void {
    ...
    if (
      gbSelectedArmsDealerID == Enum197.ARMS_DEALER_FREDO ||
      gbSelectedArmsDealerID == Enum197.ARMS_DEALER_PERKO
    ) {
        ...
        if (
          ...
          if (
            (uiHoursSinceAnyItemsShouldHaveBeenRepaired =
              RepairmanFixingAnyItemsThatShouldBeDoneNow()) !== -1 &&
            ...
            if (PreChance(50)) {
              DelayRepairsInProgressBy(
                (REPAIR_DELAY_IN_HOURS + Random(REPAIR_DELAY_IN_HOURS)) * 60,
              );
              ...
              gArmsDealerStatus[gbSelectedArmsDealerID].fRepairDelayBeenUsed =
                true;
            }
          }
        }
  ...
  function RepairmanFixingAnyItemsThatShouldBeDoneNow(): UINT32 {
    ...
    if (!DoesDealerDoRepairs(gbSelectedArmsDealerID)) return -1;
    ...
    for (usItemIndex = 1; usItemIndex < Enum225.MAXITEMS; usItemIndex++) {
      ...
      if (pDealerItem.ubTotalItems) {
        ...
        for (
          ubElement = 0;
          ubElement < pDealerItem.ubElementsAlloced;
          ubElement++
        ) {
            ...
            if (pSpecialItem.Info.bItemCondition < 0) {
              ...
              if (pSpecialItem.uiRepairDoneTime <= GetWorldTotalMin()) {
                ...
                uiMinutesSinceItWasDone =
                  GetWorldTotalMin() - pSpecialItem.uiRepairDoneTime;
                uiMinutesShopClosedSinceItWasDone =
                  CalculateMinutesClosedBetween(
                    gbSelectedArmsDealerID,
                    pSpecialItem.uiRepairDoneTime,
                    GetWorldTotalMin(),
                  );

                // calculate how many WORKING hours since this item's been repaired
                uiWorkingHoursSinceThisItemRepaired = Math.trunc(
                  (uiMinutesSinceItWasDone -
                    uiMinutesShopClosedSinceItWasDone) /
                    60,
                );
                ...
                if (
                  ...
                  uiHoursSinceOldestItemRepaired
                ) {
                  uiHoursSinceOldestItemRepaired =
                    uiWorkingHoursSinceThisItemRepaired;
                }
        ...
        for (
          ...
          if (pSpecialItem.fActive) {
            ...
            if (pSpecialItem.Info.bItemCondition < 0) {
              ...
              pSpecialItem.uiRepairDoneTime +=
                uiMinutesShopClosedBeforeItsDone + uiMinutesDelayed;
            }
          }
        }
      }
  ...
  // Mouse Call back for the Arms delaers face
  function SelectArmsDealersDropItemToGroundRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
  ...
  function SelectArmsDealersDropItemToGroundMovementRegionCallBack(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
  ...
  function CanTheDropItemToGroundStringBeDisplayed(): boolean {
    // if we don't have an item, pick one up
    if (gMoveingItem.sItemIndex != 0) return true;
    else return false;
  }
  ...
  function DisplayTheSkiDropItemToGroundString(): void {
    ...
    usHeight = DisplayWrappedString(
      SKI_DROP_ITEM_TO_GROUND_START_X,
      SKI_DROP_ITEM_TO_GROUND_TEXT_START_Y,
      640 - SKI_DROP_ITEM_TO_GROUND_START_X,
      2,
      SKI_LABEL_FONT(),
      SKI_TITLE_COLOR,
      SKI_Text[Enum367.SKI_TEXT_DROP_ITEM_TO_GROUND],
      FONT_MCOLOR_BLACK,
      false,
  ...
  function EvaluateInvSlot(pInvSlot: INVENTORY_IN_SLOT): UINT32 {
    ...
    uiBuyingPrice = CalcShopKeeperItemPrice(
      DEALER_BUYING,
      false,
      pInvSlot.sItemIndex,
      dPriceModifier,
  ...
  function BuildRepairTimeString(uiTimeInMinutesToFixItem: UINT32): string {
    ...
    if (uiTimeInMinutesToFixItem <= 90) {
      // show minutes
      sString = swprintf(
        SKI_Text[Enum367.SKI_TEXT_MINUTES],
        uiTimeInMinutesToFixItem,
      );
    } else {
      // show hours
      ...
      usNumberOfHoursToFixItem = Math.trunc(
        (uiTimeInMinutesToFixItem + 45) / 60,
      );

      if (usNumberOfHoursToFixItem > 1) {
        sString = swprintf(
          SKI_Text[Enum367.SKI_TEXT_PLURAL_HOURS],
  ...
  function BuildDoneWhenTimeString(
    ubArmsDealer: UINT8,
    usItemIndex: UINT16,
    ubElement: UINT8,
  ): string {
    ...
    if (uiDoneTime % REPAIR_MINUTES_INTERVAL > 0) {
      uiDoneTime +=
        REPAIR_MINUTES_INTERVAL - (uiDoneTime % REPAIR_MINUTES_INTERVAL);
    }

    // uiDoneTime is in minutes...
    uiDay = Math.trunc(uiDoneTime / NUM_MIN_IN_DAY);
    uiHour = Math.trunc(
      (uiDoneTime - uiDay * NUM_MIN_IN_DAY) / NUM_MIN_IN_HOUR,
    );
  ...
  function BuildItemHelpTextString(
    pInv: INVENTORY_IN_SLOT | null,
    ubScreenArea: UINT8,
  ): string {
    let sString: string;
    ...
    if (pInv != null) {
      ...
      if (
        ubScreenArea == Enum252.ARMS_DEALER_OFFER_AREA &&
        ArmsDealerInfo[gbSelectedArmsDealerID].ubTypeOfArmsDealer ==
          Enum198.ARMS_DEALER_REPAIRS
      ) {
        zRepairTime = BuildRepairTimeString(
          CalculateObjectItemRepairTime(
            gbSelectedArmsDealerID,
            pInv.ItemObject,
          ),
        );
