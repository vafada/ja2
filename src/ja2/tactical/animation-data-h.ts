namespace ja2 {
  ...
  // (M) = Sex, Male, female
  export const IS_MERC_BODY_TYPE = (p: SOLDIERTYPE) =>
    p.ubBodyType <= Enum194.REGFEMALE ? true : false;
  export const IS_CIV_BODY_TYPE = (p: SOLDIERTYPE) =>
    p.ubBodyType >= Enum194.FATCIV && p.ubBodyType <= Enum194.CRIPPLECIV;
  ...
  export function createAnimationSurfaceTypeFrom(
    ubName: UINT16,
    Filename: string,
    bStructDataType: CHAR8,
    ubFlags: UINT8,
  ...
  export function createAnimationStructureTypeFrom(
    Filename: string,
    pStructureFileRef: STRUCTURE_FILE_REF | null,
