namespace ja2 {
  let sBasementEnterGridNos: INT16[] /* [] */ = [
    13362, 13363, 13364, 13365, 13525, 13524,
  ];
  let sBasementExitGridNos: INT16[] /* [] */ = [
    8047, 8207, 8208, 8048, 7888, 7728, 7727, 7567,
  ];
  ...
  export function InitiateConversation(
    ...
    if (DialogueQueueIsEmptyOrSomebodyTalkingNow()) {
      ...
      // Initiate directly....
      return InternalInitiateConversation(
        pDestSoldier,
        pSrcSoldier,
        bApproach,
        uiApproachData,
  ...
  function InternalInitiateConversation(
    pDestSoldier: SOLDIERTYPE,
    pSrcSoldier: SOLDIERTYPE,
    bApproach: INT8,
    uiApproachData: any,
    ...
    Converse(
      gTalkPanel.ubCharNum,
      gubSrcSoldierProfile,
      bApproach,
      uiApproachData,
    );
  ...
  function InitTalkingMenu(ubCharacterNum: UINT8, sGridNo: INT16): boolean {
    ...
    // Get XY values
    {
      ...
      ({ sScreenX, sScreenY } = CellXYToScreenXY(
        sXMapPos * CELL_X_SIZE,
        sYMapPos * CELL_Y_SIZE,
      ));
  ...
  export function InternalInitTalkingMenu(
    ...
    CalculatePopupTextOrientation(
      TALK_PANEL_CALC_SUBTITLE_WIDTH,
      TALK_PANEL_CALC_SUBTITLE_HEIGHT,
    );
    ...
    iFaceIndex = InitFace(
      ubCharacterNum,
      NOBODY,
      FACE_BIGFACE | FACE_POTENTIAL_KEYWAIT,
    );
    ...
    MSYS_DefineRegion(
      ...
      gTalkPanel.sX,
      gTalkPanel.sY,
      gTalkPanel.sX + gTalkPanel.usWidth,
    ...
    // Define name region
    MSYS_DefineRegion(
      gTalkPanel.NameRegion,
      gTalkPanel.sX + TALK_PANEL_NAME_X,
      gTalkPanel.sY + TALK_PANEL_NAME_Y,
      gTalkPanel.sX + TALK_PANEL_NAME_WIDTH + TALK_PANEL_NAME_X,
      gTalkPanel.sY + TALK_PANEL_NAME_HEIGHT + TALK_PANEL_NAME_Y,
      MSYS_PRIORITY_HIGHEST,
      Enum317.CURSOR_NORMAL,
      TalkPanelNameRegionMoveCallback,
    ...
    for (cnt = 0; cnt < 6; cnt++) {
      ...
      MSYS_DefineRegion(
        gTalkPanel.Regions[cnt],
        sX,
        sY,
        sX + TALK_PANEL_REGION_WIDTH,
        sY + TALK_PANEL_REGION_HEIGHT,
        MSYS_PRIORITY_HIGHEST,
        Enum317.CURSOR_NORMAL,
        TalkPanelMoveCallback,
    ...
    gTalkPanel.uiCancelButton = CreateIconAndTextButton(
      gTalkPanel.iButtonImages,
      zDialogActions[Enum211.DIALOG_DONE],
      MILITARYFONT1(),
      33,
      DEFAULT_SHADOW,
      33,
  ...
  function DoneTalkingButtonClickCallback(
    btn: GUI_BUTTON,
    reason: INT32,
  ): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      gTalkPanel.fHandledTalkingVal =
        gFacesData[gTalkPanel.iFaceIndex].fTalking;
      ...
      if (DialogueQueueIsEmpty() && !gfWaitingForTriggerTimer) {
        ...
        if (ubNPC != NO_PROFILE) {
          ...
          if (pNPC) {
            ...
            if (fNice) {
              SayQuote58FromNearbyMercInSector(
                pNPC.sGridNo,
                10,
                Enum202.QUOTE_LISTEN_LIKABLE_PERSON,
  ...
  export function RenderTalkingMenu(): void {
    ...
    if (gTalkPanel.fDirtyLevel == DIRTYLEVEL2) {
      ...
      ({ sX: sFontX, sY: sFontY } = VarFindFontCenterCoordinates(
        gTalkPanel.sX + TALK_PANEL_NAME_X,
        gTalkPanel.sY + TALK_PANEL_NAME_Y,
        TALK_PANEL_NAME_WIDTH,
        TALK_PANEL_NAME_HEIGHT,
        MILITARYFONT1(),
        "%s",
      ...
      Blt16BPPTo16BPP(
        ...
        pSrcBuf,
        uiSrcPitchBYTES,
        gTalkPanel.sX + TALK_PANEL_FACE_X,
        gTalkPanel.sY + TALK_PANEL_FACE_Y,
        0,
        0,
        pFace.usFaceWidth,
        pFace.usFaceHeight,
      ...
      if (pFace.fTalking || !DialogueQueueIsEmpty()) {
        ShadowVideoSurfaceRect(
          FRAME_BUFFER,
          gTalkPanel.sX + TALK_PANEL_SHADOW_AREA_X,
          gTalkPanel.sY + TALK_PANEL_SHADOW_AREA_Y,
          gTalkPanel.sX +
            TALK_PANEL_SHADOW_AREA_X +
            TALK_PANEL_SHADOW_AREA_WIDTH,
          gTalkPanel.sY +
            TALK_PANEL_SHADOW_AREA_Y +
            TALK_PANEL_SHADOW_AREA_HEIGHT,
        );
      ...
      if (gTalkPanel.fSetupSubTitles) {
        ...
        iInterfaceDialogueBox = PrepareMercPopupBox(
          iInterfaceDialogueBox,
          Enum324.BASIC_MERC_POPUP_BACKGROUND,
          Enum325.BASIC_MERC_POPUP_BORDER,
          gTalkPanel.zQuoteStr,
          TALK_PANEL_DEFAULT_SUBTITLE_WIDTH,
          0,
          0,
          0,
          createPointer(
        ...
        MSYS_DefineRegion(
          gTalkPanel.TextRegion,
          gTalkPanel.sPopupX,
          gTalkPanel.sPopupY,
          gTalkPanel.sPopupX + usTextBoxWidth,
          gTalkPanel.sPopupY + usTextBoxHeight,
          MSYS_PRIORITY_HIGHEST,
          Enum317.CURSOR_NORMAL,
          MSYS_NO_CALLBACK,
            ...
            switch (cnt) {
              case 0:
                ({ sX: sFontX, sY: sFontY } = VarFindFontCenterCoordinates(
                  sX,
                  sY,
                  TALK_PANEL_MENUTEXT_WIDTH,
                  TALK_PANEL_MENUTEXT_HEIGHT,
                  MILITARYFONT1(),
                  "%s",
                  zTalkMenuStrings[cnt],
                ));
              ...
              case 4:
                ...
                if (IsMercADealer(ubCharacterNum)) {
                  ...
                  ubType = GetTypeOfArmsDealer(
                    GetArmsDealerIDFromMercID(ubCharacterNum),
                  );

                  zTempString = zDealerStrings[ubType];
                } else zTempString = zTalkMenuStrings[cnt];
      ...
      if (!gFacesData[gTalkPanel.iFaceIndex].fTalking) {
        if (ubTalkMenuApproachIDs[uiItemPos] == Enum296.APPROACH_BUYSELL) {
          ...
          */
            ...
            if (
              (<SOLDIERTYPE>gpDestSoldier).bAction !=
              Enum289.AI_ACTION_PENDING_ACTION
            ) {
          ...
          if (fDoConverse) {
            ...
            Converse(
              gTalkPanel.ubCharNum,
              gubSrcSoldierProfile,
              ubTalkMenuApproachIDs[uiItemPos],
              0,
            );
          }
        }
  ...
  /* static */ let TalkPanelBaseRegionClickCallback__fLButtonDown: boolean =
    false;
  function TalkPanelBaseRegionClickCallback(
    ...
    if (
      ...
      TalkPanelBaseRegionClickCallback__fLButtonDown
    ) {
  ...
  function TalkPanelNameRegionClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
  ...
  function TalkPanelNameRegionMoveCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    // Donot do this if we are talking already
  ...
  export function ProfileCurrentlyTalkingInDialoguePanel(
    ubProfile: UINT8,
  ): boolean {
    if (gfInTalkPanel) {
  ...
  export function HandleTalkingMenuEscape(
    fCanDelete: boolean,
    fFromEscKey: boolean,
  ): boolean {
    let pFace: FACETYPE;
      ...
      // Else if our queue is empty, delete emnu
        ...
        if (DialogueQueueIsEmpty() && fCanDelete) {
          ...
          ResetOncePerConvoRecordsForNPC(
            (<SOLDIERTYPE>gpDestSoldier).ubProfile,
          );
          return true;
        }
      }
  ...
  */
  ...
  function CalculatePopupTextPosition(sWidth: INT16, sHeight: INT16): void {
    switch (gTalkPanel.ubPopupOrientation) {
      case TALK_PANEL_POPUP_LEFT:
        ...
        gTalkPanel.sPopupY =
          gTalkPanel.sY +
          Math.trunc(gTalkPanel.usHeight / 2) -
          Math.trunc(sHeight / 2);
        break;
      ...
      case TALK_PANEL_POPUP_BOTTOM:
        ...
        gTalkPanel.sPopupX =
          gTalkPanel.sX +
          Math.trunc(gTalkPanel.usWidth / 2) -
          Math.trunc(sWidth / 2);
        // Calc height
  ...
  export function TalkingMenuGiveItem(
    ubNPC: UINT8,
    pObject: OBJECTTYPE,
    bInvPos: INT8,
  ): boolean {
    if (
      SpecialCharacterDialogueEvent(
        DIALOGUE_SPECIAL_EVENT_GIVE_ITEM,
        ubNPC,
        pObject,
        bInvPos,
        gTalkPanel.iFaceIndex,
  ...
  export function NPCTriggerNPC(
    ubTargetNPC: UINT8,
    ubTargetRecord: UINT8,
    ubTargetApproach: UINT8,
    fShowDialogueMenu: boolean,
  ): boolean {
    ...
    if (
      SpecialCharacterDialogueEventWithExtraParam(
        DIALOGUE_SPECIAL_EVENT_TRIGGER_NPC,
        ubTargetNPC,
        ubTargetRecord,
        fShowDialogueMenu,
        ubTargetApproach,
  ...
  export function NPCGotoGridNo(
    ...
    if (
      SpecialCharacterDialogueEvent(
        DIALOGUE_SPECIAL_EVENT_GOTO_GRIDNO,
        ubTargetNPC,
        usGridNo,
        ubRecordNum,
        gTalkPanel.iFaceIndex,
  ...
  export function NPCDoAction(
    ...
    if (
      SpecialCharacterDialogueEvent(
        DIALOGUE_SPECIAL_EVENT_DO_ACTION,
        ubTargetNPC,
        usActionCode,
        ubQuoteNum,
        gTalkPanel.iFaceIndex,
  ...
  export function NPCClosePanel(): boolean {
    if (
      SpecialCharacterDialogueEvent(
        DIALOGUE_SPECIAL_EVENT_CLOSE_PANEL,
        0,
        0,
        0,
        0,
  ...
  function SourceSoldierPointerIsValidAndReachableForGive(
    pGiver: SOLDIERTYPE | null,
  ): boolean {
    ...
    if (
      PythSpacesAway(pGiver.sGridNo, gpSrcSoldier.sGridNo) >
      MaxDistanceVisible()
    ) {
      return false;
    }
  ...
  export function HandleNPCItemGiven(
    ubNPC: UINT8,
    pObject: OBJECTTYPE,
    bInvPos: INT8,
  ): void {
    ...
    if (!SourceSoldierPointerIsValidAndReachableForGive(gpDestSoldier)) {
      ...
      // Give this to buddy!
      SoldierGiveItem(
        <SOLDIERTYPE>gpDestSoldier,
        <SOLDIERTYPE>gpSrcSoldier,
        pObject,
        bInvPos,
      );
    }
  ...
  export function HandleNPCTriggerNPC(
    ubTargetNPC: UINT8,
    ubTargetRecord: UINT8,
    fShowDialogueMenu: boolean,
    ubTargetApproach: UINT8,
  ...
  function HandleNPCTrigger(): void {
    ...
    if (gfInTalkPanel) {
      if (pSoldier == gpDestSoldier) {
        ...
        } else if (gpSrcSoldier != null) {
          // if we can, reinitialize menu
  ...
  export function HandleNPCGotoGridNo(
    ubTargetNPC: UINT8,
    usGridNo: UINT16,
    ubQuoteNum: UINT8,
  ): void {
    ...
    pSoldier.ubQuoteActionID = ActionIDForMovementRecord(
      ubTargetNPC,
      ubQuoteNum,
    );
      ...
      case Enum268.JOHN:
        ...
        if (pSoldier) {
          ScreenMsg(
            ...
            MSG_INTERFACE,
            TacticalStr[Enum335.NOW_BING_ESCORTED_STR],
            gMercProfiles[Enum268.MARY].zNickname,
      ...
      case Enum268.MARY:
        ...
        if (pSoldier) {
          ScreenMsg(
            ...
            MSG_INTERFACE,
            TacticalStr[Enum335.NOW_BING_ESCORTED_STR],
            gMercProfiles[Enum268.JOHN].zNickname,
            pSoldier.bAssignment + 1,
          );
        }
  ...
  */
  ...
  export function HandleNPCDoAction(
    ubTargetNPC: UINT8,
    usActionCode: UINT16,
    ubQuoteNum: UINT8,
  ): void {
    ...
    if (
      usActionCode > Enum213.NPC_ACTION_TURN_TO_FACE_NEAREST_MERC &&
      usActionCode < Enum213.NPC_ACTION_LAST_TURN_TO_FACE_PROFILE
    ) {
      pSoldier = FindSoldierByProfileID(ubTargetNPC, false);
      ...
      switch (usActionCode) {
            ...
            if (
              ...
              if (bNumDone < 6) {
                ...
                pSoldier.usStrategicInsertionData =
                  sBasementEnterGridNos[bNumDone];
              }
              bNumDone++;
            }
          }
        ...
        */
        ...
        case Enum213.NPC_ACTION_FATIMA_GIVE_LETTER:
          ...
          // Look for letter....
          {
            ...
            AssertMsg(
              bInvPos != NO_SLOT,
              "Interface Dialogue.C:  Gift item does not exist in NPC.",
            );

            SoldierGiveItem(
              pSoldier,
              pSoldier2,
              pSoldier.inv[bInvPos],
              bInvPos,
            );
          }
          break;
        ...
        case Enum213.NPC_ACTION_LOWER_GUN:
          ...
          if (pSoldier.inv[Enum261.HANDPOS].usItem != NOTHING) {
            ...
            if (
              bNewSlot != NO_SLOT &&
              gMercProfiles[ubTargetNPC].inv[bNewSlot] == NOTHING
            ) {
        ...
        case Enum213.NPC_ACTION_FACE_NORTH_WEST:
          ...
          if (pSoldier) {
            ...
            SendSoldierSetDesiredDirectionEvent(
              pSoldier,
              Enum245.NORTH +
                (usActionCode - Enum213.NPC_ACTION_FACE_NORTH_EAST),
            );
          }
          break;
        ...
        case Enum213.NPC_ACTION_RECRUIT:
          // gonna work for free!
          gMercProfiles[ubTargetNPC].sTrueSalary =
            gMercProfiles[ubTargetNPC].sSalary;
        ...
        case Enum213.NPC_ACTION_RECRUIT_WITH_SALARY:
          ...
          if (PlayerTeamFull()) {
            ScreenMsg(
              FONT_MCOLOR_LTYELLOW,
              MSG_UI_FEEDBACK,
              TacticalStr[Enum335.CANNOT_RECRUIT_TEAM_FULL],
            );
          } else {
            ...
            ScreenMsg(
              FONT_MCOLOR_LTYELLOW,
              MSG_INTERFACE,
              TacticalStr[Enum335.HAS_BEEN_RECRUITED_STR],
        ...
        case Enum213.NPC_ACTION_SEND_PACOS_INTO_HIDING:
          ...
          if (pSoldier) {
            if (NewOKDestination(pSoldier, sGridNo, true, 0)) {
              ...
              sAdjustedGridNo = FindAdjacentGridEx(
                pSoldier,
                sGridNo,
                null,
                null,
        ...
        case Enum213.NPC_ACTION_SET_DELAYED_PACKAGE_TIMER:
          AddFutureDayStrategicEvent(
            ...
            Enum170.FACT_SHIPMENT_DELAYED_24_HOURS,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_SET_RANDOM_PACKAGE_DAMAGE_TIMER:
          AddFutureDayStrategicEvent(
            ...
            GetWorldMinutesInDay(),
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_SET_RANDOM_PACKAGE_DAMAGE_TIMER,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_ENABLE_CAMBRIA_DOCTOR_BONUS:
          ...
          AddFutureDayStrategicEvent(
            Enum132.EVENT_SET_BY_NPC_SYSTEM,
            GetWorldMinutesInDay() + (24 + iRandom) * 60,
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_ENABLE_CAMBRIA_DOCTOR_BONUS,
            1,
          );
          break;
        case Enum213.NPC_ACTION_TRIGGER_END_OF_FOOD_QUEST:
          AddHistoryToPlayersLog(
            Enum83.HISTORY_TALKED_TO_FATHER_WALKER,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
          ...
          AddFutureDayStrategicEvent(
            ...
            GetWorldMinutesInDay(),
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_TRIGGER_END_OF_FOOD_QUEST,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_REPORT_BALANCE:
          ScreenMsg(
            ...
            gMercProfiles[ubTargetNPC].zNickname,
            -gMercProfiles[ubTargetNPC].iBalance,
          );
          break;
        ...
        case Enum213.NPC_ACTION_DELAYED_MAKE_BRENDA_LEAVE:
          ...
          AddSameDayStrategicEvent(
            Enum132.EVENT_SET_BY_NPC_SYSTEM,
            GetWorldMinutesInDay() + 360,
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_DELAYED_MAKE_BRENDA_LEAVE,
          );
          break;
        ...
        */
        ...
        case Enum213.NPC_ACTION_HAVE_MARRIED_NPC_LEAVE_TEAM:
          ...
          pSoldier = FindSoldierByProfileID(
            gMercProfiles[Enum268.DARYL].bNPCData,
            false,
          );
          ...
          AddHistoryToPlayersLog(
            Enum83.HISTORY_MERC_MARRIED_OFF,
            pSoldier.ubProfile,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_TRIGGER_MARIA:
          if (
            CheckFact(Enum170.FACT_MARIA_ESCAPE_NOTICED, Enum268.MARIA) == false
          ) {
        ...
        case Enum213.NPC_ACTION_SET_DELAY_TILL_GIRLS_AVAILABLE:
          AddSameDayStrategicEvent(
            Enum132.EVENT_SET_BY_NPC_SYSTEM,
            GetWorldMinutesInDay() + 1 + Random(2),
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_SET_DELAY_TILL_GIRLS_AVAILABLE,
          );
          break;
        ...
        case Enum213.NPC_ACTION_FREE_KIDS:
          AddFutureDayStrategicEvent(
            Enum132.EVENT_SET_BY_NPC_SYSTEM,
            420,
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS + Enum213.NPC_ACTION_FREE_KIDS,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_CHECK_LAST_TERRORIST_HEAD:
          ...
          AddHistoryToPlayersLog(
            Enum83.HISTORY_GAVE_CARMEN_HEAD,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_CARMEN_LEAVES_FOR_GOOD:
          gMercProfiles[ubTargetNPC].ubMiscFlags2 |=
        ...
        case Enum213.NPC_ACTION_BECOME_FRIENDLY_END_COMBAT:
          ...
          if (pSoldier) {
            ...
            if (
              ubTargetNPC == Enum268.SLAY &&
              pSoldier.ubBodyType == Enum194.CRIPPLECIV
            ) {
              HandleNPCDoAction(
                Enum268.SLAY,
                Enum213.NPC_ACTION_GET_OUT_OF_WHEELCHAIR,
                ubQuoteNum,
              );
        ...
        case Enum213.NPC_ACTION_TERRORIST_REVEALS_SELF:
          ...
          // copy new nickname into soldier structure
          {
            ...
            gMercProfiles[ubTargetNPC].zNickname = gMercProfiles[
              ubTargetNPC
            ].zName.substring(0, NICKNAME_LENGTH);
            // wcsncpy( gMercProfiles[ ubTargetNPC ].zName, zTemp, NICKNAME_LENGTH );
            pSoldier = FindSoldierByProfileID(ubTargetNPC, false);
            if (pSoldier) {
              pSoldier.name = gMercProfiles[ubTargetNPC].zNickname.substring(
                0,
                10,
              );
            }
        ...
        case Enum213.NPC_ACTION_READY_ROBOT:
          AddFutureDayStrategicEvent(
            ...
            420,
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_READY_ROBOT,
            1,
          );
          break;
        ...
        */
          ...
          if (pSoldier) {
            ...
            if (pSoldier2) {
              ...
              if (bMoneySlot != NO_SLOT && bEmptySlot != NO_SLOT) {
                CreateMoney(
                  gMercProfiles[ubTargetNPC].iBalance * 2,
                  pSoldier.inv[bEmptySlot],
                );
                pSoldier.inv[bMoneySlot].uiMoneyAmount -=
                  gMercProfiles[ubTargetNPC].iBalance * 2;
        ...
        case Enum213.NPC_ACTION_SHOW_TIXA:
          SetTixaAsFound();
          AddHistoryToPlayersLog(
            Enum83.HISTORY_DISCOVERED_TIXA,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_SHOW_ORTA:
          SetOrtaAsFound();
          AddHistoryToPlayersLog(
            Enum83.HISTORY_DISCOVERED_ORTA,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_PUNCH_PC_SLOT_2:
          ...
          if (pSoldier) {
            ...
            } // if ( usActionCode == NPC_ACTION_PUNCH_PC_SLOT_2 )
            else {
              // pTarget = MercPtrs[ 2 ];
        ...
        case Enum213.NPC_ACTION_START_TIMER_ON_KEITH_GOING_OUT_OF_BUSINESS:
          ...
          AddStrategicEvent(
            Enum132.EVENT_KEITH_GOING_OUT_OF_BUSINESS,
            GetWorldTotalMin() + 6 * 24 * 60,
            0,
          );
          break;
        ...
        case Enum213.NPC_ACTION_TRIGGER_QUEEN_BY_CITIES_CONTROLLED:
          switch (
            GetNumberOfWholeTownsUnderControlButExcludeCity(Enum135.OMERTA)
          ) {
            case 0:
            case 1:
        ...
        case Enum213.NPC_ACTION_TRIGGER_ELLIOT_BY_SAM_DISABLED:
          if (
            IsThereAFunctionalSAMSiteInSector(
              gTacticalStatus.ubLastBattleSectorX,
              gTacticalStatus.ubLastBattleSectorY,
              0,
            )
          ) {
        ...
        case Enum213.NPC_ACTION_TRIGGER_VINCE_BY_LOYALTY:
          if (
            CheckFact(Enum170.FACT_NPC_OWED_MONEY, ubTargetNPC) &&
            ubTargetNPC == Enum268.VINCE
          ) {
            // check if we owe vince cash
            TriggerNPCRecord(ubTargetNPC, 21);
          } else if (
            CheckFact(
              Enum170.FACT_VINCE_EXPLAINED_HAS_TO_CHARGE,
              ubTargetNPC,
            ) == false
          ) {
            ...
            if (CheckFact(Enum170.FACT_LOYALTY_LOW, ubTargetNPC)) {
              ...
              if (ubTargetNPC == Enum268.VINCE) {
                if (
                  ...
                  (CheckFact(Enum170.FACT_HOSPITAL_FREEBIE_DECISION_MADE, 0) ==
                    false &&
                    iRandom < CHANCE_FOR_DOCTOR_TO_SAY_RANDOM_QUOTE)
                ) {
                  SetFactTrue(Enum170.FACT_HOSPITAL_FREEBIE_DECISION_MADE);
                  if (
                    CheckFact(Enum170.FACT_LOYALTY_HIGH, ubTargetNPC) &&
                    CheckFact(
                      Enum170.FACT_24_HOURS_SINCE_DOCTOR_TALKED_TO,
                      ubTargetNPC,
                    )
                  ) {
                ...
                // in discount mode?
                if (
                  CheckFact(Enum170.FACT_WILLIS_GIVES_DISCOUNT, ubTargetNPC)
                ) {
                  // yep inform player
                  gbHospitalPriceModifier = Enum212.HOSPITAL_COST;
                  TriggerNPCRecord(ubTargetNPC, 21);
                  ...
                  CheckFact(
                    Enum170.FACT_WILLIS_HEARD_ABOUT_JOEY_RESCUE,
                    ubTargetNPC,
                  )
                ) {
                  ...
                  (gbHospitalPriceModifier == Enum212.HOSPITAL_FREEBIE ||
                    (CheckFact(
                      Enum170.FACT_HOSPITAL_FREEBIE_DECISION_MADE,
                      0,
                    ) == false &&
                      iRandom < CHANCE_FOR_DOCTOR_TO_SAY_RANDOM_QUOTE))
                ) {
          ...
          if (pSoldier2) {
            ...
            for (
              ...
              if (
                ...
                PythSpacesAway(pSoldier.sGridNo, pSoldier2.sGridNo) <
                  HOSPITAL_PATIENT_DISTANCE
              ) {
                SetSoldierAssignment(
                  pSoldier,
                  Enum117.ASSIGNMENT_HOSPITAL,
                  0,
                  0,
                  0,
                );
        ...
        case Enum213.NPC_ACTION_START_DOCTORING:
          {
            ...
            // check fact
            if (
              CheckFact(Enum170.FACT_PLAYER_STOLE_MEDICAL_SUPPLIES, ubTargetNPC)
            ) {
        ...
        */
          if (gMercProfiles[Enum268.SERGEANT].bMercStatus != MERC_IS_DEAD) {
            ...
            IncrementTownLoyalty(
              Enum135.ALMA,
              LOYALTY_BONUS_FOR_SERGEANT_KROTT,
            );
          }
          break;
        ...
        case Enum213.NPC_ACTION_SEND_ENRICO_MIGUEL_EMAIL:
          AddFutureDayStrategicEvent(
            ...
            390 + Random(60),
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_SEND_ENRICO_MIGUEL_EMAIL,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_KINGPIN_TRIGGER_25_OR_14:
          if (
            CheckFact(Enum170.FACT_KINGPIN_INTRODUCED_SELF, ubTargetNPC) == true
          ) {
        ...
        case Enum213.NPC_ACTION_TRIGGER_ANGEL_22_OR_24:
          if (CheckFact(120, ubTargetNPC)) {
            // NB fact 120 is Angel left deed on counter
        ...
        case Enum213.NPC_ACTION_CHANGE_MANNY_POSITION:
          gMercProfiles[Enum268.MANNY].ubMiscFlags3 |=
            PROFILE_MISC_FLAG3_PERMANENT_INSERTION_CODE;
          gMercProfiles[Enum268.MANNY].ubStrategicInsertionCode =
            Enum175.INSERTION_CODE_GRIDNO;
        ...
        case Enum213.NPC_ACTION_MAKE_BRENDA_STATIONARY:
          ...
          if (pSoldier) {
            gMercProfiles[Enum268.BRENDA].ubMiscFlags3 |=
              PROFILE_MISC_FLAG3_PERMANENT_INSERTION_CODE;
            gMercProfiles[Enum268.BRENDA].ubStrategicInsertionCode =
              Enum175.INSERTION_CODE_GRIDNO;
            gMercProfiles[Enum268.BRENDA].usStrategicInsertionData =
              pSoldier.sGridNo;
        ...
        case Enum213.NPC_ACTION_MAKE_MIGUEL_STATIONARY:
          ...
          if (pSoldier) {
            gMercProfiles[Enum268.MIGUEL].ubMiscFlags3 |=
              PROFILE_MISC_FLAG3_PERMANENT_INSERTION_CODE;
            gMercProfiles[Enum268.MIGUEL].ubStrategicInsertionCode =
              Enum175.INSERTION_CODE_GRIDNO;
            gMercProfiles[Enum268.MIGUEL].usStrategicInsertionData =
              pSoldier.sGridNo;
        ...
        case Enum213.NPC_ACTION_24_HOURS_SINCE_JOEY_RESCUED:
          AddFutureDayStrategicEvent(
            Enum132.EVENT_SET_BY_NPC_SYSTEM,
            GetWorldMinutesInDay(),
            Enum170.FACT_24_HOURS_SINCE_JOEY_RESCUED,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_TIMER_FOR_VEHICLE:
          AddFutureDayStrategicEvent(
            ...
            GetWorldMinutesInDay(),
            NPC_SYSTEM_EVENT_ACTION_PARAM_BONUS +
              Enum213.NPC_ACTION_TIMER_FOR_VEHICLE,
            1,
          );
          break;
        ...
        case Enum213.NPC_ACTION_HISTORY_GOT_ROCKET_RIFLES:
          AddHistoryToPlayersLog(
            Enum83.HISTORY_GOT_ROCKET_RIFLES,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_HISTORY_DEIDRANNA_DEAD_BODIES:
          AddHistoryToPlayersLog(
            Enum83.HISTORY_DEIDRANNA_DEAD_BODIES,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_HISTORY_SOMETHING_IN_MINES:
          AddHistoryToPlayersLog(
            Enum83.HISTORY_SOMETHING_IN_MINES,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_HISTORY_KEITH_OUT_OF_BUSINESS:
          AddHistoryToPlayersLog(
            Enum83.HISTORY_KEITH_OUT_OF_BUSINESS,
            0,
            GetWorldTotalMin(),
            gWorldSectorX,
            gWorldSectorY,
        ...
        case Enum213.NPC_ACTION_TRIGGER_HANS_BY_ROOM:
          {
            if (gpSrcSoldier) {
              ...
              if (
                (ubRoom = InARoom(gpSrcSoldier.sGridNo)) !== -1 &&
                ubRoom == 49
              ) {
        ...
        case Enum213.NPC_ACTION_TRIGGER_BREWSTER_BY_WARDEN_PROXIMITY:
          ...
          if (pSoldier) {
            ...
            if (
              sGridNo != NOWHERE &&
              PythSpacesAway(pSoldier.sGridNo, sGridNo) <= 10
            ) {
        ...
        default:
          ScreenMsg(
            FONT_MCOLOR_RED,
            MSG_TESTVERSION,
            "No code support for NPC action %d",
            usActionCode,
          );
          break;
      }
  ...
  export function CalcPatientMedicalCost(pSoldier: SOLDIERTYPE | null): UINT32 {
    ...
    if (
      pSoldier.bHospitalPriceModifier == Enum212.HOSPITAL_FREEBIE ||
      pSoldier.bHospitalPriceModifier == Enum212.HOSPITAL_RANDOM_FREEBIE
    ) {
      return 0;
    }
    ...
    for (
      ...
      if (
        ...
        if (pSoldier.bLife < pSoldier.bLifeMax) {
          if (
            PythSpacesAway(sGridNo, pSoldier.sGridNo) <=
            HOSPITAL_PATIENT_DISTANCE
          ) {
  ...
  function PlayerTeamHasTwoSpotsLeft(): boolean {
    ...
    for (
      cnt = gTacticalStatus.Team[gbPlayerNum].bFirstID,
        pSoldier = MercPtrs[cnt];
      cnt <= gTacticalStatus.Team[gbPlayerNum].bLastID - 2;
      cnt++, pSoldier = MercPtrs[cnt]
    ) {
      if (pSoldier.bActive) {
        uiCount++;
  ...
  function StartDialogueMessageBox(
    ubProfileID: UINT8,
    usMessageBoxType: UINT16,
  ): void {
    let iTemp: INT32;
    ...
    switch (gusDialogueMessageBoxType) {
      case Enum213.NPC_ACTION_ASK_ABOUT_ESCORTING_EPC:
        if (
          (ubProfileID == Enum268.JOHN &&
            gMercProfiles[Enum268.MARY].bMercStatus != MERC_IS_DEAD) ||
          (ubProfileID == Enum268.MARY &&
            gMercProfiles[Enum268.JOHN].bMercStatus != MERC_IS_DEAD)
        ) {
          zTemp = gzLateLocalizedString[59];
        } else {
          zTemp = swprintf(
            TacticalStr[Enum335.ESCORT_PROMPT],
      ...
      case Enum213.NPC_ACTION_REDUCE_CONRAD_SALARY_CONDITIONS:
        ...
        zTemp = swprintf(
          TacticalStr[Enum335.HIRE_PROMPT],
          gMercProfiles[ubProfileID].zNickname,
          zTemp2,
        );
        DoMessageBox(
      ...
      case Enum213.NPC_ACTION_BUY_LEATHER_KEVLAR_VEST:
        ...
        zTemp2 = InsertDollarSignInToString(zTemp2);
        zTemp = swprintf(
          TacticalStr[Enum335.BUY_VEST_PROMPT],
          ItemNames[Enum225.LEATHER_JACKET_W_KEVLAR],
          zTemp2,
        );
        DoMessageBox(
          Enum24.MSG_BOX_BASIC_STYLE,
    ...
    switch (gusDialogueMessageBoxType) {
        ...
        if (ubExitValue == MSG_BOX_RETURN_YES) {
          ...
          if (PlayerTeamFull()) {
            ...
            ScreenMsg(
              ...
              MSG_INTERFACE,
              TacticalStr[Enum335.NOW_BING_ESCORTED_STR],
              gMercProfiles[ubProfile].zNickname,
              pSoldier.bAssignment + 1,
            );
      ...
      case Enum213.NPC_ACTION_MEDICAL_REQUESTOR_2:
        if (ubProfile == Enum268.VINCE) {
          if (
            gusDialogueMessageBoxType == Enum213.NPC_ACTION_MEDICAL_REQUESTOR
          ) {
            if (ubExitValue == MSG_BOX_RETURN_YES) {
            ...
            if (ubExitValue == MSG_BOX_RETURN_YES) {
              ...
              if (CheckFact(Enum170.FACT_WOUNDED_MERCS_NEARBY, Enum268.VINCE)) {
                ...
                CheckFact(Enum170.FACT_ONE_WOUNDED_MERC_NEARBY, Enum268.VINCE)
              ) {
          ...
          if (
            ...
            if (ubExitValue == MSG_BOX_RETURN_YES) {
              ...
              if (CheckFact(Enum170.FACT_WOUNDED_MERCS_NEARBY, Enum268.STEVE)) {
                ...
                CheckFact(Enum170.FACT_ONE_WOUNDED_MERC_NEARBY, Enum268.STEVE)
              ) {
      ...
      case Enum213.NPC_ACTION_TRIGGER_MARRY_DARYL_PROMPT:
        Assert(gpSrcSoldier);
        gMercProfiles[gpSrcSoldier.ubProfile].ubMiscFlags2 |=
  ...
  function TextRegionClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
    ...
    if (
      iReason & MSYS_CALLBACK_REASON_LBUTTON_UP &&
      TextRegionClickCallback__fLButtonDown
    ) {
      InternalShutupaYoFace(gTalkPanel.iFaceIndex, false);
    } else if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
