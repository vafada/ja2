...
*/
  ...
  export function readTacticalTeamType(
    o: TacticalTeamType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset += 2; // padding
    o.RadarColor = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export function writeTacticalTeamType(
    o: TacticalTeamType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function readTacticalStatusType(
    o: TacticalStatusType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset++; // padding
    o.sSlideTarget = buffer.readInt16LE(offset);
    offset += 2;
    o.sSlideReason = buffer.readInt16LE(offset);
    offset += 2;
    offset += 2; // padding
    o.uiTimeSinceMercAIStart = buffer.readUInt32LE(offset);
    offset += 4;
    o.fPanicFlags = buffer.readInt8(offset++);
    offset++; // padding
    o.sPanicTriggerGridnoUnused = buffer.readInt16LE(offset);
    offset += 2;
    o.sHandGrid = buffer.readInt16LE(offset);
    offset += 2;
    o.ubSpottersCalledForBy = buffer.readUInt8(offset++);
    o.ubTheChosenOne = buffer.readUInt8(offset++);
    o.uiTimeOfLastInput = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiTimeSinceDemoOn = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiCountdownToRestart = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.usTactialTurnLimitCounter = buffer.readUInt16LE(offset);
    offset += 2;
    o.fInTopMessage = Boolean(buffer.readUInt8(offset++));
    o.ubTopMessageType = buffer.readUInt8(offset++);
    o.zTopMessageString = readStringNL(buffer, "utf16le", offset, offset + 40);
    offset += 40;
    o.usTactialTurnLimitMax = buffer.readUInt16LE(offset);
    offset += 2;
    o.uiTactialTurnLimitClock = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.ubEnemyKilledOnAttackLocation = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.usItemsSeenOnAttackGridNo = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.sCantGetThroughGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sCantGetThroughSoldierGridNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.uiTimeCounterForGiveItemSrc = buffer.readUInt32LE(offset);
    offset += 4;
    o.fUnLockUIAfterHiddenInterrupt = Boolean(buffer.readUInt8(offset++));
    offset = readIntArray(o.bNumFoughtInBattle, buffer, offset, 1);
    offset++; // padding
    o.uiDecayBloodLastUpdate = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiTimeSinceLastInTactical = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.uiTimeSinceLastOpplistDecay = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.sCreatureTenseQuoteDelay = buffer.readUInt16LE(offset);
    offset += 2;
    offset += 2; // padding
    o.uiCreatureTenseQuoteLastUpdate = buffer.readUInt32LE(offset);
    offset += 4;
    return offset;
  }

  export function writeTacticalStatusType(
    o: TacticalStatusType,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset = buffer.writeUInt8(
      Number(o.fCountingDownForGuideDescription),
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      Number(o.fHasEnteredCombatModeSinceEntering),
      offset,
    );
