namespace ja2 {
  ...
  let iSMPanelImages: INT32[] /* [NUM_SM_BUTTON_IMAGES] */ = createArray(
    Enum218.NUM_SM_BUTTON_IMAGES,
    0,
  );
  let iBurstButtonImages: INT32[] /* [NUM_WEAPON_MODES] */ = createArray(
    Enum265.NUM_WEAPON_MODES,
    0,
  );
  let iTEAMPanelImages: INT32[] /* [NUM_TEAM_BUTTON_IMAGES] */ = createArray(
    Enum219.NUM_TEAM_BUTTON_IMAGES,
    0,
  );
  ...
  let gSMCamoXY: INV_REGION_DESC = createInvRegionDescFrom(
    SM_BODYINV_X,
    SM_BODYINV_Y,
  );
  ...
  let sTEAMFacesXY: INT16[] /* [] */ = [
    13, 366, 97, 366, 180, 366, 263, 366, 346, 366, 429, 366,
  ];

  let sTEAMNamesXY: INT16[] /* [] */ = [
    7, 415, 90, 415, 173, 415, 256, 415, 339, 415, 422, 415,
  ];
  ...
  let sTEAMApXY: INT16[] /* [] */ = [
    70, 413, 153, 413, 235, 413, 319, 413, 402, 413, 485, 413,
  ];

  let sTEAMBarsXY: INT16[] /* [] */ = [
    61, 363, 145, 363, 228, 363, 311, 363, 394, 363, 477, 362,
  ];

  let sTEAMHandInvXY: INT16[] /* [] */ = [
    TM_INV_HAND1STARTX + 0 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
    TM_INV_HAND1STARTX + 1 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
    TM_INV_HAND1STARTX + 2 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
    TM_INV_HAND1STARTX + 3 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
    TM_INV_HAND1STARTX + 4 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
    TM_INV_HAND1STARTX + 5 * TM_INV_HAND_SEP,
    TM_INV_HAND1STARTY,
  ];

  export let iSMPanelButtons: INT32[] /* [NUM_SM_BUTTONS] */ = createArray(
    Enum220.NUM_SM_BUTTONS,
    0,
  );
  export let iTEAMPanelButtons: INT32[] /* [NUM_TEAM_BUTTONS] */ = createArray(
    Enum221.NUM_TEAM_BUTTONS,
    0,
  );
  ...
  let gTEAM_FaceRegions: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );
  let gTEAM_BarsRegions: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );
  let gTEAM_LeftBarsRegions: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );
  let gTEAM_FirstHandInv: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );
  let gTEAM_SecondHandInv: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );
  let gTEAM_EnemyIndicator: MOUSE_REGION[] /* [6] */ = createArrayFrom(
    6,
    createMouseRegion,
  );

  let gfTEAM_HandInvDispText: UINT8[][] /* boolean[6][NUM_INV_SLOTS] */ =
    createArrayFrom(6, () => createArray(Enum261.NUM_INV_SLOTS, 0));
  let gfSM_HandInvDispText: boolean[] /* [NUM_INV_SLOTS] */ = createArray(
  ...
  export let gpSMCurrentMerc: SOLDIERTYPE /* Pointer<SOLDIERTYPE> */ = <
    SOLDIERTYPE
  >(<unknown>null);
  ...
  export function CheckForDisabledForGiveItem(): void {
    ...
    if (guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE) {
      gfSMDisableForItems =
        !CanMercInteractWithSelectedShopkeeper(gpSMCurrentMerc);
      return;
    }
      ...
      for (
        ...
        if (
          ...
          sDistVisible = DistanceVisible(
            ...
            Enum245.DIRECTION_IRRELEVANT,
            gpSMCurrentMerc.sGridNo,
            gpSMCurrentMerc.bLevel,
          );
  ...
  export function UpdateForContOverPortrait(
  ...
  function UpdateSMPanel(): void {
    ...
    if (gfUIStanceDifferent) {
      ...
      giSMStealthImages = UseLoadedButtonImage(
        iSMPanelImages[Enum218.STANCE_IMAGES],
        gbStanceButPos[Number(gpSMCurrentMerc.bStealthMode)][
          gbSMCurStanceObj
        ][0],
        gbStanceButPos[Number(gpSMCurrentMerc.bStealthMode)][
          gbSMCurStanceObj
      ...
      giSMStealthButton = QuickCreateButton(
        ...
        BtnStealthModeCallback,
      );

      SetButtonFastHelpText(
        giSMStealthButton,
        TacticalStr[Enum335.TOGGLE_STEALTH_MODE_POPUPTEXT],
      );
    ...
    if (
      ButtonList[iSMPanelButtons[Enum220.BURSTMODE_BUTTON]].ImageNum !=
      iBurstButtonImages[gpSMCurrentMerc.bWeaponMode]
    ) {
      ButtonList[iSMPanelButtons[Enum220.BURSTMODE_BUTTON]].ImageNum =
        iBurstButtonImages[gpSMCurrentMerc.bWeaponMode];
      ButtonList[iSMPanelButtons[Enum220.BURSTMODE_BUTTON]].uiFlags |=
        BUTTON_DIRTY;
    }
  ...
  */
    ...
    if (gpSMCurrentMerc.uiStatusFlags & SOLDIER_MUTE) {
      if (
        !ButtonList[iSMPanelButtons[Enum220.MUTE_BUTTON]]
          .ubToggleButtonActivated
      ) {
        ButtonList[iSMPanelButtons[Enum220.MUTE_BUTTON]].uiFlags |=
          BUTTON_CLICKED_ON;
      }
    } else {
      if (
    ...
    ({ fNearLowerLevel, fNearHeigherLevel } = GetMercClimbDirection(
    ...
    if (fNearLowerLevel || fNearHeigherLevel) {
      if (fNearLowerLevel) {
        if (
          EnoughPoints(
            gpSMCurrentMerc,
            GetAPsToClimbRoof(gpSMCurrentMerc, true),
            0,
            false,
          )
        ) {
      ...
      if (fNearHeigherLevel) {
        if (
          EnoughPoints(
            gpSMCurrentMerc,
            GetAPsToClimbRoof(gpSMCurrentMerc, false),
            0,
            false,
          )
        ) {
    ...
    if (gsInterfaceLevel > 0) {
      if (
        !ButtonList[iSMPanelButtons[Enum220.UPDOWN_BUTTON]]
          .ubToggleButtonActivated
      ) {
    ...
    if (gCurrentUIMode == Enum206.HANDCURSOR_MODE) {
      if (
        !ButtonList[iSMPanelButtons[Enum220.HANDCURSOR_BUTTON]]
          .ubToggleButtonActivated
      ) {
        ButtonList[iSMPanelButtons[Enum220.HANDCURSOR_BUTTON]].uiFlags |=
          BUTTON_CLICKED_ON;
      }
    } else {
      if (
    ...
    if (gCurrentUIMode == Enum206.TALKCURSOR_MODE) {
      if (
        !ButtonList[iSMPanelButtons[Enum220.TALK_BUTTON]]
          .ubToggleButtonActivated
      ) {
        ButtonList[iSMPanelButtons[Enum220.TALK_BUTTON]].uiFlags |=
          BUTTON_CLICKED_ON;
      }
    } else {
      if (
    ...
    if (gCurrentUIMode == Enum206.LOOKCURSOR_MODE) {
      if (
        !ButtonList[iSMPanelButtons[Enum220.LOOK_BUTTON]]
          .ubToggleButtonActivated
      ) {
    ...
    if (
      gusSelectedSoldier != gpSMCurrentMerc.ubID ||
      gpSMCurrentMerc.bLife < OKLIFE ||
      gTacticalStatus.ubCurrentTeam != gbPlayerNum ||
      gfSMDisableForItems
    ) {
      ...
      // Enable some buttons!
      if (
        IsGunBurstCapable(gpSMCurrentMerc, Enum261.HANDPOS, false) ||
        FindAttachment(
          gpSMCurrentMerc.inv[Enum261.HANDPOS],
  ...
  export function ReevaluateItemHatches(
    pSoldier: SOLDIERTYPE,
    fAllValid: boolean,
  ): void {
    let cnt: INT32;
    ...
    if (gpItemPointer != null && !fAllValid) {
      ...
      for (cnt = 0; cnt < Enum261.NUM_INV_SLOTS; cnt++) {
        gbInvalidPlacementSlot[cnt] = !CanItemFitInPosition(
          pSoldier,
          gpItemPointer,
          cnt,
          false,
  ...
  export function EnableSMPanelButtons(
    fEnable: boolean,
    fFromItemPickup: boolean,
  ): void {
    if (fFromItemPickup) {
  ...
  export function InitializeSMPanel(): boolean {
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "INTERFACE\\inventory_gold_front.sti",
    );
    ...
    MSYS_DefineRegion(
      gSM_SELMERCPanelRegion,
      SM_SELMERC_FACE_X,
      SM_SELMERC_FACE_Y,
      SM_SELMERC_FACE_X + SM_SELMERC_FACE_WIDTH,
      SM_SELMERC_FACE_Y + SM_SELMERC_FACE_HEIGHT,
      MSYS_PRIORITY_NORMAL,
      MSYS_NO_CURSOR,
      SelectedMercButtonMoveCallback,
    ...
    // DEfine region for selected guy panel
    MSYS_DefineRegion(
      gSM_SELMERCEnemyIndicatorRegion,
      SM_SELMERC_FACE_X + 1,
      SM_SELMERC_FACE_Y + 1,
      SM_SELMERC_FACE_X + INDICATOR_BOX_WIDTH,
      SM_SELMERC_FACE_Y + INDICATOR_BOX_HEIGHT,
      MSYS_PRIORITY_NORMAL,
      MSYS_NO_CURSOR,
      MSYS_NO_CALLBACK,
      SelectedMercEnemyIndicatorCallback,
    );
    // Add region
    ...
    SetRegionFastHelpText(
      gSM_SELMERCMoneyRegion,
      TacticalStr[Enum335.MONEY_BUTTON_HELP_TEXT],
    );
    ...
    InitInvSlotInterface(
      ...
      SMInvMoveCallback,
      SMInvClickCallback,
      SMInvMoveCammoCallback,
      SMInvClickCamoCallback,
      false,
    );
  ...
  export function CreateSMPanelButtons(): boolean {
    ...
    iSMPanelImages[Enum218.STANCEUP_IMAGES] = LoadButtonImage(
      ubString,
      -1,
      0,
      -1,
    ...
    iSMPanelImages[Enum218.UPDOWN_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      9,
      -1,
      19,
    ...
    iSMPanelImages[Enum218.CLIMB_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      3,
      -1,
    ...
    iSMPanelImages[Enum218.STANCEDOWN_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      8,
      -1,
    ...
    iSMPanelImages[Enum218.HANDCURSOR_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      1,
      -1,
    ...
    iSMPanelImages[Enum218.PREVMERC_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      20,
      -1,
    ...
    iSMPanelImages[Enum218.NEXTMERC_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      21,
      -1,
    ...
    iSMPanelImages[Enum218.LOOK_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      2,
      -1,
    ...
    iSMPanelImages[Enum218.TALK_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      6,
      -1,
    ...
    iSMPanelImages[Enum218.MUTE_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      5,
      -1,
    ...
    iSMPanelImages[Enum218.OPTIONS_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      24,
      -1,
    ...
    iBurstButtonImages[Enum265.WM_NORMAL] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      7,
      -1,
    ...
    iBurstButtonImages[Enum265.WM_BURST] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      17,
      -1,
    ...
    iBurstButtonImages[Enum265.WM_ATTACHED] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      -1,
      26,
      -1,
    ...
    // Load button Graphics
    iSMPanelImages[Enum218.STANCE_IMAGES] = LoadButtonImage(
      ubString,
      0,
      0,
      -1,
    ...
    // Load button Graphics
    iSMPanelImages[Enum218.DONE_IMAGES] = LoadButtonImage(
      ubString,
      -1,
      1,
      -1,
    ...
    iSMPanelImages[Enum218.MAPSCREEN_IMAGES] = UseLoadedButtonImage(
      iSMPanelImages[Enum218.DONE_IMAGES],
      -1,
      0,
      -1,
      2,
    ...
    iSMPanelButtons[Enum220.SM_MAP_SCREEN_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.MAPSCREEN_IMAGES],
      SM_MAPSCREEN_X,
      SM_MAPSCREEN_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
      DEFAULT_MOVE_CALLBACK(),
      BtnMapScreenCallback,
    );
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.SM_MAP_SCREEN_BUTTON],
      TacticalStr[Enum335.MAPSCREEN_POPUPTEXT],
    );
    ...
    iSMPanelButtons[Enum220.SM_DONE_BUTTON] = CreateIconAndTextButton(
      iSMPanelImages[Enum218.DONE_IMAGES],
      "",
      FONT12ARIAL(),
      FONT_MCOLOR_WHITE,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.SM_DONE_BUTTON],
      TacticalStr[Enum335.END_TURN_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.SM_DONE_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.TALK_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.TALK_IMAGES],
      SM_TALKB_X,
      SM_TALKB_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.TALK_BUTTON],
      TacticalStr[Enum335.TALK_CURSOR_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.TALK_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.MUTE_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.MUTE_IMAGES],
      SM_MUTEB_X,
      SM_MUTEB_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.MUTE_BUTTON],
      TacticalStr[Enum335.TOGGLE_MUTE_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.MUTE_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.STANCEUP_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.STANCEUP_IMAGES],
      SM_STANCEUPB_X,
      SM_STANCEUPB_Y,
      BUTTON_TOGGLE,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.STANCEUP_BUTTON],
      TacticalStr[Enum335.CHANGE_STANCE_UP_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.STANCEUP_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.UPDOWN_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.UPDOWN_IMAGES],
      SM_UPDOWNB_X,
      SM_UPDOWNB_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.UPDOWN_BUTTON],
      TacticalStr[Enum335.CURSOR_LEVEL_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.UPDOWN_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.CLIMB_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.CLIMB_IMAGES],
      SM_CLIMBB_X,
      SM_CLIMBB_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.CLIMB_BUTTON],
      TacticalStr[Enum335.JUMPCLIMB_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.CLIMB_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.STANCEDOWN_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.STANCEDOWN_IMAGES],
      SM_STANCEDOWNB_X,
      SM_STANCEDOWNB_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
      DEFAULT_MOVE_CALLBACK(),
      BtnStanceDownCallback,
    );
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.STANCEDOWN_BUTTON],
      TacticalStr[Enum335.CHANGE_STANCE_DOWN_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.STANCEDOWN_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.HANDCURSOR_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.HANDCURSOR_IMAGES],
      SM_HANDCURSORB_X,
      SM_HANDCURSORB_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGH - 1,
      MSYS_NO_CALLBACK,
      BtnHandCursorCallback,
    );
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.HANDCURSOR_BUTTON],
      TacticalStr[Enum335.EXAMINE_CURSOR_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.HANDCURSOR_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.PREVMERC_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.PREVMERC_IMAGES],
      SM_PREVMERCB_X,
      SM_PREVMERCB_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.PREVMERC_BUTTON],
      TacticalStr[Enum335.PREV_MERC_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.PREVMERC_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.NEXTMERC_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.NEXTMERC_IMAGES],
      SM_NEXTMERCB_X,
      SM_NEXTMERCB_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.NEXTMERC_BUTTON],
      TacticalStr[Enum335.NEXT_MERC_POPUPTEXT],
    );
    ...
    iSMPanelButtons[Enum220.OPTIONS_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.OPTIONS_IMAGES],
      SM_OPTIONSB_X,
      SM_OPTIONSB_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.OPTIONS_BUTTON],
      TacticalStr[Enum335.CHANGE_OPTIONS_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.OPTIONS_BUTTON],
      HelpTextDoneCallback,
    ...
    iSMPanelButtons[Enum220.BURSTMODE_BUTTON] = QuickCreateButton(
      iBurstButtonImages[Enum265.WM_NORMAL],
      SM_BURSTMODEB_X,
      SM_BURSTMODEB_Y,
      BUTTON_NO_TOGGLE,
      MSYS_PRIORITY_HIGH,
      MSYS_NO_CALLBACK,
      BtnBurstModeCallback,
    );
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.BURSTMODE_BUTTON],
      TacticalStr[Enum335.TOGGLE_BURSTMODE_POPUPTEXT],
    );
    ...
    iSMPanelButtons[Enum220.LOOK_BUTTON] = QuickCreateButton(
      iSMPanelImages[Enum218.LOOK_IMAGES],
      SM_LOOKB_X,
      SM_LOOKB_Y,
      BUTTON_NEWTOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iSMPanelButtons[Enum220.LOOK_BUTTON],
      TacticalStr[Enum335.LOOK_CURSOR_POPUPTEXT],
    );
    SetBtnHelpEndCallback(
      iSMPanelButtons[Enum220.LOOK_BUTTON],
      HelpTextDoneCallback,
    ...
    if (pfDirty.value == DIRTYLEVEL2) {
      ...
      if (InItemDescriptionBox()) {
        ...
        mprintf(
          Math.trunc(
            SM_ARMOR_LABEL_X -
              StringPixLength(pInvPanelTitleStrings[0], BLOCKFONT2()) / 2,
          ),
          SM_ARMOR_LABEL_Y,
          pInvPanelTitleStrings[0],
        );
        mprintf(SM_ARMOR_PERCENT_X, SM_ARMOR_PERCENT_Y, "%");

        mprintf(
          SM_WEIGHT_LABEL_X -
            StringPixLength(pInvPanelTitleStrings[1], BLOCKFONT2()),
          SM_WEIGHT_LABEL_Y,
          pInvPanelTitleStrings[1],
        );
        mprintf(SM_WEIGHT_PERCENT_X, SM_WEIGHT_PERCENT_Y, "%");

        mprintf(
          SM_CAMMO_LABEL_X -
            StringPixLength(pInvPanelTitleStrings[2], BLOCKFONT2()),
          SM_CAMMO_LABEL_Y,
          pInvPanelTitleStrings[2],
        );
        mprintf(SM_CAMMO_PERCENT_X, SM_CAMMO_PERCENT_Y, "%");

        UpdateStatColor(
          gpSMCurrentMerc.uiChangeAgilityTime,
          gpSMCurrentMerc.usValueGoneUp & AGIL_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bAgility.toString().padStart(2),
        );
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeDexterityTime,
          gpSMCurrentMerc.usValueGoneUp & DEX_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bDexterity.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_DEX_X,
          SM_DEX_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeStrengthTime,
          gpSMCurrentMerc.usValueGoneUp & STRENGTH_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bStrength.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_STR_X,
          SM_STR_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeLeadershipTime,
          gpSMCurrentMerc.usValueGoneUp & LDR_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bLeadership.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_CHAR_X,
          SM_CHAR_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeWisdomTime,
          gpSMCurrentMerc.usValueGoneUp & WIS_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bWisdom.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_WIS_X,
          SM_WIS_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeLevelTime,
          gpSMCurrentMerc.usValueGoneUp & LVL_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bExpLevel.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_EXPLVL_X,
          SM_EXPLVL_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeMarksmanshipTime,
          gpSMCurrentMerc.usValueGoneUp & MRK_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bMarksmanship.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_MRKM_X,
          SM_MRKM_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeExplosivesTime,
          gpSMCurrentMerc.usValueGoneUp & EXP_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bExplosive.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_EXPL_X,
          SM_EXPL_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeMechanicalTime,
          gpSMCurrentMerc.usValueGoneUp & MECH_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bMechanical.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_MECH_X,
          SM_MECH_Y,
        ...
        UpdateStatColor(
          gpSMCurrentMerc.uiChangeMedicalTime,
          gpSMCurrentMerc.usValueGoneUp & MED_INCREASE ? true : false,
        );

        sString = swprintf(
          "%s",
          gpSMCurrentMerc.bMedical.toString().padStart(2),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_MED_X,
          SM_MED_Y,
        ...
        sString = swprintf(
          "%s",
          ArmourPercent(gpSMCurrentMerc).toString().padStart(3),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_ARMOR_X,
          SM_ARMOR_Y,
        ...
        sString = swprintf(
          "%s",
          CalculateCarriedWeight(gpSMCurrentMerc).toString().padStart(3),
        );
        ({ sX: usX, sY: usY } = FindFontRightCoordinates(
          SM_WEIGHT_X,
          SM_WEIGHT_Y,
    ...
    if (pfDirty.value != DIRTYLEVEL0) {
      ...
      if (gpSMCurrentMerc.bLife != 0) {
        if (gpSMCurrentMerc.uiStatusFlags & SOLDIER_VEHICLE) {
          RenderSMPanel__pStr = swprintf(
            TacticalStr[Enum335.VEHICLE_VITAL_STATS_POPUPTEXT],
            gpSMCurrentMerc.bLife,
            gpSMCurrentMerc.bLifeMax,
            gpSMCurrentMerc.bBreath,
          ...
          RenderSMPanel__pStr = swprintf(
            TacticalStr[Enum335.MERC_VITAL_STATS_POPUPTEXT],
            gpSMCurrentMerc.bLife,
            gpSMCurrentMerc.bLifeMax,
            gpSMCurrentMerc.bBreath,
            gpSMCurrentMerc.bBreathMax,
            RenderSMPanel__pMoraleStr,
          );
          SetRegionFastHelpText(gSM_SELMERCBarsRegion, RenderSMPanel__pStr);
        }
      } else {
      ...
      if (!(gpSMCurrentMerc.uiStatusFlags & SOLDIER_DEAD)) {
        if (
          ...
          if (
            !EnoughPoints(
              gpSMCurrentMerc,
              MinAPsToAttack(gpSMCurrentMerc, gpSMCurrentMerc.sLastTarget, 0),
              0,
              false,
            ) ||
          ...
          gprintfRestore(
            ...
            SM_SELMERC_AP_Y,
            "%s",
            GetUIApsToDisplay(gpSMCurrentMerc).toString().padStart(2),
          );
          ({ sX: sFontX, sY: sFontY } = VarFindFontCenterCoordinates(
            SM_SELMERC_AP_X,
            SM_SELMERC_AP_Y,
            SM_SELMERC_AP_WIDTH,
            SM_SELMERC_AP_HEIGHT,
            TINYFONT1(),
            "%d",
        ...
        DrawLifeUIBarEx(
          ...
          SM_SELMERC_HEALTH_X,
          SM_SELMERC_HEALTH_Y,
          SM_SELMERC_HEALTH_WIDTH,
          SM_SELMERC_HEALTH_HEIGHT,
          true,
          FRAME_BUFFER,
        );
        ...
        if (!(gpSMCurrentMerc.uiStatusFlags & SOLDIER_ROBOT)) {
          ...
          DrawMoraleUIBarEx(
            ...
            SM_SELMERC_MORALE_X,
            SM_SELMERC_MORALE_Y,
            SM_SELMERC_MORALE_WIDTH,
            SM_SELMERC_MORALE_HEIGHT,
            true,
            FRAME_BUFFER,
          );
        }
  ...
  function UpdateStatColor(uiTimer: UINT32, fIncrease: boolean): void {
    if (gpSMCurrentMerc.bLife >= OKLIFE) {
      if (
        GetJA2Clock() < CHANGE_STAT_RECENTLY_DURATION + uiTimer &&
        uiTimer != 0
      ) {
        if (fIncrease) {
  ...
  function InvPanelButtonClickCallback(
  ...
  function SMInvClickCamoCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    let fGoodAPs__Pointer = createPointer(
      () => fGoodAPs,
      (v) => (fGoodAPs = v),
    );
        ...
        // if ( ubSrcID == ubDestID )
        {
          ...
          if (gpSMCurrentMerc.bLife >= CONSCIOUSNESS) {
            ...
            if (ApplyCammo(gpSMCurrentMerc, gpItemPointer, fGoodAPs__Pointer)) {
              ...
              ApplyCanteen(gpSMCurrentMerc, gpItemPointer, fGoodAPs__Pointer)
            ) {
              // Dirty
              if (fGoodAPs) {
                fInterfacePanelDirty = DIRTYLEVEL2;
              ...
              ApplyElixir(gpSMCurrentMerc, gpItemPointer, fGoodAPs__Pointer)
            ) {
              if (fGoodAPs) {
                // Dirty
                fInterfacePanelDirty = DIRTYLEVEL2;
            ...
            */
              ...
              ScreenMsg(
                ...
                MSG_UI_FEEDBACK,
                TacticalStr[Enum335.CANNOT_DO_INV_STUFF_STR],
              );
            }
          }
        }
  ...
  export function HandleNailsVestFetish(
    pSoldier: SOLDIERTYPE,
    uiHandPos: UINT32,
    usReplaceItem: UINT16,
  ): boolean {
    ...
    if (pSoldier.ubProfile == 34) {
      ...
      if (uiHandPos == Enum261.VESTPOS) {
        ...
        if (usReplaceItem == NOTHING) {
          ...
          if (
            usReplaceItem == Enum225.LEATHER_JACKET ||
            usReplaceItem == Enum225.LEATHER_JACKET_W_KEVLAR ||
            usReplaceItem == Enum225.LEATHER_JACKET_W_KEVLAR_18 ||
            usReplaceItem == Enum225.LEATHER_JACKET_W_KEVLAR_Y ||
            usReplaceItem == Enum225.COMPOUND18 ||
            usReplaceItem == Enum225.JAR_QUEEN_CREATURE_BLOOD
          ) {
            // This is good....
            fRefuse = false;
          } else {
  ...
  function UIHandleItemPlacement(
    ubHandPos: UINT8,
    usOldItemIndex: UINT16,
    usNewItemIndex: UINT16,
    fDeductPoints: boolean,
  ): boolean {
    if (_KeyDown(CTRL)) {
  ...
  function SMInvClickCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE) {
      ...
      if (
        ShouldSoldierDisplayHatchOnItem(gpSMCurrentMerc.ubProfile, uiHandPos)
      ) {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (gpItemPointer == null) {
        ...
        if (fOKToGo) {
          ...
          if (guiTacticalInterfaceFlags & INTERFACE_SHOPKEEP_INTERFACE) {
            ...
            fNewItem = Boolean(
              gMoveingItem.uiFlags &
                (ARMS_INV_JUST_PURCHASED | ARMS_INV_ITEM_REPAIRED),
            );
          }

          // try to place the item in the cursor into this inventory slot
          if (
            UIHandleItemPlacement(
              uiHandPos,
              usOldItemIndex,
              usNewItemIndex,
              fDeductPoints,
      ...
      SMInvClickCallback__fRightDown
    ) {
  ...
  function HandleMouseOverSoldierFaceForContMove(
    pSoldier: SOLDIERTYPE,
    fOn: boolean,
  ): void {
    let pFace: FACETYPE;
  ...
  function SelectedMercButtonMoveCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (gpSMCurrentMerc == null) {
  ...
  function SelectedMercButtonCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let pVehicle: SOLDIERTYPE;
  ...
  function SelectedMercEnemyIndicatorCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (gpSMCurrentMerc == null) {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (gpSMCurrentMerc.uiStatusFlags & SOLDIER_MUTE) {
        ScreenMsg(
          FONT_MCOLOR_LTYELLOW,
          MSG_INTERFACE,
          TacticalStr[Enum335.MUTE_OFF_STR],
          gpSMCurrentMerc.name,
        );
        ...
        ScreenMsg(
          FONT_MCOLOR_LTYELLOW,
          MSG_INTERFACE,
          TacticalStr[Enum335.MUTE_ON_STR],
          gpSMCurrentMerc.name,
        );
        gpSMCurrentMerc.uiStatusFlags |= SOLDIER_MUTE;
      }
  ...
  function BtnPrevMercCallback(btn: GUI_BUTTON, reason: INT32): void {
    ...
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (!gfInItemPickupMenu) {
        ...
        } else LocateSoldier(sID, SETLOCATOR);
      }
...
*/
  ...
  export function InitializeTEAMPanel(): boolean {
    ...
    for (posIndex = 0, cnt = 0; cnt < 6; cnt++, posIndex += 2) {
      MSYS_DefineRegion(
        gTEAM_FaceRegions[cnt],
        sTEAMFacesXY[posIndex],
        sTEAMFacesXY[posIndex + 1],
        sTEAMFacesXY[posIndex] + TM_FACE_WIDTH,
        sTEAMFacesXY[posIndex + 1] + TM_FACE_HEIGHT,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MercFacePanelMoveCallback,
      ...
      MSYS_DefineRegion(
        gTEAM_EnemyIndicator[cnt],
        sTEAMFacesXY[posIndex] + 1,
        sTEAMFacesXY[posIndex + 1] + 1,
        sTEAMFacesXY[posIndex] + INDICATOR_BOX_WIDTH,
        sTEAMFacesXY[posIndex + 1] + INDICATOR_BOX_HEIGHT,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
      ...
      if (IsMouseInRegion(gTEAM_FaceRegions[cnt])) {
        if (gTeamPanel[cnt].ubID != NOBODY) {
          HandleMouseOverSoldierFaceForContMove(
            MercPtrs[gTeamPanel[cnt].ubID],
            true,
          );
        }
      }
      ...
      MSYS_DefineRegion(
        gTEAM_BarsRegions[cnt],
        sTEAMBarsXY[posIndex],
        sTEAMBarsXY[posIndex + 1],
        sTEAMBarsXY[posIndex] + TM_BARS_REGION_WIDTH,
        sTEAMBarsXY[posIndex + 1] + TM_BARS_REGION_HEIGHT,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
        MercFacePanelCallback,
      ...
      MSYS_DefineRegion(
        ...
        sTEAMFacesXY[posIndex] - 8,
        sTEAMFacesXY[posIndex + 1],
        sTEAMFacesXY[posIndex],
        sTEAMFacesXY[posIndex + 1] + TM_BARS_REGION_HEIGHT,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
        MercFacePanelCallback,
      ...
      MSYS_DefineRegion(
        gTEAM_FirstHandInv[cnt],
        sTEAMHandInvXY[posIndex],
        sTEAMHandInvXY[posIndex + 1],
        sTEAMHandInvXY[posIndex] + TM_INV_WIDTH,
        sTEAMHandInvXY[posIndex + 1] + TM_INV_HEIGHT,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
      ...
      MSYS_DefineRegion(
        gTEAM_SecondHandInv[cnt],
        sTEAMHandInvXY[posIndex],
        sTEAMHandInvXY[posIndex + 1] + 24,
        sTEAMHandInvXY[posIndex] + TM_INV_WIDTH,
        sTEAMHandInvXY[posIndex + 1] + TM_INV_HEIGHT + 24,
        MSYS_PRIORITY_NORMAL,
        MSYS_NO_CURSOR,
        MSYS_NO_CALLBACK,
      ...
      for (cnt = 0, posIndex = 0; cnt < NUM_TEAM_SLOTS; cnt++, posIndex += 2) {
        ...
        if (!gTeamPanel[cnt].fOccupied) {
          ...
          if (pSoldier.uiStatusFlags & SOLDIER_DRIVER) {
            ...
            RenderTEAMPanel__pStr = swprintf(
              TacticalStr[Enum335.DRIVER_POPUPTEXT],
              pVehicle.bLife,
              pVehicle.bLifeMax,
              pVehicle.bBreath,
              pVehicle.bBreathMax,
            ...
            SetRegionFastHelpText(
              gTEAM_FirstHandInv[cnt],
              RenderTEAMPanel__pStr,
            );
          }
          // Add text for first hand popup
          else {
            RenderTEAMPanel__pStr = GetHelpTextForItem(
          ...
          if (pSoldier.uiStatusFlags & (SOLDIER_PASSENGER | SOLDIER_DRIVER)) {
            ...
            SetRegionFastHelpText(
              gTEAM_SecondHandInv[cnt],
              TacticalStr[Enum335.EXIT_VEHICLE_POPUPTEXT],
            );
          } else {
            RenderTEAMPanel__pStr = GetHelpTextForItem(
          ...
          SetFontDestBuffer(guiSAVEBUFFER, 0, 0, 640, 480, false);
          ({ sX: sFontX, sY: sFontY } = VarFindFontCenterCoordinates(
            sTEAMNamesXY[posIndex] + 2,
            sTEAMNamesXY[posIndex + 1],
            TM_NAME_WIDTH,
            TM_NAME_HEIGHT,
            BLOCKFONT2(),
            "%s",
      ...
      if (gTeamPanel[cnt].fOccupied) {
        ...
        if (fDirty != DIRTYLEVEL0) {
          ...
          if (!(pSoldier.uiStatusFlags & SOLDIER_DEAD)) {
            DrawLifeUIBarEx(
              pSoldier,
              sTEAMLifeXY[posIndex],
              sTEAMLifeXY[posIndex + 1],
              TM_LIFEBAR_WIDTH,
              TM_LIFEBAR_HEIGHT,
              true,
              FRAME_BUFFER,
            ...
            if (!(pSoldier.uiStatusFlags & SOLDIER_ROBOT)) {
              DrawBreathUIBarEx(
                pSoldier,
                sTEAMBreathXY[posIndex],
                sTEAMBreathXY[posIndex + 1],
                TM_LIFEBAR_WIDTH,
                TM_LIFEBAR_HEIGHT,
                true,
                FRAME_BUFFER,
              ...
              DrawMoraleUIBarEx(
                pSoldier,
                sTEAMMoraleXY[posIndex],
                sTEAMMoraleXY[posIndex + 1],
                TM_LIFEBAR_WIDTH,
                TM_LIFEBAR_HEIGHT,
                true,
                FRAME_BUFFER,
            ...
            if (
              ...
              if (
                !EnoughPoints(
                  pSoldier,
                  MinAPsToAttack(pSoldier, pSoldier.sLastTarget, 1),
                  0,
                  false,
                ) ||
  ...
  export function CreateTEAMPanelButtons(): boolean {
    ...
    // Load button Graphics
    iTEAMPanelImages[Enum219.ENDTURN_IMAGES] = LoadButtonImage(
      ubString,
      -1,
      0,
      -1,
    ...
    iTEAMPanelImages[Enum219.ROSTERMODE_IMAGES] = UseLoadedButtonImage(
      iTEAMPanelImages[Enum219.ENDTURN_IMAGES],
      -1,
      1,
      -1,
      4,
    ...
    iTEAMPanelImages[Enum219.DISK_IMAGES] = UseLoadedButtonImage(
      iTEAMPanelImages[Enum219.ENDTURN_IMAGES],
      -1,
      2,
      -1,
    ...
    // Create buttons
    iTEAMPanelButtons[Enum221.TEAM_DONE_BUTTON] = QuickCreateButton(
      iTEAMPanelImages[Enum219.ENDTURN_IMAGES],
      TM_ENDTURN_X,
      TM_ENDTURN_Y,
      BUTTON_TOGGLE,
    ...
    SetButtonFastHelpText(
      iTEAMPanelButtons[Enum221.TEAM_DONE_BUTTON],
      TacticalStr[Enum335.END_TURN_POPUPTEXT],
    );

    iTEAMPanelButtons[Enum221.TEAM_MAP_SCREEN_BUTTON] = QuickCreateButton(
      iTEAMPanelImages[Enum219.ROSTERMODE_IMAGES],
      TM_ROSTERMODE_X,
      TM_ROSTERMODE_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
      DEFAULT_MOVE_CALLBACK(),
      BtnRostermodeCallback,
    );
    ...
    iTEAMPanelButtons[Enum221.CHANGE_SQUAD_BUTTON] = QuickCreateButton(
      iTEAMPanelImages[Enum219.DISK_IMAGES],
      TM_DISK_X,
      TM_DISK_Y,
      BUTTON_TOGGLE,
      MSYS_PRIORITY_HIGH - 1,
    ...
    SetButtonFastHelpText(
      iTEAMPanelButtons[Enum221.CHANGE_SQUAD_BUTTON],
      TacticalStr[Enum335.CHANGE_SQUAD_POPUPTEXT],
    );
  ...
  function HandleMouseOverTeamFaceForContMove(fOn: boolean): void {
    ...
    if (fOn) {
      ...
      if (CheckForMercContMove(gpSMCurrentMerc)) {
        ...
        PlotPath(
          gpSMCurrentMerc,
          gpSMCurrentMerc.sFinalDestination,
          NO_COPYROUTE,
          PLOT,
          TEMPORARY,
          gpSMCurrentMerc.usUIMovementMode,
          NOT_STEALTH,
          FORWARD,
  ...
  function MercFacePanelMoveCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubID: UINT8;
  ...
  function EnemyIndicatorClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubID: UINT8;
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      if (
        MercPtrs[ubSoldierID].uiStatusFlags &
        (SOLDIER_DRIVER | SOLDIER_PASSENGER)
      ) {
      } else {
        let pSoldier: SOLDIERTYPE;
  ...
  function MercFacePanelCallback(pRegion: MOUSE_REGION, iReason: INT32): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      if (!gfInItemPickupMenu && gpItemPointer == null) {
        if (
          ...
          pVehicle = GetSoldierStructureForVehicle(
            MercPtrs[ubSoldierID].iVehicleId,
          );
      ...
      if (!InOverheadMap()) {
        ...
        if (
          !(MercPtrs[ubSoldierID].uiStatusFlags & SOLDIER_DEAD) &&
  ...
  function CheckForFacePanelStartAnims(
    pSoldier: SOLDIERTYPE,
    sPanelX: INT16,
    sPanelY: INT16,
  ): void {
  ...
  export function FinishAnySkullPanelAnimations(): void {
    ...
    // run through list
    for (
      pTeamSoldier = MercPtrs[cnt2];
      cnt2 <= gTacticalStatus.Team[gbPlayerNum].bLastID;
      cnt2++, pTeamSoldier = MercPtrs[cnt2]
    ) {
  ...
  function HandleSoldierFaceFlash(
    pSoldier: SOLDIERTYPE,
    sFaceX: INT16,
    sFaceY: INT16,
  ): void {}

  function RenderSoldierTeamInv(
    pSoldier: SOLDIERTYPE,
    sX: INT16,
    sY: INT16,
    ubPanelNum: UINT8,
    fDirty: UINT8 /* boolean */,
  ): void {
      ...
      if (pSoldier.uiStatusFlags & SOLDIER_DRIVER) {
        ...
        INVRenderItem(
          ...
          createElementPointer(
            gfTEAM_HandInvDispText[ubPanelNum],
            Enum261.HANDPOS,
          ),
          0,
          false,
  ...
  function TMClickFirstHandInvCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubID: UINT8;
    ...
    if (iReason == MSYS_CALLBACK_REASON_RBUTTON_UP) {
      if (!AM_A_ROBOT(MercPtrs[ubSoldierID])) {
        ...
        ReLoadSoldierAnimationDueToHandItemChange(
          ...
          usOldHandItem,
          MercPtrs[ubSoldierID].inv[Enum261.HANDPOS].usItem,
        );
        fInterfacePanelDirty = DIRTYLEVEL2;
      }
    }
  ...
  function TMClickSecondHandInvCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let ubID: UINT8;
    ...
    if (iReason == MSYS_CALLBACK_REASON_LBUTTON_UP) {
      if (
        MercPtrs[ubSoldierID].uiStatusFlags &
        (SOLDIER_PASSENGER | SOLDIER_DRIVER)
      ) {
  ...
  export function RemovePlayerFromTeamSlotGivenMercID(
    ubMercID: UINT8,
  ): boolean {
    let cnt: INT32;
  ...
  export function GetPlayerIDFromInterfaceTeamSlot(
    ubPanelSlot: UINT8,
    pubID: Pointer<UINT8>,
  ): boolean {
  ...
  function RemovePlayerFromInterfaceTeamSlot(ubPanelSlot: UINT8): boolean {
    ...
    if (gTeamPanel[ubPanelSlot].fOccupied) {
      if (
        !(MercPtrs[gTeamPanel[ubPanelSlot].ubID].uiStatusFlags & SOLDIER_DEAD)
      ) {
        // Set Id to close
  ...
  export function RenderTownIDString(): void {
    ...
    zTownIDString = GetSectorIDString(
      gWorldSectorX,
      gWorldSectorY,
      gbWorldSectorZ,
      true,
      ...
      if (pSoldier.bTeam == gbPlayerNum) {
        ...
        if (
          ...
          if (
            ...
            SoldierIsDeadAndWasOnSquad(pSoldier, CurrentSquad())
          ) {
            ...
            if (
              ...
              Enum175.INSERTION_CODE_CHOPPER
            ) {
  ...
  export function FindNextMercInTeamPanel(
    pSoldier: SOLDIERTYPE,
    fGoodForLessOKLife: boolean,
    fOnlyRegularMercs: boolean,
  ): UINT8 {
    let cnt: INT32;
    let bFirstID: INT32;
    let pTeamSoldier: SOLDIERTYPE;
      ...
      if (gTeamPanel[cnt].fOccupied) {
        ...
        if (fGoodForLessOKLife) {
          if (
            ...
            pTeamSoldier.bAssignment < Enum117.ON_DUTY &&
  ...
  export function KeyRingItemPanelButtonCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    let pSoldier: SOLDIERTYPE;
  ...
  export function KeyRingSlotInvClickCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    ...
    if (iReason & MSYS_CALLBACK_REASON_LBUTTON_DWN) {
      ...
      if (gpItemPointer == null) {
        // Return if empty
        if (
          gpItemPopupSoldier.pKeyRing[uiKeyRing].ubKeyID ==
            INVALID_KEY_NUMBER ||
        ...
        if (
          gpItemPointer.usItem < FIRST_KEY ||
          gpItemPointer.usItem > Enum225.KEY_32
        ) {
          return;
        }
        ...
        if (fOKToGo) {
          ...
          if (
            gpItemPopupSoldier.pKeyRing[uiKeyRing].ubKeyID ==
              INVALID_KEY_NUMBER ||
            gpItemPopupSoldier.pKeyRing[uiKeyRing].ubKeyID ==
              gpItemPointer.ubKeyID
          ) {
            // Try to place here
            if (
              (iNumberOfKeysTaken = AddKeysToSlot(
                gpItemPopupSoldier,
                uiKeyRing,
                gpItemPointer,
              ))
            ...
            if (fDeductPoints) {
              ...
              if (
                gpItemPointerSoldier &&
                gpItemPointerSoldier.bLife >= CONSCIOUSNESS
              ) {
                DeductPoints(gpItemPointerSoldier, 2, 0);
              }
              if (gpSMCurrentMerc.bLife >= CONSCIOUSNESS) {
      ...
      iReason & MSYS_CALLBACK_REASON_RBUTTON_UP &&
      KeyRingSlotInvClickCallback__fRightDown
    ) {
      KeyRingSlotInvClickCallback__fRightDown = false;

      // Return if empty
      if (
        gpItemPopupSoldier.pKeyRing[uiKeyRing].ubKeyID == INVALID_KEY_NUMBER ||
        gpItemPopupSoldier.pKeyRing[uiKeyRing].ubNumber == 0
      ) {
        DeleteKeyRingPopup();
  ...
  export function DisableSMPpanelButtonsWhenInShopKeeperInterface(
    fDontDrawButtons: boolean,
  ): void {
    ...
    if (fDontDrawButtons) {
      ...
      // Go through the buttons that will be under the ShopKeepers ATM panel and disable them
      ButtonList[iSMPanelButtons[Enum220.STANCEUP_BUTTON]].uiFlags &=
        ~BUTTON_DIRTY;
      ButtonList[iSMPanelButtons[Enum220.UPDOWN_BUTTON]].uiFlags &=
        ~BUTTON_DIRTY;
      ButtonList[iSMPanelButtons[Enum220.CLIMB_BUTTON]].uiFlags &=
        ~BUTTON_DIRTY;
      ButtonList[iSMPanelButtons[Enum220.STANCEDOWN_BUTTON]].uiFlags &=
        ~BUTTON_DIRTY;
      ButtonList[iSMPanelButtons[Enum220.HANDCURSOR_BUTTON]].uiFlags &=
        ~BUTTON_DIRTY;
      ButtonList[iSMPanelButtons[Enum220.BURSTMODE_BUTTON]].uiFlags &=
      ...
      // Make sure the mapscreen button is disabled
      ButtonList[iSMPanelButtons[Enum220.SM_MAP_SCREEN_BUTTON]].uiFlags &=
        ~BUTTON_ENABLED;
  ...
  function IsMouseInRegion(pRegion: MOUSE_REGION): boolean {
    if (
      gusMouseXPos >= pRegion.RegionTopLeftX &&
      gusMouseXPos <= pRegion.RegionBottomRightX &&
      gusMouseYPos >= pRegion.RegionTopLeftY &&
      gusMouseYPos <= pRegion.RegionBottomRightY
    ) {
      return true;
    } else {
      return false;
  ...
  function SMInvMoneyButtonCallback(
    pRegion: MOUSE_REGION,
    iReason: INT32,
  ): void {
    if (iReason & MSYS_CALLBACK_REASON_INIT) {
        ...
        if (Item[gpItemPointer.usItem].usItemClass == IC_MONEY) {
          ...
          zText = swprintf(
            gzMoneyWithdrawMessageText[
              Enum374.CONFIRMATION_TO_DEPOSIT_MONEY_TO_ACCOUNT
            ],
            zMoney,
          );
  ...
  function ConfirmationToDepositMoneyToPlayersAccount(
    ubExitValue: UINT8,
  ): void {
    if (ubExitValue == MSG_BOX_RETURN_YES) {
      // add the money to the players account
      AddTransactionToPlayersBook(
        Enum80.MERC_DEPOSITED_MONEY_TO_PLAYER_ACCOUNT,
  ...
  export function HandleTacticalEffectsOfEquipmentChange(
    pSoldier: SOLDIERTYPE,
    uiInvPos: UINT32,
    usOldItem: UINT16,
    usNewItem: UINT16,
    ...
    if (pSoldier.bInSector) {
      ...
      if (
        ...
        Weapon[pSoldier.inv[Enum261.HANDPOS].usItem].ubShotsPerBurst == 0
      ) {
        pSoldier.bDoBurst = 0;
        pSoldier.bWeaponMode = Enum265.WM_NORMAL;
      }
