namespace ja2 {
  ...
  export function copyAirRaidDefinition(
    destination: AIR_RAID_DEFINITION,
    source: AIR_RAID_DEFINITION,
  ) {
  ...
  export function readAirRaidDefinition(
    o: AIR_RAID_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeAirRaidDefinition(
    o: AIR_RAID_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
