namespace ja2 {
  ...
  export function copyMapCreateStruct(
    destination: MAPCREATE_STRUCT,
    source: MAPCREATE_STRUCT,
  ) {
  ...
  export function readMapCreateStruct(
    o: MAPCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.sNorthGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sEastGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sSouthGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sWestGridNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.sCenterGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sIsolatedGridNo = buffer.readInt16LE(offset);
    offset += 2;
  ...
  export function writeMapCreateStruct(
    o: MAPCREATE_STRUCT,
    buffer: Buffer,
    offset: number = 0,
  ): number {
