namespace ja2 {
  ...
  export function HandleDoorChangeFromGridNo(
    pSoldier: SOLDIERTYPE | null,
    sGridNo: INT16,
    fNoAnimations: boolean,
  ): void {
    ...
    fDoorsAnimated = HandleDoorsOpenClose(
      pSoldier,
      sGridNo,
      pStructure,
      fNoAnimations,
  ...
  export function GetAnimStateForInteraction(
  ...
  export function InteractWithClosedDoor(
    pSoldier: SOLDIERTYPE,
    ubHandleCode: UINT8,
  ): void {
    ...
    switch (ubHandleCode) {
      ...
      case HANDLE_DOOR_CROWBAR:
        ChangeSoldierState(
          pSoldier,
          GetAnimStateForInteraction(pSoldier, true, Enum193.OPEN_DOOR),
          0,
          false,
        );
        break;
      ...
      case HANDLE_DOOR_LOCKPICK:
        ChangeSoldierState(
          pSoldier,
          GetAnimStateForInteraction(pSoldier, true, Enum193.PICK_LOCK),
          0,
          false,
        );
        break;
  ...
  function DoTrapCheckOnStartingMenu(
    pSoldier: SOLDIERTYPE,
    pDoor: DOOR | null,
  ): boolean {
  ...
  export function InteractWithOpenableStruct(
    pSoldier: SOLDIERTYPE,
      ...
      if (pDoorStatus && pDoorStatus.ubFlags & DOOR_BUSY) {
        ...
        if (pSoldier.bTeam == gbPlayerNum) {
          ScreenMsg(
            ...
            MSG_UI_FEEDBACK,
            TacticalStr[Enum335.DOOR_IS_BUSY],
          );
        } else {
          DebugMsg(
            TOPIC_JA2,
            DBG_LEVEL_3,
            FormatString(
              "Trying to open door and door is busy: %d",
              pSoldier.ubID,
            ),
          );
        }
    ...
    if (pStructure.fFlags & STRUCTURE_OPEN) {
      if (
        ...
        ChangeSoldierState(
          pSoldier,
          GetAnimStateForInteraction(pSoldier, fDoor, Enum193.CLOSE_DOOR),
          0,
          false,
        );
      }
      ...
      if (fDoMenu) {
        ...
        ChangeSoldierState(
          pSoldier,
          GetAnimStateForInteraction(pSoldier, fDoor, Enum193.OPEN_DOOR),
          0,
          false,
        );
      }
  ...
  function ProcessImplicationsOfPCMessingWithDoor(pSoldier: SOLDIERTYPE): void {
    ...
    if (
      ((ubRoom = InARoom(pSoldier.sGridNo)) !== -1 && IN_BROTHEL(ubRoom)) ||
      (gWorldSectorX == 5 &&
      ...
      for (
        ...
        if (
          pGoon.ubCivilianGroup == Enum246.KINGPIN_CIV_GROUP &&
          pGoon.bActive &&
          pGoon.bInSector &&
          pGoon.bLife >= OKLIFE &&
  ...
  export function HandleOpenableStruct(
    pSoldier: SOLDIERTYPE,
    sGridNo: INT16,
    pStructure: STRUCTURE,
  ): boolean {
    ...
    if (pStructure.fFlags & STRUCTURE_OPEN) {
      ...
      if (pSoldier.ubID < 20) {
        ...
        if (
          pSoldier.ubDoorHandleCode != HANDLE_DOOR_EXAMINE &&
          ...
          if (pDoor != null) {
            ...
            if (pDoor.fLocked && pDoor.ubTrapID != Enum227.NO_TRAP) {
              ...
              if (HasDoorTrapGoneOff(pSoldier, pDoor)) {
                ...
                if (
                  DoorTrapTable[pDoor.ubTrapID].fFlags & DOOR_TRAP_STOPS_ACTION
                ) {
                  // trap stops person from opening door!
                  fDoAction = false;
                }
                if (
                  !(DoorTrapTable[pDoor.ubTrapID].fFlags & DOOR_TRAP_RECURRING)
                ) {
                ...
                if (pDoor.bPerceivedTrapped == DOOR_PERCEIVED_UNKNOWN) {
                  switch (pDoor.ubTrapID) {
                    case Enum227.BROTHEL_SIREN:
                      ScreenMsg(
                        MSG_FONT_YELLOW,
                        MSG_INTERFACE,
                        TacticalStr[Enum335.DOOR_LOCK_DESCRIPTION_STR],
                  ...
                  HandleDoorTrap(pSoldier, pDoor);
                  if (
                    DoorTrapTable[pDoor.ubTrapID].fFlags &
                    DOOR_TRAP_STOPS_ACTION
                  ) {
                    // trap stops person from opening door!
                    fDoAction = false;
                  }
                ...
                if (pDoor.fLocked) {
                  ...
                  if (!AM_AN_EPC(pSoldier)) {
                    ...
                    ScreenMsg(
                      MSG_FONT_YELLOW,
                      MSG_INTERFACE,
                      TacticalStr[Enum335.DOOR_LOCK_HAS_BEEN_LOCKED_STR],
                    );
                  }
                } else {
                  ChangeSoldierState(
            ...
            case HANDLE_DOOR_FORCE:
              ...
              if (pDoor == null) {
                ...
                ScreenMsg(
                  MSG_FONT_YELLOW,
                  MSG_INTERFACE,
                  TacticalStr[Enum335.DOOR_THERE_IS_NO_LOCK_STR],
                );
              } else {
              ...
              if (pDoor == null) {
                ...
                if (ExamineDoorForTraps(pSoldier, pDoor)) {
                  ...
                  ScreenMsg(
                    MSG_FONT_YELLOW,
                    MSG_INTERFACE,
                    TacticalStr[Enum335.DOOR_LOCK_UNTRAPPED_STR],
                  );
                }
              }
              break;
              ...
              if (pDoor == null) {
                ...
                if (fTrapFound) {
                  ...
                  ScreenMsg(
                    MSG_FONT_YELLOW,
                    MSG_INTERFACE,
                    TacticalStr[Enum335.DOOR_LOCK_IS_NOT_TRAPPED_STR],
                  );
                }
              }
              break;
              ...
              if (pDoor == null) {
                ...
                if (AttemptToLockDoor(pSoldier, pDoor)) {
                  ...
                  ScreenMsg(
                    MSG_FONT_YELLOW,
                    MSG_INTERFACE,
                    TacticalStr[Enum335.DOOR_NOT_PROPER_KEY_STR],
                    pSoldier.name,
                  );
        ...
        ChangeSoldierState(
          pSoldier,
          GetAnimStateForInteraction(pSoldier, fDoor, Enum193.END_OPEN_DOOR),
          0,
          false,
        );
        fHandleDoor = true;
  ...
  function HandleDoorsOpenClose(
    ...
    pNode = FindLevelNodeBasedOnStructure(
      ...
      if (pNode.pAniTile != null) {
        if (pNode.pAniTile.uiFlags & ANITILE_DOOR) {
          ...
          if (pNode.pAniTile.uiFlags & ANITILE_FORWARD) {
            pNode.sCurrentFrame =
              pNode.pAniTile.sStartFrame + pNode.pAniTile.usNumFrames;
          }
          ...
          pNode.uiFlags &= ~(
            LEVELNODE_LASTDYNAMIC | LEVELNODE_UPDATESAVEBUFFERONCE
          );
    ...
    if (!(pStructure.fFlags & STRUCTURE_OPEN)) {
      ...
      if (pSoldier) {
        ...
        if (pSoldier.bTeam != gbPlayerNum) {
          ...
          if (
            pSoldier.bVisible == -1 &&
            !AllMercsLookForDoor(sGridNo, false) &&
      ...
      if (fDoAnimation) {
        ...
        if (fOpenedGraphic) {
          ...
          AniParams.uiFlags =
            ANITILE_DOOR | ANITILE_FORWARD | ANITILE_EXISTINGTILE;
          ...
          AniParams.sStartFrame = pNode.sCurrentFrame;
          AniParams.uiFlags =
            ANITILE_DOOR | ANITILE_BACKWARD | ANITILE_EXISTINGTILE;
          AniParams.pGivenLevelNode = pNode;
      ...
      if (fDoAnimation && pSoldier && pSoldier.ubDoorOpeningNoise) {
        ...
        if (pStructure.fFlags & STRUCTURE_SLIDINGDOOR) {
          ...
          pStructure.pDBStructureRef.pDBStructure.ubArmour ==
            Enum309.MATERIAL_LIGHT_METAL ||
          pStructure.pDBStructureRef.pDBStructure.ubArmour ==
            Enum309.MATERIAL_THICKER_METAL ||
          pStructure.pDBStructureRef.pDBStructure.ubArmour ==
            Enum309.MATERIAL_HEAVY_METAL
        ) {
          // change sound ID
      ...
      if (pDoor == null) {
        ...
        switch (pDoor.bPerceivedTrapped) {
          case DOOR_PERCEIVED_TRAPPED:
            gzIntTileLocation2 =
              TacticalStr[Enum335.DOOR_TRAPPED_MOUSE_DESCRIPTION];
        ...
        if (!fTrapped) {
          ...
          switch (pDoor.bPerceivedLocked) {
            ...
            case DOOR_PERCEIVED_LOCKED:
              gzIntTileLocation2 =
                TacticalStr[Enum335.DOOR_LOCKED_MOUSE_DESCRIPTION];
              gfUIIntTileLocation2 = true;
              break;

            case DOOR_PERCEIVED_UNLOCKED:
              gzIntTileLocation2 =
                TacticalStr[Enum335.DOOR_UNLOCKED_MOUSE_DESCRIPTION];
              gfUIIntTileLocation2 = true;
              break;

            case DOOR_PERCEIVED_BROKEN:
              gzIntTileLocation2 =
                TacticalStr[Enum335.DOOR_BROKEN_MOUSE_DESCRIPTION];
              gfUIIntTileLocation2 = true;
              break;
          }
        }
