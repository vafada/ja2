namespace ja2 {
  ...
  export function copyRottingCorpseDefinition(
    destination: ROTTING_CORPSE_DEFINITION,
    source: ROTTING_CORPSE_DEFINITION,
  ) {
  ...
  export function readRottingCorpseDefinition(
    o: ROTTING_CORPSE_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset++; // padding
    o.uiTimeOfDeath = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export function writeRottingCorpseDefinition(
    o: ROTTING_CORPSE_DEFINITION,
    buffer: Buffer,
    offset: number = 0,
  ): number {
