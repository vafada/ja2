...
*/
  export const HAS_SKILL_TRAIT = (s: SOLDIERTYPE, t: number) =>
    s.ubSkillTrait1 == t || s.ubSkillTrait2 == t;
  export const NUM_SKILL_TRAITS = (s: SOLDIERTYPE, t: number) =>
    s.ubSkillTrait1 == t
      ? s.ubSkillTrait2 == t
        ? 2
        : 1
  ...
  export function readPathSt(
    o: PathSt,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.uiSectorId = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiEta = buffer.readUInt32LE(offset);
    offset += 4;
  ...
  export const SOLDIER_CLASS_ENEMY = (bSoldierClass: number) =>
    bSoldierClass >= Enum262.SOLDIER_CLASS_ADMINISTRATOR &&
    bSoldierClass <= Enum262.SOLDIER_CLASS_ARMY;
  export const SOLDIER_CLASS_MILITIA = (bSoldierClass: number) =>
  ...
  export const CONSIDERED_NEUTRAL = (me: SOLDIERTYPE, them: SOLDIERTYPE) =>
    them.bNeutral &&
    (me.bTeam != CREATURE_TEAM || them.uiStatusFlags & SOLDIER_VEHICLE);
  ...
  export function writeKeyOnRing(
    o: KEY_ON_RING,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function createSoldierType(): SOLDIERTYPE {
    return {
      ...
      bAimShotLocation: 0,
      ubHitLocation: 0,
      pEffectShades: createArray(
        NUM_SOLDIER_EFFECTSHADES,
        <Uint16Array>(<unknown>null),
      ),
      ubPlannedUIAPCost: 0,
      sPlannedTargetX: 0,
      sPlannedTargetY: 0,
  ...
  export function copySoldierType(
    destination: SOLDIERTYPE,
    source: SOLDIERTYPE,
  ) {
    ...
    destination.fContinueMoveAfterStanceChange =
      source.fContinueMoveAfterStanceChange;
    ...
    destination.sDelayedMovementCauseGridNo =
      source.sDelayedMovementCauseGridNo;
    ...
    destination.ubTilesMovedPerRTBreathUpdate =
      source.ubTilesMovedPerRTBreathUpdate;
    destination.usLastMovementAnimPerRTBreathUpdate =
      source.usLastMovementAnimPerRTBreathUpdate;
    ...
    copyArray(
      destination.usFrontArcFullTileList,
      source.usFrontArcFullTileList,
    );
    copyArray(
      destination.usFrontArcFullTileGridNos,
      source.usFrontArcFullTileGridNos,
    );
    ...
    destination.iTotalLengthOfInsuranceContract =
      source.iTotalLengthOfInsuranceContract;
    destination.ubSoldierClass = source.ubSoldierClass;
    destination.ubAPsLostToSuppression = source.ubAPsLostToSuppression;
    destination.fChangingStanceDueToSuppression =
      source.fChangingStanceDueToSuppression;
    destination.ubSuppressorID = source.ubSuppressorID;
    destination.ubDesiredSquadAssignment = source.ubDesiredSquadAssignment;
    destination.ubNumTraversalsAllowedToMerge =
      source.ubNumTraversalsAllowedToMerge;
    ...
    destination.bBlockedByAnotherMercDirection =
      source.bBlockedByAnotherMercDirection;
    ...
    destination.usDontUpdateNewGridNoOnMoveAnimChange =
      source.usDontUpdateNewGridNoOnMoveAnimChange;
    ...
    copyArray(
      destination.bTimesDrugUsedSinceSleep,
      source.bTimesDrugUsedSinceSleep,
    );
    destination.bBlindedCounter = source.bBlindedCounter;
    destination.fMercCollapsedFlag = source.fMercCollapsedFlag;
    destination.fDoneAssignmentAndNothingToDoFlag =
      source.fDoneAssignmentAndNothingToDoFlag;
    destination.fMercAsleep = source.fMercAsleep;
    destination.fDontChargeAPsForStanceChange =
      source.fDontChargeAPsForStanceChange;
    destination.ubHoursOnAssignment = source.ubHoursOnAssignment;
    destination.ubMercJustFired = source.ubMercJustFired;
    destination.ubTurnsUntilCanSayHeardNoise =
      source.ubTurnsUntilCanSayHeardNoise;
    ...
    destination.ubNumTilesMovesSinceLastForget =
      source.ubNumTilesMovesSinceLastForget;
    ...
    destination.bUseExitGridForReentryDirection =
      source.bUseExitGridForReentryDirection;
    ...
    destination.fDontUnsetLastTargetFromTurn =
      source.fDontUnsetLastTargetFromTurn;
    ...
    destination.uiStartTimeOfInsuranceContract =
      source.uiStartTimeOfInsuranceContract;
  ...
  export function readSoldierType(
    o: SOLDIERTYPE,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset += 3; // padding
    o.uiStatusFlags = buffer.readInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.sFractLife = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.sBreathRed = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.sWeightCarriedAtTurnStart = buffer.readInt16LE(offset);
    offset += 2;
    o.name = readStringNL(buffer, "utf16le", offset, offset + 20);
    offset += 20;
    ...
    o.dXPos = buffer.readFloatLE(offset);
    offset += 4;
    o.dYPos = buffer.readFloatLE(offset);
    offset += 4;
    o.dOldXPos = buffer.readFloatLE(offset);
    offset += 4;
    o.dOldYPos = buffer.readFloatLE(offset);
    offset += 4;
    o.sInitialGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.bDirection = buffer.readInt8(offset++);
    offset++; // padding
    o.sHeightAdjustment = buffer.readInt16LE(offset);
    offset += 2;
    o.sDesiredHeight = buffer.readInt16LE(offset);
    offset += 2;
    o.sTempNewGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sRoomNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.usPendingAnimation = buffer.readUInt16LE(offset);
    offset += 2;
    o.ubPendingStanceChange = buffer.readUInt8(offset++);
    offset++; // padding
    o.usAnimState = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    offset += 3; // padding
    o.UpdateCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.DamageCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.ReloadCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.FlashSelCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.AICounter = buffer.readInt32LE(offset);
    offset += 4;
    o.FadeCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.ubSkillTrait1 = buffer.readUInt8(offset++);
    o.ubSkillTrait2 = buffer.readUInt8(offset++);
    offset += 2; // padding
    o.uiAIDelay = buffer.readUInt32LE(offset);
    offset += 4;
    o.bDexterity = buffer.readInt8(offset++);
    o.bWisdom = buffer.readInt8(offset++);
    o.sReloadDelay = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.sInsertionGridNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.usAniCode = buffer.readUInt16LE(offset);
    offset += 2;
    o.usAniFrame = buffer.readUInt16LE(offset);
    offset += 2;
    o.sAniDelay = buffer.readInt16LE(offset);
    offset += 2;
    o.bAgility = buffer.readInt8(offset++);
    o.ubDelayedMovementCauseMerc = buffer.readUInt8(offset++);
    o.sDelayedMovementCauseGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sReservedMovementGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.bStrength = buffer.readInt8(offset++);
    o.fHoldAttackerUntilDone = Boolean(buffer.readUInt8(offset++));
    o.sTargetGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.bTargetLevel = buffer.readInt8(offset++);
    o.bTargetCubeLevel = buffer.readInt8(offset++);
    o.sLastTarget = buffer.readInt16LE(offset);
    offset += 2;
    o.bTilesMoved = buffer.readInt8(offset++);
    o.bLeadership = buffer.readInt8(offset++);
    o.dNextBleed = buffer.readFloatLE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.usLastMovementAnimPerRTBreathUpdate = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.sLocatorFrame = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset += 2; // padding
    o.iFaceIndex = buffer.readInt32LE(offset);
    offset += 4;
    o.HeadPal = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.PantsPal = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.VestPal = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.SkinPal = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    o.MiscPal = readStringNL(buffer, "ascii", offset, offset + 30);
    offset += 30;
    ...
    offset += 4; // pointer
    o.pShades.fill(<Uint16Array>(<unknown>null));
    offset += 4 * NUM_SOLDIER_SHADES; // pointers
    o.pGlowShades.fill(<Uint16Array>(<unknown>null));
    offset += 4 * 20; // pointers
    o.pCurrentShade = <Uint16Array>(<unknown>null);
    offset += 4; // pointer
    ...
    offset++; // padding
    o.sDestXPos = buffer.readInt16LE(offset);
    offset += 2;
    o.sDestYPos = buffer.readInt16LE(offset);
    offset += 2;
    o.sDesiredDest = buffer.readInt16LE(offset);
    offset += 2;
    o.sDestination = buffer.readInt16LE(offset);
    offset += 2;
    o.sFinalDestination = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.usPathDataSize = buffer.readUInt16LE(offset);
    offset += 2;
    o.usPathIndex = buffer.readUInt16LE(offset);
    offset += 2;
    o.sBlackList = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.pZBackground = null;
    offset += 4; // pointer
    o.usUnblitX = buffer.readUInt16LE(offset);
    offset += 2;
    o.usUnblitY = buffer.readUInt16LE(offset);
    offset += 2;
    o.usUnblitWidth = buffer.readUInt16LE(offset);
    offset += 2;
    o.usUnblitHeight = buffer.readUInt16LE(offset);
    offset += 2;
    o.ubStrategicInsertionCode = buffer.readUInt8(offset++);
    offset++; // padding
    o.usStrategicInsertionData = buffer.readUInt16LE(offset);
    offset += 2;
    o.iLight = buffer.readInt32LE(offset);
    offset += 4;
    o.iMuzFlash = buffer.readInt32LE(offset);
    offset += 4;
    o.bMuzFlashCount = buffer.readInt8(offset++);
    offset++; // padding
    o.sX = buffer.readInt16LE(offset);
    offset += 2;
    o.sY = buffer.readInt16LE(offset);
    offset += 2;
    o.usOldAniState = buffer.readUInt16LE(offset);
    offset += 2;
    o.sOldAniCode = buffer.readInt16LE(offset);
    offset += 2;
    o.bBulletsLeft = buffer.readInt8(offset++);
    o.ubSuppressionPoints = buffer.readUInt8(offset++);
    o.uiTimeOfLastRandomAction = buffer.readUInt32LE(offset);
    offset += 4;
    o.usLastRandomAnim = buffer.readInt16LE(offset);
    offset += 2;
    offset = readIntArray(o.bOppList, buffer, offset, 1);
    o.bLastAction = buffer.readInt8(offset++);
    o.bAction = buffer.readInt8(offset++);
    o.usActionData = buffer.readUInt16LE(offset);
    offset += 2;
    o.bNextAction = buffer.readInt8(offset++);
    offset++; // padding
    o.usNextActionData = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.sNoiseGridno = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.dHeightAdjustment = buffer.readFloatLE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.uiPendingActionData1 = buffer.readUInt32LE(offset);
    offset += 4;
    o.sPendingActionData2 = buffer.readInt16LE(offset);
    offset += 2;
    o.bPendingActionData3 = buffer.readInt8(offset++);
    o.ubDoorHandleCode = buffer.readInt8(offset++);
    o.uiPendingActionData4 = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.sCallerGridNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.usAnimSurface = buffer.readUInt16LE(offset);
    offset += 2;
    o.sZLevel = buffer.readUInt16LE(offset);
    offset += 2;
    o.fPrevInWater = Boolean(buffer.readUInt8(offset++));
    o.fGoBackToAimAfterHit = Boolean(buffer.readUInt8(offset++));
    o.sWalkToAttackGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sWalkToAttackWalkToCost = buffer.readInt16LE(offset);
    offset += 2;
    o.fForceRenderColor = Boolean(buffer.readUInt8(offset++));
    o.fForceNoRenderPaletteCycle = Boolean(buffer.readUInt8(offset++));
    o.sLocatorOffX = buffer.readInt16LE(offset);
    offset += 2;
    o.sLocatorOffY = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.sDamage = buffer.readInt16LE(offset);
    offset += 2;
    o.sDamageX = buffer.readInt16LE(offset);
    offset += 2;
    o.sDamageY = buffer.readInt16LE(offset);
    offset += 2;
    o.bDamageDir = buffer.readInt8(offset++);
    o.bDoBurst = buffer.readInt8(offset++);
    o.usUIMovementMode = buffer.readInt16LE(offset);
    offset += 2;
    o.bUIInterfaceLevel = buffer.readInt8(offset++);
    o.fUIMovementFast = Boolean(buffer.readUInt8(offset++));
    offset += 2; // padding
    o.BlinkSelCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.PortraitFlashCounter = buffer.readInt32LE(offset);
    offset += 4;
    ...
    o.sPanelFaceX = buffer.readInt16LE(offset);
    offset += 2;
    o.sPanelFaceY = buffer.readInt16LE(offset);
    offset += 2;
    o.bNumHitsThisTurn = buffer.readInt8(offset++);
    offset++; // padding
    o.usQuoteSaidFlags = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.uiAnimSubFlags = buffer.readUInt32LE(offset);
    offset += 4;
    o.bAimShotLocation = buffer.readUInt8(offset++);
    o.ubHitLocation = buffer.readUInt8(offset++);
    offset += 2; // padding
    o.pEffectShades.fill(<Uint16Array>(<unknown>null));
    offset += 4 * NUM_SOLDIER_EFFECTSHADES; // pointers
    o.ubPlannedUIAPCost = buffer.readUInt8(offset++);
    offset++; // padding
    o.sPlannedTargetX = buffer.readInt16LE(offset);
    offset += 2;
    o.sPlannedTargetY = buffer.readInt16LE(offset);
    offset += 2;
    offset = readIntArray(o.sSpreadLocations, buffer, offset, 2);
    o.fDoSpread = buffer.readUInt8(offset++);
    offset++; // padding
    o.sStartGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sEndGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.sForcastGridno = buffer.readInt16LE(offset);
    offset += 2;
    o.sZLevelOverride = buffer.readInt16LE(offset);
    offset += 2;
    o.bMovedPriorToInterrupt = Boolean(buffer.readUInt8(offset++));
    offset += 3; // padding
    o.iEndofContractTime = buffer.readInt32LE(offset);
    offset += 4;
    o.iStartContractTime = buffer.readInt32LE(offset);
    offset += 4;
    o.iTotalContractLength = buffer.readInt32LE(offset);
    offset += 4;
    o.iNextActionSpecialData = buffer.readInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.sSectorX = buffer.readInt16LE(offset);
    offset += 2;
    o.sSectorY = buffer.readInt16LE(offset);
    offset += 2;
    o.bSectorZ = buffer.readInt8(offset++);
    offset++; // padding
    o.iVehicleId = buffer.readInt32LE(offset);
    offset += 4;
    o.pMercPath = <PathSt>(<unknown>null);
    offset += 4; // pointer
    o.fHitByGasFlags = buffer.readUInt8(offset++);
    offset++; // padding
    o.usMedicalDeposit = buffer.readUInt16LE(offset);
    offset += 2;
    o.usLifeInsurance = buffer.readUInt16LE(offset);
    offset += 2;
    offset += 2; // padding
    o.uiStartMovementTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiOptimumMovementTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.usLastUpdateTime = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.uiSoldierUpdateNumber = buffer.readUInt32LE(offset);
    offset += 4;
    o.ubSoldierUpdateType = buffer.readUInt8(offset++);
    offset += 3; // padding
    o.iStartOfInsuranceContract = buffer.readInt32LE(offset);
    offset += 4;
    o.uiLastAssignmentChangeMin = buffer.readUInt32LE(offset);
    offset += 4;
    o.iTotalLengthOfInsuranceContract = buffer.readInt32LE(offset);
    offset += 4;
    ...
    o.usPendingAnimation2 = buffer.readUInt16LE(offset);
    offset += 2;
    o.ubCivilianGroup = buffer.readUInt8(offset++);
    offset += 3; // padding
    o.uiChangeLevelTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeHealthTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeStrengthTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeDexterityTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeAgilityTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeWisdomTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeLeadershipTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeMarksmanshipTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeExplosivesTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeMedicalTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiChangeMechanicalTime = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiUniqueSoldierIdValue = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.sAbsoluteFinalDestination = buffer.readInt16LE(offset);
    offset += 2;
    ...
    offset++; // padding
    o.sOldGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.usDontUpdateNewGridNoOnMoveAnimChange = buffer.readUInt16LE(offset);
    offset += 2;
    o.sBoundingBoxWidth = buffer.readInt16LE(offset);
    offset += 2;
    o.sBoundingBoxHeight = buffer.readInt16LE(offset);
    offset += 2;
    o.sBoundingBoxOffsetX = buffer.readInt16LE(offset);
    offset += 2;
    o.sBoundingBoxOffsetY = buffer.readInt16LE(offset);
    offset += 2;
    o.uiTimeSameBattleSndDone = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.iBurstSoundID = buffer.readInt32LE(offset);
    offset += 4;
    ...
    offset++; // padding
    o.uiTimeOfLastContractUpdate = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.usQuoteSaidExtFlags = buffer.readUInt16LE(offset);
    offset += 2;
    o.sContPathLocation = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.sSkillCheckGridNo = buffer.readInt16LE(offset);
    offset += 2;
    ...
    o.PanelAnimateCounter = buffer.readInt32LE(offset);
    offset += 4;
    o.uiMercChecksum = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.sLocationOfFadeStart = buffer.readInt16LE(offset);
    offset += 2;
    o.bUseExitGridForReentryDirection = Boolean(buffer.readUInt8(offset++));
    offset++; // padding
    o.uiTimeSinceLastSpoke = buffer.readUInt32LE(offset);
    offset += 4;
    o.ubContractRenewalQuoteCode = buffer.readUInt8(offset++);
    offset++; // padding
    o.sPreTraversalGridNo = buffer.readInt16LE(offset);
    offset += 2;
    o.uiXRayActivatedTime = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.uiTimeSoldierWillArrive = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.iTimeCanSignElsewhere = buffer.readInt32LE(offset);
    offset += 4;
    o.bHospitalPriceModifier = buffer.readInt8(offset++);
    offset = readIntArray(o.bFillerBytes, buffer, offset, 1);
    o.uiStartTimeOfInsuranceContract = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.iPositionSndID = buffer.readInt32LE(offset);
    offset += 4;
    o.iTuringSoundID = buffer.readUInt32LE(offset);
    offset += 4;
    ...
    o.bFillerDude = buffer.readInt16LE(offset);
    offset += 2;
    o.uiTimeSinceLastBleedGrunt = buffer.readInt32LE(offset);
    offset += 4;
  ...
  export function writeSoldierType(
    o: SOLDIERTYPE,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    offset = buffer.writeUInt16LE(
      o.usLastMovementAnimPerRTBreathUpdate,
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      Number(o.fChangingStanceDueToSuppression),
      offset,
    );
    ...
    offset = buffer.writeUInt16LE(
      o.usDontUpdateNewGridNoOnMoveAnimChange,
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      Number(o.fDoneAssignmentAndNothingToDoFlag),
      offset,
    );
    ...
    offset = buffer.writeUInt8(
      Number(o.bUseExitGridForReentryDirection),
      offset,
    );
    offset = writePadding(buffer, offset, 1); // padding
  ...
  export const PTR_CIVILIAN = (pSoldier: SOLDIERTYPE) =>
    pSoldier.bTeam == CIV_TEAM;
  export const PTR_CROUCHED = (pSoldier: SOLDIERTYPE) =>
    gAnimControl[pSoldier.usAnimState].ubHeight == ANIM_CROUCH;
  export const PTR_STANDING = (pSoldier: SOLDIERTYPE) =>
    gAnimControl[pSoldier.usAnimState].ubHeight == ANIM_STAND;
  const PTR_PRONE = (pSoldier: SOLDIERTYPE) =>
