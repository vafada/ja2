...
*/
  ...
  let guiDifficultySettingsToggles: UINT32[] /* [NUM_DIFF_SETTINGS] */ =
    createArray(Enum3.NUM_DIFF_SETTINGS, 0);

  // checkbox to toggle Game style
  let guiGameStyleToggles: UINT32[] /* [NUM_GAME_STYLES] */ = createArray(
    Enum4.NUM_GAME_STYLES,
    0,
  );

  // checkbox to toggle Gun options
  let guiGunOptionToggles: UINT32[] /* [NUM_GUN_OPTIONS] */ = createArray(
    Enum5.NUM_GUN_OPTIONS,
    0,
  );
...
*/
  ...
  let guiGameSaveToggles: UINT32[] /* [NUM_SAVE_OPTIONS] */ = createArray(
    Enum6.NUM_SAVE_OPTIONS,
    0,
  );
  ...
  function EnterGIOScreen(): boolean {
    ...
    VObjectDesc.ImageFile = FilenameForBPP(
      "InterFace\\OptionsScreenBackGround.sti",
    );
    ...
    // Ok button
    giGIODoneBtnImage = LoadButtonImage(
      "INTERFACE\\PreferencesButtons.sti",
      -1,
      0,
      -1,
      2,
    ...
    guiGIODoneButton = CreateIconAndTextButton(
      giGIODoneBtnImage,
      gzGIOScreenText[Enum375.GIO_OK_TEXT],
      OPT_BUTTON_FONT(),
      OPT_BUTTON_ON_COLOR,
      DEFAULT_SHADOW,
    ...
    // Cancel button
    giGIOCancelBtnImage = UseLoadedButtonImage(
      giGIODoneBtnImage,
      -1,
      1,
      -1,
    ...
    guiGIOCancelButton = CreateIconAndTextButton(
      giGIOCancelBtnImage,
      gzGIOScreenText[Enum375.GIO_CANCEL_TEXT],
      OPT_BUTTON_FONT(),
      OPT_BUTTON_ON_COLOR,
      DEFAULT_SHADOW,
      OPT_BUTTON_OFF_COLOR,
    ...
    for (cnt = 0; cnt < Enum3.NUM_DIFF_SETTINGS; cnt++) {
      guiDifficultySettingsToggles[cnt] = CreateCheckBoxButton(
        GIO_DIF_SETTINGS_X + GIO_OFFSET_TO_TOGGLE_BOX,
        usPosY,
    ...
    if (gGameOptions.ubDifficultyLevel == Enum9.DIF_LEVEL_EASY)
      ButtonList[guiDifficultySettingsToggles[Enum3.GIO_DIFF_EASY]].uiFlags |=
        BUTTON_CLICKED_ON;
    else if (gGameOptions.ubDifficultyLevel == Enum9.DIF_LEVEL_MEDIUM)
      ButtonList[guiDifficultySettingsToggles[Enum3.GIO_DIFF_MED]].uiFlags |=
        BUTTON_CLICKED_ON;
    else if (gGameOptions.ubDifficultyLevel == Enum9.DIF_LEVEL_HARD)
      ButtonList[guiDifficultySettingsToggles[Enum3.GIO_DIFF_HARD]].uiFlags |=
        BUTTON_CLICKED_ON;
    else
      ButtonList[guiDifficultySettingsToggles[Enum3.GIO_DIFF_MED]].uiFlags |=
        BUTTON_CLICKED_ON;
    ...
    for (cnt = 0; cnt < Enum4.NUM_GAME_STYLES; cnt++) {
      guiGameStyleToggles[cnt] = CreateCheckBoxButton(
        GIO_GAME_SETTINGS_X + GIO_OFFSET_TO_TOGGLE_BOX,
        usPosY,
        "INTERFACE\\OptionsCheck.sti",
        MSYS_PRIORITY_HIGH + 10,
    ...
    if (gGameOptions.fSciFi)
      ButtonList[guiGameStyleToggles[Enum4.GIO_SCI_FI]].uiFlags |=
        BUTTON_CLICKED_ON;
    else
      ButtonList[guiGameStyleToggles[Enum4.GIO_REALISTIC]].uiFlags |=
        BUTTON_CLICKED_ON;
    ...
    for (cnt = 0; cnt < Enum6.NUM_SAVE_OPTIONS; cnt++) {
      guiGameSaveToggles[cnt] = CreateCheckBoxButton(
        GIO_IRON_MAN_SETTING_X + GIO_OFFSET_TO_TOGGLE_BOX,
        usPosY,
        "INTERFACE\\OptionsCheck.sti",
        MSYS_PRIORITY_HIGH + 10,
    ...
    if (gGameOptions.fIronManMode)
      ButtonList[guiGameSaveToggles[Enum6.GIO_IRON_MAN]].uiFlags |=
        BUTTON_CLICKED_ON;
    else
      ButtonList[guiGameSaveToggles[Enum6.GIO_CAN_SAVE]].uiFlags |=
        BUTTON_CLICKED_ON;
    ...
    for (cnt = 0; cnt < Enum5.NUM_GUN_OPTIONS; cnt++) {
      guiGunOptionToggles[cnt] = CreateCheckBoxButton(
        GIO_GUN_SETTINGS_X + GIO_OFFSET_TO_TOGGLE_BOX,
        usPosY,
        "INTERFACE\\OptionsCheck.sti",
        MSYS_PRIORITY_HIGH + 10,
    ...
    if (gGameOptions.fGunNut)
      ButtonList[guiGunOptionToggles[Enum5.GIO_GUN_NUT]].uiFlags |=
        BUTTON_CLICKED_ON;
    else
      ButtonList[guiGunOptionToggles[Enum5.GIO_REDUCED_GUNS]].uiFlags |=
        BUTTON_CLICKED_ON;
  ...
  */
  ...
  function RenderGIOScreen(): boolean {
    ...
    // Display the title
    DrawTextToScreen(
      gzGIOScreenText[Enum375.GIO_INITIAL_GAME_SETTINGS],
      GIO_MAIN_TITLE_X,
      GIO_MAIN_TITLE_Y,
    ...
    DisplayWrappedString(
      GIO_DIF_SETTINGS_X,
      GIO_DIF_SETTINGS_Y - GIO_GAP_BN_SETTINGS,
      GIO_DIF_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_DIF_LEVEL_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_DIF_SETTINGS_X + GIO_OFFSET_TO_TEXT,
      usPosY,
      GIO_DIF_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_EASY_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_MEDIUM_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_HARD_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_GAME_SETTINGS_X,
      GIO_GAME_SETTINGS_Y - GIO_GAP_BN_SETTINGS,
      GIO_GAME_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_GAME_STYLE_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_GAME_SETTINGS_X + GIO_OFFSET_TO_TEXT,
      usPosY,
      GIO_GAME_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_REALISTIC_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_SCI_FI_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_GUN_SETTINGS_X,
      GIO_GUN_SETTINGS_Y - GIO_GAP_BN_SETTINGS,
      GIO_GUN_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_GUN_OPTIONS_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_GUN_SETTINGS_X + GIO_OFFSET_TO_TEXT,
      usPosY,
      GIO_GUN_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_REDUCED_GUNS_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      ...
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_GUN_NUT_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
  ...
  */
    ...
    DisplayWrappedString(
      GIO_IRON_MAN_SETTING_X,
      GIO_IRON_MAN_SETTING_Y - GIO_GAP_BN_SETTINGS,
      GIO_DIF_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
      GIO_TOGGLE_TEXT_COLOR,
      gzGIOScreenText[Enum375.GIO_GAME_SAVE_STYLE_TEXT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
    ...
    DisplayWrappedString(
      GIO_IRON_MAN_SETTING_X + GIO_OFFSET_TO_TEXT,
      usPosY,
      GIO_DIF_SETTINGS_WIDTH,
      2,
      GIO_TOGGLE_TEXT_FONT(),
    ...
    DisplayWrappedString(
      ...
      FONT12ARIAL(),
      GIO_TOGGLE_TEXT_COLOR,
      zNewTacticalMessages[Enum320.TCTL_MSG__CANNOT_SAVE_DURING_COMBAT],
      FONT_MCOLOR_BLACK,
      false,
      LEFT_JUSTIFIED,
    );
  ...
  function BtnDifficultyTogglesCallback(btn: GUI_BUTTON, reason: INT32): void {
    if (reason & MSYS_CALLBACK_REASON_LBUTTON_UP) {
      ...
      if (btn.uiFlags & BUTTON_CLICKED_ON) {
        ...
        for (cnt = 0; cnt < Enum3.NUM_DIFF_SETTINGS; cnt++) {
          ButtonList[guiDifficultySettingsToggles[cnt]].uiFlags &=
            ~BUTTON_CLICKED_ON;
        }
