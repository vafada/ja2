namespace ja2 {
  ...
  export function copyNPCQuoteInfo(
    destination: NPCQuoteInfo,
    source: NPCQuoteInfo,
  ) {
  ...
  export function readNPCQuoteInfo(
    o: NPCQuoteInfo,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.fFlags = buffer.readUInt16LE(offset);
    offset += 2;
    o.sRequiredItem = buffer.readInt16LE(offset);
    offset += 2;
    o.usFactMustBeTrue = buffer.readUInt16LE(offset);
    offset += 2;
    o.usFactMustBeFalse = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.usSetFactTrue = buffer.readUInt16LE(offset);
    offset += 2;
    o.usGiftItem = buffer.readUInt16LE(offset);
    offset += 2;
    o.usGoToGridno = buffer.readUInt16LE(offset);
    offset += 2;
    o.sActionData = buffer.readInt16LE(offset);
    offset += 2;
    offset = readUIntArray(o.ubUnused, buffer, offset, 1);
    return offset;
  }

  export function writeNPCQuoteInfo(
    o: NPCQuoteInfo,
    buffer: Buffer,
    offset: number = 0,
  ): number {
