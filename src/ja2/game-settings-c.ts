namespace ja2 {
  ...
  export function LoadGameSettings(): boolean {
    ...
    if (
      !FileExists(GAME_SETTINGS_FILE) ||
      FileSize(GAME_SETTINGS_FILE) != GAME_SETTINGS_SIZE
    ) {
    ...
    if (
      ...
      gGameSettings.bLastSavedGameSlot >= NUM_SAVE_GAMES
    )
    ...
    if (
      ...
      !gGameSettings.fOptions[Enum8.TOPTION_SPEECH]
    ) {
  ...
  export function DisplayGameSettings(): void {
    ...
    ScreenMsg(
      ...
      gzGIOScreenText[
        gGameOptions.ubDifficultyLevel + Enum375.GIO_EASY_TEXT - 1
      ],
    );
    ...
    ScreenMsg(
      ...
      gzGIOScreenText[
        Enum375.GIO_SAVE_ANYWHERE_TEXT + Number(gGameOptions.fIronManMode)
      ],
    );
    ...
    ScreenMsg(
      ...
      gzGIOScreenText[Enum375.GIO_REALISTIC_TEXT + Number(gGameOptions.fSciFi)],
    );
