namespace ja2 {
  ...
  export function AddStandardVideoSurface(
    pVSurfaceDesc: VSURFACE_DESC,
  ): UINT32 {
  ...
  export function LockVideoSurface(
    uiVSurface: UINT32,
    puiPitch: Pointer<UINT32>,
  ): Uint8ClampedArray {
    let curr: VSURFACE_NODE | null;
  ...
  export function SetVideoSurfaceTransparency(
    uiIndex: UINT32,
    TransColor: COLORVAL,
  ): boolean {
    let hVSurface: SGPVSurface;
  ...
  export function BltVideoSurface(
    uiDestVSurface: UINT32,
    uiSrcVSurface: UINT32,
    usRegionIndex: UINT16,
    iDestX: INT32,
    iDestY: INT32,
    fBltFlags: UINT32,
    pBltFx: blt_vs_fx | null,
  ): boolean {
  ...
  export function ColorFillVideoSurfaceArea(
    uiDestVSurface: UINT32,
    iDestX1: INT32,
    iDestY1: INT32,
    iDestX2: INT32,
  ...
  export function ImageFillVideoSurfaceArea(
    uiDestVSurface: UINT32,
    iDestX1: INT32,
    iDestY1: INT32,
    iDestX2: INT32,
    iDestY2: INT32,
    BkgrndImg: SGPVObject,
    Index: UINT16,
    Ox: INT16,
    Oy: INT16,
  ): boolean {
  ...
  export function CreateVideoSurface(VSurfaceDesc: VSURFACE_DESC): SGPVSurface {
    ...
    hVSurface.pSurfaceData = new Uint8ClampedArray(
      usHeight * usWidth * (ubBitDepth === 16 ? 4 : 1),
    );
    ...
    hVSurface.pSavedSurfaceData1 = <Uint8ClampedArray>(<unknown>null);
    hVSurface.pSavedSurfaceData = new Uint8ClampedArray(
      usHeight * usWidth * (ubBitDepth === 16 ? 4 : 1),
    );
    ...
    giMemUsedInSurfaces +=
      hVSurface.usHeight * hVSurface.usWidth * (hVSurface.ubBitDepth / 8);

    DbgMessage(
      TOPIC_VIDEOSURFACE,
      DBG_LEVEL_3,
      FormatString("Success in Creating Video Surface"),
    );
  ...
  function LockVideoSurfaceBuffer(
    hVSurface: SGPVSurface,
    pPitch: Pointer<UINT32>,
  ): Uint8ClampedArray {
    Assert(hVSurface != null);
    Assert(pPitch != null);
  ...
  function SetVideoSurfaceDataFromHImage(
    hVSurface: SGPVSurface,
    hImage: ImageType,
    usX: UINT16,
    usY: UINT16,
    ...
    if (
      ...
      DbgMessage(
        TOPIC_VIDEOSURFACE,
        DBG_LEVEL_2,
        FormatString("Error Occured Copying HIMAGE to HVSURFACE"),
      );
  ...
  export function SetVideoSurfacePalette(
    hVSurface: SGPVSurface,
    ...
    DbgMessage(
      TOPIC_VIDEOSURFACE,
      DBG_LEVEL_3,
      FormatString("Video Surface Palette change successfull"),
    );
    return true;
  }
  ...
  // colorkey value.
  function SetVideoSurfaceTransparencyColor(
    hVSurface: SGPVSurface,
    TransColor: COLORVAL,
  ): boolean {
    // Assertions
  ...
  export function GetVSurfacePaletteEntries(
    hVSurface: SGPVSurface,
  ...
  export function BltVideoSurfaceToVideoSurface(
    hDestVSurface: SGPVSurface,
    ...
    if (fBltFlags & VS_BLT_SRCREGION && fBltFlags & VS_BLT_SRCSUBRECT) {
      DbgMessage(
        TOPIC_VIDEOSURFACE,
        DBG_LEVEL_2,
        FormatString("Inconsistant blit flags given"),
      );
      return false;
    }
    ...
    do {
      ...
      if (hDestVSurface.usHeight < hSrcVSurface.usHeight) {
        DbgMessage(
          TOPIC_VIDEOSURFACE,
          DBG_LEVEL_2,
          FormatString("Incompatible height size given in Video Surface blit"),
        );
        return false;
      }
    ...
    if (iDestX + uiWidth < DestRect.left) return false;
    if (iDestY + uiHeight < DestRect.top) return false;
    ...
    if (hDestVSurface.ubBitDepth == 16 && hSrcVSurface.ubBitDepth == 16) {
      if (fBltFlags & VS_BLT_MIRROR_Y) {
        if (
          (pSrcSurface16 = LockVideoSurfaceBuffer(
            hSrcVSurface,
            createPointer(
              () => uiSrcPitch,
              (v) => (uiSrcPitch = v),
          ...
          DbgMessage(
            TOPIC_VIDEOSURFACE,
            DBG_LEVEL_2,
            FormatString("Failed on lock of 16BPP surface for blitting"),
          );
          return false;
        }

        if (
          (pDestSurface16 = LockVideoSurfaceBuffer(
            hDestVSurface,
            createPointer(
              () => uiDestPitch,
              (v) => (uiDestPitch = v),
          ...
          DbgMessage(
            TOPIC_VIDEOSURFACE,
            DBG_LEVEL_2,
            FormatString("Failed on lock of 16BPP dest surface for blitting"),
          );
          return false;
        }
      ...
      if (
        (pSrcSurface8 = LockVideoSurfaceBuffer(
          hSrcVSurface,
          createPointer(
            () => uiSrcPitch,
            (v) => (uiSrcPitch = v),
        ...
        DbgMessage(
          TOPIC_VIDEOSURFACE,
          DBG_LEVEL_2,
          FormatString("Failed on lock of 8BPP surface for blitting"),
        );
        return false;
      }

      if (
        (pDestSurface8 = LockVideoSurfaceBuffer(
          hDestVSurface,
          createPointer(
            () => uiDestPitch,
            (v) => (uiDestPitch = v),
        ...
        DbgMessage(
          TOPIC_VIDEOSURFACE,
          DBG_LEVEL_2,
          FormatString("Failed on lock of 8BPP dest surface for blitting"),
        );
        return false;
      }
      ...
      DbgMessage(
        ...
        DBG_LEVEL_2,
        FormatString(
          "Incompatible BPP values with src and dest Video Surfaces for blitting",
        ),
      );
      return false;
    }
  ...
  export function GetVideoSurfaceDDSurface(
    hVSurface: HVSURFACE,
  ): Uint8ClampedArray {
    Assert(hVSurface != null);
  ...
  function CreateVideoSurfaceFromDDSurface(
    lpDDSurface: ImageData,
  ): SGPVSurface {
    // Create Video Surface
    let hVSurface: SGPVSurface;
    let SGPPalette: SGPPaletteEntry[] /* [256] */ = createArrayFrom(
      256,
    ...
    DbgMessage(
      TOPIC_VIDEOSURFACE,
      DBG_LEVEL_0,
      FormatString("Success in Creating Video Surface from DD Surface"),
    );
  ...
  function ClipReleatedSrcAndDestRectangles(
    hDestVSurface: SGPVSurface,
    hSrcVSurface: SGPVSurface,
    DestRect: RECT,
    SrcRect: RECT,
    ...
    if (
      DestRect.left >= hDestVSurface.usWidth ||
      DestRect.top >= hDestVSurface.usHeight
    ) {
      return false;
    }

    if (
      SrcRect.left >= hSrcVSurface.usWidth ||
      SrcRect.top >= hSrcVSurface.usHeight
    ) {
      return false;
    }
  ...
  function FillSurface(
    ...
    if (
      hDestVSurface.fFlags & VSURFACE_VIDEO_MEM_USAGE &&
  ...
  export function BltVSurfaceUsingDD(
    hDestVSurface: SGPVSurface,
    hSrcVSurface: SGPVSurface,
    fBltFlags: UINT32,
    iDestX: INT32,
    ...
    if (fBltFlags & VS_BLT_FAST) {
      ...
      if (fBltFlags & VS_BLT_USECOLORKEY) {
        ...
        for (let y = top; y < bottom; y++) {
          for (let x = left; x < right; x++) {
            const rgb = FROMRGB(
              srcSurfaceData[srcIndex],
              srcSurfaceData[srcIndex + 1],
              srcSurfaceData[srcIndex + 2],
            );
  ...
  function InternalShadowVideoSurfaceRect(
    uiDestVSurface: UINT32,
    X1: INT32,
    Y1: INT32,
    X2: INT32,
    Y2: INT32,
    fLowPercentShadeTable: boolean,
  ): boolean {
  ...
  export function ShadowVideoSurfaceRect(
    uiDestVSurface: UINT32,
    X1: INT32,
    Y1: INT32,
    X2: INT32,
    ...
    return InternalShadowVideoSurfaceRect(
      uiDestVSurface,
      X1,
      Y1,
      X2,
  ...
  export function ShadowVideoSurfaceRectUsingLowPercentTable(
    uiDestVSurface: UINT32,
    X1: INT32,
    Y1: INT32,
    X2: INT32,
  ...
  function BltVSurfaceUsingDDBlt(
    hDestVSurface: SGPVSurface,
    hSrcVSurface: SGPVSurface,
    fBltFlags: UINT32,
    iDestX: INT32,
  ...
  //
  export function BltStretchVideoSurface(
    uiDestVSurface: UINT32,
    uiSrcVSurface: UINT32,
    iDestX: INT32,
    iDestY: INT32,
  ...
  export function ShadowVideoSurfaceImage(
    uiDestVSurface: UINT32,
    hImageHandle: SGPVObject,
    iPosX: INT32,
    iPosY: INT32,
  ): boolean {
    // Horizontal shadow
    ShadowVideoSurfaceRect(
      uiDestVSurface,
      iPosX + 3,
      iPosY + hImageHandle.pETRLEObject[0].usHeight,
      iPosX + hImageHandle.pETRLEObject[0].usWidth,
      iPosY + hImageHandle.pETRLEObject[0].usHeight + 3,
    );
    ...
    ShadowVideoSurfaceRect(
      ...
      iPosX + hImageHandle.pETRLEObject[0].usWidth,
      iPosY + 3,
      iPosX + hImageHandle.pETRLEObject[0].usWidth + 3,
      iPosY + hImageHandle.pETRLEObject[0].usHeight,
    );
    return true;
  }

  function MakeVSurfaceFromVObject(
    uiVObject: UINT32,
    usSubIndex: UINT16,
    puiVSurface: Pointer<UINT32>,
  ): boolean {
    ...
    if ((hSrcVObject = GetVideoObject(uiVObject))) {
      ...
      if ((uiVSurface = AddVideoSurface(hDesc)) !== -1) {
        if (
          ...
          return true;
        } else DeleteVideoSurfaceFromIndex(uiVSurface);
      }
    }
  ...
  function copyRow(
    destSurfaceData: Uint8ClampedArray,
    destIndex: number,
    destWidth: number,
    srcSurfaceData: Uint8ClampedArray,
    srcIndex: number,
    srcWidth: number,
  ) {
    let pos = 0x10000;
  ...
  function DDBltSurface(
    ...
    let destIndex =
      hDestVSurface.usWidth * DestRect.top * 4 + DestRect.left * 4;
    let destLineSkip = hDestVSurface.usWidth * 4 - (right - left) * 4;
