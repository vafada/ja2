namespace ja2 {
  ...
  export type MOUSE_CALLBACK = (
    mouseRegion: MOUSE_REGION,
    reason: INT32,
  ) => void; // Define MOUSE_CALLBACK type as pointer to void
  ...
  export function createMouseRegionFrom(
    IDNumber: UINT16,
    PriorityLevel: INT8,
    uiFlags: UINT32,
    RegionTopLeftX: INT16,
    RegionTopLeftY: INT16,
    RegionBottomRightX: INT16,
    RegionBottomRightY: INT16,
    MouseXPos: INT16,
    ...
    ButtonState: UINT16,
    Cursor: UINT16,
    MovementCallback: MOUSE_CALLBACK | null,
    ButtonCallback: MOUSE_CALLBACK | null,
    UserData: INT32[] /* [4] */,
    FastHelpTimer: INT16,
    FastHelpText: string /* Pointer<UINT16> */,
    FastHelpRect: INT32,
    HelpDoneCallback: MOUSE_HELPTEXT_DONE_CALLBACK | null,
    next: MOUSE_REGION | null,
    prev: MOUSE_REGION | null,
  ): MOUSE_REGION {
    return {
      IDNumber,
  ...
  export const MSYS_DO_BUTTONS =
    MSYS_DO_LBUTTON_DWN |
    MSYS_DO_LBUTTON_UP |
    MSYS_DO_RBUTTON_DWN |
    MSYS_DO_RBUTTON_UP |
    MSYS_DO_RBUTTON_REPEAT |
    MSYS_DO_LBUTTON_REPEAT;
  ...
  const MSYS_CALLBACK_REASON_BUTTONS =
    MSYS_CALLBACK_REASON_LBUTTON_DWN |
    MSYS_CALLBACK_REASON_LBUTTON_UP |
    MSYS_CALLBACK_REASON_RBUTTON_DWN |
