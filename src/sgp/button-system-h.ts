namespace ja2 {
  ...
  export const BUTTON_TYPES =
    BUTTON_QUICK | BUTTON_GENERIC | BUTTON_HOT_SPOT | BUTTON_CHECKBOX;
  // effects how the button is processed
  export const BUTTON_TYPE_MASK =
    BUTTON_NO_TOGGLE |
    BUTTON_ALLOW_DISABLED_CALLBACK |
    BUTTON_CHECKBOX |
    BUTTON_IGNORE_CLICKS;
  ...
  const GetButtonPtr = (x: number) =>
    x >= 0 && x < MAX_BUTTONS ? ButtonList[x] : null;
