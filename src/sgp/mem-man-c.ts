  ...
  export function ShutdownMemoryManager(): void {
    if (MemDebugCounter != 0) {
      ...
      DbgMessage(
        ...
        DBG_LEVEL_0,
        FormatString("***** WARNING - WARNING - WARNING *****"),
      );
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
      ...
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
        FormatString("  >>>>> MEMORY LEAK DETECTED!!! <<<<<  "),
      );
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
        FormatString("%d memory blocks still allocated", MemDebugCounter),
      );
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
        FormatString("%d bytes memory total STILL allocated", guiMemTotal),
      );
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
        FormatString("%d bytes memory total was allocated", guiMemAlloced),
      );
      DbgMessage(
        TOPIC_MEMORY_MANAGER,
        DBG_LEVEL_0,
        FormatString("%d bytes memory total was freed", guiMemFreed),
      );
