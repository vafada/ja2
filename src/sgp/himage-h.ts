namespace ja2 {
  ...
  export function createSGPPaletteEntryFrom(
    peRed: UINT8,
    peGreen: UINT8,
    peBlue: UINT8,
    peFlags: UINT8,
  ...
  export function copySGPPaletteEntry(
    destination: SGPPaletteEntry,
    source: SGPPaletteEntry,
  ) {
  ...
  export function readSGPPaletteEntry(
    o: SGPPaletteEntry,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeSGPPaletteEntry(
    o: SGPPaletteEntry,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function copyAuxObjectData(
    destination: AuxObjectData,
    source: AuxObjectData,
  ) {
  ...
  export function readAuxObjectData(
    o: AuxObjectData,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    ...
    o.usTileLocIndex = buffer.readUInt16LE(offset);
    offset += 2;
  ...
  export function writeAuxObjectData(
    o: AuxObjectData,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function readRelativeTileLocation(
    o: RelTileLoc,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function writeRelativeTileLocation(
    o: RelTileLoc,
    buffer: Buffer,
    offset: number = 0,
  ): number {
  ...
  export function copyETRLEObject(
    destination: ETRLEObject,
    source: ETRLEObject,
  ) {
  ...
  export function readETRLEObject(
    o: ETRLEObject,
    buffer: Buffer,
    offset: number = 0,
  ): number {
    o.uiDataOffset = buffer.readUInt32LE(offset);
    offset += 4;
    o.uiDataLength = buffer.readUInt32LE(offset);
    offset += 4;
    o.sOffsetX = buffer.readInt16LE(offset);
    offset += 2;
    o.sOffsetY = buffer.readInt16LE(offset);
    offset += 2;
