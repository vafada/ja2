namespace ja2 {
  ...
  function copyMouseCursorBackground(
    destination: MouseCursorBackground,
    source: MouseCursorBackground,
  ) {
  ...
  /* static */ let gpDirectDrawObject: CanvasRenderingContext2D = <
  ...
  /* static */ let gpMouseCursorOriginal: ImageData = <ImageData>(
    (<unknown>null)
  );

  /* static */ let gMouseCursorBackground: MouseCursorBackground[] /* [2] */ =
    createArrayFrom(2, createMouseCursorBackground);
  ...
  let gSgpPalette: SGPPaletteEntry[] /* [256] */ = createArrayFrom(
    256,
  ...
  let gListOfDirtyRegions: SGPRect[] /* [MAX_DIRTY_REGIONS] */ =
    createArrayFrom(MAX_DIRTY_REGIONS, createSGPRect);
  let guiDirtyRegionCount: UINT32;
  let gfForceFullScreenRefresh: boolean;

  let gDirtyRegionsEx: SGPRect[] /* [MAX_DIRTY_REGIONS] */ = createArrayFrom(
    MAX_DIRTY_REGIONS,
    createSGPRect,
  );
  let gDirtyRegionsFlagsEx: UINT32[] /* [MAX_DIRTY_REGIONS] */ = createArray(
    MAX_DIRTY_REGIONS,
    0,
  );
  ...
  export function InitializeVideoManager(hInstance: HTMLElement): boolean {
    ...
    gpPrimarySurface = gpDirectDrawObject.createImageData(
      SCREEN_WIDTH,
      SCREEN_HEIGHT,
    );
    gpBackBuffer = gpDirectDrawObject.createImageData(
      SCREEN_WIDTH,
      SCREEN_HEIGHT,
    );
    ...
    gpFrameBuffer = gpDirectDrawObject.createImageData(
      SCREEN_WIDTH,
      SCREEN_HEIGHT,
    );
    ...
    gpMouseCursor = gpDirectDrawObject.createImageData(
      MAX_CURSOR_WIDTH,
      MAX_CURSOR_HEIGHT,
    );
    ...
    gpMouseCursorOriginal = gpDirectDrawObject.createImageData(
      MAX_CURSOR_WIDTH,
      MAX_CURSOR_HEIGHT,
    );
    ...
    for (uiIndex = 0; uiIndex < 1; uiIndex++) {
      ...
      gMouseCursorBackground[uiIndex].pSurface =
        gpDirectDrawObject.createImageData(MAX_CURSOR_WIDTH, MAX_CURSOR_HEIGHT);
    }
  ...
  export function InvalidateRegionEx(
    iLeft: INT32,
    iTop: INT32,
    iRight: INT32,
    iBottom: INT32,
  ...
  function InvalidateRegions(
    pArrayOfRegions: SGPRect[],
    uiRegionCount: UINT32,
  ): void {
    if (gfForceFullScreenRefresh == true) {
      //
      // There's no point in going on since we are forcing a full screen refresh
    ...
    if (guiDirtyRegionCount + uiRegionCount < MAX_DIRTY_REGIONS) {
      ...
      for (uiIndex = 0; uiIndex < uiRegionCount; uiIndex++) {
        ...
        gListOfDirtyRegions[guiDirtyRegionCount].iLeft =
          pArrayOfRegions[uiIndex].iLeft;
        gListOfDirtyRegions[guiDirtyRegionCount].iTop =
          pArrayOfRegions[uiIndex].iTop;
        gListOfDirtyRegions[guiDirtyRegionCount].iRight =
          pArrayOfRegions[uiIndex].iRight;
        gListOfDirtyRegions[guiDirtyRegionCount].iBottom =
          pArrayOfRegions[uiIndex].iBottom;
  ...
  function SetFrameBufferRefreshOverride(
    pFrameBufferRefreshOverride: (() => void) | null,
  ): void {
  ...
  /* static */ let ScrollJA2Background__StripRegions: RECT[] /* [2] */ =
    createArrayFrom(2, createRect);
  /* static */ let ScrollJA2Background__MouseRegion: RECT = createRect();
  function ScrollJA2Background(
    uiDirection: UINT32,
    sScrollXIncrement: INT16,
    sScrollYIncrement: INT16,
    pSource: ImageData,
    pDest: ImageData,
    fRenderStrip: boolean,
    uiCurrentMouseBackbuffer: UINT32,
  ): void {
    let usWidth: UINT16;
    let usHeight: UINT16;
    ...
    ScrollJA2Background__MouseRegion.left =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usLeft;
    ScrollJA2Background__MouseRegion.top =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usTop;
    ScrollJA2Background__MouseRegion.right =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usRight;
    ScrollJA2Background__MouseRegion.bottom =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usBottom;

    ScrollJA2Background__usMouseXPos =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usMouseXPos;
    ScrollJA2Background__usMouseYPos =
      gMouseCursorBackground[uiCurrentMouseBackbuffer].usMouseYPos;
    ...
    switch (uiDirection) {
      case SCROLL_LEFT:
        ...
        ScrollJA2Background__Region.bottom =
          gsVIEWPORT_WINDOW_START_Y + usHeight;

        BltFastDDSurfaceUsingSoftware(
          pDest,
          sScrollXIncrement,
          gsVIEWPORT_WINDOW_START_Y,
          pSource,
          ScrollJA2Background__Region,
          DDBLTFAST_NOCOLORKEY,
        );

        // memset z-buffer
        for (
          uiCountY = gsVIEWPORT_WINDOW_START_Y;
          uiCountY < gsVIEWPORT_WINDOW_END_Y;
          uiCountY++
        ) {
          gpZBuffer.fill(0, +(uiCountY * 1280 * 2), sScrollXIncrement * 2 * 2);
        }

        ScrollJA2Background__StripRegions[0].right =
          gsVIEWPORT_START_X + sScrollXIncrement;
      ...
      case SCROLL_RIGHT:
        ...
        for (
          ...
          gpZBuffer.fill(
            0,
            uiCountY * 1280 * 2 +
              (gsVIEWPORT_END_X - sScrollXIncrement) * 2 * 2,
            sScrollXIncrement * 2 * 2,
          );
        }
        ...
        ScrollJA2Background__StripRegions[0].left =
          gsVIEWPORT_END_X - sScrollXIncrement;
        ScrollJA2Background__usMouseXPos -= sScrollXIncrement;
      ...
      case SCROLL_UP:
        ...
        ScrollJA2Background__Region.right = usWidth;
        ScrollJA2Background__Region.bottom =
          gsVIEWPORT_WINDOW_START_Y + usHeight - sScrollYIncrement;
        ...
        for (
          uiCountY = sScrollYIncrement - 1 + gsVIEWPORT_WINDOW_START_Y;
          uiCountY >= gsVIEWPORT_WINDOW_START_Y;
          uiCountY--
        ) {
        ...
        //					uiDestPitchBYTES);
        //}
        ScrollJA2Background__StripRegions[0].bottom =
          gsVIEWPORT_WINDOW_START_Y + sScrollYIncrement;
        usNumStrips = 1;
      ...
      case SCROLL_DOWN:
        ScrollJA2Background__Region.left = 0;
        ScrollJA2Background__Region.top =
          gsVIEWPORT_WINDOW_START_Y + sScrollYIncrement;
        ScrollJA2Background__Region.right = usWidth;
        ScrollJA2Background__Region.bottom =
          gsVIEWPORT_WINDOW_START_Y + usHeight;
        ...
        // Zero out z
        for (
          uiCountY = gsVIEWPORT_WINDOW_END_Y - sScrollYIncrement;
          uiCountY < gsVIEWPORT_WINDOW_END_Y;
          uiCountY++
        ) {
          gpZBuffer.fill(0, uiCountY * 1280 * 2, 1280 * 2);
        ...
        ScrollJA2Background__StripRegions[0].top =
          gsVIEWPORT_WINDOW_END_Y - sScrollYIncrement;
        usNumStrips = 1;
      ...
      case SCROLL_UPLEFT:
        ...
        for (
          uiCountY = gsVIEWPORT_WINDOW_START_Y + sScrollYIncrement - 1;
          uiCountY >= gsVIEWPORT_WINDOW_START_Y;
          uiCountY--
        ) {
          gpZBuffer.fill(0, uiCountY * 1280 * 2, 1280 * 2);
        ...
        ScrollJA2Background__StripRegions[0].right =
          gsVIEWPORT_START_X + sScrollXIncrement;
        ScrollJA2Background__StripRegions[1].bottom =
          gsVIEWPORT_WINDOW_START_Y + sScrollYIncrement;
        ScrollJA2Background__StripRegions[1].left =
          gsVIEWPORT_START_X + sScrollXIncrement;
        usNumStrips = 2;
      ...
      case SCROLL_UPRIGHT:
        ...
        ScrollJA2Background__StripRegions[1].bottom =
          gsVIEWPORT_WINDOW_START_Y + sScrollYIncrement;
        ScrollJA2Background__StripRegions[1].right =
          gsVIEWPORT_END_X - sScrollXIncrement;
        usNumStrips = 2;
      ...
      case SCROLL_DOWNLEFT:
        ...
        ScrollJA2Background__StripRegions[1].top =
          gsVIEWPORT_WINDOW_END_Y - sScrollYIncrement;
        ScrollJA2Background__StripRegions[1].left =
          gsVIEWPORT_START_X + sScrollXIncrement;
        usNumStrips = 2;
    ...
    if (fRenderStrip) {
      ...
      for (cnt = 0; cnt < usNumStrips; cnt++) {
        RenderStaticWorldRect(
          ScrollJA2Background__StripRegions[cnt].left,
          ScrollJA2Background__StripRegions[cnt].top,
          ScrollJA2Background__StripRegions[cnt].right,
          ScrollJA2Background__StripRegions[cnt].bottom,
          true,
        );
        ...
        BltFastDDSurfaceUsingSoftware(
          ...
          ScrollJA2Background__StripRegions[cnt].top,
          gpFrameBuffer,
          ScrollJA2Background__StripRegions[cnt],
          DDBLTFAST_NOCOLORKEY,
        );
      }
  ...
  export function RefreshScreen(): void {
    ...
    if (gMouseCursorBackground[CURRENT_MOUSE_DATA].fRestore == true) {
      ...
      BltFastDDSurfaceUsingSoftware(
        ...
        gMouseCursorBackground[CURRENT_MOUSE_DATA].pSurface,
        RefreshScreen__Region,
        DDBLTFAST_NOCOLORKEY,
      );

      // Save position into other background region
      copyMouseCursorBackground(
        gMouseCursorBackground[PREVIOUS_MOUSE_DATA],
    ...
    if (guiFrameBufferState == BUFFER_DIRTY) {
      ...
      //
        ...
        if (gfForceFullScreenRefresh == true) {
          ...
          for (
            RefreshScreen__uiIndex = 0;
            RefreshScreen__uiIndex < guiDirtyRegionCount;
            RefreshScreen__uiIndex++
          ) {
            RefreshScreen__Region.left =
              gListOfDirtyRegions[RefreshScreen__uiIndex].iLeft;
            RefreshScreen__Region.top =
              gListOfDirtyRegions[RefreshScreen__uiIndex].iTop;
            RefreshScreen__Region.right =
              gListOfDirtyRegions[RefreshScreen__uiIndex].iRight;
            RefreshScreen__Region.bottom =
              gListOfDirtyRegions[RefreshScreen__uiIndex].iBottom;
          ...
          for (
            RefreshScreen__uiIndex = 0;
            RefreshScreen__uiIndex < guiDirtyRegionExCount;
            RefreshScreen__uiIndex++
          ) {
            RefreshScreen__Region.left =
              gDirtyRegionsEx[RefreshScreen__uiIndex].iLeft;
            RefreshScreen__Region.top =
              gDirtyRegionsEx[RefreshScreen__uiIndex].iTop;
            RefreshScreen__Region.right =
              gDirtyRegionsEx[RefreshScreen__uiIndex].iRight;
            RefreshScreen__Region.bottom =
              gDirtyRegionsEx[RefreshScreen__uiIndex].iBottom;

            // Do some checks if we are in the process of scrolling!
            if (gfRenderScroll) {
              // Check if we are completely out of bounds
              if (
                RefreshScreen__Region.top <= gsVIEWPORT_WINDOW_END_Y &&
                RefreshScreen__Region.bottom <= gsVIEWPORT_WINDOW_END_Y
              ) {
                continue;
              }
            }
    ...
    if (RefreshScreen__fShowMouse == true) {
      ...
      RefreshScreen__Region.left =
        RefreshScreen__MousePos.x - gsMouseCursorXOffset;
      RefreshScreen__Region.top =
        RefreshScreen__MousePos.y - gsMouseCursorYOffset;
      RefreshScreen__Region.right =
        RefreshScreen__Region.left + gusMouseCursorWidth;
      RefreshScreen__Region.bottom =
        RefreshScreen__Region.top + gusMouseCursorHeight;
      ...
      if (
        RefreshScreen__Region.right > RefreshScreen__Region.left &&
        RefreshScreen__Region.bottom > RefreshScreen__Region.top
      ) {
        //
        ...
        if (
          ...
          // Save clipped region
          copyRect(
            gMouseCursorBackground[CURRENT_MOUSE_DATA].Region,
            RefreshScreen__Region,
          );
    ...
    if (gMouseCursorBackground[PREVIOUS_MOUSE_DATA].fRestore == true) {
      copyRect(
        RefreshScreen__Region,
        gMouseCursorBackground[PREVIOUS_MOUSE_DATA].Region,
      );
  ...
  export function LockPrimarySurface(
    uiPitch: Pointer<UINT32>,
  ): Uint8ClampedArray {
  ...
  function GetRGBDistribution(): boolean {
    ...
    if (gusRedMask == 0x7c00 && gusGreenMask == 0x03e0 && gusBlueMask == 0x1f)
      guiTranslucentMask = 0x3def; // if((gusRedMask==0xf800) && (gusGreenMask==0x03e0) && (gusBlueMask==0x1f))
    // RGB 5,6,5
    else guiTranslucentMask = 0x7bef;
  ...
  export function GetPrimaryRGBDistributionMasks(): {
    usRedMask: UINT16;
    usGreenMask: UINT16;
    usBlueMask: UINT16;
  } {
  ...
  export function SetMouseCursorProperties(
    sOffsetX: INT16,
    sOffsetY: INT16,
    usCursorHeight: UINT16,
    usCursorWidth: UINT16,
  ): boolean {
  ...
  export function SetCurrentCursor(
    ...
    if (
      ...
      DebugMsg(
        ...
        DBG_LEVEL_0,
        FormatString(
          "Mouse Create with [ %d. %d ] [ %d, %d]",
          pETRLEPointer.sOffsetX,
          pETRLEPointer.sOffsetY,
          pETRLEPointer.usWidth,
          pETRLEPointer.usHeight,
        ),
      );
      DebugMsg(
        TOPIC_VIDEO,
  ...
  function BltFastDDSurfaceUsingSoftware(
    pDestSurface: ImageData,
    uiX: INT32,
    uiY: INT32,
    pSrcSurface: ImageData,
    pSrcRect: RECT,
    uiTrans: UINT32,
  ): boolean {
