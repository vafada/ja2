namespace ja2 {
  ...
  let FontObjs: SGPVObject[] /* [MAX_FONTS] */ = createArray(
    MAX_FONTS,
  ...
  //
  //*****************************************************************************
  function SetFontObjectPalette8BPP(
    iFont: INT32,
    pPal8: SGPPaletteEntry[],
  ): Uint16Array {
  ...
  //
  //*****************************************************************************
  function SetFontObjectPalette16BPP(
    iFont: INT32,
    pPal16: Uint16Array,
  ): Uint16Array {
    Assert(iFont >= 0);
  ...
  export function LoadFontFile(filename: string /* Pointer<UINT8> */): INT32 {
    ...
    if ((LoadIndex = FindFreeFont()) == -1) {
      DbgMessage(
        TOPIC_FONT_HANDLER,
        DBG_LEVEL_0,
        FormatString("Out of font slots (%s)", filename),
      );
    ...
    if ((FontObjs[LoadIndex] = CreateVideoObject(vo_desc)) == null) {
      DbgMessage(
        TOPIC_FONT_HANDLER,
        DBG_LEVEL_0,
        FormatString("Error creating VOBJECT (%s)", filename),
      );
      FatalError("Cannot init FONT file %s", filename);
      return -1;
    }
  ...
  //*****************************************************************************
  export function StringPixLengthArg(
    usUseFont: INT32,
    uiCharCount: UINT32,
  ...
  //*****************************************************************************
  export function StringPixLengthArgFastHelp(
    usUseFont: INT32,
    usBoldFont: INT32,
    uiCharCount: UINT32,
    pFontString: string /* Pointer<UINT16> */,
    ...
    while (i < uiCharCount) {
      if (string[i] == "|") {
        ...
        str = string[i];
        sBoldDiff +=
          StringPixLength(str, usBoldFont) - StringPixLength(str, usUseFont);
      }
      i++;
    }
  ...
  //
  //*****************************************************************************
  export function StringPixLength(
    string: string /* Pointer<UINT16> */,
    UseFont: INT32,
  ): INT16 {
    let Cur: UINT32;
  ...
  export function GetIndex(siChar: UINT16): INT16 {
    ...
    let usNumberOfSymbols: UINT16 =
      pFManager.pTranslationTable.usNumberOfSymbols;
    ...
    DbgMessage(
      TOPIC_FONT_HANDLER,
      DBG_LEVEL_0,
      FormatString("Error: Invalid character given %d", siChar),
    );
  ...
  //
  //*****************************************************************************
  export function SetFontDestBuffer(
    DestBuffer: UINT32,
    x1: INT32,
    y1: INT32,
    x2: INT32,
  ...
  export function VarFindFontRightCoordinates(
    sLeft: INT16,
    sTop: INT16,
    sWidth: INT16,
    sHeight: INT16,
    ...
    return FindFontRightCoordinates(
      sLeft,
      sTop,
      sWidth,
      sHeight,
  ...
  export function VarFindFontCenterCoordinates(
    sLeft: INT16,
    sTop: INT16,
    sWidth: INT16,
    sHeight: INT16,
    ...
    return FindFontCenterCoordinates(
      sLeft,
      sTop,
      sWidth,
      sHeight,
  ...
  export function FindFontRightCoordinates(
    sLeft: INT16,
    sTop: INT16,
    sWidth: INT16,
    sHeight: INT16,
    pStr: string /* Pointer<UINT16> */,
    iFontIndex: INT32,
  ): { sX: INT16; sY: INT16 } {
    let xp: INT16;
    let yp: INT16;
  ...
  export function FindFontCenterCoordinates(
    sLeft: INT16,
    sTop: INT16,
    sWidth: INT16,
    sHeight: INT16,
    ...
    xp =
      Math.trunc((sWidth - StringPixLength(pStr, iFontIndex) + 1) / 2) + sLeft;
    yp = Math.trunc((sHeight - GetFontHeight(iFontIndex)) / 2) + sTop;
  ...
  // than 512 word-characters.
  //*****************************************************************************
  function gprintf_buffer(
    pDestBuf: Uint8ClampedArray,
  ...
  export function mprintf_buffer(
    pDestBuf: Uint8ClampedArray,
    uiDestPitchBYTES: UINT32,
    FontType: UINT32,
    x: INT32,
  ...
  export function mprintf_buffer_coded(
    pDestBuf: Uint8ClampedArray,
    uiDestPitchBYTES: UINT32,
    FontType: UINT32,
    x: INT32,
  ...
  export function InitializeFontManager(
    usDefaultPixelDepth: UINT16,
    pTransTable: FontTranslationTable,
  ): boolean {
    ...
    if (pFManager) {
      if (pFManager.pTranslationTable != null) {
        if (pFManager.pTranslationTable.DynamicArrayOf16BitValues != null) {
          pFManager.pTranslationTable.DynamicArrayOf16BitValues = <Uint16Array>(
            (<unknown>null)
          );
        }
  ...
  export function CreateEnglishTransTable(): FontTranslationTable {
    ...
    pTable.DynamicArrayOf16BitValues = new Uint16Array(
      pTable.usNumberOfSymbols,
    );
    temp = 0;
