namespace ja2 {
  ...
  export function readPcxHeader(
    ...
    o.usLeft = buffer.readUInt16LE(offset);
    offset += 2;
    o.usTop = buffer.readUInt16LE(offset);
    offset += 2;
    o.usRight = buffer.readUInt16LE(offset);
    offset += 2;
    o.usBottom = buffer.readUInt16LE(offset);
    offset += 2;
    o.usHorRez = buffer.readUInt16LE(offset);
    offset += 2;
    o.usVerRez = buffer.readUInt16LE(offset);
    offset += 2;
    ...
    o.usBytesPerLine = buffer.readUInt16LE(offset);
    offset += 2;
    o.usPaletteType = buffer.readUInt16LE(offset);
    offset += 2;
